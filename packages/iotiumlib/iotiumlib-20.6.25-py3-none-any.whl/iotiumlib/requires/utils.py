    ...
    if resp and method=="iNode":
        ...
        for networks in resp:
            ...
            formatted_output.append({"NetworkName": networks['name'],
                                     ...
                                     networks['id']:"{}/{}".format(networks['node']['name'], networks['name']),
                                     "NodeName": networks['node']['name'],
                                     "NetworkNodeName": networks['node']['name'],
                                     "NodeId": networks['node']['id'],
        ...
        for result in resp:
            ...
            op.update({'ServiceName': result['name'],
                       ...
                       'ServiceStatus': result['status']['status'],
                       'Organization': result['organization']['name'],
                       'ServiceIp': '-',
                       'TotalContainers': '-',
                       'Message':'-'
