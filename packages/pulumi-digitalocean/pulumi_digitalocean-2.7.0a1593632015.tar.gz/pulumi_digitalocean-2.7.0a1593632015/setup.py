...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.7.0-alpha.1593632015+d5ac92c2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.7.0-alpha.1593632015+d5ac92c2`
                """)
            else:
                raise
