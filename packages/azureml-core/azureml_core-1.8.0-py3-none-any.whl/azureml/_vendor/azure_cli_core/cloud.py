...
def _arm_to_cli_mapper(arm_dict):
    return Cloud(
        ...
        endpoints=CloudEndpoints(
            ...
            media_resource_id=arm_dict['media']  if 'media' in arm_dict['suffixes'] else None,
        ...
        suffixes=CloudSuffixes(
            ...
            sql_server_hostname=arm_dict['suffixes']['sqlServerHostname'] if 'sqlServerHostname' in arm_dict['suffixes'] else None,
