...
from ..models import ErrorResponse, RootError, DebugInfoResponse, InnerErrorResponse
...
def create_error_event(run_id, error_dict):
    ...
    root_error = RootError(
        ...
        reference_code=error_dict.get("reference_code"), inner_error=inner_error, debug_info=debug_info,
