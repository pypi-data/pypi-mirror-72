...
class Workspace(object):
    ...
    * `Azure Machine Learning
    ...
    :param sku: The workspace SKU, which can be "basic" or "enterprise". For more information see `Azure Machine
    ...
    def __init__(
        ...
        :param _workspace_id: Internal use only.
        :type _workspace_id: str
        :param sku: The workspace SKU. For example - basic or enterprise.
        :type sku: str
        """
        if not auth:
    ...
    def create(name, auth=None, subscription_id=None, resource_group=None,
               location=None, create_resource_group=True, sku='basic',
        ...
        :param sku: The SKU name, which can be "basic" or "enterprise" (also referred as edition).
            The parameter defaults to "basic" if not specified.
        ...
        :param hbi_workspace: Specifies whether the workspace contains data of High Business Impact (HBI), i.e.,
            contains sensitive business information. The default value is False.
        ...
        :param exist_ok: Indicates whether this method succeeds if the workspace already exists. If False,
            this method fails if the workspace exists.
        :type exist_ok: bool
    ...
    def get_mlflow_tracking_uri(self, _with_auth=True):
        ...
        try:
            ...
            return get_mlflow_tracking_uri(self, with_auth=_with_auth)
    ...
    def _get_or_create(
        ...
        :param hbi_workspace: Specifies whether the customer data is of High Business Impact(HBI), i.e., contains
            ...
            will selectively disable logging.
        :type hbi_workspace: bool
        :param default_cpu_compute_target: (DEPRECATED) A configuration that will be used to create a CPU compute.
            The parameter defaults to {min_nodes=0, max_nodes=2, vm_size="STANDARD_DS2_V2", vm_priority="dedicated"}
            If None, no compute will be created.
    ...
    def _create_legacy(
        ...
        :param create_resource_group: Flag to create resource group or not.
        :type create_resource_group: bool
        :param sku: The SKU name, which can be "basic" or "enterprise".
        :type sku: str
        :param friendly_name: The friendly name of the workspace.
        :type friendly_name: str
        :param storage_account: The storage account to use for this workspace.
    ...
    def update(self, friendly_name=None, description=None,
        ...
        """Update friendly name, description, tags, or image build compute associated with a workspace.
