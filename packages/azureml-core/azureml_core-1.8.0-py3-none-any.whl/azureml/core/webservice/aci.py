...
class AciWebservice(Webservice):
    ...
    @staticmethod
    def _deploy(workspace, name, image, deployment_config, overwrite):
    ...
    @staticmethod
    def _build_create_payload(name, image, deploy_config, overwrite):
...
class AciServiceDeploymentConfiguration(WebserviceDeploymentConfiguration):
    ...
    def validate_configuration(self):
        ...
        if not ((self.cmk_vault_base_url and self.cmk_key_name and self.cmk_key_version) or
                (not self.cmk_vault_base_url and not self.cmk_key_name and not self.cmk_key_version)):
