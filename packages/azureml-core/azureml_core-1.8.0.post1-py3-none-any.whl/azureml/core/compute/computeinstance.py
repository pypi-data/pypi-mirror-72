...
class ComputeInstance(ComputeTarget):
    ...
    def _update_instance_state(self, state, wait_for_completion=False, show_output=False):
        ...
        rasie_error = current_state == "createfailed" or \
            ...
            (current_state == "running" and state == "start")
    ...
    def _wait_for_status_update(self, operation, refresh_interval=5, show_output=False):
        ...
        prev_state = None
        current_state = None
        expected_state = "Stopped" if operation is "stop" else "Running"
        ...
        if show_output:
            ...
            if current_state.endswith(expected_state):
                print("{operation} operation completed successfully.".format(operation=operation.capitalize()))
        ...
        while True:
            ...
            if show_output:
                ...
                if current_state == deleted_state:
                    print('Compute instance has successfully deleted.')
                sys.stdout.flush()
