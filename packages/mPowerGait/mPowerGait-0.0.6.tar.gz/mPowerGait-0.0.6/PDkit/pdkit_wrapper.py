...
About: Featurization Pipeline Class on Gait Signal Data based on
userAcceleration, and rotation rate (gyroscope)
"""
...
class GaitFeaturize:
    ...
    def format_time_series_data(self, data):
        ...
        Return Dataframe Columns:
            timestamp (dtype: DatetimeIndex) : An index of time in seconds
