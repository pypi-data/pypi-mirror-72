...
if sys.platform != "win32":
  ...
  if os.path.isfile("/usr/include/soundio/soundio.h"):
    have_soundio = True
...
if have_soundio:
	libraries.append('soundio')
	sources.append('sound_io.c')
else:
	define_macros.append(("QUISK_NO_SOUNDIO", None))
...
modulew1 = Extension ('quisk._quisk',
	include_dirs = ['../fftw3', '../soundio-1.1.0'],
