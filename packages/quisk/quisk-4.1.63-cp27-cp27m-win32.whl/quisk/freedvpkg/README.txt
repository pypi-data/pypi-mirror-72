...
The new FreeDV mode 2020 requires an additional shared library liblpcnetfreedv. To use mode 2020 you
need to install this library to the correct system directory yourself. If you work with FreeDV you
should probably install your own codec2 so you always have the most recent version.
...
The new mode 2020 has special requirements not covered below. See the codec2 docs.
