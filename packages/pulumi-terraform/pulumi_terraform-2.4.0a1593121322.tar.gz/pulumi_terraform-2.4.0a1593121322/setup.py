...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v2.4.0-alpha.1593121322+g29bc629'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v2.4.0-alpha.1593121322+g29bc629`
                """)
