...
disC = discountCurve(alias_disC, referenceDate, dayCount,
                     compounding, allowExtrapolation)
disC.values = dF
...
volCube = volatilityCube([1, 2, 3], [0.02, 0.03, 0.04], [
                         1, 2], np.arange(10, 28) * 0.01)

# set swap
strike = 0.03  # near money option due to interpolation methodolgy
vanillaS = vanillaSwap(startDate, 'payer', s, fS, forwardC, disC)# swap rate is 0.029781
