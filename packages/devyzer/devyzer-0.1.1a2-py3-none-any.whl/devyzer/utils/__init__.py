...
from devyzer.utils.cli import print_with_color, bcolors
...
def get_current_folder_name():
    return get_folder_name(os.getcwd())


def print_devyzer():
    banner = '''
    ____  _______    ___  _______   __________
   / __ \/ ____| |  / \ \/ /__  /  / ____/ __ \\
  / / / / __/  | | / / \  /  / /  / __/ / /_/ /
 / /_/ / /___  | |/ /  / /  / /__/ /___/ _, _/
/_____/_____/  |___/  /_/  /____/_____/_/ |_|

    '''
    print_with_color(banner, bcolors.HEADER)
