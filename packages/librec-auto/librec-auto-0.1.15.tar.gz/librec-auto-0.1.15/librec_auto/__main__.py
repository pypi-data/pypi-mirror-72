...
from librec_auto.cmd import Cmd, SequenceCmd, PurgeCmd, LibrecCmd, PostCmd, RerankCmd, StatusCmd, ParallelCmd, InstallCmd
import logging
...
def setup_commands (args, config):
    ...
    if action == 'install':
        # cmd1 = PurgeCmd(purge_type(args), noask=purge_noask)
        # cmd = InstallCmd([cmd1])
        print("5")
        cmd = InstallCmd()
        print("6")
