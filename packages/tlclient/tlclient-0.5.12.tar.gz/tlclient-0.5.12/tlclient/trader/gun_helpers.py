...
from tlclient.linker.constant import MASTER_FIST_NAME, FistType, MsgType
...
class EnvHelper(object):
    ...
    def register_env_info(env_info):
        from linker.frame import Frame
        f = Frame()
        f.set_msg_type(MsgType.ENV_INFO_UPDATE)
...
class GunInspector(object):
    ...
    def update_status(self):
        f = Frame()
        f.set_msg_type(MsgType.GET_FULL_STATUS)
        f.set_data('')
