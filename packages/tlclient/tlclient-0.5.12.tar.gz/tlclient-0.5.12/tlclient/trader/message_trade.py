...
class OrderBasic(ctypes.Structure):
    ...
    def to_dict(self):
        return {
            ...
            'ticker': self.ticker.decode(errors='ignore'),
            'source': self.source.decode(errors='ignore'),
            'price': self.price,
            'volume': self.volume,
...
class ReqOrderInsert(OrderBasic):
    ...
    def to_dict(self):
        return dict(OrderBasic.to_dict(self), **{
            'tg_name': self.tg_name.decode(errors='ignore'),
            'parent_id': self.parent_id,
            'order_id': self.order_id,
            'order_ref': self.order_ref.decode(errors='ignore'),
            'client_name': self.client_name.decode(errors='ignore'),
        })
...
class RspOrderInsert(ctypes.Structure):
    ...
    def to_dict(self):
        return {
            ...
            'order_ref': self.order_ref.decode(errors='ignore'),
            'err_id': self.err_id,
            'err_msg': self.err_msg.decode(errors='ignore'),
        }
...
class RtnTrade(ctypes.Structure):
    ...
    def to_dict(self):
        return {
            ...
            'direction': Direction.read(self.direction),
            'offset_flag': OffsetFlag.read(self.offset_flag),
            'trade_id': self.trade_id.decode(errors='ignore'),
            'trade_time': self.trade_time,
            'trading_day': self.trading_day.decode(errors='ignore'),
            'order_id': self.order_id,
            'order_ref': self.order_ref.decode(errors='ignore'),
        }
...
class RspOrderInfo(ReqOrderInsert):
    ...
    def to_dict(self):
        return dict(ReqOrderInsert.to_dict(self), **{
            ...
            'cancel_err_msg': self.cancel_err_msg.decode(errors='ignore'),
            'order_status': self.order_status,
            'volume_traded': self.volume_traded,
        })
