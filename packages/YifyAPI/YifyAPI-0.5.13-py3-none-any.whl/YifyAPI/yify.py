	...
	try:
		for movie in response['data']:
			...
			entry = {
				...
				"trailer": ["N/A" if "https://www.youtube.com/watch?v=" + html.find('a', id='playTrailer')['href'].split('?')[0].split('/')[-1].strip() == "https://www.youtube.com/watch?v=" else "https://www.youtube.com/watch?v=" + soup.find('a', id='playTrailer')['href'].split('?')[0].split('/')[-1].strip()][0],
