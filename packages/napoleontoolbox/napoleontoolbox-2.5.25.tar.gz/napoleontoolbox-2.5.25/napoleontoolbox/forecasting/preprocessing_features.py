...
def drop_most_correlated_features(X,threshold):
    ...
    X=X.drop(output_correlations_df.loc[output_correlations_df['abs_correlation'] > threshold]['daily_feature_2'].unique(),axis=1)
    return X
