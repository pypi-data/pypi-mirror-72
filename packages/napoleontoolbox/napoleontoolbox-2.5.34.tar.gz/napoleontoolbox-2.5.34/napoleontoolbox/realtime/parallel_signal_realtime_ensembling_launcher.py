...
class RealTimeSignalEnsemblingParalleLauncher():
    ...
    def minutely_apply_standard_mean_two_states_discretization_last_signal(self, method='find_best_three_states_discretization_lo'):
    ...
    def minutely_apply_standard_mean_discretization(self, signals_df=None, s=21, method ='find_best_two_states_discretization'):
