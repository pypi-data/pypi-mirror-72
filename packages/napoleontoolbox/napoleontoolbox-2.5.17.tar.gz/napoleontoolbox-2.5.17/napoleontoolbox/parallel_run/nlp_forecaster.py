...
class AbstractRunner(ABC):
    def __init__(self, starting_date = None, running_date = None, drop_token=None, dropbox_backup = True, underlying=None, frequence = None, target='target', stationarize_ohlc=False, apply_zscore=False, skipping_point=5, sentiment_grouping=False, add_bbbands=False, add_rsi_indicator=False, local_root_directory='../data/', user = 'napoleon',number_per_year=252, use_light=False, starting_iterations_to_pass=0):
        ...
        self.predictors_file_name = 'features_'+str(self.apply_zscore)+str(self.sentiment_grouping)+str(self.add_bbbands)+str(self.add_rsi_indicator)+str(self.stationarize_ohlc)+'_set.pkl'
