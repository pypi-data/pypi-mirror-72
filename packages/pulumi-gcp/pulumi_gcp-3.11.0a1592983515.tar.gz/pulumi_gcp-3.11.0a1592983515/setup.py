...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.11.0-alpha.1592983515+a444a7e3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.11.0-alpha.1592983515+a444a7e3`
                """)
            else:
                raise
