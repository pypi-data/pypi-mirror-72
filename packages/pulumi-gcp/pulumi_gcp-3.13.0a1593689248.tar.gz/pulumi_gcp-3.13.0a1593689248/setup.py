...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.13.0-alpha.1593689248+ce351a4e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.13.0-alpha.1593689248+ce351a4e`
                """)
            else:
                raise
