...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '2.5.0-alpha.1592990709+9de471bd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 2.5.0-alpha.1592990709+9de471bd`
                """)
            else:
                raise
