...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '2.5.0-alpha.1593632025+6e44566b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 2.5.0-alpha.1593632025+6e44566b`
                """)
            else:
                raise
