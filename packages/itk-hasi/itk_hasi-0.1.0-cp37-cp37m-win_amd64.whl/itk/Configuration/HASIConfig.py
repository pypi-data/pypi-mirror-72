...
templates = (
  ...
  ('LandmarkAtlasSegmentationFilter', 'itk::LandmarkAtlasSegmentationFilter', 'itkLandmarkAtlasSegmentationFilterISS3ISS3', True, 'itk::Image< signed short,3 >, itk::Image< signed short,3 >'),
  ('LandmarkAtlasSegmentationFilter', 'itk::LandmarkAtlasSegmentationFilter', 'itkLandmarkAtlasSegmentationFilterISS3IUC3', True, 'itk::Image< signed short,3 >, itk::Image< unsigned char,3 >'),
  ('LandmarkAtlasSegmentationFilter', 'itk::LandmarkAtlasSegmentationFilter', 'itkLandmarkAtlasSegmentationFilterISS3IUS3', True, 'itk::Image< signed short,3 >, itk::Image< unsigned short,3 >'),
  ('LandmarkAtlasSegmentationFilter', 'itk::LandmarkAtlasSegmentationFilter', 'itkLandmarkAtlasSegmentationFilterISS3IF3', True, 'itk::Image< signed short,3 >, itk::Image< float,3 >'),
  ('LandmarkAtlasSegmentationFilter', 'itk::LandmarkAtlasSegmentationFilter', 'itkLandmarkAtlasSegmentationFilterISS3ID3', True, 'itk::Image< signed short,3 >, itk::Image< double,3 >'),
...
snake_case_functions = ('segment_bones_in_micro_ct_filter', 'landmark_atlas_segmentation_filter', )
