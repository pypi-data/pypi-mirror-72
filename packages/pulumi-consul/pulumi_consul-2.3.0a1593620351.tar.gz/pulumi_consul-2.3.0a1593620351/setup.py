...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.3.0-alpha.1593620351+e4473d63'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.3.0-alpha.1593620351+e4473d63`
                """)
            else:
                raise
