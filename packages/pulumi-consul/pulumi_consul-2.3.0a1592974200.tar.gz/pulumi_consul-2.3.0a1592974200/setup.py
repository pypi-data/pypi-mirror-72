...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.3.0-alpha.1592974200+e48bc152'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.3.0-alpha.1592974200+e48bc152`
                """)
            else:
                raise
