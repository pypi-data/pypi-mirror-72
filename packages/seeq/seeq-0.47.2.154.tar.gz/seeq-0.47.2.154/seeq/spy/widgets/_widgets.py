...
from seeq.spy import _search, _login
from seeq.sdk import DatasourcesApi

from ._ipy_utils import WidgetLogHandler
...
class SeeqItemSelect(ipywidgets.VBox):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if datasource_dropdown:
            if _login.client and _login.client.auth_token:
    ...
    def _on_search_click(self, b):
        if _login.client is None or not hasattr(_login.client, 'auth_token') or not _login.client.auth_token:
...
class LogWindowWidget(ipywidgets.VBox):
    def __init__(self, title):
        ...
        self.level_select = ipywidgets.Dropdown(
            ...
            layout=ipywidgets.Layout(width='auto', margin='0px 0px 0px 10px'),
            style={'description_width': 'initial'}
        )
        ...
        super().__init__(
            children=[_title_box, self.message_window]
        )
