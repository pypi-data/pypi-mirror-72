...
class ModelProperty(Model):
    ...
    def __init__(self, id: str=None, address: str=None, postal_code: str=None, community: str=None, properly_city_code: str=None, zone: str=None, yr_built: int=None, living_space_square_footage_ag: int=None, lot_size: float=None, lot_depth: float=None, lot_frontage: float=None, land_use_code: str=None, assessed_value: float=None, tax_amount: float=None, building_type: str=None, style: str=None, basement_development: str=None, basement_percent_development: float=None, basement: List[str]=None, bedrooms_total: float=None, bedrooms_ag: float=None, bedrooms_with_closet: float=None, master_walk_in: bool=None, master_ensuite: bool=None, bathrooms_total: float=None, bathrooms_full: float=None, bathrooms_half: float=None, bathrooms_main: float=None, bathrooms_basement: float=None, room_number: float=None, kitchen_countertops: List[str]=None, kitchen_island: bool=None, kitchen_appliances: List[str]=None, kitchen_layout: str=None, flooring: List[str]=None, fireplace: List[str]=None, heating_type: List[str]=None, backyard_details: str=None, exterior: List[str]=None, parking: List[str]=None, total_parking: float=None, enclosed_parking: float=None, roof_type: str=None, roof_age_years: int=None, is_renovated: bool=None, renovations_or_upgrades: str=None, property_photos_user_submitted: str=None, latitude: float=None, longitude: float=None, google_place_id: str=None, geo_hash5: str=None, geo_hash12: str=None, custom_annotations: List[CustomAnnotation]=None, images: List[Image]=None, rooms: List[List[str]]=None, property_rooms: List[Room]=None, tax_assessment_roll_number: str=None, assessed_year: int=None, air_conditioning: str=None, approx_sqft: str=None, elevator: bool=None, direction_faces: str=None, basement_ensuite: bool=None, unit_number: str=None, mls_id: str=None, share_percentage: str=None, patio_and_porch_features: str=None, association_amenities: List[str]=None, condo_corp_number: str=None, condo_corp: str=None, laundry_features: List[str]=None, association_fee: float=None, parking_fee: float=None, parking_included: bool=None, pets_allowed: List[str]=None):  # noqa: E501
        ...
        :param mls_id: The mls_id of this ModelProperty.  # noqa: E501
        :type mls_id: str
    ...
    def parking(self, parking: List[str]):
        ...
        :type parking: List[str]
        """
        allowed_values = ["Attached", "Carport", "Detached", "Driveway", "Parking Pad", "Rear Drive Access", "RV Parking", "Outdoor Stalls", "220 Volt Wiring", "Street Parking", "Built-In", "None"]  # noqa: E501
    ...
    def direction_faces(self, direction_faces: str):
        ...
        :type direction_faces: str
        """
        allowed_values = ["N", "S", "E", "W", "NW", "NE", "SW", "SE"]  # noqa: E501
    ...
    @property
    def mls_id(self) -> str:
        """Gets the mls_id of this ModelProperty.

        ID reference to a MLS system  # noqa: E501

        :return: The mls_id of this ModelProperty.
        :rtype: str
        """
        return self._mls_id
    ...
    def mls_id(self, mls_id: str):
        """Sets the mls_id of this ModelProperty.

        ID reference to a MLS system  # noqa: E501

        :param mls_id: The mls_id of this ModelProperty.
        :type mls_id: str
        """
    ...
    @property
    def pets_allowed(self) -> List[str]:
    ...
    @pets_allowed.setter
    def pets_allowed(self, pets_allowed: List[str]):
