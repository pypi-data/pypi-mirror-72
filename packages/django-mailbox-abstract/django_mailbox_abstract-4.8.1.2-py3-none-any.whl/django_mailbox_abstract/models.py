...
from django_mailbox_abstract.signals import message_received
from django_mailbox_abstract.transports import Pop3Transport, ImapTransport, \
...
class Message(models.Model):
    ...
    in_reply_to = models.ForeignKey(
        'django_mailbox_abstract.Message',
