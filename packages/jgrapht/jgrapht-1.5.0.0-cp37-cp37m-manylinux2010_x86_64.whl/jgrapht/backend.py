...
def jgrapht_isolate_create():
    return _backend.jgrapht_isolate_create()

def jgrapht_isolate_destroy():
    return _backend.jgrapht_isolate_destroy()

def jgrapht_isolate_is_attached():
    return _backend.jgrapht_isolate_is_attached()
