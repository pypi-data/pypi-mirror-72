...
_DOMAINKEYRESPONSE = _descriptor.Descriptor(
  name='DomainKeyResponse',
  full_name='spaceone.api.identity.v1.DomainKeyResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='domain_id', full_name='spaceone.api.identity.v1.DomainKeyResponse.domain_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='domain_key', full_name='spaceone.api.identity.v1.DomainKeyResponse.domain_key', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['DomainKeyResponse'] = _DOMAINKEYRESPONSE
...
DomainKeyResponse = _reflection.GeneratedProtocolMessageType('DomainKeyResponse', (_message.Message,), {
  'DESCRIPTOR' : _DOMAINKEYRESPONSE,
  '__module__' : 'spaceone.api.identity.v1.domain_pb2'
  # @@protoc_insertion_point(class_scope:spaceone.api.identity.v1.DomainKeyResponse)
  })
_sym_db.RegisterMessage(DomainKeyResponse)
...
_DOMAIN = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='get_domain_key',
    full_name='spaceone.api.identity.v1.Domain.get_domain_key',
    index=9,
    containing_service=None,
    input_type=spaceone_dot_api_dot_core_dot_v1_dot_handler__pb2._AUTHENTICATIONREQUEST,
    output_type=_DOMAINKEYRESPONSE,
    serialized_options=None,
  ),
])
