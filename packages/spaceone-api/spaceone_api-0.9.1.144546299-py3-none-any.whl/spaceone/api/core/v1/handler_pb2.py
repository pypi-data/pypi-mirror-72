...
_AUTHORIZATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='api_class', full_name='spaceone.api.core.v1.AuthorizationRequest.api_class', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method', full_name='spaceone.api.core.v1.AuthorizationRequest.method', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parameter', full_name='spaceone.api.core.v1.AuthorizationRequest.parameter', index=3,
...
_AUTHORIZATIONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='changed_parameter', full_name='spaceone.api.core.v1.AuthorizationResponse.changed_parameter', index=1,
...
_EVENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='api_class', full_name='spaceone.api.core.v1.EventRequest.api_class', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='method', full_name='spaceone.api.core.v1.EventRequest.method', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='event_type', full_name='spaceone.api.core.v1.EventRequest.event_type', index=3,
...
_AUTHORIZATIONREQUEST.fields_by_name['parameter'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_AUTHORIZATIONRESPONSE.fields_by_name['changed_parameter'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
