...
class CollectorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.verify_plugin = channel.unary_unary(
                ...
                response_deserializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.VerifyInfo.FromString,
                )
...
def add_CollectorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'verify_plugin': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.VerifyInfo.SerializeToString,
            ),
...
class Collector(object):
    ...
    def verify_plugin(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.inventory.v1.Collector/verify_plugin',
            ...
            spaceone_dot_api_dot_inventory_dot_v1_dot_collector__pb2.VerifyInfo.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
