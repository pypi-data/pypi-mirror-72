...
class Region(object):
    ...
    def add_member(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.inventory.v1.Region/add_member',
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RegionMemberRequest.SerializeToString,
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RegionMemberInfo.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def modify_member(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.inventory.v1.Region/modify_member',
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RegionMemberRequest.SerializeToString,
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RegionMemberInfo.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def remove_member(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.inventory.v1.Region/remove_member',
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RemoveRegionMemberRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def list_members(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.inventory.v1.Region/list_members',
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RegionMemberQuery.SerializeToString,
            spaceone_dot_api_dot_inventory_dot_v1_dot_region__pb2.RegionMembersInfo.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
