...
*MessagesApi* | [**create_message_endpoint**](agilicus_api/docs/MessagesApi.md#create_message_endpoint) | **POST** /v1/messages | Create a messaging endpoint
*MessagesApi* | [**create_user_message**](agilicus_api/docs/MessagesApi.md#create_user_message) | **POST** /v1/messages/{user_id}/send | send a message to a user on all (optionally of a type) endpoints.
...
*MessagesApi* | [**list_message_endpoints**](agilicus_api/docs/MessagesApi.md#list_message_endpoints) | **GET** /v1/messages | List all message endpoints (all users)
