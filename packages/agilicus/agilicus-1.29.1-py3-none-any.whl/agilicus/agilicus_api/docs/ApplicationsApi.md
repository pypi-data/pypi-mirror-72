...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    api_instance = agilicus_api.ApplicationsApi(api_client)
    org_id = '1234' # str | Organisation Unique identifier (optional)
scopes = agilicus_api.RuleScopeEnumList() # RuleScopeEnumList | The scopes of the rules to search for. Multiple values are ORed together. (optional)
...
------------- | ------------- | ------------- | -------------
 **org_id** | **str**| Organisation Unique identifier | [optional] 
 **scopes** | [**RuleScopeEnumList**](.md)| The scopes of the rules to search for. Multiple values are ORed together. | [optional] 
