...
class Message(object):
    ...
    def __init__(self, id=None, title=None, sub_header=None, icon=None, image=None, text=None, uri=None, context=None, actions=None, type=None, local_vars_configuration=None):  # noqa: E501
