...
*MessagesApi* | [**create_message**](agilicus_api/docs/MessagesApi.md#create_message) | **POST** /v1/user_messages/{user_id}/message | Create a message (to a user)
*MessagesApi* | [**create_message_user**](agilicus_api/docs/MessagesApi.md#create_message_user) | **POST** /v1/user_messages | create a user with messaging endpoints
*MessagesApi* | [**list_message_users**](agilicus_api/docs/MessagesApi.md#list_message_users) | **GET** /v1/user_messages | List all users
*MessagesApi* | [**replace_message_user**](agilicus_api/docs/MessagesApi.md#replace_message_user) | **PUT** /v1/user_messages | update a user with messaging endpoints
...
## Documentation For Models
 ...
 - [ListMessageUsersResponse](agilicus_api/docs/ListMessageUsersResponse.md)
 ...
 - [MessageUser](agilicus_api/docs/MessageUser.md)
 - [MessageUserSpec](agilicus_api/docs/MessageUserSpec.md)
 ...
 - [RuleScope](agilicus_api/docs/RuleScope.md)
 - [RuleScopeEnum](agilicus_api/docs/RuleScopeEnum.md)
 - [RuleScopeEnumList](agilicus_api/docs/RuleScopeEnumList.md)
