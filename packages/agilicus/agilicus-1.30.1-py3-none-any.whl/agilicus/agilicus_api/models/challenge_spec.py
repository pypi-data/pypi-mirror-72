...
"""
    ...
    The version of the OpenAPI document: 2020.06.29
...
class ChallengeSpec(object):
    ...
    def __init__(self, challenge_type=None, user_id=None, send_now=False, timeout_seconds=600, response_uri=None, local_vars_configuration=None):  # noqa: E501
    ...
    def challenge_type(self):
        ...
        The type of challenge to issue. This controls how the user is informed of the challenge, as well as how the challenge can be satisfied. The follow types are supported:   - web_push: a `web_push` challenge informs the user of the challenge on every device they have     registered via the web push (rfc8030) mechanism. If the user accepts via the link provided in     the web push, the challenge will be satisfied. The user can deny the challenge via this     mechanism as well.   # noqa: E501
    ...
    def challenge_type(self, challenge_type):
        ...
        allowed_values = ["web_push"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and challenge_type not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `challenge_type` ({0}), must be one of {1}"  # noqa: E501
                .format(challenge_type, allowed_values)
            )
