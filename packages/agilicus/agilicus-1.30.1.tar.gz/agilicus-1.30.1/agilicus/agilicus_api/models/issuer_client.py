...
class IssuerClient(object):
    ...
    def __init__(self, id=None, issuer_id=None, name=None, secret=None, application=None, org_id=None, restricted_organisations=None, organisation_scope='here_only', redirects=None, local_vars_configuration=None):  # noqa: E501
