...
def file_is_valid(uploaded_file):
    ...
    if magic_type is not None:
        if file_type != magic_type:
            ...
            if file_type == 'text/csv' and magic_type == 'text/plain':
                pass
            elif file_type == 'text/csv' and magic_type == 'inode/x-empty':
                pass
            elif file_type == 'text/csv' and magic_type == 'application/vnd.ms-excel':
                pass
            else:
...
def _read_file_content(file_instance, byte_limit, convert_to_string):
    ...
    return contents.decode("utf-8") if convert_to_string else contents
