...
class DialogBox(pygame.sprite.DirtySprite):
    def __init__(self, parent):
        ...
        self.dirty = 2
        self.orig_image = pygame.image.load(cwd+'\xiaobanma\DialogBox.png')
        self.font = pygame.font.Font(cwd+'\xiaobanma\simkai.ttf', 25)
        self._text = ''
        self._parent = parent
        self.hide()
...
class TextBox(pygame.sprite.DirtySprite):
    def __init__(self, size = 20, font = './xiaobanma/simkai.ttf'):
        pygame.sprite.DirtySprite.__init__(self, global_var.ALL_SPRITES)
