...
def make_grid_search_promise(phase):
    ...
    grid_search_phase.model.one = af.PriorModel(mock.MockComponents, light=mock.EllipticalProfile)
...
class TestCase:
    ...
    def test_populate_prior_model_model(self, collection, model_promise):
        new_galaxy = af.PriorModel(mock.MockComponents, redshift=model_promise)
    ...
    def test_populate_prior_model_instance(self, collection, instance_promise):
        new_galaxy = af.PriorModel(mock.MockComponents, redshift=instance_promise)
    ...
    def test_kwarg_promise(self, profile_promise, collection):
        galaxy = af.PriorModel(mock.MockComponents, light=profile_promise)
