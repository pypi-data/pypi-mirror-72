...
def make_phase():
    ...
    phase.model.one = af.PriorModel(mock.MockComponents, light=mock.EllipticalProfile)
    return phase
...
def make_collection():
    ...
    model.one = af.PriorModel(mock.MockComponents, light=mock.EllipticalProfile)
    instance = af.ModelInstance()
    instance.one = mock.MockComponents(light=mock.EllipticalProfile())
