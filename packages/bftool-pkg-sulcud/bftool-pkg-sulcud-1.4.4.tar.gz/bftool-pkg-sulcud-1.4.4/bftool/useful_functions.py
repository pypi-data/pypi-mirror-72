...
def get_wordlist_from_path(wordlist_path: str) -> map:
    ...
    Returns:
        - map object containing all the lines of the file
    """
...
def get_wordlists_from_paths(wordlists_paths: tuple) -> iter:
    ...
    Arguments:
        - wordlists_paths: tuple filled with string of the paths of wordlists files

    Returns:
        - It yields a map object that iterates over the lines of the file
    """
...
def wordlist_divider(wordlist: tuple, step: int) -> tuple:
    ...
    Arguments:
        - wordlist: iterable
        - step: int, divide the wordlist in small wordlist of this size

    Returns:
        - yields each subwordlist created
    """
    length = len(wordlist)
    if step > length:
