...
class FundEngine:
    ...
    def __init__(self, data_manager: FundDataManager, trader, taa_params:TAAParam=None, fa_params:FAParam=None, taa_param_details:dict=None, is_old_version=True, white_list:set=None, black_list:set=None):
    ...
    def calc_trade(self, dt, cur_asset_position: AssetPosition, cur_fund_position: FundPosition=None):
        if not self.is_fund_backtest:
            ...
            v_fund_position, fund_trade_list = self._trader.calc_trade(
