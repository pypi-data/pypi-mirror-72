...
class ReportHelper:
    ...
    def backtest_fund_plot(self):
        ...
        HybridPainter.plot_market_value(self.fund_mv, bt_type, self.index_price, self.saa_weight, w)
    ...
    def update_rebalance_detail(self, dt:datetime, expired_con:bool):
        self._rebalance_details.append({'datetime':dt,'fund_ended':expired_con})
