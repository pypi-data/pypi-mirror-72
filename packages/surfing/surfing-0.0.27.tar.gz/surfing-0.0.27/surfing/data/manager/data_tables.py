...
class FundDataTables:
    ...
    def _agg_indicator(self):
        ...
        self.index_fund_indicator_pack['ir'] = self.index_fund_indicator_pack['alpha'] / self.index_fund_indicator_pack['track_err']
        self.index_list = set(self.index_fund_indicator_pack.index.levels[0])
