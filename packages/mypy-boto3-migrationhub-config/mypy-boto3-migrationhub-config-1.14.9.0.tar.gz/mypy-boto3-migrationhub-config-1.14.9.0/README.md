...
[boto3.MigrationHubConfig 1.14.9](https://boto3.amazonaws.com/v1/documentation/api/1.14.9/reference/services/migrationhub-config.html#MigrationHubConfig) service
