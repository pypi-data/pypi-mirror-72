...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '0.0.1-alpha.1593620293+1186bbf5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 0.0.1-alpha.1593620293+1186bbf5`
                """)
            else:
                raise
