...
class dispersion(Observatory):
	'''
		...
		cassini(n1, n2, zenith, reduced_height=None)
			Returns the atmospheric dispersion asusming Cassini's homegeneous
			atmosphere model
	...
	def refractionIntegral(self, n1, n2, z0, R0=None, useStandardAtmosphere=True, 
	...
	def cassiniError(self, z, l1, l2, T, p, RH, xc, dl1=0, dl2=0, dT=0.2, dP=20,
						dRH=0.02, dCO2=20, dz=0, lat=None, h=None):
		'''
