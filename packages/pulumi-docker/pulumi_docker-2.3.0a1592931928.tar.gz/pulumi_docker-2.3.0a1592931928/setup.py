...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.3.0-alpha.1592931928+d71f5748'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.3.0-alpha.1592931928+d71f5748`
                """)
            else:
                raise
