...
from sri.d3mglue.d3mwrap import D3MWrapperClassFactory, D3MWrappedOperators

# NOTE: This primitive was removed prior to summer 2020 (not exactly sure when). To get TPOT running again in autoflow
# we will probably need to add it back in
# so_wrapping_class = D3MWrapperClassFactory(StackingOperator, 'd3m.primitives.sri.tpot.StackingOperator')
so_wrapping_class = None
