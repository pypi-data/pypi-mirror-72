...
class Pinterest:
    ...
    def repin(self, pin_id: str, board_name: str, get_repinned_post_id: bool=False) -> (bool, Optional[str]):
        try:
            ...
            if board_dropdown is not None:
                ...
                if get_repinned_post_id:
                    return (self.__create_and_save_to_board(board_name), self.__get_link_to_repinned_post())
                else:
                    return (self.__create_and_save_to_board(board_name), None)
    ...
    def search_pinterest_boards(self, search_term: str, number_of_boards_to_get: int=35) -> Optional[List[(str, str)]]:
        try:
