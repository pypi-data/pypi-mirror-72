...
from .utils import (SeekableList, determine_fragment_label, format_log, get_open_output_lanes, get_params,
...
STAGE_ATTRIBUTE_ALIASES = {
    ...
    'com_streamsets_pipeline_stage_destination_snowflake_SnowflakeDTarget': {
        ...
        'snowflake_stage_name': 'external_stage_name',
    },
...
class PipelineBuilder:
    ...
    def _get_new_stage_instance(self, stage):
        ...
        if self._pipeline[self._config_key]['schemaVersion'] >= 5:
