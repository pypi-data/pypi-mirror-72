...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.2.0-alpha.1592965215+cf5f4ace'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.2.0-alpha.1592965215+cf5f4ace`
                """)
            else:
                raise
