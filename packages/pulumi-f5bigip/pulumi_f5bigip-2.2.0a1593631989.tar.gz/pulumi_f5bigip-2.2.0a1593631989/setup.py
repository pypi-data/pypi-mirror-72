...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', '2.2.0-alpha.1593631989+7a593d7f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip 2.2.0-alpha.1593631989+7a593d7f`
                """)
            else:
                raise
