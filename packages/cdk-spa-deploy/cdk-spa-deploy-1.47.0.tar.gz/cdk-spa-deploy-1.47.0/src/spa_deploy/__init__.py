...
class HostedZoneConfig():
    def __init__(self, *, index_doc: str, website_folder: str, zone_name: str, error_doc: typing.Optional[str]=None) -> None:
        """
        :param index_doc: -
...
class SPADeployConfig():
    def __init__(self, *, index_doc: str, website_folder: str, certificate_arn: typing.Optional[str]=None, cf_aliases: typing.Optional[typing.List[str]]=None, error_doc: typing.Optional[str]=None, export_website_url_name: typing.Optional[str]=None, export_website_url_output: typing.Optional[bool]=None) -> None:
        """
        :param index_doc: -
        :param website_folder: -
        :param certificate_arn: -
...
class SPAGlobalConfig():
    def __init__(self, *, encrypt_bucket: typing.Optional[bool]=None, ip_filter: typing.Optional[bool]=None, ip_list: typing.Optional[typing.List[str]]=None) -> None:
        """
        :param encrypt_bucket: -
        :param ip_filter: -
        :param ip_list: -
