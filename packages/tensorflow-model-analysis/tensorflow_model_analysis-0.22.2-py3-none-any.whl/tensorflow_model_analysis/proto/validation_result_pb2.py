...
_METRICSVALIDATIONFORSLICE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='failures', full_name='tensorflow_model_analysis.MetricsValidationForSlice.failures', index=1,
...
_VALIDATIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metric_validations_per_slice', full_name='tensorflow_model_analysis.ValidationResult.metric_validations_per_slice', index=1,
