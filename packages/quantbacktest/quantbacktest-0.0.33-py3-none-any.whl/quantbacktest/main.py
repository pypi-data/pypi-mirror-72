...
try:
    ...
    raise ImportError('Please make sure to insert the project path in configuration/__init__.py. You can access your path by typing pwd in your shell.')
