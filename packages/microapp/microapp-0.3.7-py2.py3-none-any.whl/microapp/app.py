...
class App(MicroappObject, AppArgParser, DataRegistry):
    ...
    def run(self, args, subargs, forward):
        ...
        self.logger.debug("App '%s' finished." % self._name_)
    ...
    def run_subgroup(self, group_opts=None, group_class=None, app_args=None, forward=None):
        ...
        return grp.run(group_opts, app_args, forward)
