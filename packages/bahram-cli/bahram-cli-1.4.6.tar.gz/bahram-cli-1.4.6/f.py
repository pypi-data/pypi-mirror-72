...
class ParsPaas(object):
        ...
        if r.status_code == 200:
            ...
            try:
                if x['access'] is not None:
                    init()
                    with open(user_home + '/.cloud/a4e1daa4f02f756b865ce2f9a9f9b689', 'w') as commit:
                        commit.write(x['access'])
                    result = "successfully logged in ..."
                else:
                    result = "access denied - code :  1004"
            except:
                result = "access denied - code :  1005 "
        else:
    ...
    def logout():
        ...
        if answer:
            ...
            try:
                myf = user_home + '/.cloud/a4e1daa4f02f756b865ce2f9a9f9b689'
                os.remove(myf)
