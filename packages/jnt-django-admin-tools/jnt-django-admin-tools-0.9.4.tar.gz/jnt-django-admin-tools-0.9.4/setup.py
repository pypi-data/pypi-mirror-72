...
['jnt_admin_tools',
 ...
 'jnt_admin_tools.static.admin_tools.css',
 'jnt_admin_tools.static.admin_tools.css.widgets',
 'jnt_admin_tools.static.admin_tools.js.widgets',
 'jnt_admin_tools.templates',
 'jnt_admin_tools.templates.admin_tools',
...
{'': ['*'],
 ...
 'jnt_admin_tools.menu': ['static/admin_tools/css/*',
                          'static/admin_tools/js/*',
                          'templates/admin/*',
                          'templates/admin_tools/menu/*'],
 'jnt_admin_tools.static.admin_tools.css': ['autocomplete_filter/*'],
 'jnt_admin_tools.templates.admin_tools': ['autocomplete_filter/*',
                                           'widgets/*'],
