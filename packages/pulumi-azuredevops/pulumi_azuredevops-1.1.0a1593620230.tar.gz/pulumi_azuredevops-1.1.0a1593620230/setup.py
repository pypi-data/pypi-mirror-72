...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '1.1.0-alpha.1593620230+f0dfd6ff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 1.1.0-alpha.1593620230+f0dfd6ff`
                """)
            else:
                raise
