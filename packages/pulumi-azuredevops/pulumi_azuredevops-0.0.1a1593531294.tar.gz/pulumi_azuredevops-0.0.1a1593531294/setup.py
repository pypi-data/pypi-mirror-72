...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azuredevops', '0.0.1-alpha.1593531294+07e72144'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azuredevops 0.0.1-alpha.1593531294+07e72144`
                """)
            else:
                raise
