...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '0.0.1-alpha.1593535997+ca46ee08'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 0.0.1-alpha.1593535997+ca46ee08`
                """)
            else:
                raise
