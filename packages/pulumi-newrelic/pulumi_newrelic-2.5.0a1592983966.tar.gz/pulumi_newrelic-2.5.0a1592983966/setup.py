...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '2.5.0-alpha.1592983966+4b02d5e2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 2.5.0-alpha.1592983966+4b02d5e2`
                """)
            else:
                raise
