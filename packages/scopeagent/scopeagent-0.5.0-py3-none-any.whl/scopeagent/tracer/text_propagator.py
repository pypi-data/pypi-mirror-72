...
class TextPropagator(Propagator):
    ...
    def inject(self, span_context, carrier):
        carrier[field_name_trace_id] = '{0:032x}'.format(span_context.trace_id)
        carrier[field_name_span_id] = '{0:016x}'.format(span_context.span_id)
    ...
    def extract(self, carrier):  # noqa
        ...
        return SpanContext(span_id=span_id, trace_id=trace_id, baggage=baggage, sampled=sampled)
