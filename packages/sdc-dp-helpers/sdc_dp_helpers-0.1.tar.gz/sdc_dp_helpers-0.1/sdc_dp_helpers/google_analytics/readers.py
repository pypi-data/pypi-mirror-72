...
class BaseGAV4Reader:
    ...
    class ReaderIter:
        ...
        page_counter = 0
        def __init__(self, *, query_fn: Callable, query: list, pageToken: str = None, **kwargs):
        ...
        def __next__(self):
            ...
            """
            # run get_report
            report, self.pageToken = self.query_fn(queries=self.query, page_token=self.pageToken)
            print(
    ...
    def auth_credentials(self, **kwargs):
        ...
        credentials = None
        assert credentials is not None, NotImplementedError(
            "Must implement an appropriate Authetication of credentials object")
        return credentials

    def build_analytics_service_object(self, api_name: str = 'analyticsreporting', api_version: str = 'v4'):
...
class CustomGoogleAnalyticsReaderWithServiceAcc(BaseGAV4Reader):
    ...
    """
    def __init__(self, service_account_secrets_path: str, service_account_email: str, scopes: list, **kwargs):
        self.max_pages = kwargs.get("max_pages", None)
    ...
    def auth_credentials(self, service_account_secrets_path, service_account_email, scopes):
        """Get a service that communicates to a Google API.
        Args:
            api_name: The name of the api to connect to.
            api_version: The api version to connect to.
