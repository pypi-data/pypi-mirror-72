...
def run():
    ...
    # Maybe use cache for every request
    # And use another dump option for just raw posts??
    parser.add_argument('--cache', type=str, help="Cache HTTP responses in this directory")
