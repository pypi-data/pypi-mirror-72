...
@click.option(
    ...
    "--default-report-type",
    required=False,
    help='This value is used when report type attribute is missing. This not override an existing value at report file',
)
@help_option
@pass_flow_context
def version_tracker(flow_context, project_code, finding_report_files, repository_dir, current_commit, default_report_type):
    try:
