...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        """
        density_func = (math.factorial(self.n))/(math.factorial(k)*math.factorial(self.n-k)) * (self.p**k) * (1-self.p)**(self.n-k)
        return density_func
    ...
    def __repr__(self):
        ...
        p_str = str(p)[2:]
        return f"mean {self.mean}, standard deviation {self.stdev}, p .{p_str}, n {self.n}"
