...
from ayx_plugin_sdk.core.plugin import Plugin
from ayx_plugin_sdk.core.provider_base import ProviderBase
from ayx_plugin_sdk.core.record_packet import RecordPacket
from ayx_plugin_sdk.providers.file_provider.environment import Environment
from ayx_plugin_sdk.providers.file_provider.file_adapter import FileAdapter
from ayx_plugin_sdk.providers.file_provider.file_provider_input_connection import (
    FileProviderInputConnection,
)
from ayx_plugin_sdk.providers.file_provider.iox import IO
...
if TYPE_CHECKING:
    ...
    from ayx_plugin_sdk.providers.file_provider.tool_input import AnchorDefinition
...
class FileProvider(ProviderBase):
    ...
    def __add_input_connection_to_anchor(
        ...
        """
        # TODO make sure metadata_file and csv_file exist, if not raise FileNotFoundError
