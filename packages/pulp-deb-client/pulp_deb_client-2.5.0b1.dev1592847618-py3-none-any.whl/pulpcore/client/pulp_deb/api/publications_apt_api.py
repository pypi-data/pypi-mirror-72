...
class PublicationsAptApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        """Create a deb publication  # noqa: E501
        ...
        :param DebDebPublication data: (required)
    ...
    def delete(self, deb_publication_href, **kwargs):  # noqa: E501
        """Delete a deb publication  # noqa: E501

        A ViewSet for DebPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(deb_publication_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str deb_publication_href: URI of Deb Publication. e.g.: /pulp/api/v3/publications/deb/apt/1/ (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(deb_publication_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, deb_publication_href, **kwargs):  # noqa: E501
        """Delete a deb publication  # noqa: E501

        A ViewSet for DebPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(deb_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['deb_publication_href']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('deb_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_publication_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'deb_publication_href' in local_var_params:
            path_params['deb_publication_href'] = local_var_params['deb_publication_href']  # noqa: E501
    ...
    def list(self, **kwargs):  # noqa: E501
        """List deb publications  # noqa: E501
    ...
    def read(self, deb_publication_href, **kwargs):  # noqa: E501
        """Inspect a deb publication  # noqa: E501

        A ViewSet for DebPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(deb_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(deb_publication_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, deb_publication_href, **kwargs):  # noqa: E501
        """Inspect a deb publication  # noqa: E501

        A ViewSet for DebPublication.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(deb_publication_href, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DebDebPublicationRead, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['deb_publication_href', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('deb_publication_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_publication_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_publication_href` when calling `read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DebDebPublicationRead',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
