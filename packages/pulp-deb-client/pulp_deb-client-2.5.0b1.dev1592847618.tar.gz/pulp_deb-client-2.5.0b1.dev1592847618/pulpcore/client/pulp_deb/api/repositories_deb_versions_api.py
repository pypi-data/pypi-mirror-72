...
class RepositoriesDebVersionsApi(object):
    ...
    def list(self, apt_repository_pk, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        DebRepositoryVersion represents a single deb repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list(apt_repository_pk, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str apt_repository_pk: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_with_http_info(apt_repository_pk, **kwargs)  # noqa: E501

    def list_with_http_info(self, apt_repository_pk, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        DebRepositoryVersion represents a single deb repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_with_http_info(apt_repository_pk, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['apt_repository_pk', 'ordering', 'number', 'number__lt', 'number__lte', 'number__gt', 'number__gte', 'number__range', 'pulp_created__lt', 'pulp_created__lte', 'pulp_created__gt', 'pulp_created__gte', 'pulp_created__range', 'content', 'pulp_created', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('apt_repository_pk' not in local_var_params or  # noqa: E501
                                                        local_var_params['apt_repository_pk'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `apt_repository_pk` when calling `list`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'apt_repository_pk' in local_var_params:
            path_params['apt_repository_pk'] = local_var_params['apt_repository_pk']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/repositories/deb/apt/{apt_repository_pk}/versions/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_with_http_info(self, apt_repository_version_href, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RepositoryVersionRead, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='RepositoryVersionRead',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
