#!/home/jmorat/miniconda3/envs/kapture/bin/python3
...
from kapture.io.records import TransferAction, get_image_fullpath, import_record_data_from_dir_explicit
...
def import_silda(silda_dirpath: str,
    ...
    if images_import_strategy != TransferAction.skip:
        ...
        import_record_data_from_dir_explicit(silda_image_filepaths, kapture_image_filepaths, images_import_strategy)
    logger.info('done.')
