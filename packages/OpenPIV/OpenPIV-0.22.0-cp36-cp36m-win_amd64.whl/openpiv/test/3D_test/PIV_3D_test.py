...
# saving the plots
if save_plots:
    fig5.savefig(os.path.join(out_put_folder, "expanded_box_frame1.png"))
    fig6.savefig(os.path.join(out_put_folder, "expanded_box_frame2.png"))
    fig7.savefig(os.path.join(out_put_folder, "expanded_box_sig2noise.png"))
    fig8.savefig(os.path.join(out_put_folder, "expanded_box_deformation_field.png"))
...
if save_plots:
    ...
    try:
        ...
        imageio.mimsave(os.path.join(out_put_folder, "reaL_data_max_proj.gif"),[i1,i2])
