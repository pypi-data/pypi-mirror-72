...
class CfnAssociation(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnAssociation"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, name: str, association_name: typing.Optional[str]=None, automation_target_parameter_name: typing.Optional[str]=None, compliance_severity: typing.Optional[str]=None, document_version: typing.Optional[str]=None, instance_id: typing.Optional[str]=None, max_concurrency: typing.Optional[str]=None, max_errors: typing.Optional[str]=None, output_location: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "InstanceAssociationOutputLocationProperty"]]=None, parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Mapping[str, str]]]=None, schedule_expression: typing.Optional[str]=None, sync_compliance: typing.Optional[str]=None, targets: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "TargetProperty"]]]]=None, wait_for_success_timeout_seconds: typing.Optional[jsii.Number]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnAssociation":
    ...
    def output_location(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "InstanceAssociationOutputLocationProperty"]]:
    ...
    def output_location(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "InstanceAssociationOutputLocationProperty"]]) -> None:
    ...
    def targets(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "TargetProperty"]]]]:
    ...
    @targets.setter
    def targets(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "TargetProperty"]]]]) -> None:
    ...
    class InstanceAssociationOutputLocationProperty():
        def __init__(self, *, s3_location: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAssociation.S3OutputLocationProperty"]]=None) -> None:
            """
        ...
        @builtins.property
        def s3_location(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAssociation.S3OutputLocationProperty"]]:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-ssm.CfnAssociation.S3OutputLocationProperty", jsii_struct_bases=[], name_mapping={'output_s3_bucket_name': 'outputS3BucketName', 'output_s3_key_prefix': 'outputS3KeyPrefix', 'output_s3_region': 'outputS3Region'})
...
class CfnAssociationProps():
    ...
    @builtins.property
    def output_location(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAssociation.InstanceAssociationOutputLocationProperty"]]:
        """``AWS::SSM::Association.OutputLocation``.
    ...
    @builtins.property
    def targets(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnAssociation.TargetProperty"]]]]:
        """``AWS::SSM::Association.Targets``.
...
class CfnDocument(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnDocument"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnDocument":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
class CfnMaintenanceWindow(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnMaintenanceWindow"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnMaintenanceWindow":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def allow_unassociated_targets(self, value: typing.Union[bool, aws_cdk.core.IResolvable]) -> None:
...
class CfnMaintenanceWindowTarget(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnMaintenanceWindowTarget"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnMaintenanceWindowTarget":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @targets.setter
    def targets(self, value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "TargetsProperty"]]]) -> None:
        jsii.set(self, "targets", value)
...
class CfnMaintenanceWindowTask(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnMaintenanceWindowTask"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnMaintenanceWindowTask":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @targets.setter
    def targets(self, value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "TargetProperty"]]]) -> None:
        jsii.set(self, "targets", value)
    ...
    def logging_info(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LoggingInfoProperty"]]:
    ...
    @logging_info.setter
    def logging_info(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "LoggingInfoProperty"]]) -> None:
    ...
    def task_invocation_parameters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "TaskInvocationParametersProperty"]]:
    ...
    def task_invocation_parameters(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "TaskInvocationParametersProperty"]]) -> None:
    ...
    class MaintenanceWindowRunCommandParametersProperty():
        ...
        @builtins.property
        def notification_config(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.NotificationConfigProperty"]]:
    ...
    class TaskInvocationParametersProperty():
        def __init__(self, *, maintenance_window_automation_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowAutomationParametersProperty"]]=None, maintenance_window_lambda_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowLambdaParametersProperty"]]=None, maintenance_window_run_command_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowRunCommandParametersProperty"]]=None, maintenance_window_step_functions_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowStepFunctionsParametersProperty"]]=None) -> None:
            """
        ...
        @builtins.property
        def maintenance_window_automation_parameters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowAutomationParametersProperty"]]:
        ...
        @builtins.property
        def maintenance_window_lambda_parameters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowLambdaParametersProperty"]]:
        ...
        @builtins.property
        def maintenance_window_run_command_parameters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowRunCommandParametersProperty"]]:
        ...
        @builtins.property
        def maintenance_window_step_functions_parameters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.MaintenanceWindowStepFunctionsParametersProperty"]]:
...
class CfnMaintenanceWindowTaskProps():
    def __init__(self, *, max_concurrency: str, max_errors: str, priority: jsii.Number, targets: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.TargetProperty"]]], task_arn: str, task_type: str, window_id: str, description: typing.Optional[str]=None, logging_info: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.LoggingInfoProperty"]]=None, name: typing.Optional[str]=None, service_role_arn: typing.Optional[str]=None, task_invocation_parameters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.TaskInvocationParametersProperty"]]=None, task_parameters: typing.Any=None) -> None:
    ...
    @builtins.property
    def logging_info(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.LoggingInfoProperty"]]:
        """``AWS::SSM::MaintenanceWindowTask.LoggingInfo``.
    ...
    @builtins.property
    def task_invocation_parameters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnMaintenanceWindowTask.TaskInvocationParametersProperty"]]:
        """``AWS::SSM::MaintenanceWindowTask.TaskInvocationParameters``.
...
class CfnParameter(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnParameter"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnParameter":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-ssm.CfnParameterProps", jsii_struct_bases=[], name_mapping={'type': 'type', 'value': 'value', 'allowed_pattern': 'allowedPattern', 'data_type': 'dataType', 'description': 'description', 'name': 'name', 'policies': 'policies', 'tags': 'tags', 'tier': 'tier'})
...
class CfnPatchBaseline(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnPatchBaseline"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, name: str, approval_rules: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RuleGroupProperty"]]=None, approved_patches: typing.Optional[typing.List[str]]=None, approved_patches_compliance_level: typing.Optional[str]=None, approved_patches_enable_non_security: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, description: typing.Optional[str]=None, global_filters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "PatchFilterGroupProperty"]]=None, operating_system: typing.Optional[str]=None, patch_groups: typing.Optional[typing.List[str]]=None, rejected_patches: typing.Optional[typing.List[str]]=None, rejected_patches_action: typing.Optional[str]=None, sources: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PatchSourceProperty"]]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnPatchBaseline":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def approval_rules(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RuleGroupProperty"]]:
    ...
    def approval_rules(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RuleGroupProperty"]]) -> None:
    ...
    def approved_patches_enable_non_security(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
    ...
    def approved_patches_enable_non_security(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
    ...
    def global_filters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "PatchFilterGroupProperty"]]:
    ...
    def global_filters(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "PatchFilterGroupProperty"]]) -> None:
    ...
    def sources(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PatchSourceProperty"]]]]:
    ...
    @sources.setter
    def sources(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "PatchSourceProperty"]]]]) -> None:
    ...
    class PatchFilterGroupProperty():
        def __init__(self, *, patch_filters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchFilterProperty"]]]]=None) -> None:
            """
        ...
        @builtins.property
        def patch_filters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchFilterProperty"]]]]:
    ...
    class RuleGroupProperty():
        def __init__(self, *, patch_rules: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.RuleProperty"]]]]=None) -> None:
            """
        ...
        @builtins.property
        def patch_rules(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.RuleProperty"]]]]:
    ...
    class RuleProperty():
        ...
        @builtins.property
        def enable_non_security(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
        ...
        @builtins.property
        def patch_filter_group(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchFilterGroupProperty"]]:
...
class CfnPatchBaselineProps():
    def __init__(self, *, name: str, approval_rules: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.RuleGroupProperty"]]=None, approved_patches: typing.Optional[typing.List[str]]=None, approved_patches_compliance_level: typing.Optional[str]=None, approved_patches_enable_non_security: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, description: typing.Optional[str]=None, global_filters: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchFilterGroupProperty"]]=None, operating_system: typing.Optional[str]=None, patch_groups: typing.Optional[typing.List[str]]=None, rejected_patches: typing.Optional[typing.List[str]]=None, rejected_patches_action: typing.Optional[str]=None, sources: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchSourceProperty"]]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None) -> None:
    ...
    @builtins.property
    def approval_rules(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.RuleGroupProperty"]]:
        """``AWS::SSM::PatchBaseline.ApprovalRules``.
    ...
    @builtins.property
    def global_filters(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchFilterGroupProperty"]]:
        """``AWS::SSM::PatchBaseline.GlobalFilters``.
    ...
    @builtins.property
    def sources(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnPatchBaseline.PatchSourceProperty"]]]]:
        """``AWS::SSM::PatchBaseline.Sources``.
...
class CfnResourceDataSync(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ssm.CfnResourceDataSync"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnResourceDataSync":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def s3_destination(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "S3DestinationProperty"]]:
    ...
    def s3_destination(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "S3DestinationProperty"]]) -> None:
    ...
    def sync_source(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "SyncSourceProperty"]]:
    ...
    @sync_source.setter
    def sync_source(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "SyncSourceProperty"]]) -> None:
    ...
    class SyncSourceProperty():
        def __init__(self, *, source_regions: typing.List[str], source_type: str, aws_organizations_source: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnResourceDataSync.AwsOrganizationsSourceProperty"]]=None, include_future_regions: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None) -> None:
            """
        ...
        @builtins.property
        def aws_organizations_source(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnResourceDataSync.AwsOrganizationsSourceProperty"]]:
        ...
        @builtins.property
        def include_future_regions(self) -> typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]:
...
class CfnResourceDataSyncProps():
    ...
    @builtins.property
    def s3_destination(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnResourceDataSync.S3DestinationProperty"]]:
        """``AWS::SSM::ResourceDataSync.S3Destination``.
    ...
    @builtins.property
    def sync_source(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnResourceDataSync.SyncSourceProperty"]]:
        """``AWS::SSM::ResourceDataSync.SyncSource``.
