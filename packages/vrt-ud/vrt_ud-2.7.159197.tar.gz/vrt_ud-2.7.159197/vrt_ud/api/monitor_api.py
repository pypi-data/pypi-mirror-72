...
class MonitorApi(object):
    ...
    def read_facts(self, facts_filter, **kwargs):  # noqa: E501
        """Получение фактов за промежуток времени  # noqa: E501
        ...
        :param FactsFilter facts_filter: Фильтр фактов (required)
    ...
    def read_performers(self, performers_filter, **kwargs):  # noqa: E501
        """Получение текущей информации об исполнителе по фильтру  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param PerformersFilter performers_filter: Фильтр исполнителей (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def read_trips(self, trips_filter, **kwargs):  # noqa: E501
        """Получение рейсов по фильтру  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param TripsFilter trips_filter: Фильтр рейсов (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def run_trips(self, run_trips_task, **kwargs):  # noqa: E501
        """Запуск рейсов  # noqa: E501

        Запуск рейсов по их идентификаторам  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param RunTripsTask run_trips_task: Новый запрос на запуск рейсов (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
