...
class PredictorApi(object):
    ...
    def predictor_check(self, **kwargs):  # noqa: E501
        ...
        Мониторинг работы сценария, который подготавливает данные для подсказки временных окон.  # noqa: E501
    ...
    def predictor_insert(self, predictor_insert_task, **kwargs):  # noqa: E501
        ...
        Сценарий вставляет добавляет один заказ, если стоимость его выполнения не превышает указанную в запросе сумму. При этом происходит сохранение данного заказа на сервере.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param PredictorInsertTask predictor_insert_task: Запрос на добавление заказа. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def predictor_predict(self, predictor_task, **kwargs):  # noqa: E501
        ...
        Получение ранжированного списка окон для нового заказа  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param PredictorTask predictor_task: Новый запрос на подсказку окон (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
