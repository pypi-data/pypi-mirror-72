...
class TripJob(object):
    ...
    def job_type(self):
        ...
        Возможные типы работ   * `LOCATION_ARRIVAL` - Прибытие на локацию   * `READY_TO_WORK` - Исполнитель готов к работе   * `START_WORK` - Начало работы на локации   * `FINISH_WORK` - Конец работы на локации   * `LOCATION_DEPARTURE` - Отъезд с локации   * `CUSTOM` - Дополнительная работа   # noqa: E501
    ...
    def job_time(self):
        ...
        Время начала работы в соответствии с [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6)  # noqa: E501
