...
class PredictorCheckResult(object):
    ...
    def currently_started_data_preparation(self):
        ...
        Время последнего старта сценария  # noqa: E501
    ...
    def previous_data_preparation(self):
        ...
        Время предыдущего старта сценария  # noqa: E501
    ...
    def last_succesful_data_preparation(self):
        ...
        Время последнего удачного проигрывания сценария  # noqa: E501
    ...
    def validation_result(self):
        ...
        Результат валидации данных последнего запуска сценария  # noqa: E501
    ...
    def current_data_preparation_errors(self):
        ...
        Ошибки последнего запуска сценария  # noqa: E501
    ...
    def last_owp_validation_errors(self):
        ...
        Ошибки предыдущего запуска сценария  # noqa: E501
