...
class FactTripProgress(object):
    ...
    def executed_orders_in_trip(self):
        ...
        Доля завершенных заказов в рейсе  # noqa: E501
    ...
    def executed_orders_for_current_time(self):
        ...
        Отношение количества выполненных заказов к количеству заказов, которые должны быть выполнены на данный момент, значение более единицы означает отставание от плана.  # noqa: E501
