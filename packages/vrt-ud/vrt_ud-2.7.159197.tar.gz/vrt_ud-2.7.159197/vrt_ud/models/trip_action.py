...
class TripAction(object):
    ...
    def order_key(self):
        ...
        Ключ заказа, с которым производится действие  # noqa: E501
    ...
    def demand_key(self):
        ...
        Ключ заявки, с которой производится действие  # noqa: E501
    ...
    def location_key(self):
        ...
        Ключ локации, в которой производится действие  # noqa: E501
    ...
    def todolist(self):
        ...
        Список работ, каждая происходит во временном окне job_time  # noqa: E501
    ...
    def cargo_placements(self):
        ...
        Список расположений грузов  # noqa: E501
