...
def run(sim_data, feature):
    ...
    sim_data_zero, sim_min_time, sim_min_value, sim_max_time, sim_max_value = score.cut_zero(sim_time_values, sim_data_values_smooth, min_value, max_value)
...
def setup(sim, feature, selectedTimes, selectedValues, CV_time, abstol, cache):
    ...
    min_time, min_value, max_time, max_value = score.find_cuts(selectedTimes, smooth_value, spline, spline_der)

    exp_data_zero, exp_min_time, exp_min_value, exp_max_time, exp_max_value = score.cut_zero(selectedTimes, smooth_value, min_value, max_value)
