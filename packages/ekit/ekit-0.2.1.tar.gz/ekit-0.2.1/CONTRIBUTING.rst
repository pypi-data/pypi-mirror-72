...
To fix bugs please fork the repository and create a merge request. See also                             │  36 official pythonproject docs, in docstrings, or even on the web in blog posts,
merge_requests_.

Write Documentation
~~~~~~~~~~~~~~~~~~~

``ekit`` could always use more documentation, whether as part of the 
official ``ekit`` docs, in docstrings, or even on
