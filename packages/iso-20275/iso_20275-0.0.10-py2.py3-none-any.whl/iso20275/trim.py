...
with open('Cleaned - ISO-20275 - 2020-06-10.csv', newline='', encoding='utf-8') as input_file:
	with open('Cleaned - ISO-20275 - 2020-06-10 - Trimmed.csv', 'w', newline='', encoding='utf-8') as output_file:
