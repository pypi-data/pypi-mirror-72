...
function GetOciSubcommands_analytics() {
    $ociSubcommands = @{
        ...
        'analytics analytics-instance' = 'change-compartment create delete get list scale start stop update'
...
function GetOciCommandsToLongParams_analytics() {
    $ociCommandsToLongParams = @{
        ...
        'analytics analytics-instance create' = 'capacity-type capacity-value compartment-id defined-tags description email-notification feature-set freeform-tags from-json help idcs-access-token-file license-type max-wait-seconds name wait-for-state wait-interval-seconds'
