...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        ...
        'db autonomous-database' = 'change-compartment create create-from-backup-id create-from-backup-timestamp create-from-clone data-safe delete generate-wallet get list restart restore start stop update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-id' = 'admin-password autonomous-container-database-id autonomous-database-backup-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-timestamp' = 'admin-password autonomous-container-database-id autonomous-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label subnet-id timestamp wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-clone' = 'admin-password autonomous-container-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label source-id subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db autonomous-database list' = 'all autonomous-container-database-id compartment-id db-version db-workload display-name from-json help infrastructure-type is-free-tier lifecycle-state limit page page-size sort-by sort-order'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name db-version defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled is-free-tier license-model max-wait-seconds nsg-ids wait-for-state wait-interval-seconds whitelisted-ips'
