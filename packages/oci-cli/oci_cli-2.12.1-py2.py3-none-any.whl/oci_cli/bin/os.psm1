...
function GetOciSubcommands_os() {
    $ociSubcommands = @{
        ...
        'os object' = 'bulk-delete bulk-delete-versions bulk-download bulk-upload copy delete get head list list-object-versions put rename restore restore-status resume-put'
