...
class GetTestPlanResponse(betterproto.Message):
    ...
    testplan_compressed: Optional[bytes] = betterproto.message_field(
        5, wraps=betterproto.TYPE_BYTES
    )
...
class TestPlanRunRequest(betterproto.Message):
    ...
    testplan_compressed: Optional[bytes] = betterproto.message_field(
        3, wraps=betterproto.TYPE_BYTES
    )
...
class StatusResultsUrl(betterproto.Message):
    ...
    download_url: Optional[str] = betterproto.message_field(
...
class StatusBody(betterproto.Message):
    ...
    test_total: Optional[int] = betterproto.message_field(
