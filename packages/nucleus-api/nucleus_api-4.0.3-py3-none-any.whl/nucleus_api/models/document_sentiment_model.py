...
class DocumentSentimentModel(object):
    ...
    def __init__(self, dataset=None, doc_title=None, query=None, num_topics=None, num_keywords=None, custom_stop_words=None, custom_dict_file=None, cache_sentiment=False):  # noqa: E501
