...
class LoginRequest(DSRequest):
    ...
    def get_chats(user):
        ...
        settings.LOCKS.acquire('LoginRequest.get_chats')
        ...
        settings.LOCKS.release('LoginRequest.get_chats')
    ...
    def send_bot_message(user, bot, message, compulsory_reading=False):
        ...
        settings.LOCKS.acquire('LoginRequest.send_bot_message')
        ...
        if created:
            ...
            if chat_user_user.props._value != props:
                ...
                time.sleep(3)
            send()
        settings.LOCKS.release('LoginRequest.send_bot_message')
