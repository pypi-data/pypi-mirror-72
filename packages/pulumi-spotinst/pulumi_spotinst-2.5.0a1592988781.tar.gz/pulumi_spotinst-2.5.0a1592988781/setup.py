...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.5.0-alpha.1592988781+99bf4dd0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.5.0-alpha.1592988781+99bf4dd0`
                """)
            else:
                raise
