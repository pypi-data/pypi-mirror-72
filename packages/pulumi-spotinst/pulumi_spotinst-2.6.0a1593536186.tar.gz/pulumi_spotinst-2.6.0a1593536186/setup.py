...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.6.0-alpha.1593536186+bdc80dbc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.6.0-alpha.1593536186+bdc80dbc`
                """)
            else:
                raise
