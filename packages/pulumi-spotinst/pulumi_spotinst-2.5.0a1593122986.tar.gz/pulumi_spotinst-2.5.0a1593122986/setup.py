...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.5.0-alpha.1593122986+ca1c1e1b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.5.0-alpha.1593122986+ca1c1e1b`
                """)
            else:
                raise
