...
class BaselineRacer(object):
    ...
    def initialize_drone(self):
        ...
        traj_tracker_gains = TrajectoryTrackerGains(kp_cross_track = 5.0, kd_cross_track = 0.0, 
    ...
    def fly_through_all_gates_at_once_with_moveOnSpline(self):
        ...
        if self.level_name in ["ZhangJiaJie_Medium", "Qualifier_Tier_2", "Qualifier_Tier_3"]:
            vel_max = 30.0
            acc_max = 17.5
    ...
    def run_in_thread(self):
        t1 = threading.Thread(target=self.takeoff_and_fly_through_all_gates_at_once_with_moveOnSpline)
        t1.start()