...
[boto3.MarketplaceEntitlementService 1.14.15](https://boto3.amazonaws.com/v1/documentation/api/1.14.15/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
