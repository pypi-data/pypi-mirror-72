...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_iot_lambda_dynamodb._jsii": [
            "aws-iot-lambda-dynamodb@1.46.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_iot_lambda_dynamodb": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-iot-lambda>=1.46.0, <1.47.0",
        "aws-solutions-constructs.aws-lambda-dynamodb>=1.46.0, <1.47.0",
