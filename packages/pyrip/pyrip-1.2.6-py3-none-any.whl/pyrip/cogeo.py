...
def optimize(infile, outfile, block_size=512, compression='LZW', predictor=2, big_tiff=True,
...
def query_radius(infile, lat, lon, radius, outfile, compression='LZW', bbox_srs='EPSG:4326', verbose=False,
                 access_key_id=None, secret_access_key=None, endpoint=None):
    return query(infile, Point(lon, lat).buffer(radius).bounds, outfile, compression, bbox_srs, verbose,
