...
class Config(DefaultConfig):
    ...
    sitename = u'just another Wiki'

    # Wiki logo. You can use an image, text or both. [Unicode]
    # For no logo or text, use '' - the default is to show the sitename.
    # See also url_prefix setting below!
    #logo_string = '<img src="http://beauceroninformatique.ca/media/img/g3097.png">'
    logo_string = ''
    ...
    #page_front_page = u"PageD'Accueil"

    # The interwiki name used in interwiki links
    interwikiname = u'just another Wiki'
    ...
    data_dir = '/home/www/default_wiki/data/'
    ...
    # backup it.
    data_underlay_dir = '/home/www/default_wiki/underlay/'
    ...
    superuser = [u"EtienneRobillard", ]

    # IMPORTANT: grant yourself admin rights! replace YourName with
    # your user name. See HelpOnAccessControlLists for more help.
    # All acl_rights_xxx options must use unicode [Unicode]
    acl_rights_before = u"EtienneRobillard:read,write,delete,revert,admin"
    ...
    # Textchas ----------------------------------------------------------
    textchas = {
        'en': {u"Enter the code name of notmm 0.3.4?":ur"HappyLady"}
    }
    ...
    # mail_smarthost = "gthcfoundation.org"
    mail_smarthost = u"localhost"

    # The return address, e.g u"J?rgen Wiki <noreply@mywiki.org>" [Unicode]
    #mail_from = u"<postmaster@gthcfoundation.org>"
    mail_from = "<postmaster@localhost.localdomain>"
