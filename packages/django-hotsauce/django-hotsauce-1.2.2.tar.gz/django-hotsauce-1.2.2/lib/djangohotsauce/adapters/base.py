...
class BaseHandler(object):
    ...
    def get_response(self, request):
        ...
        from django.core import exceptions
        from django.conf import settings
        from djangohotsauce.utils import django_compat as urlresolvers
        try:
            ...
            if hasattr(urlresolvers, 'set_urlconf'):
                ...
                urlresolvers._urlconfs.value = urlconf
            ...
            try:
                ...
                if response is None:
                    ...
                    callback, callback_args, callback_kwargs = resolver.resolve(request.path_info)# SCRIPT_NAME
            ...
            except (http.Http404, NoReverseMatch) as e:
