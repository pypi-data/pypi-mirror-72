...
class ReverseTranslator:
    ...
    def translate(self,uncheckedNames):
    ...
    def mapToCommonName(self):
        try:
            ...
            speciesNamesOnly = reverseNameAPI(bestEffortOfSpecies)
            self.writeApiResultsToIndex(speciesNamesOnly)
        except Exception as e:
