            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i330 in range(_size326):
                        _elem331 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.path.append(_elem331)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class deleteStorageGroups_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i337 in range(_size333):
                        ...
                        self.storageGroup.append(_elem338)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.storageGroup is not None:
            ...
            for iter339 in self.storageGroup:
