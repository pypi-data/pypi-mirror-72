"""
Required device info for the AVR128DA28 device
"""
...
DEVICE_INFO = {
    ...
    'flash_page_size_bytes': 0x200, # Erase size of 0x100, write size is actually 1 word (2 bytes)
