...
class Backend(object):
    ...
    def __init__(self, loglevel=logging.WARNING):
        """
        :param loglevel: python logging level to be used throughout the complete pymcuprog stack
        """
    ...
    @staticmethod
    def get_available_hid_tools(serial_number_substring='', tool_name=None):
        """
        ...
        :param tool_name: tool type to connect to. If None any tool matching the serial_number_substring
            will be returned
        ...
        return transport.get_matching_tools(serial_number_substring, tool_name)
    ...
    def connect_to_tool(self, toolconnection):
        ...
        if isinstance(toolconnection, ToolSerialConnection):
            ...
            try:
                connect_status = self.transport.connect(serial_number=toolconnection.serial_number,
