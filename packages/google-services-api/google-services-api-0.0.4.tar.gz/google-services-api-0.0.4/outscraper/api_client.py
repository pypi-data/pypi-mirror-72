...
class ApiClient(object):
    ...
    def google_maps_search(self, query, language='en', region='us', limit=400, extractContacts=False, coordinates=None):
    ...
    def google_maps_business_reviews(self, query, language='en', region='us', limit=100, cutoff=None, coordinates=None):
        ...
        sleep(30)
        organizations = self._wait_request_archive(response.json()['id'], 5).get('data', [])
