...
setup(
  ...
  version = '5.0.7',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/JorryZ/motionConstrain/archive/v5.0.7.tar.gz',    # I explain this later on
