...
$PUSH_TAG_REMOTE = 'git@github.com:quansight/django-scoped-rbac.git'  # Repo to push tags to

$GITHUB_ORG = 'quansight'  # Github org for Github releases and conda-forge
$GITHUB_REPO = 'django-scoped-rbac'  # Github repo for Github releases  and conda-forge
