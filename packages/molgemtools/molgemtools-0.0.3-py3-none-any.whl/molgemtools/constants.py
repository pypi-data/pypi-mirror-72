...
class Constants:
    ...
    # Fundamental constants according to reference [Lide2010].
    # Bohr radius (m).
    a = 0.5291772085936*10**-10
    # Angstrom (m).
    ang = 10**-10
    # Speed of light in vacuum (m/s).
    c = 299792458
    # Hartree energy (J).
    hartree = 4.3597439422*10**-18
    # Hartree energy per mol (J/mol).
    hartree_per_mol = 2625499.6201
    # Planck constant (J*s).
    h = 6.6260689633*10**-34
    # Boltzmann constant (J/K).
    k = 1.380650424*10**-23
    # Atomic mass unit, amu (kg).
    u = 1.66053878283*10**-27
    # Electron mass (kg).
    m_e = 9.1093821545*10**-31
    # Proton mass (kg).
    m_p = 1.67262163783*10**-27
    # Avogadro constant (1/mol).
    n_a = 6.0221417930*10**23

    # Conversion ratios.
    # A Bohr radius to angstroms.
    a_to_ang = 0.5291772085936
    # A calorie to joules.
    calorie_to_joule = 4.1868
