...
Introduction
===============================
Fork created by 'django-activity-stream'. The difference between this two libs are that
'django-activity-stream-action-expanded' have a model defined like ActionEvent and field
'verb' from Action is a FK of this type.

[ActionEvent]
Field 1: entity_name <string>, reference name of entity name defined
