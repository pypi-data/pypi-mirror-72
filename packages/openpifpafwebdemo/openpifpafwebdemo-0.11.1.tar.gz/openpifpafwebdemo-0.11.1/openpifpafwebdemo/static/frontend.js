    ...
    setCamera(mode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (['user', 'environment'].includes(this.mode)) {
                let capabilities = Object.assign({}, defaultCapabilities, { video: Object.assign({}, defaultCapabilities.video, { facingMode: this.mode }) });
...
function newImage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch(backend_location + '/process' + document.location.search, {
            method: 'post',
            mode: 'cors',
