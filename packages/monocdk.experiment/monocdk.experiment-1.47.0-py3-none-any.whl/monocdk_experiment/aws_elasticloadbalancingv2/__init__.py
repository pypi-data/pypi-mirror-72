...
from .. import (Duration as _Duration_5170c158, Construct as _Construct_f50a3f53, IConstruct as _IConstruct_db0cc7e3, SecretValue as _SecretValue_99478b8b, Resource as _Resource_884d0774, CfnResource as _CfnResource_7760e8e4, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, TagManager as _TagManager_2508893f, CfnTag as _CfnTag_b4661f1a, IResource as _IResource_72f7ee7e, IDependable as _IDependable_4fc803f7, ConcreteDependable as _ConcreteDependable_ac6d9807)
from ..aws_certificatemanager import (ICertificate as _ICertificate_8f3d4c96)
from ..aws_cloudwatch import (Metric as _Metric_53e89548, MetricOptions as _MetricOptions_ad2c4d5d)
from ..aws_ec2 import (IConnectable as _IConnectable_a587039f, Port as _Port_7d870cca, Connections as _Connections_231f38b5, ISecurityGroup as _ISecurityGroup_d72ab8e8, IVpc as _IVpc_3795853f, SubnetSelection as _SubnetSelection_36a13cd6, IVpcEndpointServiceLoadBalancer as _IVpcEndpointServiceLoadBalancer_98c930f6)
from ..aws_s3 import (IBucket as _IBucket_25bad983)


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddNetworkActionProps", jsii_struct_bases=[], name_mapping={'action': 'action'})
class AddNetworkActionProps():
    ...
    def __repr__(self) -> str:
        return 'AddNetworkActionProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddNetworkTargetsProps", jsii_struct_bases=[], name_mapping={'port': 'port', 'deregistration_delay': 'deregistrationDelay', 'health_check': 'healthCheck', 'proxy_protocol_v2': 'proxyProtocolV2', 'target_group_name': 'targetGroupName', 'targets': 'targets'})
class AddNetworkTargetsProps():
    def __init__(self, *, port: jsii.Number, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, proxy_protocol_v2: typing.Optional[bool]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["INetworkLoadBalancerTarget"]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddRuleProps", jsii_struct_bases=[], name_mapping={'conditions': 'conditions', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority'})
class AddRuleProps():
    def __init__(self, *, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListenerAttributes", jsii_struct_bases=[], name_mapping={'listener_arn': 'listenerArn', 'default_port': 'defaultPort', 'security_group': 'securityGroup', 'security_group_allows_all_outbound': 'securityGroupAllowsAllOutbound', 'security_group_id': 'securityGroupId'})
class ApplicationListenerAttributes():
    def __init__(self, *, listener_arn: str, default_port: typing.Optional[jsii.Number]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, security_group_id: typing.Optional[str]=None) -> None:
...
class ApplicationListenerCertificate(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListenerCertificate"):
    """Add certificates to a listener.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, listener: "IApplicationListener", certificate_arns: typing.Optional[typing.List[str]]=None, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListenerCertificateProps", jsii_struct_bases=[], name_mapping={'listener': 'listener', 'certificate_arns': 'certificateArns', 'certificates': 'certificates'})
...
class ApplicationListenerRule(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListenerRule"):
    """Define a new listener rule.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, listener: "IApplicationListener", priority: jsii.Number, action: typing.Optional["ListenerAction"]=None, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param listener: The listener to attach the rule to.
        ...
        :stability: experimental
        """
        props = ApplicationListenerRuleProps(listener=listener, priority=priority, action=action, conditions=conditions, fixed_response=fixed_response, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, redirect_response=redirect_response, target_groups=target_groups)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationLoadBalancerAttributes", jsii_struct_bases=[], name_mapping={'load_balancer_arn': 'loadBalancerArn', 'security_group_id': 'securityGroupId', 'load_balancer_canonical_hosted_zone_id': 'loadBalancerCanonicalHostedZoneId', 'load_balancer_dns_name': 'loadBalancerDnsName', 'security_group_allows_all_outbound': 'securityGroupAllowsAllOutbound', 'vpc': 'vpc'})
class ApplicationLoadBalancerAttributes():
    def __init__(self, *, load_balancer_arn: str, security_group_id: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> None:
...
@jsii.enum(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationProtocol")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AuthenticateOidcOptions", jsii_struct_bases=[], name_mapping={'authorization_endpoint': 'authorizationEndpoint', 'client_id': 'clientId', 'client_secret': 'clientSecret', 'issuer': 'issuer', 'next': 'next', 'token_endpoint': 'tokenEndpoint', 'user_info_endpoint': 'userInfoEndpoint', 'authentication_request_extra_params': 'authenticationRequestExtraParams', 'on_unauthenticated_request': 'onUnauthenticatedRequest', 'scope': 'scope', 'session_cookie_name': 'sessionCookieName', 'session_timeout': 'sessionTimeout'})
class AuthenticateOidcOptions():
    def __init__(self, *, authorization_endpoint: str, client_id: str, client_secret: _SecretValue_99478b8b, issuer: str, next: "ListenerAction", token_endpoint: str, user_info_endpoint: str, authentication_request_extra_params: typing.Optional[typing.Mapping[str, str]]=None, on_unauthenticated_request: typing.Optional["UnauthenticatedAction"]=None, scope: typing.Optional[str]=None, session_cookie_name: typing.Optional[str]=None, session_timeout: typing.Optional[_Duration_5170c158]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'AuthenticateOidcOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseApplicationListenerProps", jsii_struct_bases=[], name_mapping={'certificate_arns': 'certificateArns', 'certificates': 'certificates', 'default_action': 'defaultAction', 'default_target_groups': 'defaultTargetGroups', 'open': 'open', 'port': 'port', 'protocol': 'protocol', 'ssl_policy': 'sslPolicy'})
class BaseApplicationListenerProps():
    def __init__(self, *, certificate_arns: typing.Optional[typing.List[str]]=None, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["ListenerAction"]=None, default_target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, open: typing.Optional[bool]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseApplicationListenerRuleProps", jsii_struct_bases=[], name_mapping={'priority': 'priority', 'action': 'action', 'conditions': 'conditions', 'fixed_response': 'fixedResponse', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'redirect_response': 'redirectResponse', 'target_groups': 'targetGroups'})
...
class BaseListener(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseListener"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, additional_props: typing.Any) -> None:
        """
        :param scope: -
        :param id: -
...
class BaseLoadBalancer(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseLoadBalancer"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, base_props: "BaseLoadBalancerProps", additional_props: typing.Any) -> None:
        """
        :param scope: -
        :param id: -
        :param base_props: -
    ...
    def log_access_logs(self, bucket: _IBucket_25bad983, prefix: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseLoadBalancerProps", jsii_struct_bases=[], name_mapping={'vpc': 'vpc', 'deletion_protection': 'deletionProtection', 'internet_facing': 'internetFacing', 'load_balancer_name': 'loadBalancerName', 'vpc_subnets': 'vpcSubnets'})
class BaseLoadBalancerProps():
    def __init__(self, *, vpc: _IVpc_3795853f, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseNetworkListenerProps", jsii_struct_bases=[], name_mapping={'port': 'port', 'certificates': 'certificates', 'default_action': 'defaultAction', 'default_target_groups': 'defaultTargetGroups', 'protocol': 'protocol', 'ssl_policy': 'sslPolicy'})
class BaseNetworkListenerProps():
    def __init__(self, *, port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["NetworkListenerAction"]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.BaseTargetGroupProps", jsii_struct_bases=[], name_mapping={'deregistration_delay': 'deregistrationDelay', 'health_check': 'healthCheck', 'target_group_name': 'targetGroupName', 'target_type': 'targetType', 'vpc': 'vpc'})
class BaseTargetGroupProps():
    def __init__(self, *, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> None:
...
class CfnListener(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, default_actions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ActionProperty", _IResolvable_9ceae33e]]], load_balancer_arn: str, port: jsii.Number, protocol: str, certificates: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CertificateProperty", _IResolvable_9ceae33e]]]]=None, ssl_policy: typing.Optional[str]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnListener":
    ...
    def default_actions(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ActionProperty", _IResolvable_9ceae33e]]]:
    ...
    def default_actions(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ActionProperty", _IResolvable_9ceae33e]]]) -> None:
    ...
    def certificates(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CertificateProperty", _IResolvable_9ceae33e]]]]:
    ...
    @certificates.setter
    def certificates(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CertificateProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.ActionProperty", jsii_struct_bases=[], name_mapping={'type': 'type', 'authenticate_cognito_config': 'authenticateCognitoConfig', 'authenticate_oidc_config': 'authenticateOidcConfig', 'fixed_response_config': 'fixedResponseConfig', 'forward_config': 'forwardConfig', 'order': 'order', 'redirect_config': 'redirectConfig', 'target_group_arn': 'targetGroupArn'})
    class ActionProperty():
        def __init__(self, *, type: str, authenticate_cognito_config: typing.Optional[typing.Union["CfnListener.AuthenticateCognitoConfigProperty", _IResolvable_9ceae33e]]=None, authenticate_oidc_config: typing.Optional[typing.Union["CfnListener.AuthenticateOidcConfigProperty", _IResolvable_9ceae33e]]=None, fixed_response_config: typing.Optional[typing.Union["CfnListener.FixedResponseConfigProperty", _IResolvable_9ceae33e]]=None, forward_config: typing.Optional[typing.Union["CfnListener.ForwardConfigProperty", _IResolvable_9ceae33e]]=None, order: typing.Optional[jsii.Number]=None, redirect_config: typing.Optional[typing.Union["CfnListener.RedirectConfigProperty", _IResolvable_9ceae33e]]=None, target_group_arn: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def authenticate_cognito_config(self) -> typing.Optional[typing.Union["CfnListener.AuthenticateCognitoConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def authenticate_oidc_config(self) -> typing.Optional[typing.Union["CfnListener.AuthenticateOidcConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def fixed_response_config(self) -> typing.Optional[typing.Union["CfnListener.FixedResponseConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def forward_config(self) -> typing.Optional[typing.Union["CfnListener.ForwardConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def redirect_config(self) -> typing.Optional[typing.Union["CfnListener.RedirectConfigProperty", _IResolvable_9ceae33e]]:
    ...
    class AuthenticateCognitoConfigProperty():
        ...
        @builtins.property
        def authentication_request_extra_params(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.CertificateProperty", jsii_struct_bases=[], name_mapping={'certificate_arn': 'certificateArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.FixedResponseConfigProperty", jsii_struct_bases=[], name_mapping={'status_code': 'statusCode', 'content_type': 'contentType', 'message_body': 'messageBody'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.ForwardConfigProperty", jsii_struct_bases=[], name_mapping={'target_groups': 'targetGroups', 'target_group_stickiness_config': 'targetGroupStickinessConfig'})
    class ForwardConfigProperty():
        def __init__(self, *, target_groups: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListener.TargetGroupTupleProperty", _IResolvable_9ceae33e]]]]=None, target_group_stickiness_config: typing.Optional[typing.Union["CfnListener.TargetGroupStickinessConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def target_groups(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListener.TargetGroupTupleProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def target_group_stickiness_config(self) -> typing.Optional[typing.Union["CfnListener.TargetGroupStickinessConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.RedirectConfigProperty", jsii_struct_bases=[], name_mapping={'status_code': 'statusCode', 'host': 'host', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'query': 'query'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.TargetGroupStickinessConfigProperty", jsii_struct_bases=[], name_mapping={'duration_seconds': 'durationSeconds', 'enabled': 'enabled'})
    class TargetGroupStickinessConfigProperty():
        def __init__(self, *, duration_seconds: typing.Optional[jsii.Number]=None, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListener.TargetGroupTupleProperty", jsii_struct_bases=[], name_mapping={'target_group_arn': 'targetGroupArn', 'weight': 'weight'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnListenerCertificate(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerCertificate"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, certificates: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CertificateProperty", _IResolvable_9ceae33e]]], listener_arn: str) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnListenerCertificate":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @builtins.property
    @jsii.member(jsii_name="certificates")
    def certificates(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CertificateProperty", _IResolvable_9ceae33e]]]:
    ...
    @certificates.setter
    def certificates(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CertificateProperty", _IResolvable_9ceae33e]]]) -> None:
        jsii.set(self, "certificates", value)
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerCertificate.CertificateProperty", jsii_struct_bases=[], name_mapping={'certificate_arn': 'certificateArn'})
    class CertificateProperty():
        def __init__(self, *, certificate_arn: typing.Optional[str]=None) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerCertificateProps", jsii_struct_bases=[], name_mapping={'certificates': 'certificates', 'listener_arn': 'listenerArn'})
class CfnListenerCertificateProps():
    def __init__(self, *, certificates: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerCertificate.CertificateProperty", _IResolvable_9ceae33e]]], listener_arn: str) -> None:
    ...
    @builtins.property
    def certificates(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerCertificate.CertificateProperty", _IResolvable_9ceae33e]]]:
        """``AWS::ElasticLoadBalancingV2::ListenerCertificate.Certificates``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerProps", jsii_struct_bases=[], name_mapping={'default_actions': 'defaultActions', 'load_balancer_arn': 'loadBalancerArn', 'port': 'port', 'protocol': 'protocol', 'certificates': 'certificates', 'ssl_policy': 'sslPolicy'})
class CfnListenerProps():
    def __init__(self, *, default_actions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListener.ActionProperty", _IResolvable_9ceae33e]]], load_balancer_arn: str, port: jsii.Number, protocol: str, certificates: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListener.CertificateProperty", _IResolvable_9ceae33e]]]]=None, ssl_policy: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def default_actions(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListener.ActionProperty", _IResolvable_9ceae33e]]]:
        """``AWS::ElasticLoadBalancingV2::Listener.DefaultActions``.
    ...
    @builtins.property
    def certificates(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListener.CertificateProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::ElasticLoadBalancingV2::Listener.Certificates``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnListenerRule(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, actions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["ActionProperty", _IResolvable_9ceae33e]]], conditions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["RuleConditionProperty", _IResolvable_9ceae33e]]], listener_arn: str, priority: jsii.Number) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnListenerRule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def conditions(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["RuleConditionProperty", _IResolvable_9ceae33e]]]:
    ...
    @conditions.setter
    def conditions(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["RuleConditionProperty", _IResolvable_9ceae33e]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.ActionProperty", jsii_struct_bases=[], name_mapping={'type': 'type', 'authenticate_cognito_config': 'authenticateCognitoConfig', 'authenticate_oidc_config': 'authenticateOidcConfig', 'fixed_response_config': 'fixedResponseConfig', 'forward_config': 'forwardConfig', 'order': 'order', 'redirect_config': 'redirectConfig', 'target_group_arn': 'targetGroupArn'})
    class ActionProperty():
        def __init__(self, *, type: str, authenticate_cognito_config: typing.Optional[typing.Union["CfnListenerRule.AuthenticateCognitoConfigProperty", _IResolvable_9ceae33e]]=None, authenticate_oidc_config: typing.Optional[typing.Union["CfnListenerRule.AuthenticateOidcConfigProperty", _IResolvable_9ceae33e]]=None, fixed_response_config: typing.Optional[typing.Union["CfnListenerRule.FixedResponseConfigProperty", _IResolvable_9ceae33e]]=None, forward_config: typing.Optional[typing.Union["CfnListenerRule.ForwardConfigProperty", _IResolvable_9ceae33e]]=None, order: typing.Optional[jsii.Number]=None, redirect_config: typing.Optional[typing.Union["CfnListenerRule.RedirectConfigProperty", _IResolvable_9ceae33e]]=None, target_group_arn: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def authenticate_cognito_config(self) -> typing.Optional[typing.Union["CfnListenerRule.AuthenticateCognitoConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def authenticate_oidc_config(self) -> typing.Optional[typing.Union["CfnListenerRule.AuthenticateOidcConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def fixed_response_config(self) -> typing.Optional[typing.Union["CfnListenerRule.FixedResponseConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def forward_config(self) -> typing.Optional[typing.Union["CfnListenerRule.ForwardConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def redirect_config(self) -> typing.Optional[typing.Union["CfnListenerRule.RedirectConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.AuthenticateCognitoConfigProperty", jsii_struct_bases=[], name_mapping={'user_pool_arn': 'userPoolArn', 'user_pool_client_id': 'userPoolClientId', 'user_pool_domain': 'userPoolDomain', 'authentication_request_extra_params': 'authenticationRequestExtraParams', 'on_unauthenticated_request': 'onUnauthenticatedRequest', 'scope': 'scope', 'session_cookie_name': 'sessionCookieName', 'session_timeout': 'sessionTimeout'})
    class AuthenticateCognitoConfigProperty():
        def __init__(self, *, user_pool_arn: str, user_pool_client_id: str, user_pool_domain: str, authentication_request_extra_params: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, on_unauthenticated_request: typing.Optional[str]=None, scope: typing.Optional[str]=None, session_cookie_name: typing.Optional[str]=None, session_timeout: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.AuthenticateOidcConfigProperty", jsii_struct_bases=[], name_mapping={'authorization_endpoint': 'authorizationEndpoint', 'client_id': 'clientId', 'client_secret': 'clientSecret', 'issuer': 'issuer', 'token_endpoint': 'tokenEndpoint', 'user_info_endpoint': 'userInfoEndpoint', 'authentication_request_extra_params': 'authenticationRequestExtraParams', 'on_unauthenticated_request': 'onUnauthenticatedRequest', 'scope': 'scope', 'session_cookie_name': 'sessionCookieName', 'session_timeout': 'sessionTimeout'})
    class AuthenticateOidcConfigProperty():
        def __init__(self, *, authorization_endpoint: str, client_id: str, client_secret: str, issuer: str, token_endpoint: str, user_info_endpoint: str, authentication_request_extra_params: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, on_unauthenticated_request: typing.Optional[str]=None, scope: typing.Optional[str]=None, session_cookie_name: typing.Optional[str]=None, session_timeout: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.FixedResponseConfigProperty", jsii_struct_bases=[], name_mapping={'status_code': 'statusCode', 'content_type': 'contentType', 'message_body': 'messageBody'})
    class FixedResponseConfigProperty():
        def __init__(self, *, status_code: str, content_type: typing.Optional[str]=None, message_body: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.ForwardConfigProperty", jsii_struct_bases=[], name_mapping={'target_groups': 'targetGroups', 'target_group_stickiness_config': 'targetGroupStickinessConfig'})
    class ForwardConfigProperty():
        def __init__(self, *, target_groups: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.TargetGroupTupleProperty", _IResolvable_9ceae33e]]]]=None, target_group_stickiness_config: typing.Optional[typing.Union["CfnListenerRule.TargetGroupStickinessConfigProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def target_groups(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.TargetGroupTupleProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def target_group_stickiness_config(self) -> typing.Optional[typing.Union["CfnListenerRule.TargetGroupStickinessConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.HostHeaderConfigProperty", jsii_struct_bases=[], name_mapping={'values': 'values'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.HttpHeaderConfigProperty", jsii_struct_bases=[], name_mapping={'http_header_name': 'httpHeaderName', 'values': 'values'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.HttpRequestMethodConfigProperty", jsii_struct_bases=[], name_mapping={'values': 'values'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.PathPatternConfigProperty", jsii_struct_bases=[], name_mapping={'values': 'values'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.QueryStringConfigProperty", jsii_struct_bases=[], name_mapping={'values': 'values'})
    class QueryStringConfigProperty():
        def __init__(self, *, values: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.QueryStringKeyValueProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def values(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.QueryStringKeyValueProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.QueryStringKeyValueProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.RedirectConfigProperty", jsii_struct_bases=[], name_mapping={'status_code': 'statusCode', 'host': 'host', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'query': 'query'})
    class RedirectConfigProperty():
        def __init__(self, *, status_code: str, host: typing.Optional[str]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional[str]=None, query: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.RuleConditionProperty", jsii_struct_bases=[], name_mapping={'field': 'field', 'host_header_config': 'hostHeaderConfig', 'http_header_config': 'httpHeaderConfig', 'http_request_method_config': 'httpRequestMethodConfig', 'path_pattern_config': 'pathPatternConfig', 'query_string_config': 'queryStringConfig', 'source_ip_config': 'sourceIpConfig', 'values': 'values'})
    class RuleConditionProperty():
        def __init__(self, *, field: typing.Optional[str]=None, host_header_config: typing.Optional[typing.Union["CfnListenerRule.HostHeaderConfigProperty", _IResolvable_9ceae33e]]=None, http_header_config: typing.Optional[typing.Union["CfnListenerRule.HttpHeaderConfigProperty", _IResolvable_9ceae33e]]=None, http_request_method_config: typing.Optional[typing.Union["CfnListenerRule.HttpRequestMethodConfigProperty", _IResolvable_9ceae33e]]=None, path_pattern_config: typing.Optional[typing.Union["CfnListenerRule.PathPatternConfigProperty", _IResolvable_9ceae33e]]=None, query_string_config: typing.Optional[typing.Union["CfnListenerRule.QueryStringConfigProperty", _IResolvable_9ceae33e]]=None, source_ip_config: typing.Optional[typing.Union["CfnListenerRule.SourceIpConfigProperty", _IResolvable_9ceae33e]]=None, values: typing.Optional[typing.List[str]]=None) -> None:
            """
        ...
        @builtins.property
        def host_header_config(self) -> typing.Optional[typing.Union["CfnListenerRule.HostHeaderConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def http_header_config(self) -> typing.Optional[typing.Union["CfnListenerRule.HttpHeaderConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def http_request_method_config(self) -> typing.Optional[typing.Union["CfnListenerRule.HttpRequestMethodConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def path_pattern_config(self) -> typing.Optional[typing.Union["CfnListenerRule.PathPatternConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def query_string_config(self) -> typing.Optional[typing.Union["CfnListenerRule.QueryStringConfigProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def source_ip_config(self) -> typing.Optional[typing.Union["CfnListenerRule.SourceIpConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.SourceIpConfigProperty", jsii_struct_bases=[], name_mapping={'values': 'values'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.TargetGroupStickinessConfigProperty", jsii_struct_bases=[], name_mapping={'duration_seconds': 'durationSeconds', 'enabled': 'enabled'})
    class TargetGroupStickinessConfigProperty():
        def __init__(self, *, duration_seconds: typing.Optional[jsii.Number]=None, enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRule.TargetGroupTupleProperty", jsii_struct_bases=[], name_mapping={'target_group_arn': 'targetGroupArn', 'weight': 'weight'})
    class TargetGroupTupleProperty():
        def __init__(self, *, target_group_arn: typing.Optional[str]=None, weight: typing.Optional[jsii.Number]=None) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnListenerRuleProps", jsii_struct_bases=[], name_mapping={'actions': 'actions', 'conditions': 'conditions', 'listener_arn': 'listenerArn', 'priority': 'priority'})
class CfnListenerRuleProps():
    def __init__(self, *, actions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.ActionProperty", _IResolvable_9ceae33e]]], conditions: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.RuleConditionProperty", _IResolvable_9ceae33e]]], listener_arn: str, priority: jsii.Number) -> None:
    ...
    @builtins.property
    def actions(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.ActionProperty", _IResolvable_9ceae33e]]]:
        """``AWS::ElasticLoadBalancingV2::ListenerRule.Actions``.
    ...
    @builtins.property
    def conditions(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnListenerRule.RuleConditionProperty", _IResolvable_9ceae33e]]]:
        """``AWS::ElasticLoadBalancingV2::ListenerRule.Conditions``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnLoadBalancer(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnLoadBalancer"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, ip_address_type: typing.Optional[str]=None, load_balancer_attributes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["LoadBalancerAttributeProperty", _IResolvable_9ceae33e]]]]=None, name: typing.Optional[str]=None, scheme: typing.Optional[str]=None, security_groups: typing.Optional[typing.List[str]]=None, subnet_mappings: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["SubnetMappingProperty", _IResolvable_9ceae33e]]]]=None, subnets: typing.Optional[typing.List[str]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, type: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnLoadBalancer":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def load_balancer_attributes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["LoadBalancerAttributeProperty", _IResolvable_9ceae33e]]]]:
    ...
    def load_balancer_attributes(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["LoadBalancerAttributeProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    def subnet_mappings(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["SubnetMappingProperty", _IResolvable_9ceae33e]]]]:
    ...
    def subnet_mappings(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["SubnetMappingProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnLoadBalancer.LoadBalancerAttributeProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnLoadBalancer.SubnetMappingProperty", jsii_struct_bases=[], name_mapping={'subnet_id': 'subnetId', 'allocation_id': 'allocationId', 'private_i_pv4_address': 'privateIPv4Address'})
    class SubnetMappingProperty():
        def __init__(self, *, subnet_id: str, allocation_id: typing.Optional[str]=None, private_i_pv4_address: typing.Optional[str]=None) -> None:
            """
            ...
            if private_i_pv4_address is not None: self._values["private_i_pv4_address"] = private_i_pv4_address
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnLoadBalancerProps", jsii_struct_bases=[], name_mapping={'ip_address_type': 'ipAddressType', 'load_balancer_attributes': 'loadBalancerAttributes', 'name': 'name', 'scheme': 'scheme', 'security_groups': 'securityGroups', 'subnet_mappings': 'subnetMappings', 'subnets': 'subnets', 'tags': 'tags', 'type': 'type'})
class CfnLoadBalancerProps():
    def __init__(self, *, ip_address_type: typing.Optional[str]=None, load_balancer_attributes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnLoadBalancer.LoadBalancerAttributeProperty", _IResolvable_9ceae33e]]]]=None, name: typing.Optional[str]=None, scheme: typing.Optional[str]=None, security_groups: typing.Optional[typing.List[str]]=None, subnet_mappings: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnLoadBalancer.SubnetMappingProperty", _IResolvable_9ceae33e]]]]=None, subnets: typing.Optional[typing.List[str]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, type: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def load_balancer_attributes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnLoadBalancer.LoadBalancerAttributeProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::ElasticLoadBalancingV2::LoadBalancer.LoadBalancerAttributes``.
    ...
    @builtins.property
    def subnet_mappings(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnLoadBalancer.SubnetMappingProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::ElasticLoadBalancingV2::LoadBalancer.SubnetMappings``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnTargetGroup(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnTargetGroup"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, health_check_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, health_check_interval_seconds: typing.Optional[jsii.Number]=None, health_check_path: typing.Optional[str]=None, health_check_port: typing.Optional[str]=None, health_check_protocol: typing.Optional[str]=None, health_check_timeout_seconds: typing.Optional[jsii.Number]=None, healthy_threshold_count: typing.Optional[jsii.Number]=None, matcher: typing.Optional[typing.Union["MatcherProperty", _IResolvable_9ceae33e]]=None, name: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, target_group_attributes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetGroupAttributeProperty", _IResolvable_9ceae33e]]]]=None, targets: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetDescriptionProperty", _IResolvable_9ceae33e]]]]=None, target_type: typing.Optional[str]=None, unhealthy_threshold_count: typing.Optional[jsii.Number]=None, vpc_id: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnTargetGroup":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def health_check_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def health_check_enabled(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def matcher(self) -> typing.Optional[typing.Union["MatcherProperty", _IResolvable_9ceae33e]]:
    ...
    @matcher.setter
    def matcher(self, value: typing.Optional[typing.Union["MatcherProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def target_group_attributes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetGroupAttributeProperty", _IResolvable_9ceae33e]]]]:
    ...
    def target_group_attributes(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetGroupAttributeProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "targetGroupAttributes", value)

    @builtins.property
    @jsii.member(jsii_name="targets")
    def targets(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetDescriptionProperty", _IResolvable_9ceae33e]]]]:
    ...
    @targets.setter
    def targets(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetDescriptionProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnTargetGroup.MatcherProperty", jsii_struct_bases=[], name_mapping={'http_code': 'httpCode'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnTargetGroup.TargetDescriptionProperty", jsii_struct_bases=[], name_mapping={'id': 'id', 'availability_zone': 'availabilityZone', 'port': 'port'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnTargetGroup.TargetGroupAttributeProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.CfnTargetGroupProps", jsii_struct_bases=[], name_mapping={'health_check_enabled': 'healthCheckEnabled', 'health_check_interval_seconds': 'healthCheckIntervalSeconds', 'health_check_path': 'healthCheckPath', 'health_check_port': 'healthCheckPort', 'health_check_protocol': 'healthCheckProtocol', 'health_check_timeout_seconds': 'healthCheckTimeoutSeconds', 'healthy_threshold_count': 'healthyThresholdCount', 'matcher': 'matcher', 'name': 'name', 'port': 'port', 'protocol': 'protocol', 'tags': 'tags', 'target_group_attributes': 'targetGroupAttributes', 'targets': 'targets', 'target_type': 'targetType', 'unhealthy_threshold_count': 'unhealthyThresholdCount', 'vpc_id': 'vpcId'})
class CfnTargetGroupProps():
    def __init__(self, *, health_check_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, health_check_interval_seconds: typing.Optional[jsii.Number]=None, health_check_path: typing.Optional[str]=None, health_check_port: typing.Optional[str]=None, health_check_protocol: typing.Optional[str]=None, health_check_timeout_seconds: typing.Optional[jsii.Number]=None, healthy_threshold_count: typing.Optional[jsii.Number]=None, matcher: typing.Optional[typing.Union["CfnTargetGroup.MatcherProperty", _IResolvable_9ceae33e]]=None, name: typing.Optional[str]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, target_group_attributes: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTargetGroup.TargetGroupAttributeProperty", _IResolvable_9ceae33e]]]]=None, targets: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTargetGroup.TargetDescriptionProperty", _IResolvable_9ceae33e]]]]=None, target_type: typing.Optional[str]=None, unhealthy_threshold_count: typing.Optional[jsii.Number]=None, vpc_id: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def matcher(self) -> typing.Optional[typing.Union["CfnTargetGroup.MatcherProperty", _IResolvable_9ceae33e]]:
        """``AWS::ElasticLoadBalancingV2::TargetGroup.Matcher``.
    ...
    @builtins.property
    def target_group_attributes(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTargetGroup.TargetGroupAttributeProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::ElasticLoadBalancingV2::TargetGroup.TargetGroupAttributes``.
    ...
    @builtins.property
    def targets(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnTargetGroup.TargetDescriptionProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::ElasticLoadBalancingV2::TargetGroup.Targets``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.FixedResponse", jsii_struct_bases=[], name_mapping={'status_code': 'statusCode', 'content_type': 'contentType', 'message_body': 'messageBody'})
class FixedResponse():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.FixedResponseOptions", jsii_struct_bases=[], name_mapping={'content_type': 'contentType', 'message_body': 'messageBody'})
class FixedResponseOptions():
    def __init__(self, *, content_type: typing.Optional[str]=None, message_body: typing.Optional[str]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'FixedResponseOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ForwardOptions", jsii_struct_bases=[], name_mapping={'stickiness_duration': 'stickinessDuration'})
class ForwardOptions():
    def __init__(self, *, stickiness_duration: typing.Optional[_Duration_5170c158]=None) -> None:
        ...
        if stickiness_duration is not None: self._values["stickiness_duration"] = stickiness_duration
    ...
    def __repr__(self) -> str:
        return 'ForwardOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.HealthCheck", jsii_struct_bases=[], name_mapping={'enabled': 'enabled', 'healthy_http_codes': 'healthyHttpCodes', 'healthy_threshold_count': 'healthyThresholdCount', 'interval': 'interval', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'timeout': 'timeout', 'unhealthy_threshold_count': 'unhealthyThresholdCount'})
class HealthCheck():
    def __init__(self, *, enabled: typing.Optional[bool]=None, healthy_http_codes: typing.Optional[str]=None, healthy_threshold_count: typing.Optional[jsii.Number]=None, interval: typing.Optional[_Duration_5170c158]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional["Protocol"]=None, timeout: typing.Optional[_Duration_5170c158]=None, unhealthy_threshold_count: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IApplicationListener")
class IApplicationListener(_IResource_72f7ee7e, _IConnectable_a587039f, jsii.compat.Protocol):
    """Properties to reference an existing listener.
    ...
    def add_target_groups(self, id: str, *, target_groups: typing.List["IApplicationTargetGroup"], conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
    ...
    def add_targets(self, id: str, *, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[_Duration_5170c158]=None, stickiness_cookie_duration: typing.Optional[_Duration_5170c158]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> "ApplicationTargetGroup":
    ...
    def register_connectable(self, connectable: _IConnectable_a587039f, port_range: _Port_7d870cca) -> None:
...
class _IApplicationListenerProxy(jsii.proxy_for(_IResource_72f7ee7e), jsii.proxy_for(_IConnectable_a587039f)):
    """Properties to reference an existing listener.
    ...
    def add_target_groups(self, id: str, *, target_groups: typing.List["IApplicationTargetGroup"], conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        ...
        :stability: experimental
        """
        props = AddApplicationTargetGroupsProps(target_groups=target_groups, conditions=conditions, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority)
    ...
    def add_targets(self, id: str, *, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[_Duration_5170c158]=None, stickiness_cookie_duration: typing.Optional[_Duration_5170c158]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> "ApplicationTargetGroup":
        ...
        :stability: experimental
        """
        props = AddApplicationTargetsProps(deregistration_delay=deregistration_delay, health_check=health_check, port=port, protocol=protocol, slow_start=slow_start, stickiness_cookie_duration=stickiness_cookie_duration, target_group_name=target_group_name, targets=targets, conditions=conditions, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority)
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IApplicationLoadBalancerTarget")
...
class _IApplicationLoadBalancerTargetProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_elasticloadbalancingv2.IApplicationLoadBalancerTarget"
    @jsii.member(jsii_name="attachToApplicationTargetGroup")
    def attach_to_application_target_group(self, target_group: "IApplicationTargetGroup") -> "LoadBalancerTargetProps":
        """Attach load-balanced target to a TargetGroup.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IListenerAction")
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IListenerCertificate")
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ILoadBalancerV2")
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.INetworkListener")
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.INetworkListenerCertificateProps")
...
class _INetworkListenerCertificatePropsProxy(jsii.proxy_for(IListenerCertificate)):
    ...
    :stability: deprecated
    """
    __jsii_type__ = "monocdk-experiment.aws_elasticloadbalancingv2.INetworkListenerCertificateProps"
    pass

@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.INetworkLoadBalancer")
class INetworkLoadBalancer(ILoadBalancerV2, _IVpcEndpointServiceLoadBalancer_98c930f6, jsii.compat.Protocol):
    ...
    def add_listener(self, id: str, *, port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["NetworkListenerAction"]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> "NetworkListener":
...
class _INetworkLoadBalancerProxy(jsii.proxy_for(ILoadBalancerV2), jsii.proxy_for(_IVpcEndpointServiceLoadBalancer_98c930f6)):
    """A network load balancer.
    ...
    def add_listener(self, id: str, *, port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["NetworkListenerAction"]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> "NetworkListener":
        ...
        :stability: experimental
        """
        props = BaseNetworkListenerProps(port=port, certificates=certificates, default_action=default_action, default_target_groups=default_target_groups, protocol=protocol, ssl_policy=ssl_policy)

        return jsii.invoke(self, "addListener", [id, props])


@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.INetworkLoadBalancerTarget")
...
class _INetworkLoadBalancerTargetProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_elasticloadbalancingv2.INetworkLoadBalancerTarget"
    @jsii.member(jsii_name="attachToNetworkTargetGroup")
    def attach_to_network_target_group(self, target_group: "INetworkTargetGroup") -> "LoadBalancerTargetProps":
        """Attach load-balanced target to a TargetGroup.
...
class InstanceTarget(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.InstanceTarget"):
...
@jsii.implements(IApplicationLoadBalancerTarget, INetworkLoadBalancerTarget)
class IpTarget(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IpTarget"):
...
class ListenerAction(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ListenerAction"):
    ...
    *(weighted)forward*, *fixedResponse* or *redirect* action.
    ...
    :stability: experimental
    """
    def __init__(self, action_json: "CfnListener.ActionProperty", next: typing.Optional["ListenerAction"]=None) -> None:
    ...
    @builtins.classmethod
    def authenticate_oidc(cls, *, authorization_endpoint: str, client_id: str, client_secret: _SecretValue_99478b8b, issuer: str, next: "ListenerAction", token_endpoint: str, user_info_endpoint: str, authentication_request_extra_params: typing.Optional[typing.Mapping[str, str]]=None, on_unauthenticated_request: typing.Optional["UnauthenticatedAction"]=None, scope: typing.Optional[str]=None, session_cookie_name: typing.Optional[str]=None, session_timeout: typing.Optional[_Duration_5170c158]=None) -> "ListenerAction":
    ...
    def fixed_response(cls, status_code: jsii.Number, *, content_type: typing.Optional[str]=None, message_body: typing.Optional[str]=None) -> "ListenerAction":
        ...
        :stability: experimental
        """
        options = FixedResponseOptions(content_type=content_type, message_body=message_body)

        return jsii.sinvoke(cls, "fixedResponse", [status_code, options])

    @jsii.member(jsii_name="forward")
    @builtins.classmethod
    def forward(cls, target_groups: typing.List["IApplicationTargetGroup"], *, stickiness_duration: typing.Optional[_Duration_5170c158]=None) -> "ListenerAction":
    ...
    @builtins.classmethod
    def redirect(cls, *, host: typing.Optional[str]=None, path: typing.Optional[str]=None, permanent: typing.Optional[bool]=None, port: typing.Optional[str]=None, protocol: typing.Optional[str]=None, query: typing.Optional[str]=None) -> "ListenerAction":
        ...
        :stability: experimental
        """
        options = RedirectOptions(host=host, path=path, permanent=permanent, port=port, protocol=protocol, query=query)

        return jsii.sinvoke(cls, "redirect", [options])

    @jsii.member(jsii_name="weightedForward")
    @builtins.classmethod
    def weighted_forward(cls, target_groups: typing.List["WeightedTargetGroup"], *, stickiness_duration: typing.Optional[_Duration_5170c158]=None) -> "ListenerAction":
    ...
    def bind(self, scope: _Construct_f50a3f53, listener: "IApplicationListener", associating_construct: typing.Optional[_IConstruct_db0cc7e3]=None) -> None:
    ...
    def _renumber(self, actions: typing.List["CfnListener.ActionProperty"]) -> typing.List["CfnListener.ActionProperty"]:
...
class ListenerCertificate(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ListenerCertificate"):
    """A certificate source for an ELBv2 listener.
    ...
    @builtins.classmethod
    def from_certificate_manager(cls, acm_certificate: _ICertificate_8f3d4c96) -> "ListenerCertificate":
...
class ListenerCondition(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ListenerCondition"):
    ...
    @builtins.classmethod
    def query_strings(cls, values: typing.List["QueryStringCondition"]) -> "ListenerCondition":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.LoadBalancerTargetProps", jsii_struct_bases=[], name_mapping={'target_type': 'targetType', 'target_json': 'targetJson'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkForwardOptions", jsii_struct_bases=[], name_mapping={'stickiness_duration': 'stickinessDuration'})
class NetworkForwardOptions():
    ...
    def __repr__(self) -> str:
        return 'NetworkForwardOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(INetworkListener)
class NetworkListener(BaseListener, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkListener"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, load_balancer: "INetworkLoadBalancer", port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["NetworkListenerAction"]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = NetworkListenerProps(load_balancer=load_balancer, port=port, certificates=certificates, default_action=default_action, default_target_groups=default_target_groups, protocol=protocol, ssl_policy=ssl_policy)

        jsii.create(NetworkListener, self, [scope, id, props])

    @jsii.member(jsii_name="fromNetworkListenerArn")
    @builtins.classmethod
    def from_network_listener_arn(cls, scope: _Construct_f50a3f53, id: str, network_listener_arn: str) -> "INetworkListener":
    ...
    @jsii.member(jsii_name="addTargets")
    def add_targets(self, id: str, *, port: jsii.Number, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, proxy_protocol_v2: typing.Optional[bool]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["INetworkLoadBalancerTarget"]]=None) -> "NetworkTargetGroup":
        """Load balance incoming requests to the given load balancing targets.
...
@jsii.implements(IListenerAction)
class NetworkListenerAction(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkListenerAction"):
    """What to do when a client makes a request to a listener.
    ...
    *(weighted)forward*, *fixedResponse* or *redirect* action.
    ...
    :stability: experimental
    """
    def __init__(self, action_json: "CfnListener.ActionProperty", next: typing.Optional["NetworkListenerAction"]=None) -> None:
    ...
    @jsii.member(jsii_name="forward")
    @builtins.classmethod
    def forward(cls, target_groups: typing.List["INetworkTargetGroup"], *, stickiness_duration: typing.Optional[_Duration_5170c158]=None) -> "NetworkListenerAction":
        """Forward to one or more Target Groups.
    ...
    @jsii.member(jsii_name="weightedForward")
    @builtins.classmethod
    def weighted_forward(cls, target_groups: typing.List["NetworkWeightedTargetGroup"], *, stickiness_duration: typing.Optional[_Duration_5170c158]=None) -> "NetworkListenerAction":
        """Forward to one or more Target Groups which are weighted differently.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkListenerProps", jsii_struct_bases=[BaseNetworkListenerProps], name_mapping={'port': 'port', 'certificates': 'certificates', 'default_action': 'defaultAction', 'default_target_groups': 'defaultTargetGroups', 'protocol': 'protocol', 'ssl_policy': 'sslPolicy', 'load_balancer': 'loadBalancer'})
class NetworkListenerProps(BaseNetworkListenerProps):
    def __init__(self, *, port: jsii.Number, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["NetworkListenerAction"]=None, default_target_groups: typing.Optional[typing.List["INetworkTargetGroup"]]=None, protocol: typing.Optional["Protocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None, load_balancer: "INetworkLoadBalancer") -> None:
...
class NetworkLoadBalancer(BaseLoadBalancer, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkLoadBalancer"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cross_zone_enabled: typing.Optional[bool]=None, vpc: _IVpc_3795853f, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_network_load_balancer_attributes(cls, scope: _Construct_f50a3f53, id: str, *, load_balancer_arn: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> "INetworkLoadBalancer":
        """
        :param scope: -
        :param id: -
        :param load_balancer_arn: ARN of the load balancer.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkLoadBalancerAttributes", jsii_struct_bases=[], name_mapping={'load_balancer_arn': 'loadBalancerArn', 'load_balancer_canonical_hosted_zone_id': 'loadBalancerCanonicalHostedZoneId', 'load_balancer_dns_name': 'loadBalancerDnsName', 'vpc': 'vpc'})
class NetworkLoadBalancerAttributes():
    def __init__(self, *, load_balancer_arn: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> None:
        """Properties to reference an existing load balancer.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkLoadBalancerProps", jsii_struct_bases=[BaseLoadBalancerProps], name_mapping={'vpc': 'vpc', 'deletion_protection': 'deletionProtection', 'internet_facing': 'internetFacing', 'load_balancer_name': 'loadBalancerName', 'vpc_subnets': 'vpcSubnets', 'cross_zone_enabled': 'crossZoneEnabled'})
class NetworkLoadBalancerProps(BaseLoadBalancerProps):
    def __init__(self, *, vpc: _IVpc_3795853f, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None, cross_zone_enabled: typing.Optional[bool]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkTargetGroupProps", jsii_struct_bases=[BaseTargetGroupProps], name_mapping={'deregistration_delay': 'deregistrationDelay', 'health_check': 'healthCheck', 'target_group_name': 'targetGroupName', 'target_type': 'targetType', 'vpc': 'vpc', 'port': 'port', 'protocol': 'protocol', 'proxy_protocol_v2': 'proxyProtocolV2', 'targets': 'targets'})
class NetworkTargetGroupProps(BaseTargetGroupProps):
    def __init__(self, *, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[_IVpc_3795853f]=None, port: jsii.Number, protocol: typing.Optional["Protocol"]=None, proxy_protocol_v2: typing.Optional[bool]=None, targets: typing.Optional[typing.List["INetworkLoadBalancerTarget"]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkWeightedTargetGroup", jsii_struct_bases=[], name_mapping={'target_group': 'targetGroup', 'weight': 'weight'})
class NetworkWeightedTargetGroup():
    def __init__(self, *, target_group: "INetworkTargetGroup", weight: typing.Optional[jsii.Number]=None) -> None:
    ...
    def __repr__(self) -> str:
        return 'NetworkWeightedTargetGroup(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.QueryStringCondition", jsii_struct_bases=[], name_mapping={'value': 'value', 'key': 'key'})
class QueryStringCondition():
    ...
    def __repr__(self) -> str:
        return 'QueryStringCondition(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.RedirectOptions", jsii_struct_bases=[], name_mapping={'host': 'host', 'path': 'path', 'permanent': 'permanent', 'port': 'port', 'protocol': 'protocol', 'query': 'query'})
class RedirectOptions():
    def __init__(self, *, host: typing.Optional[str]=None, path: typing.Optional[str]=None, permanent: typing.Optional[bool]=None, port: typing.Optional[str]=None, protocol: typing.Optional[str]=None, query: typing.Optional[str]=None) -> None:
        ...
        if host is not None: self._values["host"] = host
        if path is not None: self._values["path"] = path
        if permanent is not None: self._values["permanent"] = permanent
        if port is not None: self._values["port"] = port
        if protocol is not None: self._values["protocol"] = protocol
        if query is not None: self._values["query"] = query
    ...
    def __repr__(self) -> str:
        return 'RedirectOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.RedirectResponse", jsii_struct_bases=[], name_mapping={'status_code': 'statusCode', 'host': 'host', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'query': 'query'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.TargetGroupAttributes", jsii_struct_bases=[], name_mapping={'target_group_arn': 'targetGroupArn', 'default_port': 'defaultPort', 'load_balancer_arns': 'loadBalancerArns'})
...
class TargetGroupBase(_Construct_f50a3f53, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.TargetGroupBase"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, base_props: "BaseTargetGroupProps", additional_props: typing.Any) -> None:
        """
        :param scope: -
        :param id: -
        :param base_props: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.TargetGroupImportProps", jsii_struct_bases=[TargetGroupAttributes], name_mapping={'target_group_arn': 'targetGroupArn', 'default_port': 'defaultPort', 'load_balancer_arns': 'loadBalancerArns'})
...
@jsii.enum(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.UnauthenticatedAction")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.WeightedTargetGroup", jsii_struct_bases=[], name_mapping={'target_group': 'targetGroup', 'weight': 'weight'})
class WeightedTargetGroup():
    def __init__(self, *, target_group: "IApplicationTargetGroup", weight: typing.Optional[jsii.Number]=None) -> None:
        """A Target Group and weight combination.
    ...
    def __repr__(self) -> str:
        return 'WeightedTargetGroup(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddApplicationActionProps", jsii_struct_bases=[AddRuleProps], name_mapping={'conditions': 'conditions', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'action': 'action'})
class AddApplicationActionProps(AddRuleProps):
    def __init__(self, *, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, action: "ListenerAction") -> None:
        """Properties for adding a new action to a listener.
    ...
    def __repr__(self) -> str:
        return 'AddApplicationActionProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddApplicationTargetGroupsProps", jsii_struct_bases=[AddRuleProps], name_mapping={'conditions': 'conditions', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'target_groups': 'targetGroups'})
class AddApplicationTargetGroupsProps(AddRuleProps):
    def __init__(self, *, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, target_groups: typing.List["IApplicationTargetGroup"]) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddApplicationTargetsProps", jsii_struct_bases=[AddRuleProps], name_mapping={'conditions': 'conditions', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'deregistration_delay': 'deregistrationDelay', 'health_check': 'healthCheck', 'port': 'port', 'protocol': 'protocol', 'slow_start': 'slowStart', 'stickiness_cookie_duration': 'stickinessCookieDuration', 'target_group_name': 'targetGroupName', 'targets': 'targets'})
class AddApplicationTargetsProps(AddRuleProps):
    def __init__(self, *, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[_Duration_5170c158]=None, stickiness_cookie_duration: typing.Optional[_Duration_5170c158]=None, target_group_name: typing.Optional[str]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddFixedResponseProps", jsii_struct_bases=[AddRuleProps, FixedResponse], name_mapping={'conditions': 'conditions', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'status_code': 'statusCode', 'content_type': 'contentType', 'message_body': 'messageBody'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.AddRedirectResponseProps", jsii_struct_bases=[AddRuleProps, RedirectResponse], name_mapping={'conditions': 'conditions', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'status_code': 'statusCode', 'host': 'host', 'path': 'path', 'port': 'port', 'protocol': 'protocol', 'query': 'query'})
...
class ApplicationListener(BaseListener, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListener"):
    ...
    :resource:: AWS::ElasticLoadBalancingV2::Listener
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, load_balancer: "IApplicationLoadBalancer", certificate_arns: typing.Optional[typing.List[str]]=None, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["ListenerAction"]=None, default_target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, open: typing.Optional[bool]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param load_balancer: The load balancer to attach this listener to.
        ...
        :stability: experimental
        """
        props = ApplicationListenerProps(load_balancer=load_balancer, certificate_arns=certificate_arns, certificates=certificates, default_action=default_action, default_target_groups=default_target_groups, open=open, port=port, protocol=protocol, ssl_policy=ssl_policy)

        jsii.create(ApplicationListener, self, [scope, id, props])

    @jsii.member(jsii_name="fromApplicationListenerAttributes")
    @builtins.classmethod
    def from_application_listener_attributes(cls, scope: _Construct_f50a3f53, id: str, *, listener_arn: str, default_port: typing.Optional[jsii.Number]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, security_group_id: typing.Optional[str]=None) -> "IApplicationListener":
        """Import an existing listener.
    ...
    @jsii.member(jsii_name="addAction")
    def add_action(self, id: str, *, action: "ListenerAction", conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        ...
        :stability: experimental
        """
        props = AddApplicationActionProps(action=action, conditions=conditions, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority)
    ...
    @jsii.member(jsii_name="addFixedResponse")
    def add_fixed_response(self, id: str, *, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, status_code: str, content_type: typing.Optional["ContentType"]=None, message_body: typing.Optional[str]=None) -> None:
        """Add a fixed response.
        ...
        :stability: deprecated
        """
        props = AddFixedResponseProps(conditions=conditions, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority, status_code=status_code, content_type=content_type, message_body=message_body)

        return jsii.invoke(self, "addFixedResponse", [id, props])

    @jsii.member(jsii_name="addRedirectResponse")
    def add_redirect_response(self, id: str, *, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, status_code: str, host: typing.Optional[str]=None, path: typing.Optional[str]=None, port: typing.Optional[str]=None, protocol: typing.Optional[str]=None, query: typing.Optional[str]=None) -> None:
        """Add a redirect response.
        ...
        :stability: deprecated
        """
        props = AddRedirectResponseProps(conditions=conditions, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority, status_code=status_code, host=host, path=path, port=port, protocol=protocol, query=query)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListenerProps", jsii_struct_bases=[BaseApplicationListenerProps], name_mapping={'certificate_arns': 'certificateArns', 'certificates': 'certificates', 'default_action': 'defaultAction', 'default_target_groups': 'defaultTargetGroups', 'open': 'open', 'port': 'port', 'protocol': 'protocol', 'ssl_policy': 'sslPolicy', 'load_balancer': 'loadBalancer'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationListenerRuleProps", jsii_struct_bases=[BaseApplicationListenerRuleProps], name_mapping={'priority': 'priority', 'action': 'action', 'conditions': 'conditions', 'fixed_response': 'fixedResponse', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'redirect_response': 'redirectResponse', 'target_groups': 'targetGroups', 'listener': 'listener'})
class ApplicationListenerRuleProps(BaseApplicationListenerRuleProps):
    def __init__(self, *, priority: jsii.Number, action: typing.Optional["ListenerAction"]=None, conditions: typing.Optional[typing.List["ListenerCondition"]]=None, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, listener: "IApplicationListener") -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationLoadBalancerProps", jsii_struct_bases=[BaseLoadBalancerProps], name_mapping={'vpc': 'vpc', 'deletion_protection': 'deletionProtection', 'internet_facing': 'internetFacing', 'load_balancer_name': 'loadBalancerName', 'vpc_subnets': 'vpcSubnets', 'http2_enabled': 'http2Enabled', 'idle_timeout': 'idleTimeout', 'ip_address_type': 'ipAddressType', 'security_group': 'securityGroup'})
class ApplicationLoadBalancerProps(BaseLoadBalancerProps):
    def __init__(self, *, vpc: _IVpc_3795853f, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None, http2_enabled: typing.Optional[bool]=None, idle_timeout: typing.Optional[_Duration_5170c158]=None, ip_address_type: typing.Optional["IpAddressType"]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationTargetGroupProps", jsii_struct_bases=[BaseTargetGroupProps], name_mapping={'deregistration_delay': 'deregistrationDelay', 'health_check': 'healthCheck', 'target_group_name': 'targetGroupName', 'target_type': 'targetType', 'vpc': 'vpc', 'port': 'port', 'protocol': 'protocol', 'slow_start': 'slowStart', 'stickiness_cookie_duration': 'stickinessCookieDuration', 'targets': 'targets'})
class ApplicationTargetGroupProps(BaseTargetGroupProps):
    def __init__(self, *, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[_IVpc_3795853f]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[_Duration_5170c158]=None, stickiness_cookie_duration: typing.Optional[_Duration_5170c158]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None) -> None:
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IApplicationLoadBalancer")
class IApplicationLoadBalancer(ILoadBalancerV2, _IConnectable_a587039f, jsii.compat.Protocol):
...
class _IApplicationLoadBalancerProxy(jsii.proxy_for(ILoadBalancerV2), jsii.proxy_for(_IConnectable_a587039f)):
    """An application load balancer.

    stability
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_elasticloadbalancingv2.IApplicationLoadBalancer"
    @builtins.property
    @jsii.member(jsii_name="loadBalancerArn")
    def load_balancer_arn(self) -> str:
        """The ARN of this load balancer.
    ...
    def add_listener(self, id: str, *, certificate_arns: typing.Optional[typing.List[str]]=None, certificates: typing.Optional[typing.List["IListenerCertificate"]]=None, default_action: typing.Optional["ListenerAction"]=None, default_target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, open: typing.Optional[bool]=None, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, ssl_policy: typing.Optional["SslPolicy"]=None) -> "ApplicationListener":
        ...
        :stability: experimental
        """
        props = BaseApplicationListenerProps(certificate_arns=certificate_arns, certificates=certificates, default_action=default_action, default_target_groups=default_target_groups, open=open, port=port, protocol=protocol, ssl_policy=ssl_policy)

        return jsii.invoke(self, "addListener", [id, props])


@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.IApplicationTargetGroup")
class IApplicationTargetGroup(ITargetGroup, jsii.compat.Protocol):
    ...
    @jsii.member(jsii_name="registerConnectable")
    def register_connectable(self, connectable: _IConnectable_a587039f, port_range: typing.Optional[_Port_7d870cca]=None) -> None:
    ...
    def register_listener(self, listener: "IApplicationListener", associating_construct: typing.Optional[_IConstruct_db0cc7e3]=None) -> None:
...
class _IApplicationTargetGroupProxy(jsii.proxy_for(ITargetGroup)):
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_elasticloadbalancingv2.IApplicationTargetGroup"
    @jsii.member(jsii_name="addTarget")
    def add_target(self, *targets: "IApplicationLoadBalancerTarget") -> None:
        """Add a load balancing target to this target group.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.INetworkTargetGroup")
...
class NetworkTargetGroup(TargetGroupBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.NetworkTargetGroup"):
    """Define a Network Target Group.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, port: jsii.Number, protocol: typing.Optional["Protocol"]=None, proxy_protocol_v2: typing.Optional[bool]=None, targets: typing.Optional[typing.List["INetworkLoadBalancerTarget"]]=None, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param port: The port on which the listener listens for requests.
        ...
        :stability: experimental
        """
        props = NetworkTargetGroupProps(port=port, protocol=protocol, proxy_protocol_v2=proxy_protocol_v2, targets=targets, deregistration_delay=deregistration_delay, health_check=health_check, target_group_name=target_group_name, target_type=target_type, vpc=vpc)

        jsii.create(NetworkTargetGroup, self, [scope, id, props])

    @jsii.member(jsii_name="fromTargetGroupAttributes")
    @builtins.classmethod
    def from_target_group_attributes(cls, scope: _Construct_f50a3f53, id: str, *, target_group_arn: str, default_port: typing.Optional[str]=None, load_balancer_arns: typing.Optional[str]=None) -> "INetworkTargetGroup":
    ...
    @builtins.classmethod
    def import_(cls, scope: _Construct_f50a3f53, id: str, *, target_group_arn: str, default_port: typing.Optional[str]=None, load_balancer_arns: typing.Optional[str]=None) -> "INetworkTargetGroup":
        """Import an existing listener.
...
class ApplicationLoadBalancer(BaseLoadBalancer, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationLoadBalancer"):
    ...
    :resource:: AWS::ElasticLoadBalancingV2::LoadBalancer
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, http2_enabled: typing.Optional[bool]=None, idle_timeout: typing.Optional[_Duration_5170c158]=None, ip_address_type: typing.Optional["IpAddressType"]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None, vpc: _IVpc_3795853f, deletion_protection: typing.Optional[bool]=None, internet_facing: typing.Optional[bool]=None, load_balancer_name: typing.Optional[str]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param http2_enabled: Indicates whether HTTP/2 is enabled. Default: true
    ...
    @builtins.classmethod
    def from_application_load_balancer_attributes(cls, scope: _Construct_f50a3f53, id: str, *, load_balancer_arn: str, security_group_id: str, load_balancer_canonical_hosted_zone_id: typing.Optional[str]=None, load_balancer_dns_name: typing.Optional[str]=None, security_group_allows_all_outbound: typing.Optional[bool]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> "IApplicationLoadBalancer":
...
class ApplicationTargetGroup(TargetGroupBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_elasticloadbalancingv2.ApplicationTargetGroup"):
    """Define an Application Target Group.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, port: typing.Optional[jsii.Number]=None, protocol: typing.Optional["ApplicationProtocol"]=None, slow_start: typing.Optional[_Duration_5170c158]=None, stickiness_cookie_duration: typing.Optional[_Duration_5170c158]=None, targets: typing.Optional[typing.List["IApplicationLoadBalancerTarget"]]=None, deregistration_delay: typing.Optional[_Duration_5170c158]=None, health_check: typing.Optional["HealthCheck"]=None, target_group_name: typing.Optional[str]=None, target_type: typing.Optional["TargetType"]=None, vpc: typing.Optional[_IVpc_3795853f]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param port: The port on which the listener listens for requests. Default: - Determined from protocol if known, optional for Lambda targets.
    ...
    @jsii.member(jsii_name="fromTargetGroupAttributes")
    @builtins.classmethod
    def from_target_group_attributes(cls, scope: _Construct_f50a3f53, id: str, *, target_group_arn: str, default_port: typing.Optional[str]=None, load_balancer_arns: typing.Optional[str]=None) -> "IApplicationTargetGroup":
        """Import an existing target group.
    ...
    @jsii.member(jsii_name="import")
    @builtins.classmethod
    def import_(cls, scope: _Construct_f50a3f53, id: str, *, target_group_arn: str, default_port: typing.Optional[str]=None, load_balancer_arns: typing.Optional[str]=None) -> "IApplicationTargetGroup":
        """Import an existing target group.
