...
class CfnAssociation(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnAssociation"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, association_name: typing.Optional[str]=None, automation_target_parameter_name: typing.Optional[str]=None, compliance_severity: typing.Optional[str]=None, document_version: typing.Optional[str]=None, instance_id: typing.Optional[str]=None, max_concurrency: typing.Optional[str]=None, max_errors: typing.Optional[str]=None, output_location: typing.Optional[typing.Union["InstanceAssociationOutputLocationProperty", _IResolvable_9ceae33e]]=None, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, schedule_expression: typing.Optional[str]=None, sync_compliance: typing.Optional[str]=None, targets: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetProperty", _IResolvable_9ceae33e]]]]=None, wait_for_success_timeout_seconds: typing.Optional[jsii.Number]=None) -> None:
    ...
    def output_location(self) -> typing.Optional[typing.Union["InstanceAssociationOutputLocationProperty", _IResolvable_9ceae33e]]:
    ...
    def output_location(self, value: typing.Optional[typing.Union["InstanceAssociationOutputLocationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def targets(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetProperty", _IResolvable_9ceae33e]]]]:
    ...
    @targets.setter
    def targets(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    def wait_for_success_timeout_seconds(self, value: typing.Optional[jsii.Number]) -> None:
        jsii.set(self, "waitForSuccessTimeoutSeconds", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnAssociation.InstanceAssociationOutputLocationProperty", jsii_struct_bases=[], name_mapping={'s3_location': 's3Location'})
    class InstanceAssociationOutputLocationProperty():
        def __init__(self, *, s3_location: typing.Optional[typing.Union["CfnAssociation.S3OutputLocationProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def s3_location(self) -> typing.Optional[typing.Union["CfnAssociation.S3OutputLocationProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnAssociation.S3OutputLocationProperty", jsii_struct_bases=[], name_mapping={'output_s3_bucket_name': 'outputS3BucketName', 'output_s3_key_prefix': 'outputS3KeyPrefix', 'output_s3_region': 'outputS3Region'})
    class S3OutputLocationProperty():
        def __init__(self, *, output_s3_bucket_name: typing.Optional[str]=None, output_s3_key_prefix: typing.Optional[str]=None, output_s3_region: typing.Optional[str]=None) -> None:
            """
            ...
            if output_s3_region is not None: self._values["output_s3_region"] = output_s3_region
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnAssociation.TargetProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'values': 'values'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnAssociationProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'association_name': 'associationName', 'automation_target_parameter_name': 'automationTargetParameterName', 'compliance_severity': 'complianceSeverity', 'document_version': 'documentVersion', 'instance_id': 'instanceId', 'max_concurrency': 'maxConcurrency', 'max_errors': 'maxErrors', 'output_location': 'outputLocation', 'parameters': 'parameters', 'schedule_expression': 'scheduleExpression', 'sync_compliance': 'syncCompliance', 'targets': 'targets', 'wait_for_success_timeout_seconds': 'waitForSuccessTimeoutSeconds'})
class CfnAssociationProps():
    def __init__(self, *, name: str, association_name: typing.Optional[str]=None, automation_target_parameter_name: typing.Optional[str]=None, compliance_severity: typing.Optional[str]=None, document_version: typing.Optional[str]=None, instance_id: typing.Optional[str]=None, max_concurrency: typing.Optional[str]=None, max_errors: typing.Optional[str]=None, output_location: typing.Optional[typing.Union["CfnAssociation.InstanceAssociationOutputLocationProperty", _IResolvable_9ceae33e]]=None, parameters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.Mapping[str, str]]]=None, schedule_expression: typing.Optional[str]=None, sync_compliance: typing.Optional[str]=None, targets: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAssociation.TargetProperty", _IResolvable_9ceae33e]]]]=None, wait_for_success_timeout_seconds: typing.Optional[jsii.Number]=None) -> None:
        ...
        if automation_target_parameter_name is not None: self._values["automation_target_parameter_name"] = automation_target_parameter_name
        if compliance_severity is not None: self._values["compliance_severity"] = compliance_severity
        ...
        if max_errors is not None: self._values["max_errors"] = max_errors
        ...
        if sync_compliance is not None: self._values["sync_compliance"] = sync_compliance
        if targets is not None: self._values["targets"] = targets
        if wait_for_success_timeout_seconds is not None: self._values["wait_for_success_timeout_seconds"] = wait_for_success_timeout_seconds
    ...
    @builtins.property
    def output_location(self) -> typing.Optional[typing.Union["CfnAssociation.InstanceAssociationOutputLocationProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::Association.OutputLocation``.
    ...
    @builtins.property
    def targets(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAssociation.TargetProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::SSM::Association.Targets``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnDocument(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnDocument"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, content: typing.Any, document_type: typing.Optional[str]=None, name: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDocument":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnDocumentProps", jsii_struct_bases=[], name_mapping={'content': 'content', 'document_type': 'documentType', 'name': 'name', 'tags': 'tags'})
class CfnDocumentProps():
    def __init__(self, *, content: typing.Any, document_type: typing.Optional[str]=None, name: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMaintenanceWindow(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindow"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, allow_unassociated_targets: typing.Union[bool, _IResolvable_9ceae33e], cutoff: jsii.Number, duration: jsii.Number, name: str, schedule: str, description: typing.Optional[str]=None, end_date: typing.Optional[str]=None, schedule_timezone: typing.Optional[str]=None, start_date: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMaintenanceWindow":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def allow_unassociated_targets(self, value: typing.Union[bool, _IResolvable_9ceae33e]) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowProps", jsii_struct_bases=[], name_mapping={'allow_unassociated_targets': 'allowUnassociatedTargets', 'cutoff': 'cutoff', 'duration': 'duration', 'name': 'name', 'schedule': 'schedule', 'description': 'description', 'end_date': 'endDate', 'schedule_timezone': 'scheduleTimezone', 'start_date': 'startDate', 'tags': 'tags'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMaintenanceWindowTarget(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTarget"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, resource_type: str, targets: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetsProperty", _IResolvable_9ceae33e]]], window_id: str, description: typing.Optional[str]=None, name: typing.Optional[str]=None, owner_information: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMaintenanceWindowTarget":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @builtins.property
    @jsii.member(jsii_name="targets")
    def targets(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetsProperty", _IResolvable_9ceae33e]]]:
    ...
    @targets.setter
    def targets(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetsProperty", _IResolvable_9ceae33e]]]) -> None:
        jsii.set(self, "targets", value)
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTarget.TargetsProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'values': 'values'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTargetProps", jsii_struct_bases=[], name_mapping={'resource_type': 'resourceType', 'targets': 'targets', 'window_id': 'windowId', 'description': 'description', 'name': 'name', 'owner_information': 'ownerInformation'})
class CfnMaintenanceWindowTargetProps():
    def __init__(self, *, resource_type: str, targets: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnMaintenanceWindowTarget.TargetsProperty", _IResolvable_9ceae33e]]], window_id: str, description: typing.Optional[str]=None, name: typing.Optional[str]=None, owner_information: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def targets(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnMaintenanceWindowTarget.TargetsProperty", _IResolvable_9ceae33e]]]:
        """``AWS::SSM::MaintenanceWindowTarget.Targets``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnMaintenanceWindowTask(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, max_concurrency: str, max_errors: str, priority: jsii.Number, targets: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetProperty", _IResolvable_9ceae33e]]], task_arn: str, task_type: str, window_id: str, description: typing.Optional[str]=None, logging_info: typing.Optional[typing.Union["LoggingInfoProperty", _IResolvable_9ceae33e]]=None, name: typing.Optional[str]=None, service_role_arn: typing.Optional[str]=None, task_invocation_parameters: typing.Optional[typing.Union["TaskInvocationParametersProperty", _IResolvable_9ceae33e]]=None, task_parameters: typing.Any=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnMaintenanceWindowTask":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    @builtins.property
    @jsii.member(jsii_name="targets")
    def targets(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetProperty", _IResolvable_9ceae33e]]]:
    ...
    @targets.setter
    def targets(self, value: typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["TargetProperty", _IResolvable_9ceae33e]]]) -> None:
        jsii.set(self, "targets", value)
    ...
    def logging_info(self) -> typing.Optional[typing.Union["LoggingInfoProperty", _IResolvable_9ceae33e]]:
    ...
    @logging_info.setter
    def logging_info(self, value: typing.Optional[typing.Union["LoggingInfoProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def task_invocation_parameters(self) -> typing.Optional[typing.Union["TaskInvocationParametersProperty", _IResolvable_9ceae33e]]:
    ...
    def task_invocation_parameters(self, value: typing.Optional[typing.Union["TaskInvocationParametersProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "taskInvocationParameters", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.LoggingInfoProperty", jsii_struct_bases=[], name_mapping={'region': 'region', 's3_bucket': 's3Bucket', 's3_prefix': 's3Prefix'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.MaintenanceWindowAutomationParametersProperty", jsii_struct_bases=[], name_mapping={'document_version': 'documentVersion', 'parameters': 'parameters'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.MaintenanceWindowLambdaParametersProperty", jsii_struct_bases=[], name_mapping={'client_context': 'clientContext', 'payload': 'payload', 'qualifier': 'qualifier'})
    ...
    class MaintenanceWindowRunCommandParametersProperty():
        ...
        @builtins.property
        def notification_config(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.NotificationConfigProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.MaintenanceWindowStepFunctionsParametersProperty", jsii_struct_bases=[], name_mapping={'input': 'input', 'name': 'name'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.NotificationConfigProperty", jsii_struct_bases=[], name_mapping={'notification_arn': 'notificationArn', 'notification_events': 'notificationEvents', 'notification_type': 'notificationType'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.TargetProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'values': 'values'})
    class TargetProperty():
        def __init__(self, *, key: str, values: typing.Optional[typing.List[str]]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTask.TaskInvocationParametersProperty", jsii_struct_bases=[], name_mapping={'maintenance_window_automation_parameters': 'maintenanceWindowAutomationParameters', 'maintenance_window_lambda_parameters': 'maintenanceWindowLambdaParameters', 'maintenance_window_run_command_parameters': 'maintenanceWindowRunCommandParameters', 'maintenance_window_step_functions_parameters': 'maintenanceWindowStepFunctionsParameters'})
    class TaskInvocationParametersProperty():
        def __init__(self, *, maintenance_window_automation_parameters: typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowAutomationParametersProperty", _IResolvable_9ceae33e]]=None, maintenance_window_lambda_parameters: typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowLambdaParametersProperty", _IResolvable_9ceae33e]]=None, maintenance_window_run_command_parameters: typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowRunCommandParametersProperty", _IResolvable_9ceae33e]]=None, maintenance_window_step_functions_parameters: typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowStepFunctionsParametersProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def maintenance_window_automation_parameters(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowAutomationParametersProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def maintenance_window_lambda_parameters(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowLambdaParametersProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def maintenance_window_run_command_parameters(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowRunCommandParametersProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def maintenance_window_step_functions_parameters(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.MaintenanceWindowStepFunctionsParametersProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnMaintenanceWindowTaskProps", jsii_struct_bases=[], name_mapping={'max_concurrency': 'maxConcurrency', 'max_errors': 'maxErrors', 'priority': 'priority', 'targets': 'targets', 'task_arn': 'taskArn', 'task_type': 'taskType', 'window_id': 'windowId', 'description': 'description', 'logging_info': 'loggingInfo', 'name': 'name', 'service_role_arn': 'serviceRoleArn', 'task_invocation_parameters': 'taskInvocationParameters', 'task_parameters': 'taskParameters'})
class CfnMaintenanceWindowTaskProps():
    ...
    @builtins.property
    def targets(self) -> typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnMaintenanceWindowTask.TargetProperty", _IResolvable_9ceae33e]]]:
        """``AWS::SSM::MaintenanceWindowTask.Targets``.
    ...
    @builtins.property
    def logging_info(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.LoggingInfoProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::MaintenanceWindowTask.LoggingInfo``.
    ...
    @builtins.property
    def task_invocation_parameters(self) -> typing.Optional[typing.Union["CfnMaintenanceWindowTask.TaskInvocationParametersProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::MaintenanceWindowTask.TaskInvocationParameters``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnParameter(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnParameter"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, type: str, value: str, allowed_pattern: typing.Optional[str]=None, data_type: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, policies: typing.Optional[str]=None, tags: typing.Any=None, tier: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnParameterProps(type=type, value=value, allowed_pattern=allowed_pattern, data_type=data_type, description=description, name=name, policies=policies, tags=tags, tier=tier)

        jsii.create(CfnParameter, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnParameter":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnParameterProps", jsii_struct_bases=[], name_mapping={'type': 'type', 'value': 'value', 'allowed_pattern': 'allowedPattern', 'data_type': 'dataType', 'description': 'description', 'name': 'name', 'policies': 'policies', 'tags': 'tags', 'tier': 'tier'})
class CfnParameterProps():
    def __init__(self, *, type: str, value: str, allowed_pattern: typing.Optional[str]=None, data_type: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, policies: typing.Optional[str]=None, tags: typing.Any=None, tier: typing.Optional[str]=None) -> None:
        ...
        if data_type is not None: self._values["data_type"] = data_type
        if description is not None: self._values["description"] = description
        if name is not None: self._values["name"] = name
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnPatchBaseline(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaseline"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, approval_rules: typing.Optional[typing.Union["RuleGroupProperty", _IResolvable_9ceae33e]]=None, approved_patches: typing.Optional[typing.List[str]]=None, approved_patches_compliance_level: typing.Optional[str]=None, approved_patches_enable_non_security: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, description: typing.Optional[str]=None, global_filters: typing.Optional[typing.Union["PatchFilterGroupProperty", _IResolvable_9ceae33e]]=None, operating_system: typing.Optional[str]=None, patch_groups: typing.Optional[typing.List[str]]=None, rejected_patches: typing.Optional[typing.List[str]]=None, rejected_patches_action: typing.Optional[str]=None, sources: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["PatchSourceProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnPatchBaseline":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def approval_rules(self) -> typing.Optional[typing.Union["RuleGroupProperty", _IResolvable_9ceae33e]]:
    ...
    def approval_rules(self, value: typing.Optional[typing.Union["RuleGroupProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def approved_patches_enable_non_security(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def approved_patches_enable_non_security(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def global_filters(self) -> typing.Optional[typing.Union["PatchFilterGroupProperty", _IResolvable_9ceae33e]]:
    ...
    def global_filters(self, value: typing.Optional[typing.Union["PatchFilterGroupProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def sources(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["PatchSourceProperty", _IResolvable_9ceae33e]]]]:
    ...
    @sources.setter
    def sources(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["PatchSourceProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "sources", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaseline.PatchFilterGroupProperty", jsii_struct_bases=[], name_mapping={'patch_filters': 'patchFilters'})
    class PatchFilterGroupProperty():
        def __init__(self, *, patch_filters: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPatchBaseline.PatchFilterProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def patch_filters(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPatchBaseline.PatchFilterProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaseline.PatchFilterProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'values': 'values'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaseline.PatchSourceProperty", jsii_struct_bases=[], name_mapping={'configuration': 'configuration', 'name': 'name', 'products': 'products'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaseline.RuleGroupProperty", jsii_struct_bases=[], name_mapping={'patch_rules': 'patchRules'})
    class RuleGroupProperty():
        def __init__(self, *, patch_rules: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPatchBaseline.RuleProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def patch_rules(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPatchBaseline.RuleProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaseline.RuleProperty", jsii_struct_bases=[], name_mapping={'approve_after_days': 'approveAfterDays', 'approve_until_date': 'approveUntilDate', 'compliance_level': 'complianceLevel', 'enable_non_security': 'enableNonSecurity', 'patch_filter_group': 'patchFilterGroup'})
    class RuleProperty():
        def __init__(self, *, approve_after_days: typing.Optional[jsii.Number]=None, approve_until_date: typing.Optional[str]=None, compliance_level: typing.Optional[str]=None, enable_non_security: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, patch_filter_group: typing.Optional[typing.Union["CfnPatchBaseline.PatchFilterGroupProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def enable_non_security(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def patch_filter_group(self) -> typing.Optional[typing.Union["CfnPatchBaseline.PatchFilterGroupProperty", _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnPatchBaselineProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'approval_rules': 'approvalRules', 'approved_patches': 'approvedPatches', 'approved_patches_compliance_level': 'approvedPatchesComplianceLevel', 'approved_patches_enable_non_security': 'approvedPatchesEnableNonSecurity', 'description': 'description', 'global_filters': 'globalFilters', 'operating_system': 'operatingSystem', 'patch_groups': 'patchGroups', 'rejected_patches': 'rejectedPatches', 'rejected_patches_action': 'rejectedPatchesAction', 'sources': 'sources', 'tags': 'tags'})
class CfnPatchBaselineProps():
    def __init__(self, *, name: str, approval_rules: typing.Optional[typing.Union["CfnPatchBaseline.RuleGroupProperty", _IResolvable_9ceae33e]]=None, approved_patches: typing.Optional[typing.List[str]]=None, approved_patches_compliance_level: typing.Optional[str]=None, approved_patches_enable_non_security: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, description: typing.Optional[str]=None, global_filters: typing.Optional[typing.Union["CfnPatchBaseline.PatchFilterGroupProperty", _IResolvable_9ceae33e]]=None, operating_system: typing.Optional[str]=None, patch_groups: typing.Optional[typing.List[str]]=None, rejected_patches: typing.Optional[typing.List[str]]=None, rejected_patches_action: typing.Optional[str]=None, sources: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPatchBaseline.PatchSourceProperty", _IResolvable_9ceae33e]]]]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @builtins.property
    def approval_rules(self) -> typing.Optional[typing.Union["CfnPatchBaseline.RuleGroupProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::PatchBaseline.ApprovalRules``.
    ...
    @builtins.property
    def global_filters(self) -> typing.Optional[typing.Union["CfnPatchBaseline.PatchFilterGroupProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::PatchBaseline.GlobalFilters``.
    ...
    @builtins.property
    def sources(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnPatchBaseline.PatchSourceProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::SSM::PatchBaseline.Sources``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnResourceDataSync(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.CfnResourceDataSync"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, sync_name: str, bucket_name: typing.Optional[str]=None, bucket_prefix: typing.Optional[str]=None, bucket_region: typing.Optional[str]=None, kms_key_arn: typing.Optional[str]=None, s3_destination: typing.Optional[typing.Union["S3DestinationProperty", _IResolvable_9ceae33e]]=None, sync_format: typing.Optional[str]=None, sync_source: typing.Optional[typing.Union["SyncSourceProperty", _IResolvable_9ceae33e]]=None, sync_type: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnResourceDataSync":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def s3_destination(self) -> typing.Optional[typing.Union["S3DestinationProperty", _IResolvable_9ceae33e]]:
    ...
    def s3_destination(self, value: typing.Optional[typing.Union["S3DestinationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def sync_source(self) -> typing.Optional[typing.Union["SyncSourceProperty", _IResolvable_9ceae33e]]:
    ...
    @sync_source.setter
    def sync_source(self, value: typing.Optional[typing.Union["SyncSourceProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnResourceDataSync.AwsOrganizationsSourceProperty", jsii_struct_bases=[], name_mapping={'organization_source_type': 'organizationSourceType', 'organizational_units': 'organizationalUnits'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnResourceDataSync.S3DestinationProperty", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'bucket_region': 'bucketRegion', 'sync_format': 'syncFormat', 'bucket_prefix': 'bucketPrefix', 'kms_key_arn': 'kmsKeyArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CfnResourceDataSync.SyncSourceProperty", jsii_struct_bases=[], name_mapping={'source_regions': 'sourceRegions', 'source_type': 'sourceType', 'aws_organizations_source': 'awsOrganizationsSource', 'include_future_regions': 'includeFutureRegions'})
    class SyncSourceProperty():
        def __init__(self, *, source_regions: typing.List[str], source_type: str, aws_organizations_source: typing.Optional[typing.Union["CfnResourceDataSync.AwsOrganizationsSourceProperty", _IResolvable_9ceae33e]]=None, include_future_regions: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def aws_organizations_source(self) -> typing.Optional[typing.Union["CfnResourceDataSync.AwsOrganizationsSourceProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def include_future_regions(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
class CfnResourceDataSyncProps():
    ...
    @builtins.property
    def s3_destination(self) -> typing.Optional[typing.Union["CfnResourceDataSync.S3DestinationProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::ResourceDataSync.S3Destination``.
    ...
    @builtins.property
    def sync_source(self) -> typing.Optional[typing.Union["CfnResourceDataSync.SyncSourceProperty", _IResolvable_9ceae33e]]:
        """``AWS::SSM::ResourceDataSync.SyncSource``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.CommonStringParameterAttributes", jsii_struct_bases=[], name_mapping={'parameter_name': 'parameterName', 'simple_name': 'simpleName'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.ParameterOptions", jsii_struct_bases=[], name_mapping={'allowed_pattern': 'allowedPattern', 'description': 'description', 'parameter_name': 'parameterName', 'simple_name': 'simpleName', 'tier': 'tier'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.SecureStringParameterAttributes", jsii_struct_bases=[CommonStringParameterAttributes], name_mapping={'parameter_name': 'parameterName', 'simple_name': 'simpleName', 'version': 'version', 'encryption_key': 'encryptionKey'})
class SecureStringParameterAttributes(CommonStringParameterAttributes):
    def __init__(self, *, parameter_name: str, simple_name: typing.Optional[bool]=None, version: jsii.Number, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> None:
...
class StringListParameter(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.StringListParameter"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, string_list_value: typing.List[str], allowed_pattern: typing.Optional[str]=None, description: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None, simple_name: typing.Optional[bool]=None, tier: typing.Optional["ParameterTier"]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_string_list_parameter_name(cls, scope: _Construct_f50a3f53, id: str, string_list_parameter_name: str) -> "IStringListParameter":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.StringListParameterProps", jsii_struct_bases=[ParameterOptions], name_mapping={'allowed_pattern': 'allowedPattern', 'description': 'description', 'parameter_name': 'parameterName', 'simple_name': 'simpleName', 'tier': 'tier', 'string_list_value': 'stringListValue'})
...
class StringParameter(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_ssm.StringParameter"):
    ...
    @builtins.classmethod
    def from_secure_string_parameter_attributes(cls, scope: _Construct_f50a3f53, id: str, *, version: jsii.Number, encryption_key: typing.Optional[_IKey_3336c79d]=None, parameter_name: str, simple_name: typing.Optional[bool]=None) -> "IStringParameter":
    ...
    @builtins.classmethod
    def from_string_parameter_attributes(cls, scope: _Construct_f50a3f53, id: str, *, type: typing.Optional["ParameterType"]=None, version: typing.Optional[jsii.Number]=None, parameter_name: str, simple_name: typing.Optional[bool]=None) -> "IStringParameter":
    ...
    @builtins.classmethod
    def from_string_parameter_name(cls, scope: _Construct_f50a3f53, id: str, string_parameter_name: str) -> "IStringParameter":
    ...
    @builtins.classmethod
    def value_for_secure_string_parameter(cls, scope: _Construct_f50a3f53, parameter_name: str, version: jsii.Number) -> str:
    ...
    @builtins.classmethod
    def value_for_string_parameter(cls, scope: _Construct_f50a3f53, parameter_name: str, version: typing.Optional[jsii.Number]=None) -> str:
    ...
    @builtins.classmethod
    def value_for_typed_string_parameter(cls, scope: _Construct_f50a3f53, parameter_name: str, type: typing.Optional["ParameterType"]=None, version: typing.Optional[jsii.Number]=None) -> str:
        """Returns a token that will resolve (during deployment) to the string value of an SSM string parameter.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.StringParameterAttributes", jsii_struct_bases=[CommonStringParameterAttributes], name_mapping={'parameter_name': 'parameterName', 'simple_name': 'simpleName', 'type': 'type', 'version': 'version'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ssm.StringParameterProps", jsii_struct_bases=[ParameterOptions], name_mapping={'allowed_pattern': 'allowedPattern', 'description': 'description', 'parameter_name': 'parameterName', 'simple_name': 'simpleName', 'tier': 'tier', 'string_value': 'stringValue', 'type': 'type'})
