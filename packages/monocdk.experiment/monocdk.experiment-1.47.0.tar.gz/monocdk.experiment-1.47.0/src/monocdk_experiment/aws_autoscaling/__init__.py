...
from .. import (Resource as _Resource_884d0774, Construct as _Construct_f50a3f53, Duration as _Duration_5170c158, CfnResource as _CfnResource_7760e8e4, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, TagManager as _TagManager_2508893f, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, IResource as _IResource_72f7ee7e)
from ..aws_cloudwatch import (IMetric as _IMetric_bfdc01fe, Alarm as _Alarm_25cfc2db)
from ..aws_ec2 import (ISecurityGroup as _ISecurityGroup_d72ab8e8, Connections as _Connections_231f38b5, OperatingSystemType as _OperatingSystemType_8e95bb65, UserData as _UserData_ec6d0f38, IConnectable as _IConnectable_a587039f, SubnetSelection as _SubnetSelection_36a13cd6, InstanceType as _InstanceType_85a97b30, IMachineImage as _IMachineImage_d5cd7b45, IVpc as _IVpc_3795853f)
...
from ..aws_elasticloadbalancingv2 import (LoadBalancerTargetProps as _LoadBalancerTargetProps_80dbd4a5, IApplicationTargetGroup as _IApplicationTargetGroup_1bf77cc5, INetworkTargetGroup as _INetworkTargetGroup_1183b98f, ApplicationTargetGroup as _ApplicationTargetGroup_7d0a8d54, IApplicationLoadBalancerTarget as _IApplicationLoadBalancerTarget_079c540c, INetworkLoadBalancerTarget as _INetworkLoadBalancerTarget_c44e1c1e)
from ..aws_iam import (PolicyStatement as _PolicyStatement_f75dc775, IPrincipal as _IPrincipal_97126874, IRole as _IRole_e69bbae4, IGrantable as _IGrantable_0fcfc53a)
from ..aws_sns import (ITopic as _ITopic_ef0ebe0e)


@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.AdjustmentTier", jsii_struct_bases=[], name_mapping={'adjustment': 'adjustment', 'lower_bound': 'lowerBound', 'upper_bound': 'upperBound'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.BaseTargetTrackingProps", jsii_struct_bases=[], name_mapping={'cooldown': 'cooldown', 'disable_scale_in': 'disableScaleIn', 'estimated_instance_warmup': 'estimatedInstanceWarmup'})
class BaseTargetTrackingProps():
    def __init__(self, *, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.BasicLifecycleHookProps", jsii_struct_bases=[], name_mapping={'lifecycle_transition': 'lifecycleTransition', 'notification_target': 'notificationTarget', 'default_result': 'defaultResult', 'heartbeat_timeout': 'heartbeatTimeout', 'lifecycle_hook_name': 'lifecycleHookName', 'notification_metadata': 'notificationMetadata', 'role': 'role'})
class BasicLifecycleHookProps():
    def __init__(self, *, lifecycle_transition: "LifecycleTransition", notification_target: "ILifecycleHookTarget", default_result: typing.Optional["DefaultResult"]=None, heartbeat_timeout: typing.Optional[_Duration_5170c158]=None, lifecycle_hook_name: typing.Optional[str]=None, notification_metadata: typing.Optional[str]=None, role: typing.Optional[_IRole_e69bbae4]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.BasicScheduledActionProps", jsii_struct_bases=[], name_mapping={'schedule': 'schedule', 'desired_capacity': 'desiredCapacity', 'end_time': 'endTime', 'max_capacity': 'maxCapacity', 'min_capacity': 'minCapacity', 'start_time': 'startTime'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.BasicStepScalingPolicyProps", jsii_struct_bases=[], name_mapping={'metric': 'metric', 'scaling_steps': 'scalingSteps', 'adjustment_type': 'adjustmentType', 'cooldown': 'cooldown', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'min_adjustment_magnitude': 'minAdjustmentMagnitude'})
class BasicStepScalingPolicyProps():
    def __init__(self, *, metric: _IMetric_bfdc01fe, scaling_steps: typing.List["ScalingInterval"], adjustment_type: typing.Optional["AdjustmentType"]=None, cooldown: typing.Optional[_Duration_5170c158]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, min_adjustment_magnitude: typing.Optional[jsii.Number]=None) -> None:
        """
...
class BasicTargetTrackingScalingPolicyProps(BaseTargetTrackingProps):
    def __init__(self, *, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, target_value: jsii.Number, custom_metric: typing.Optional[_IMetric_bfdc01fe]=None, predefined_metric: typing.Optional["PredefinedMetric"]=None, resource_label: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.BlockDevice", jsii_struct_bases=[], name_mapping={'device_name': 'deviceName', 'volume': 'volume', 'mapping_enabled': 'mappingEnabled'})
class BlockDevice():
...
class BlockDeviceVolume(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.BlockDeviceVolume"):
...
class CfnAutoScalingGroup(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup"):
    ...
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnAutoScalingGroup":
    ...
    def launch_template(self) -> typing.Optional[typing.Union["LaunchTemplateSpecificationProperty", _IResolvable_9ceae33e]]:
    ...
    def launch_template(self, value: typing.Optional[typing.Union["LaunchTemplateSpecificationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "launchTemplate", value)

    @builtins.property
    @jsii.member(jsii_name="lifecycleHookSpecificationList")
    def lifecycle_hook_specification_list(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["LifecycleHookSpecificationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def lifecycle_hook_specification_list(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["LifecycleHookSpecificationProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    def metrics_collection(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricsCollectionProperty", _IResolvable_9ceae33e]]]]:
    ...
    def metrics_collection(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricsCollectionProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "metricsCollection", value)

    @builtins.property
    @jsii.member(jsii_name="mixedInstancesPolicy")
    def mixed_instances_policy(self) -> typing.Optional[typing.Union["MixedInstancesPolicyProperty", _IResolvable_9ceae33e]]:
    ...
    def mixed_instances_policy(self, value: typing.Optional[typing.Union["MixedInstancesPolicyProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "mixedInstancesPolicy", value)

    @builtins.property
    @jsii.member(jsii_name="notificationConfigurations")
    def notification_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["NotificationConfigurationProperty", _IResolvable_9ceae33e]]]]:
    ...
    def notification_configurations(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["NotificationConfigurationProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.LaunchTemplateOverridesProperty", jsii_struct_bases=[], name_mapping={'instance_type': 'instanceType', 'weighted_capacity': 'weightedCapacity'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.LaunchTemplateProperty", jsii_struct_bases=[], name_mapping={'launch_template_specification': 'launchTemplateSpecification', 'overrides': 'overrides'})
    class LaunchTemplateProperty():
        def __init__(self, *, launch_template_specification: typing.Union["CfnAutoScalingGroup.LaunchTemplateSpecificationProperty", _IResolvable_9ceae33e], overrides: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAutoScalingGroup.LaunchTemplateOverridesProperty", _IResolvable_9ceae33e]]]]=None) -> None:
            """
        ...
        @builtins.property
        def launch_template_specification(self) -> typing.Union["CfnAutoScalingGroup.LaunchTemplateSpecificationProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def overrides(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAutoScalingGroup.LaunchTemplateOverridesProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.LaunchTemplateSpecificationProperty", jsii_struct_bases=[], name_mapping={'version': 'version', 'launch_template_id': 'launchTemplateId', 'launch_template_name': 'launchTemplateName'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.MetricsCollectionProperty", jsii_struct_bases=[], name_mapping={'granularity': 'granularity', 'metrics': 'metrics'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.MixedInstancesPolicyProperty", jsii_struct_bases=[], name_mapping={'launch_template': 'launchTemplate', 'instances_distribution': 'instancesDistribution'})
    class MixedInstancesPolicyProperty():
        def __init__(self, *, launch_template: typing.Union["CfnAutoScalingGroup.LaunchTemplateProperty", _IResolvable_9ceae33e], instances_distribution: typing.Optional[typing.Union["CfnAutoScalingGroup.InstancesDistributionProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def launch_template(self) -> typing.Union["CfnAutoScalingGroup.LaunchTemplateProperty", _IResolvable_9ceae33e]:
        ...
        @builtins.property
        def instances_distribution(self) -> typing.Optional[typing.Union["CfnAutoScalingGroup.InstancesDistributionProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.NotificationConfigurationProperty", jsii_struct_bases=[], name_mapping={'topic_arn': 'topicArn', 'notification_types': 'notificationTypes'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnAutoScalingGroup.TagPropertyProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'propagate_at_launch': 'propagateAtLaunch', 'value': 'value'})
    class TagPropertyProperty():
        def __init__(self, *, key: str, propagate_at_launch: typing.Union[bool, _IResolvable_9ceae33e], value: str) -> None:
            """
...
class CfnAutoScalingGroupProps():
    ...
    @builtins.property
    def launch_template(self) -> typing.Optional[typing.Union["CfnAutoScalingGroup.LaunchTemplateSpecificationProperty", _IResolvable_9ceae33e]]:
        """``AWS::AutoScaling::AutoScalingGroup.LaunchTemplate``.
    ...
    @builtins.property
    def lifecycle_hook_specification_list(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAutoScalingGroup.LifecycleHookSpecificationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::AutoScaling::AutoScalingGroup.LifecycleHookSpecificationList``.
    ...
    @builtins.property
    def metrics_collection(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAutoScalingGroup.MetricsCollectionProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::AutoScaling::AutoScalingGroup.MetricsCollection``.
    ...
    @builtins.property
    def mixed_instances_policy(self) -> typing.Optional[typing.Union["CfnAutoScalingGroup.MixedInstancesPolicyProperty", _IResolvable_9ceae33e]]:
        """``AWS::AutoScaling::AutoScalingGroup.MixedInstancesPolicy``.
    ...
    @builtins.property
    def notification_configurations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAutoScalingGroup.NotificationConfigurationProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::AutoScaling::AutoScalingGroup.NotificationConfigurations``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnLaunchConfiguration(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.CfnLaunchConfiguration"):
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnLaunchConfiguration":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def associate_public_ip_address(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def associate_public_ip_address(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "associatePublicIpAddress", value)

    @builtins.property
    @jsii.member(jsii_name="blockDeviceMappings")
    def block_device_mappings(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["BlockDeviceMappingProperty", _IResolvable_9ceae33e]]]]:
    ...
    def block_device_mappings(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["BlockDeviceMappingProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    def classic_link_vpc_security_groups(self, value: typing.Optional[typing.List[str]]) -> None:
        jsii.set(self, "classicLinkVpcSecurityGroups", value)

    @builtins.property
    @jsii.member(jsii_name="ebsOptimized")
    def ebs_optimized(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def ebs_optimized(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def instance_monitoring(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def instance_monitoring(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnLaunchConfiguration.BlockDeviceMappingProperty", jsii_struct_bases=[], name_mapping={'device_name': 'deviceName', 'ebs': 'ebs', 'no_device': 'noDevice', 'virtual_name': 'virtualName'})
    class BlockDeviceMappingProperty():
        def __init__(self, *, device_name: str, ebs: typing.Optional[typing.Union["CfnLaunchConfiguration.BlockDeviceProperty", _IResolvable_9ceae33e]]=None, no_device: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, virtual_name: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def ebs(self) -> typing.Optional[typing.Union["CfnLaunchConfiguration.BlockDeviceProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def no_device(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnLaunchConfiguration.BlockDeviceProperty", jsii_struct_bases=[], name_mapping={'delete_on_termination': 'deleteOnTermination', 'encrypted': 'encrypted', 'iops': 'iops', 'snapshot_id': 'snapshotId', 'volume_size': 'volumeSize', 'volume_type': 'volumeType'})
    class BlockDeviceProperty():
        def __init__(self, *, delete_on_termination: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, encrypted: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, iops: typing.Optional[jsii.Number]=None, snapshot_id: typing.Optional[str]=None, volume_size: typing.Optional[jsii.Number]=None, volume_type: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def delete_on_termination(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
class CfnLaunchConfigurationProps():
    ...
    @builtins.property
    def block_device_mappings(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnLaunchConfiguration.BlockDeviceMappingProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::AutoScaling::LaunchConfiguration.BlockDeviceMappings``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnLifecycleHook(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.CfnLifecycleHook"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group_name: str, lifecycle_transition: str, default_result: typing.Optional[str]=None, heartbeat_timeout: typing.Optional[jsii.Number]=None, lifecycle_hook_name: typing.Optional[str]=None, notification_metadata: typing.Optional[str]=None, notification_target_arn: typing.Optional[str]=None, role_arn: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnLifecycleHook":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnScalingPolicy(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.CfnScalingPolicy"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group_name: str, adjustment_type: typing.Optional[str]=None, cooldown: typing.Optional[str]=None, estimated_instance_warmup: typing.Optional[jsii.Number]=None, metric_aggregation_type: typing.Optional[str]=None, min_adjustment_magnitude: typing.Optional[jsii.Number]=None, policy_type: typing.Optional[str]=None, scaling_adjustment: typing.Optional[jsii.Number]=None, step_adjustments: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StepAdjustmentProperty", _IResolvable_9ceae33e]]]]=None, target_tracking_configuration: typing.Optional[typing.Union["TargetTrackingConfigurationProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    def step_adjustments(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StepAdjustmentProperty", _IResolvable_9ceae33e]]]]:
    ...
    def step_adjustments(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["StepAdjustmentProperty", _IResolvable_9ceae33e]]]]) -> None:
        jsii.set(self, "stepAdjustments", value)

    @builtins.property
    @jsii.member(jsii_name="targetTrackingConfiguration")
    def target_tracking_configuration(self) -> typing.Optional[typing.Union["TargetTrackingConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def target_tracking_configuration(self, value: typing.Optional[typing.Union["TargetTrackingConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "targetTrackingConfiguration", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnScalingPolicy.CustomizedMetricSpecificationProperty", jsii_struct_bases=[], name_mapping={'metric_name': 'metricName', 'namespace': 'namespace', 'statistic': 'statistic', 'dimensions': 'dimensions', 'unit': 'unit'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnScalingPolicy.MetricDimensionProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnScalingPolicy.PredefinedMetricSpecificationProperty", jsii_struct_bases=[], name_mapping={'predefined_metric_type': 'predefinedMetricType', 'resource_label': 'resourceLabel'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnScalingPolicy.StepAdjustmentProperty", jsii_struct_bases=[], name_mapping={'scaling_adjustment': 'scalingAdjustment', 'metric_interval_lower_bound': 'metricIntervalLowerBound', 'metric_interval_upper_bound': 'metricIntervalUpperBound'})
...
class CfnScalingPolicyProps():
    ...
    @builtins.property
    def target_tracking_configuration(self) -> typing.Optional[typing.Union["CfnScalingPolicy.TargetTrackingConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::AutoScaling::ScalingPolicy.TargetTrackingConfiguration``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnScheduledAction(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.CfnScheduledAction"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group_name: str, desired_capacity: typing.Optional[jsii.Number]=None, end_time: typing.Optional[str]=None, max_size: typing.Optional[jsii.Number]=None, min_size: typing.Optional[jsii.Number]=None, recurrence: typing.Optional[str]=None, start_time: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnScheduledAction":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CfnScheduledActionProps", jsii_struct_bases=[], name_mapping={'auto_scaling_group_name': 'autoScalingGroupName', 'desired_capacity': 'desiredCapacity', 'end_time': 'endTime', 'max_size': 'maxSize', 'min_size': 'minSize', 'recurrence': 'recurrence', 'start_time': 'startTime'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CpuUtilizationScalingProps", jsii_struct_bases=[BaseTargetTrackingProps], name_mapping={'cooldown': 'cooldown', 'disable_scale_in': 'disableScaleIn', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'target_utilization_percent': 'targetUtilizationPercent'})
class CpuUtilizationScalingProps(BaseTargetTrackingProps):
    def __init__(self, *, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, target_utilization_percent: jsii.Number) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.CronOptions", jsii_struct_bases=[], name_mapping={'day': 'day', 'hour': 'hour', 'minute': 'minute', 'month': 'month', 'week_day': 'weekDay'})
class CronOptions():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.EbsDeviceOptionsBase", jsii_struct_bases=[], name_mapping={'delete_on_termination': 'deleteOnTermination', 'iops': 'iops', 'volume_type': 'volumeType'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.EbsDeviceSnapshotOptions", jsii_struct_bases=[EbsDeviceOptionsBase], name_mapping={'delete_on_termination': 'deleteOnTermination', 'iops': 'iops', 'volume_type': 'volumeType', 'volume_size': 'volumeSize'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.Ec2HealthCheckOptions", jsii_struct_bases=[], name_mapping={'grace': 'grace'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.ElbHealthCheckOptions", jsii_struct_bases=[], name_mapping={'grace': 'grace'})
...
class HealthCheck(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.HealthCheck"):
...
class IAutoScalingGroup(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def add_lifecycle_hook(self, id: str, *, lifecycle_transition: "LifecycleTransition", notification_target: "ILifecycleHookTarget", default_result: typing.Optional["DefaultResult"]=None, heartbeat_timeout: typing.Optional[_Duration_5170c158]=None, lifecycle_hook_name: typing.Optional[str]=None, notification_metadata: typing.Optional[str]=None, role: typing.Optional[_IRole_e69bbae4]=None) -> "LifecycleHook":
    ...
    def scale_on_cpu_utilization(self, id: str, *, target_utilization_percent: jsii.Number, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> "TargetTrackingScalingPolicy":
    ...
    def scale_on_incoming_bytes(self, id: str, *, target_bytes_per_second: jsii.Number, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> "TargetTrackingScalingPolicy":
    ...
    def scale_on_metric(self, id: str, *, metric: _IMetric_bfdc01fe, scaling_steps: typing.List["ScalingInterval"], adjustment_type: typing.Optional["AdjustmentType"]=None, cooldown: typing.Optional[_Duration_5170c158]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, min_adjustment_magnitude: typing.Optional[jsii.Number]=None) -> "StepScalingPolicy":
    ...
    def scale_on_outgoing_bytes(self, id: str, *, target_bytes_per_second: jsii.Number, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> "TargetTrackingScalingPolicy":
    ...
    def scale_to_track_metric(self, id: str, *, metric: _IMetric_bfdc01fe, target_value: jsii.Number, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> "TargetTrackingScalingPolicy":
...
class ILifecycleHookTarget(jsii.compat.Protocol):
    ...
    def bind(self, scope: _Construct_f50a3f53, lifecycle_hook: "ILifecycleHook") -> "LifecycleHookTargetConfig":
...
class LifecycleHook(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.LifecycleHook"):
    """Define a life cycle hook.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group: "IAutoScalingGroup", lifecycle_transition: "LifecycleTransition", notification_target: "ILifecycleHookTarget", default_result: typing.Optional["DefaultResult"]=None, heartbeat_timeout: typing.Optional[_Duration_5170c158]=None, lifecycle_hook_name: typing.Optional[str]=None, notification_metadata: typing.Optional[str]=None, role: typing.Optional[_IRole_e69bbae4]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.LifecycleHookProps", jsii_struct_bases=[BasicLifecycleHookProps], name_mapping={'lifecycle_transition': 'lifecycleTransition', 'notification_target': 'notificationTarget', 'default_result': 'defaultResult', 'heartbeat_timeout': 'heartbeatTimeout', 'lifecycle_hook_name': 'lifecycleHookName', 'notification_metadata': 'notificationMetadata', 'role': 'role', 'auto_scaling_group': 'autoScalingGroup'})
class LifecycleHookProps(BasicLifecycleHookProps):
    def __init__(self, *, lifecycle_transition: "LifecycleTransition", notification_target: "ILifecycleHookTarget", default_result: typing.Optional["DefaultResult"]=None, heartbeat_timeout: typing.Optional[_Duration_5170c158]=None, lifecycle_hook_name: typing.Optional[str]=None, notification_metadata: typing.Optional[str]=None, role: typing.Optional[_IRole_e69bbae4]=None, auto_scaling_group: "IAutoScalingGroup") -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.LifecycleHookTargetConfig", jsii_struct_bases=[], name_mapping={'notification_target_arn': 'notificationTargetArn'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.MetricTargetTrackingProps", jsii_struct_bases=[BaseTargetTrackingProps], name_mapping={'cooldown': 'cooldown', 'disable_scale_in': 'disableScaleIn', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'metric': 'metric', 'target_value': 'targetValue'})
class MetricTargetTrackingProps(BaseTargetTrackingProps):
    def __init__(self, *, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, metric: _IMetric_bfdc01fe, target_value: jsii.Number) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.NetworkUtilizationScalingProps", jsii_struct_bases=[BaseTargetTrackingProps], name_mapping={'cooldown': 'cooldown', 'disable_scale_in': 'disableScaleIn', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'target_bytes_per_second': 'targetBytesPerSecond'})
class NetworkUtilizationScalingProps(BaseTargetTrackingProps):
    def __init__(self, *, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, target_bytes_per_second: jsii.Number) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.NotificationConfiguration", jsii_struct_bases=[], name_mapping={'topic': 'topic', 'scaling_events': 'scalingEvents'})
class NotificationConfiguration():
    def __init__(self, *, topic: _ITopic_ef0ebe0e, scaling_events: typing.Optional["ScalingEvents"]=None) -> None:
        ...
        if scaling_events is not None: self._values["scaling_events"] = scaling_events
    ...
    def __repr__(self) -> str:
        return 'NotificationConfiguration(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.RequestCountScalingProps", jsii_struct_bases=[BaseTargetTrackingProps], name_mapping={'cooldown': 'cooldown', 'disable_scale_in': 'disableScaleIn', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'target_requests_per_second': 'targetRequestsPerSecond'})
class RequestCountScalingProps(BaseTargetTrackingProps):
    def __init__(self, *, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, target_requests_per_second: jsii.Number) -> None:
...
class RollingUpdateConfiguration():
    def __init__(self, *, max_batch_size: typing.Optional[jsii.Number]=None, min_instances_in_service: typing.Optional[jsii.Number]=None, min_successful_instances_percent: typing.Optional[jsii.Number]=None, pause_time: typing.Optional[_Duration_5170c158]=None, suspend_processes: typing.Optional[typing.List["ScalingProcess"]]=None, wait_on_resource_signals: typing.Optional[bool]=None) -> None:
...
class ScalingEvents(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.ScalingEvents"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.ScalingInterval", jsii_struct_bases=[], name_mapping={'change': 'change', 'lower': 'lower', 'upper': 'upper'})
...
class Schedule(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_autoscaling.Schedule"):
...
class ScheduledAction(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.ScheduledAction"):
    """Define a scheduled scaling action.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group: "IAutoScalingGroup", schedule: "Schedule", desired_capacity: typing.Optional[jsii.Number]=None, end_time: typing.Optional[datetime.datetime]=None, max_capacity: typing.Optional[jsii.Number]=None, min_capacity: typing.Optional[jsii.Number]=None, start_time: typing.Optional[datetime.datetime]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class StepScalingAction(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.StepScalingAction"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group: "IAutoScalingGroup", adjustment_type: typing.Optional["AdjustmentType"]=None, cooldown: typing.Optional[_Duration_5170c158]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, metric_aggregation_type: typing.Optional["MetricAggregationType"]=None, min_adjustment_magnitude: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.StepScalingActionProps", jsii_struct_bases=[], name_mapping={'auto_scaling_group': 'autoScalingGroup', 'adjustment_type': 'adjustmentType', 'cooldown': 'cooldown', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'metric_aggregation_type': 'metricAggregationType', 'min_adjustment_magnitude': 'minAdjustmentMagnitude'})
...
class StepScalingPolicy(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.StepScalingPolicy"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group: "IAutoScalingGroup", metric: _IMetric_bfdc01fe, scaling_steps: typing.List["ScalingInterval"], adjustment_type: typing.Optional["AdjustmentType"]=None, cooldown: typing.Optional[_Duration_5170c158]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, min_adjustment_magnitude: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param auto_scaling_group: The auto scaling group.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.StepScalingPolicyProps", jsii_struct_bases=[BasicStepScalingPolicyProps], name_mapping={'metric': 'metric', 'scaling_steps': 'scalingSteps', 'adjustment_type': 'adjustmentType', 'cooldown': 'cooldown', 'estimated_instance_warmup': 'estimatedInstanceWarmup', 'min_adjustment_magnitude': 'minAdjustmentMagnitude', 'auto_scaling_group': 'autoScalingGroup'})
class StepScalingPolicyProps(BasicStepScalingPolicyProps):
    def __init__(self, *, metric: _IMetric_bfdc01fe, scaling_steps: typing.List["ScalingInterval"], adjustment_type: typing.Optional["AdjustmentType"]=None, cooldown: typing.Optional[_Duration_5170c158]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None, min_adjustment_magnitude: typing.Optional[jsii.Number]=None, auto_scaling_group: "IAutoScalingGroup") -> None:
        """
        :param metric: Metric to scale on.
        :param scaling_steps: The intervals for scaling. Maps a range of metric values to a particular scaling behavior.
        :param adjustment_type: How the adjustment numbers inside 'intervals' are interpreted. Default: ChangeInCapacity
...
class TargetTrackingScalingPolicy(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.TargetTrackingScalingPolicy"):
    """
    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_scaling_group: "IAutoScalingGroup", target_value: jsii.Number, custom_metric: typing.Optional[_IMetric_bfdc01fe]=None, predefined_metric: typing.Optional["PredefinedMetric"]=None, resource_label: typing.Optional[str]=None, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.implements(_ILoadBalancerTarget_87ce58b8, _IConnectable_a587039f, _IApplicationLoadBalancerTarget_079c540c, _INetworkLoadBalancerTarget_c44e1c1e, _IGrantable_0fcfc53a, IAutoScalingGroup)
class AutoScalingGroup(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_autoscaling.AutoScalingGroup"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, instance_type: _InstanceType_85a97b30, machine_image: _IMachineImage_d5cd7b45, vpc: _IVpc_3795853f, role: typing.Optional[_IRole_e69bbae4]=None, user_data: typing.Optional[_UserData_ec6d0f38]=None, allow_all_outbound: typing.Optional[bool]=None, associate_public_ip_address: typing.Optional[bool]=None, block_devices: typing.Optional[typing.List["BlockDevice"]]=None, cooldown: typing.Optional[_Duration_5170c158]=None, desired_capacity: typing.Optional[jsii.Number]=None, health_check: typing.Optional["HealthCheck"]=None, ignore_unmodified_size_properties: typing.Optional[bool]=None, instance_monitoring: typing.Optional["Monitoring"]=None, key_name: typing.Optional[str]=None, max_capacity: typing.Optional[jsii.Number]=None, max_instance_lifetime: typing.Optional[_Duration_5170c158]=None, min_capacity: typing.Optional[jsii.Number]=None, notifications: typing.Optional[typing.List["NotificationConfiguration"]]=None, notifications_topic: typing.Optional[_ITopic_ef0ebe0e]=None, replacing_update_min_successful_instances_percent: typing.Optional[jsii.Number]=None, resource_signal_count: typing.Optional[jsii.Number]=None, resource_signal_timeout: typing.Optional[_Duration_5170c158]=None, rolling_update_configuration: typing.Optional["RollingUpdateConfiguration"]=None, spot_price: typing.Optional[str]=None, update_type: typing.Optional["UpdateType"]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_auto_scaling_group_name(cls, scope: _Construct_f50a3f53, id: str, auto_scaling_group_name: str) -> "IAutoScalingGroup":
        """
        :param scope: -
        :param id: -
    ...
    def scale_on_request_count(self, id: str, *, target_requests_per_second: jsii.Number, cooldown: typing.Optional[_Duration_5170c158]=None, disable_scale_in: typing.Optional[bool]=None, estimated_instance_warmup: typing.Optional[_Duration_5170c158]=None) -> "TargetTrackingScalingPolicy":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.EbsDeviceOptions", jsii_struct_bases=[EbsDeviceOptionsBase], name_mapping={'delete_on_termination': 'deleteOnTermination', 'iops': 'iops', 'volume_type': 'volumeType', 'encrypted': 'encrypted'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_autoscaling.EbsDeviceProps", jsii_struct_bases=[EbsDeviceSnapshotOptions], name_mapping={'delete_on_termination': 'deleteOnTermination', 'iops': 'iops', 'volume_type': 'volumeType', 'volume_size': 'volumeSize', 'snapshot_id': 'snapshotId'})
