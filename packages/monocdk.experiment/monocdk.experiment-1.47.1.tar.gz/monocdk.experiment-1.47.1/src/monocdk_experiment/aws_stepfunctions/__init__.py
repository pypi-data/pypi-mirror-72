...
from .. import (Resource as _Resource_884d0774, Construct as _Construct_f50a3f53, CfnResource as _CfnResource_7760e8e4, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, TagManager as _TagManager_2508893f, IInspectable as _IInspectable_051e6ed8, IResolvable as _IResolvable_9ceae33e, IResource as _IResource_72f7ee7e, Duration as _Duration_5170c158, IConstruct as _IConstruct_db0cc7e3)
from ..aws_cloudwatch import (Metric as _Metric_53e89548, MetricOptions as _MetricOptions_ad2c4d5d)
from ..aws_iam import (Grant as _Grant_96af6d2d, IGrantable as _IGrantable_0fcfc53a, PolicyStatement as _PolicyStatement_f75dc775, IRole as _IRole_e69bbae4)
from ..aws_logs import (ILogGroup as _ILogGroup_6b54c8e1)


@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.ActivityProps", jsii_struct_bases=[], name_mapping={'activity_name': 'activityName'})
class ActivityProps():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.AfterwardsOptions", jsii_struct_bases=[], name_mapping={'include_error_handlers': 'includeErrorHandlers', 'include_otherwise': 'includeOtherwise'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CatchProps", jsii_struct_bases=[], name_mapping={'errors': 'errors', 'result_path': 'resultPath'})
class CatchProps():
...
class CfnActivity(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.CfnActivity"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, tags: typing.Optional[typing.List["TagsEntryProperty"]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnActivity":
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnActivity.TagsEntryProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnActivityProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'tags': 'tags'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnStateMachine(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachine"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, role_arn: str, definition_s3_location: typing.Optional[typing.Union["S3LocationProperty", _IResolvable_9ceae33e]]=None, definition_string: typing.Optional[str]=None, definition_substitutions: typing.Any=None, logging_configuration: typing.Optional[typing.Union["LoggingConfigurationProperty", _IResolvable_9ceae33e]]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional[str]=None, tags: typing.Optional[typing.List["TagsEntryProperty"]]=None) -> None:
        ...
        """
        props = CfnStateMachineProps(role_arn=role_arn, definition_s3_location=definition_s3_location, definition_string=definition_string, definition_substitutions=definition_substitutions, logging_configuration=logging_configuration, state_machine_name=state_machine_name, state_machine_type=state_machine_type, tags=tags)

        jsii.create(CfnStateMachine, self, [scope, id, props])

    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnStateMachine":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def definition_substitutions(self) -> typing.Any:
    ...
    def definition_substitutions(self, value: typing.Any) -> None:
    ...
    def definition_s3_location(self) -> typing.Optional[typing.Union["S3LocationProperty", _IResolvable_9ceae33e]]:
    ...
    def definition_s3_location(self, value: typing.Optional[typing.Union["S3LocationProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "definitionS3Location", value)

    @builtins.property
    @jsii.member(jsii_name="definitionString")
    def definition_string(self) -> typing.Optional[str]:
    ...
    def definition_string(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "definitionString", value)

    @builtins.property
    @jsii.member(jsii_name="loggingConfiguration")
    def logging_configuration(self) -> typing.Optional[typing.Union["LoggingConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def logging_configuration(self, value: typing.Optional[typing.Union["LoggingConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    def state_machine_name(self, value: typing.Optional[str]) -> None:
    ...
    def state_machine_type(self, value: typing.Optional[str]) -> None:
        jsii.set(self, "stateMachineType", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachine.CloudWatchLogsLogGroupProperty", jsii_struct_bases=[], name_mapping={'log_group_arn': 'logGroupArn'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachine.LogDestinationProperty", jsii_struct_bases=[], name_mapping={'cloud_watch_logs_log_group': 'cloudWatchLogsLogGroup'})
    class LogDestinationProperty():
        def __init__(self, *, cloud_watch_logs_log_group: typing.Optional[typing.Union["CfnStateMachine.CloudWatchLogsLogGroupProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def cloud_watch_logs_log_group(self) -> typing.Optional[typing.Union["CfnStateMachine.CloudWatchLogsLogGroupProperty", _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachine.LoggingConfigurationProperty", jsii_struct_bases=[], name_mapping={'destinations': 'destinations', 'include_execution_data': 'includeExecutionData', 'level': 'level'})
    class LoggingConfigurationProperty():
        def __init__(self, *, destinations: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnStateMachine.LogDestinationProperty", _IResolvable_9ceae33e]]]]=None, include_execution_data: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, level: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def destinations(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnStateMachine.LogDestinationProperty", _IResolvable_9ceae33e]]]]:
        ...
        @builtins.property
        def include_execution_data(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachine.S3LocationProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'key': 'key', 'version': 'version'})
    class S3LocationProperty():
        def __init__(self, *, bucket: str, key: str, version: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachine.TagsEntryProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    class TagsEntryProperty():
        def __init__(self, *, key: str, value: str) -> None:
            """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CfnStateMachineProps", jsii_struct_bases=[], name_mapping={'role_arn': 'roleArn', 'definition_s3_location': 'definitionS3Location', 'definition_string': 'definitionString', 'definition_substitutions': 'definitionSubstitutions', 'logging_configuration': 'loggingConfiguration', 'state_machine_name': 'stateMachineName', 'state_machine_type': 'stateMachineType', 'tags': 'tags'})
class CfnStateMachineProps():
    def __init__(self, *, role_arn: str, definition_s3_location: typing.Optional[typing.Union["CfnStateMachine.S3LocationProperty", _IResolvable_9ceae33e]]=None, definition_string: typing.Optional[str]=None, definition_substitutions: typing.Any=None, logging_configuration: typing.Optional[typing.Union["CfnStateMachine.LoggingConfigurationProperty", _IResolvable_9ceae33e]]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional[str]=None, tags: typing.Optional[typing.List["CfnStateMachine.TagsEntryProperty"]]=None) -> None:
        ...
        if definition_string is not None: self._values["definition_string"] = definition_string
        if definition_substitutions is not None: self._values["definition_substitutions"] = definition_substitutions
    ...
    @builtins.property
    def definition_s3_location(self) -> typing.Optional[typing.Union["CfnStateMachine.S3LocationProperty", _IResolvable_9ceae33e]]:
        """``AWS::StepFunctions::StateMachine.DefinitionS3Location``.
    ...
    def definition_substitutions(self) -> typing.Any:
        ...
        :see: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-stepfunctions-statemachine.html#cfn-stepfunctions-statemachine-definitionsubstitutions
        """
        return self._values.get('definition_substitutions')

    @builtins.property
    def logging_configuration(self) -> typing.Optional[typing.Union["CfnStateMachine.LoggingConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::StepFunctions::StateMachine.LoggingConfiguration``.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.ChoiceProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath'})
class ChoiceProps():
...
class Condition(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_stepfunctions.Condition"):
...
class Context(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Context"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.CustomStateProps", jsii_struct_bases=[], name_mapping={'state_json': 'stateJson'})
...
class Data(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Data"):
...
class Errors(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Errors"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.FailProps", jsii_struct_bases=[], name_mapping={'cause': 'cause', 'comment': 'comment', 'error': 'error'})
class FailProps():
...
class FieldUtils(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.FieldUtils"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.FindStateOptions", jsii_struct_bases=[], name_mapping={'include_error_handlers': 'includeErrorHandlers'})
...
@jsii.interface(jsii_type="monocdk-experiment.aws_stepfunctions.IActivity")
class IActivity(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IActivityProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Represents a Step Functions Activity https://docs.aws.amazon.com/step-functions/latest/dg/concepts-activities.html.

    stability
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_stepfunctions.IActivity"
    @builtins.property
    @jsii.member(jsii_name="activityArn")
    def activity_arn(self) -> str:
        """The ARN of the activity.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_stepfunctions.IChainable")
...
class _IChainableProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_stepfunctions.IChainable"
    @builtins.property
    @jsii.member(jsii_name="endStates")
    def end_states(self) -> typing.List["INextable"]:
        """The chainable end state(s) of this chainable.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_stepfunctions.INextable")
...
class _INextableProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_stepfunctions.INextable"
    @jsii.member(jsii_name="next")
    def next(self, state: "IChainable") -> "Chain":
        """Go to the indicated state after this state.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_stepfunctions.IStateMachine")
class IStateMachine(_IResource_72f7ee7e, jsii.compat.Protocol):
    """A State Machine.
    ...
    def grant(self, identity: _IGrantable_0fcfc53a, *actions: str) -> _Grant_96af6d2d:
    ...
    def grant_execution(self, identity: _IGrantable_0fcfc53a, *actions: str) -> _Grant_96af6d2d:
    ...
    def grant_read(self, identity: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
    ...
    def grant_start_execution(self, identity: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
    ...
    def grant_task_response(self, identity: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
        """Grant the given identity read permissions for this state machine.
...
class _IStateMachineProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """A State Machine.

    stability
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_stepfunctions.IStateMachine"
    @builtins.property
    @jsii.member(jsii_name="stateMachineArn")
    def state_machine_arn(self) -> str:
        """The ARN of the state machine.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_stepfunctions.IStepFunctionsTask")
...
class _IStepFunctionsTaskProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_stepfunctions.IStepFunctionsTask"
    @jsii.member(jsii_name="bind")
    def bind(self, task: "Task") -> "StepFunctionsTaskConfig":
        """Called when the task object is used in a workflow.
...
@jsii.enum(jsii_type="monocdk-experiment.aws_stepfunctions.InputType")
...
@jsii.enum(jsii_type="monocdk-experiment.aws_stepfunctions.IntegrationPattern")
...
@jsii.enum(jsii_type="monocdk-experiment.aws_stepfunctions.LogLevel")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.LogOptions", jsii_struct_bases=[], name_mapping={'destination': 'destination', 'include_execution_data': 'includeExecutionData', 'level': 'level'})
class LogOptions():
    def __init__(self, *, destination: _ILogGroup_6b54c8e1, include_execution_data: typing.Optional[bool]=None, level: typing.Optional["LogLevel"]=None) -> None:
    ...
    @builtins.property
    def destination(self) -> _ILogGroup_6b54c8e1:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.MapProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'items_path': 'itemsPath', 'max_concurrency': 'maxConcurrency', 'output_path': 'outputPath', 'parameters': 'parameters', 'result_path': 'resultPath'})
class MapProps():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.ParallelProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath', 'result_path': 'resultPath'})
class ParallelProps():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.PassProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath', 'parameters': 'parameters', 'result': 'result', 'result_path': 'resultPath'})
class PassProps():
...
class Result(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Result"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.RetryProps", jsii_struct_bases=[], name_mapping={'backoff_rate': 'backoffRate', 'errors': 'errors', 'interval': 'interval', 'max_attempts': 'maxAttempts'})
class RetryProps():
    def __init__(self, *, backoff_rate: typing.Optional[jsii.Number]=None, errors: typing.Optional[typing.List[str]]=None, interval: typing.Optional[_Duration_5170c158]=None, max_attempts: typing.Optional[jsii.Number]=None) -> None:
        """Retry details.
...
@jsii.enum(jsii_type="monocdk-experiment.aws_stepfunctions.ServiceIntegrationPattern")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.SingleStateOptions", jsii_struct_bases=[ParallelProps], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath', 'result_path': 'resultPath', 'prefix_states': 'prefixStates', 'state_id': 'stateId'})
...
class State(_Construct_f50a3f53, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_stepfunctions.State"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, result_path: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def prefix_states(cls, root: _IConstruct_db0cc7e3, prefix: str) -> None:
...
class StateGraph(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.StateGraph"):
    ...
    def register_policy_statement(self, statement: _PolicyStatement_f75dc775) -> None:
    ...
    def policy_statements(self) -> typing.List[_PolicyStatement_f75dc775]:
    ...
    @timeout.setter
    def timeout(self, value: typing.Optional[_Duration_5170c158]) -> None:
        jsii.set(self, "timeout", value)


@jsii.implements(IStateMachine)
class StateMachine(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.StateMachine"):
    """Define a StepFunctions State Machine.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, definition: "IChainable", logs: typing.Optional["LogOptions"]=None, role: typing.Optional[_IRole_e69bbae4]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional["StateMachineType"]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_state_machine_arn(cls, scope: _Construct_f50a3f53, id: str, state_machine_arn: str) -> "IStateMachine":
...
@jsii.implements(IChainable)
class StateMachineFragment(_Construct_f50a3f53, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_stepfunctions.StateMachineFragment"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.StateMachineProps", jsii_struct_bases=[], name_mapping={'definition': 'definition', 'logs': 'logs', 'role': 'role', 'state_machine_name': 'stateMachineName', 'state_machine_type': 'stateMachineType', 'timeout': 'timeout'})
class StateMachineProps():
    def __init__(self, *, definition: "IChainable", logs: typing.Optional["LogOptions"]=None, role: typing.Optional[_IRole_e69bbae4]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional["StateMachineType"]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
...
@jsii.enum(jsii_type="monocdk-experiment.aws_stepfunctions.StateMachineType")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.StateProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath', 'parameters': 'parameters', 'result_path': 'resultPath'})
class StateProps():
...
class StateTransitionMetric(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.StateTransitionMetric"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.StepFunctionsTaskConfig", jsii_struct_bases=[], name_mapping={'resource_arn': 'resourceArn', 'heartbeat': 'heartbeat', 'metric_dimensions': 'metricDimensions', 'metric_prefix_plural': 'metricPrefixPlural', 'metric_prefix_singular': 'metricPrefixSingular', 'parameters': 'parameters', 'policy_statements': 'policyStatements'})
class StepFunctionsTaskConfig():
    def __init__(self, *, resource_arn: str, heartbeat: typing.Optional[_Duration_5170c158]=None, metric_dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, metric_prefix_plural: typing.Optional[str]=None, metric_prefix_singular: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, policy_statements: typing.Optional[typing.List[_PolicyStatement_f75dc775]]=None) -> None:
    ...
    @builtins.property
    def policy_statements(self) -> typing.Optional[typing.List[_PolicyStatement_f75dc775]]:
...
class Succeed(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Succeed"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param comment: An optional description for this state. Default: No comment
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.SucceedProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath'})
class SucceedProps():
    def __init__(self, *, comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None) -> None:
...
class Task(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Task"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, task: "IStepFunctionsTask", comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    def add_retry(self, *, backoff_rate: typing.Optional[jsii.Number]=None, errors: typing.Optional[typing.List[str]]=None, interval: typing.Optional[_Duration_5170c158]=None, max_attempts: typing.Optional[jsii.Number]=None) -> "Task":
...
class TaskInput(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.TaskInput"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.TaskMetricsConfig", jsii_struct_bases=[], name_mapping={'metric_dimensions': 'metricDimensions', 'metric_prefix_plural': 'metricPrefixPlural', 'metric_prefix_singular': 'metricPrefixSingular'})
class TaskMetricsConfig():
    def __init__(self, *, metric_dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, metric_prefix_plural: typing.Optional[str]=None, metric_prefix_singular: typing.Optional[str]=None) -> None:
        """Task Metrics.
    ...
    def __repr__(self) -> str:
        return 'TaskMetricsConfig(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.TaskProps", jsii_struct_bases=[], name_mapping={'task': 'task', 'comment': 'comment', 'input_path': 'inputPath', 'output_path': 'outputPath', 'parameters': 'parameters', 'result_path': 'resultPath', 'timeout': 'timeout'})
class TaskProps():
    def __init__(self, *, task: "IStepFunctionsTask", comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
...
@jsii.implements(INextable)
class TaskStateBase(State, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_stepfunctions.TaskStateBase"):
    """Define a Task state in the state machine.
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[_Duration_5170c158]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional["IntegrationPattern"]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param comment: An optional description for this state. Default: - No comment
        ...
        :stability: experimental
        """
        props = TaskStateBaseProps(comment=comment, heartbeat=heartbeat, input_path=input_path, integration_pattern=integration_pattern, output_path=output_path, result_path=result_path, timeout=timeout)

        jsii.create(TaskStateBase, self, [scope, id, props])

    @jsii.member(jsii_name="addCatch")
    def add_catch(self, handler: "IChainable", *, errors: typing.Optional[typing.List[str]]=None, result_path: typing.Optional[str]=None) -> "TaskStateBase":
        """Add a recovery handler for this state.
    ...
    @jsii.member(jsii_name="addRetry")
    def add_retry(self, *, backoff_rate: typing.Optional[jsii.Number]=None, errors: typing.Optional[typing.List[str]]=None, interval: typing.Optional[_Duration_5170c158]=None, max_attempts: typing.Optional[jsii.Number]=None) -> "TaskStateBase":
        """Add retry configuration for this state.
...
class _TaskStateBaseProxy(TaskStateBase, jsii.proxy_for(State)):
    @jsii.member(jsii_name="renderTask")
    def _render_task(self) -> typing.Any:
        """
        stability
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.TaskStateBaseProps", jsii_struct_bases=[], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout'})
class TaskStateBaseProps():
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[_Duration_5170c158]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional["IntegrationPattern"]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[_Duration_5170c158]=None) -> None:
        """Props that are common to all tasks.
    ...
    def __repr__(self) -> str:
        return 'TaskStateBaseProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(INextable)
class Wait(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Wait"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, time: "WaitTime", comment: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions.WaitProps", jsii_struct_bases=[], name_mapping={'time': 'time', 'comment': 'comment'})
class WaitProps():
...
class WaitTime(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.WaitTime"):
    ...
    @builtins.classmethod
    def duration(cls, duration: _Duration_5170c158) -> "WaitTime":
...
class Activity(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Activity"):
    """Define a new Step Functions Activity.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, activity_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param activity_name: The name for this activity. Default: - If not supplied, a name is generated
    ...
    @builtins.classmethod
    def from_activity_arn(cls, scope: _Construct_f50a3f53, id: str, activity_arn: str) -> "IActivity":
    ...
    @builtins.classmethod
    def from_activity_name(cls, scope: _Construct_f50a3f53, id: str, activity_name: str) -> "IActivity":
...
@jsii.implements(IChainable)
class Chain(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Chain"):
...
class Choice(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Choice"):
...
class CustomState(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.CustomState"):
    """State defined by supplying Amazon States Language (ASL) in the state machine.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, state_json: typing.Mapping[str, typing.Any]) -> None:
        """
        :param scope: -
        :param id: -
        :param state_json: Amazon States Language (JSON-based) definition of the state.
...
class Fail(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Fail"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, cause: typing.Optional[str]=None, comment: typing.Optional[str]=None, error: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cause: A description for the cause of the failure. Default: No description
...
@jsii.implements(INextable)
class Map(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Map"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, items_path: typing.Optional[str]=None, max_concurrency: typing.Optional[jsii.Number]=None, output_path: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, result_path: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param comment: An optional description for this state. Default: No comment
    ...
    @jsii.member(jsii_name="addRetry")
    def add_retry(self, *, backoff_rate: typing.Optional[jsii.Number]=None, errors: typing.Optional[typing.List[str]]=None, interval: typing.Optional[_Duration_5170c158]=None, max_attempts: typing.Optional[jsii.Number]=None) -> "Map":
        """Add retry configuration for this state.
...
@jsii.implements(INextable)
class Parallel(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Parallel"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param comment: An optional description for this state. Default: No comment
    ...
    @jsii.member(jsii_name="addRetry")
    def add_retry(self, *, backoff_rate: typing.Optional[jsii.Number]=None, errors: typing.Optional[typing.List[str]]=None, interval: typing.Optional[_Duration_5170c158]=None, max_attempts: typing.Optional[jsii.Number]=None) -> "Parallel":
        """Add retry configuration for this state.
...
@jsii.implements(INextable)
class Pass(State, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions.Pass"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, comment: typing.Optional[str]=None, input_path: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, result: typing.Optional["Result"]=None, result_path: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param comment: An optional description for this state. Default: No comment
