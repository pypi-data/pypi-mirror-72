...
from .. import (Construct as _Construct_f50a3f53, Resource as _Resource_884d0774, ResourceProps as _ResourceProps_92be6f66, Duration as _Duration_5170c158, CfnResource as _CfnResource_7760e8e4, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IResolvable as _IResolvable_9ceae33e, IInspectable as _IInspectable_051e6ed8, TagManager as _TagManager_2508893f, CfnTag as _CfnTag_b4661f1a, IResource as _IResource_72f7ee7e)
from ..aws_iam import (Grant as _Grant_96af6d2d, IGrantable as _IGrantable_0fcfc53a)


@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.AlarmActionConfig", jsii_struct_bases=[], name_mapping={'alarm_action_arn': 'alarmActionArn'})
...
class AlarmRule(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.AlarmRule"):
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.AlarmState")
...
class CfnAlarm(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm"):
    ...
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnAlarm":
    ...
    def actions_enabled(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    def actions_enabled(self, value: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]) -> None:
    ...
    def dimensions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DimensionProperty", _IResolvable_9ceae33e]]]]:
    ...
    @dimensions.setter
    def dimensions(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DimensionProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    def insufficient_data_actions(self, value: typing.Optional[typing.List[str]]) -> None:
    ...
    def metrics(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricDataQueryProperty", _IResolvable_9ceae33e]]]]:
    ...
    @metrics.setter
    def metrics(self, value: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["MetricDataQueryProperty", _IResolvable_9ceae33e]]]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.DimensionProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.MetricDataQueryProperty", jsii_struct_bases=[], name_mapping={'id': 'id', 'expression': 'expression', 'label': 'label', 'metric_stat': 'metricStat', 'period': 'period', 'return_data': 'returnData'})
    class MetricDataQueryProperty():
        def __init__(self, *, id: str, expression: typing.Optional[str]=None, label: typing.Optional[str]=None, metric_stat: typing.Optional[typing.Union["CfnAlarm.MetricStatProperty", _IResolvable_9ceae33e]]=None, period: typing.Optional[jsii.Number]=None, return_data: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None) -> None:
            """
        ...
        @builtins.property
        def metric_stat(self) -> typing.Optional[typing.Union["CfnAlarm.MetricStatProperty", _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def return_data(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.MetricProperty", jsii_struct_bases=[], name_mapping={'dimensions': 'dimensions', 'metric_name': 'metricName', 'namespace': 'namespace'})
    class MetricProperty():
        def __init__(self, *, dimensions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAlarm.DimensionProperty", _IResolvable_9ceae33e]]]]=None, metric_name: typing.Optional[str]=None, namespace: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def dimensions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAlarm.DimensionProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAlarm.MetricStatProperty", jsii_struct_bases=[], name_mapping={'metric': 'metric', 'period': 'period', 'stat': 'stat', 'unit': 'unit'})
    class MetricStatProperty():
        def __init__(self, *, metric: typing.Union["CfnAlarm.MetricProperty", _IResolvable_9ceae33e], period: jsii.Number, stat: str, unit: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def metric(self) -> typing.Union["CfnAlarm.MetricProperty", _IResolvable_9ceae33e]:
...
class CfnAlarmProps():
    ...
    @builtins.property
    def metrics(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAlarm.MetricDataQueryProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::CloudWatch::Alarm.Metrics``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnAnomalyDetector(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, metric_name: str, namespace: str, stat: str, configuration: typing.Optional[typing.Union["ConfigurationProperty", _IResolvable_9ceae33e]]=None, dimensions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["DimensionProperty", _IResolvable_9ceae33e]]]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnAnomalyDetector":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def configuration(self) -> typing.Optional[typing.Union["ConfigurationProperty", _IResolvable_9ceae33e]]:
    ...
    def configuration(self, value: typing.Optional[typing.Union["ConfigurationProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector.ConfigurationProperty", jsii_struct_bases=[], name_mapping={'excluded_time_ranges': 'excludedTimeRanges', 'metric_time_zone': 'metricTimeZone'})
    class ConfigurationProperty():
        def __init__(self, *, excluded_time_ranges: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAnomalyDetector.RangeProperty", _IResolvable_9ceae33e]]]]=None, metric_time_zone: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def excluded_time_ranges(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAnomalyDetector.RangeProperty", _IResolvable_9ceae33e]]]]:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector.DimensionProperty", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
    class DimensionProperty():
        def __init__(self, *, name: str, value: str) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetector.RangeProperty", jsii_struct_bases=[], name_mapping={'end_time': 'endTime', 'start_time': 'startTime'})
    class RangeProperty():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnAnomalyDetectorProps", jsii_struct_bases=[], name_mapping={'metric_name': 'metricName', 'namespace': 'namespace', 'stat': 'stat', 'configuration': 'configuration', 'dimensions': 'dimensions'})
class CfnAnomalyDetectorProps():
    def __init__(self, *, metric_name: str, namespace: str, stat: str, configuration: typing.Optional[typing.Union["CfnAnomalyDetector.ConfigurationProperty", _IResolvable_9ceae33e]]=None, dimensions: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAnomalyDetector.DimensionProperty", _IResolvable_9ceae33e]]]]=None) -> None:
    ...
    @builtins.property
    def configuration(self) -> typing.Optional[typing.Union["CfnAnomalyDetector.ConfigurationProperty", _IResolvable_9ceae33e]]:
        """``AWS::CloudWatch::AnomalyDetector.Configuration``.
    ...
    @builtins.property
    def dimensions(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union["CfnAnomalyDetector.DimensionProperty", _IResolvable_9ceae33e]]]]:
        """``AWS::CloudWatch::AnomalyDetector.Dimensions``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnCompositeAlarm(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.CfnCompositeAlarm"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, alarm_name: str, alarm_rule: str, actions_enabled: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, alarm_actions: typing.Optional[typing.List[str]]=None, alarm_description: typing.Optional[str]=None, insufficient_data_actions: typing.Optional[typing.List[str]]=None, ok_actions: typing.Optional[typing.List[str]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnCompositeAlarm":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnDashboard(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.CfnDashboard"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, dashboard_body: str, dashboard_name: typing.Optional[str]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnDashboard":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnDashboardProps", jsii_struct_bases=[], name_mapping={'dashboard_body': 'dashboardBody', 'dashboard_name': 'dashboardName'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnInsightRule(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.CfnInsightRule"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, rule_body: str, rule_name: str, rule_state: str, tags: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union[_IResolvable_9ceae33e, _CfnTag_b4661f1a]]]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnInsightRule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CfnInsightRuleProps", jsii_struct_bases=[], name_mapping={'rule_body': 'ruleBody', 'rule_name': 'ruleName', 'rule_state': 'ruleState', 'tags': 'tags'})
class CfnInsightRuleProps():
    def __init__(self, *, rule_body: str, rule_name: str, rule_state: str, tags: typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union[_IResolvable_9ceae33e, _CfnTag_b4661f1a]]]]=None) -> None:
    ...
    @builtins.property
    def tags(self) -> typing.Optional[typing.Union[_IResolvable_9ceae33e, typing.List[typing.Union[_IResolvable_9ceae33e, _CfnTag_b4661f1a]]]]:
        """``AWS::CloudWatch::InsightRule.Tags``.
...
class Color(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Color"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CommonMetricOptions", jsii_struct_bases=[], name_mapping={'account': 'account', 'color': 'color', 'dimensions': 'dimensions', 'label': 'label', 'period': 'period', 'region': 'region', 'statistic': 'statistic', 'unit': 'unit'})
class CommonMetricOptions():
    def __init__(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional["Unit"]=None) -> None:
    ...
    @builtins.property
    def period(self) -> typing.Optional[_Duration_5170c158]:
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.ComparisonOperator")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.CompositeAlarmProps", jsii_struct_bases=[], name_mapping={'alarm_rule': 'alarmRule', 'actions_enabled': 'actionsEnabled', 'alarm_description': 'alarmDescription', 'composite_alarm_name': 'compositeAlarmName'})
class CompositeAlarmProps():
    def __init__(self, *, alarm_rule: "IAlarmRule", actions_enabled: typing.Optional[bool]=None, alarm_description: typing.Optional[str]=None, composite_alarm_name: typing.Optional[str]=None) -> None:
        ...
        if actions_enabled is not None: self._values["actions_enabled"] = actions_enabled
        if alarm_description is not None: self._values["alarm_description"] = alarm_description
        if composite_alarm_name is not None: self._values["composite_alarm_name"] = composite_alarm_name
...
class Dashboard(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Dashboard"):
    """A CloudWatch dashboard.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, dashboard_name: typing.Optional[str]=None, end: typing.Optional[str]=None, period_override: typing.Optional["PeriodOverride"]=None, start: typing.Optional[str]=None, widgets: typing.Optional[typing.List[typing.List["IWidget"]]]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.DashboardProps", jsii_struct_bases=[], name_mapping={'dashboard_name': 'dashboardName', 'end': 'end', 'period_override': 'periodOverride', 'start': 'start', 'widgets': 'widgets'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.Dimension", jsii_struct_bases=[], name_mapping={'name': 'name', 'value': 'value'})
class Dimension():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.HorizontalAnnotation", jsii_struct_bases=[], name_mapping={'value': 'value', 'color': 'color', 'fill': 'fill', 'label': 'label', 'visible': 'visible'})
...
@jsii.interface(jsii_type="monocdk-experiment.aws_cloudwatch.IAlarmAction")
class IAlarmAction(jsii.compat.Protocol):
    ...
    def bind(self, scope: _Construct_f50a3f53, alarm: "IAlarm") -> "AlarmActionConfig":
...
class _IAlarmActionProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_cloudwatch.IAlarmAction"
    @jsii.member(jsii_name="bind")
    def bind(self, scope: _Construct_f50a3f53, alarm: "IAlarm") -> "AlarmActionConfig":
        """Return the properties required to send alarm actions to this CloudWatch alarm.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_cloudwatch.IAlarmRule")
...
class _IAlarmRuleProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_cloudwatch.IAlarmRule"
    @jsii.member(jsii_name="renderAlarmRule")
    def render_alarm_rule(self) -> str:
        """serialized representation of Alarm Rule to be used when building the Composite Alarm resource.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_cloudwatch.IMetric")
...
class _IMetricProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_cloudwatch.IMetric"
    @jsii.member(jsii_name="toAlarmConfig")
    def to_alarm_config(self) -> "MetricAlarmConfig":
        """Turn this metric object into an alarm configuration.
...
@jsii.interface(jsii_type="monocdk-experiment.aws_cloudwatch.IWidget")
...
class _IWidgetProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_cloudwatch.IWidget"
    @builtins.property
    @jsii.member(jsii_name="height")
    def height(self) -> jsii.Number:
        """The amount of vertical grid units the widget will take up.
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.LegendPosition")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.LogQueryWidgetProps", jsii_struct_bases=[], name_mapping={'log_group_names': 'logGroupNames', 'height': 'height', 'query_lines': 'queryLines', 'query_string': 'queryString', 'region': 'region', 'title': 'title', 'width': 'width'})
...
class MathExpression(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.MathExpression"):
    ...
    :stability: experimental
    """
    def __init__(self, *, expression: str, using_metrics: typing.Mapping[str, "IMetric"], color: typing.Optional[str]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None) -> None:
        """
    ...
    def create_alarm(self, scope: _Construct_f50a3f53, id: str, *, evaluation_periods: jsii.Number, threshold: jsii.Number, actions_enabled: typing.Optional[bool]=None, alarm_description: typing.Optional[str]=None, alarm_name: typing.Optional[str]=None, comparison_operator: typing.Optional["ComparisonOperator"]=None, datapoints_to_alarm: typing.Optional[jsii.Number]=None, evaluate_low_sample_count_percentile: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None, statistic: typing.Optional[str]=None, treat_missing_data: typing.Optional["TreatMissingData"]=None) -> "Alarm":
    ...
    def with_(self, *, color: typing.Optional[str]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None) -> "MathExpression":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MathExpressionOptions", jsii_struct_bases=[], name_mapping={'color': 'color', 'label': 'label', 'period': 'period'})
class MathExpressionOptions():
    def __init__(self, *, color: typing.Optional[str]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MathExpressionProps", jsii_struct_bases=[MathExpressionOptions], name_mapping={'color': 'color', 'label': 'label', 'period': 'period', 'expression': 'expression', 'using_metrics': 'usingMetrics'})
class MathExpressionProps(MathExpressionOptions):
    def __init__(self, *, color: typing.Optional[str]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None, expression: str, using_metrics: typing.Mapping[str, "IMetric"]) -> None:
...
@jsii.implements(IMetric)
class Metric(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Metric"):
    ...
    @builtins.classmethod
    def grant_put_metric_data(cls, grantee: _IGrantable_0fcfc53a) -> _Grant_96af6d2d:
    ...
    def attach_to(self, scope: _Construct_f50a3f53) -> "Metric":
    ...
    @jsii.member(jsii_name="with")
    def with_(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional["Unit"]=None) -> "Metric":
        """Return a copy of Metric ``with`` properties changed.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricAlarmConfig", jsii_struct_bases=[], name_mapping={'metric_name': 'metricName', 'namespace': 'namespace', 'period': 'period', 'dimensions': 'dimensions', 'extended_statistic': 'extendedStatistic', 'statistic': 'statistic', 'unit': 'unit'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricConfig", jsii_struct_bases=[], name_mapping={'math_expression': 'mathExpression', 'metric_stat': 'metricStat', 'rendering_properties': 'renderingProperties'})
class MetricConfig():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricExpressionConfig", jsii_struct_bases=[], name_mapping={'expression': 'expression', 'period': 'period', 'using_metrics': 'usingMetrics'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricGraphConfig", jsii_struct_bases=[], name_mapping={'metric_name': 'metricName', 'namespace': 'namespace', 'period': 'period', 'rendering_properties': 'renderingProperties', 'color': 'color', 'dimensions': 'dimensions', 'label': 'label', 'statistic': 'statistic', 'unit': 'unit'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricOptions", jsii_struct_bases=[CommonMetricOptions], name_mapping={'account': 'account', 'color': 'color', 'dimensions': 'dimensions', 'label': 'label', 'period': 'period', 'region': 'region', 'statistic': 'statistic', 'unit': 'unit'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricProps", jsii_struct_bases=[CommonMetricOptions], name_mapping={'account': 'account', 'color': 'color', 'dimensions': 'dimensions', 'label': 'label', 'period': 'period', 'region': 'region', 'statistic': 'statistic', 'unit': 'unit', 'metric_name': 'metricName', 'namespace': 'namespace'})
class MetricProps(CommonMetricOptions):
    def __init__(self, *, account: typing.Optional[str]=None, color: typing.Optional[str]=None, dimensions: typing.Optional[typing.Mapping[str, typing.Any]]=None, label: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None, region: typing.Optional[str]=None, statistic: typing.Optional[str]=None, unit: typing.Optional["Unit"]=None, metric_name: str, namespace: str) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricRenderingProperties", jsii_struct_bases=[], name_mapping={'period': 'period', 'color': 'color', 'label': 'label', 'stat': 'stat'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricStatConfig", jsii_struct_bases=[], name_mapping={'metric_name': 'metricName', 'namespace': 'namespace', 'period': 'period', 'statistic': 'statistic', 'account': 'account', 'dimensions': 'dimensions', 'region': 'region', 'unit_filter': 'unitFilter'})
class MetricStatConfig():
    def __init__(self, *, metric_name: str, namespace: str, period: _Duration_5170c158, statistic: str, account: typing.Optional[str]=None, dimensions: typing.Optional[typing.List["Dimension"]]=None, region: typing.Optional[str]=None, unit_filter: typing.Optional["Unit"]=None) -> None:
        """Properties for a concrete metric.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.MetricWidgetProps", jsii_struct_bases=[], name_mapping={'height': 'height', 'region': 'region', 'title': 'title', 'width': 'width'})
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.PeriodOverride")
...
class Row(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Row"):
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.Shading")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.SingleValueWidgetProps", jsii_struct_bases=[MetricWidgetProps], name_mapping={'height': 'height', 'region': 'region', 'title': 'title', 'width': 'width', 'metrics': 'metrics', 'set_period_to_time_range': 'setPeriodToTimeRange'})
...
@jsii.implements(IWidget)
class Spacer(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Spacer"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.SpacerProps", jsii_struct_bases=[], name_mapping={'height': 'height', 'width': 'width'})
class SpacerProps():
    def __init__(self, *, height: typing.Optional[jsii.Number]=None, width: typing.Optional[jsii.Number]=None) -> None:
        """Props of the spacer.
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.Statistic")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.TextWidgetProps", jsii_struct_bases=[], name_mapping={'markdown': 'markdown', 'height': 'height', 'width': 'width'})
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.TreatMissingData")
...
@jsii.enum(jsii_type="monocdk-experiment.aws_cloudwatch.Unit")
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.YAxisProps", jsii_struct_bases=[], name_mapping={'label': 'label', 'max': 'max', 'min': 'min', 'show_units': 'showUnits'})
class YAxisProps():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.AlarmProps", jsii_struct_bases=[CreateAlarmOptions], name_mapping={'evaluation_periods': 'evaluationPeriods', 'threshold': 'threshold', 'actions_enabled': 'actionsEnabled', 'alarm_description': 'alarmDescription', 'alarm_name': 'alarmName', 'comparison_operator': 'comparisonOperator', 'datapoints_to_alarm': 'datapointsToAlarm', 'evaluate_low_sample_count_percentile': 'evaluateLowSampleCountPercentile', 'period': 'period', 'statistic': 'statistic', 'treat_missing_data': 'treatMissingData', 'metric': 'metric'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.AlarmWidgetProps", jsii_struct_bases=[MetricWidgetProps], name_mapping={'height': 'height', 'region': 'region', 'title': 'title', 'width': 'width', 'alarm': 'alarm', 'left_y_axis': 'leftYAxis'})
...
@jsii.implements(IWidget)
class Column(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Column"):
...
@jsii.implements(IWidget)
class ConcreteWidget(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_cloudwatch.ConcreteWidget"):
...
class GraphWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.GraphWidget"):
    ...
    def __init__(self, *, left: typing.Optional[typing.List["IMetric"]]=None, left_annotations: typing.Optional[typing.List["HorizontalAnnotation"]]=None, left_y_axis: typing.Optional["YAxisProps"]=None, legend_position: typing.Optional["LegendPosition"]=None, live_data: typing.Optional[bool]=None, right: typing.Optional[typing.List["IMetric"]]=None, right_annotations: typing.Optional[typing.List["HorizontalAnnotation"]]=None, right_y_axis: typing.Optional["YAxisProps"]=None, stacked: typing.Optional[bool]=None, height: typing.Optional[jsii.Number]=None, region: typing.Optional[str]=None, title: typing.Optional[str]=None, width: typing.Optional[jsii.Number]=None) -> None:
        ...
        :stability: experimental
        """
        props = GraphWidgetProps(left=left, left_annotations=left_annotations, left_y_axis=left_y_axis, legend_position=legend_position, live_data=live_data, right=right, right_annotations=right_annotations, right_y_axis=right_y_axis, stacked=stacked, height=height, region=region, title=title, width=width)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cloudwatch.GraphWidgetProps", jsii_struct_bases=[MetricWidgetProps], name_mapping={'height': 'height', 'region': 'region', 'title': 'title', 'width': 'width', 'left': 'left', 'left_annotations': 'leftAnnotations', 'left_y_axis': 'leftYAxis', 'legend_position': 'legendPosition', 'live_data': 'liveData', 'right': 'right', 'right_annotations': 'rightAnnotations', 'right_y_axis': 'rightYAxis', 'stacked': 'stacked'})
class GraphWidgetProps(MetricWidgetProps):
    def __init__(self, *, height: typing.Optional[jsii.Number]=None, region: typing.Optional[str]=None, title: typing.Optional[str]=None, width: typing.Optional[jsii.Number]=None, left: typing.Optional[typing.List["IMetric"]]=None, left_annotations: typing.Optional[typing.List["HorizontalAnnotation"]]=None, left_y_axis: typing.Optional["YAxisProps"]=None, legend_position: typing.Optional["LegendPosition"]=None, live_data: typing.Optional[bool]=None, right: typing.Optional[typing.List["IMetric"]]=None, right_annotations: typing.Optional[typing.List["HorizontalAnnotation"]]=None, right_y_axis: typing.Optional["YAxisProps"]=None, stacked: typing.Optional[bool]=None) -> None:
        ...
        if live_data is not None: self._values["live_data"] = live_data
...
@jsii.interface(jsii_type="monocdk-experiment.aws_cloudwatch.IAlarm")
class IAlarm(IAlarmRule, _IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IAlarmProxy(jsii.proxy_for(IAlarmRule), jsii.proxy_for(_IResource_72f7ee7e)):
    """Represents a CloudWatch Alarm.

    stability
    :stability: experimental
    """
    __jsii_type__ = "monocdk-experiment.aws_cloudwatch.IAlarm"
    @builtins.property
    @jsii.member(jsii_name="alarmArn")
    def alarm_arn(self) -> str:
        """Alarm ARN (i.e. arn:aws:cloudwatch:::alarm:Foo).
...
class LogQueryWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.LogQueryWidget"):
...
class SingleValueWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.SingleValueWidget"):
...
class TextWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.TextWidget"):
...
class AlarmBase(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_cloudwatch.AlarmBase"):
    ...
    def _insufficient_data_action_arns(self, value: typing.Optional[typing.List[str]]) -> None:
...
class _AlarmBaseProxy(AlarmBase, jsii.proxy_for(_Resource_884d0774)):
    @builtins.property
    @jsii.member(jsii_name="alarmArn")
    def alarm_arn(self) -> str:
        """Alarm ARN (i.e. arn:aws:cloudwatch:::alarm:Foo).
...
class AlarmWidget(ConcreteWidget, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.AlarmWidget"):
...
class CompositeAlarm(AlarmBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.CompositeAlarm"):
    """A Composite Alarm based on Alarm Rule.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, alarm_rule: "IAlarmRule", actions_enabled: typing.Optional[bool]=None, alarm_description: typing.Optional[str]=None, composite_alarm_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param alarm_rule: Expression that specifies which other alarms are to be evaluated to determine this composite alarm's state.
        ...
        :stability: experimental
        """
        props = CompositeAlarmProps(alarm_rule=alarm_rule, actions_enabled=actions_enabled, alarm_description=alarm_description, composite_alarm_name=composite_alarm_name)

        jsii.create(CompositeAlarm, self, [scope, id, props])

    @jsii.member(jsii_name="fromCompositeAlarmArn")
    @builtins.classmethod
    def from_composite_alarm_arn(cls, scope: _Construct_f50a3f53, id: str, composite_alarm_arn: str) -> "IAlarm":
    ...
    @builtins.classmethod
    def from_composite_alarm_name(cls, scope: _Construct_f50a3f53, id: str, composite_alarm_name: str) -> "IAlarm":
...
class Alarm(AlarmBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Alarm"):
    """An alarm on a CloudWatch metric.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, metric: "IMetric", evaluation_periods: jsii.Number, threshold: jsii.Number, actions_enabled: typing.Optional[bool]=None, alarm_description: typing.Optional[str]=None, alarm_name: typing.Optional[str]=None, comparison_operator: typing.Optional["ComparisonOperator"]=None, datapoints_to_alarm: typing.Optional[jsii.Number]=None, evaluate_low_sample_count_percentile: typing.Optional[str]=None, period: typing.Optional[_Duration_5170c158]=None, statistic: typing.Optional[str]=None, treat_missing_data: typing.Optional["TreatMissingData"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param metric: The metric to add the alarm on. Metric objects can be obtained from most resources, or you can construct custom Metric objects by instantiating one.
    ...
    @builtins.classmethod
    def from_alarm_arn(cls, scope: _Construct_f50a3f53, id: str, alarm_arn: str) -> "IAlarm":
