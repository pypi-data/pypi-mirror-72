...
@jsii.data_type(jsii_type="monocdk-experiment.aws_servicediscovery.CfnHttpNamespaceProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'description': 'description'})
...
class CfnPrivateDnsNamespace(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_servicediscovery.CfnPrivateDnsNamespace"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, name: str, vpc: str, description: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_servicediscovery.CfnPrivateDnsNamespaceProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'vpc': 'vpc', 'description': 'description'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_servicediscovery.CfnPublicDnsNamespaceProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'description': 'description'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_servicediscovery.CfnServiceProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'dns_config': 'dnsConfig', 'health_check_config': 'healthCheckConfig', 'health_check_custom_config': 'healthCheckCustomConfig', 'name': 'name', 'namespace_id': 'namespaceId'})
