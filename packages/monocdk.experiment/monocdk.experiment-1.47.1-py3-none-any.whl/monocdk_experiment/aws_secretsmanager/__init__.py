...
from .. import (CfnResource as _CfnResource_7760e8e4, Construct as _Construct_f50a3f53, FromCloudFormationOptions as _FromCloudFormationOptions_5f49f6f1, TreeInspector as _TreeInspector_154f5999, IInspectable as _IInspectable_051e6ed8, IResolvable as _IResolvable_9ceae33e, TagManager as _TagManager_2508893f, CfnTag as _CfnTag_b4661f1a, IResource as _IResource_72f7ee7e, SecretValue as _SecretValue_99478b8b, Resource as _Resource_884d0774, Duration as _Duration_5170c158, RemovalPolicy as _RemovalPolicy_5986e9f3)
from ..aws_ec2 import (IConnectable as _IConnectable_a587039f, IVpc as _IVpc_3795853f, ISecurityGroup as _ISecurityGroup_d72ab8e8, SubnetSelection as _SubnetSelection_36a13cd6)
from ..aws_iam import (AddToResourcePolicyResult as _AddToResourcePolicyResult_d2a345d1, PolicyStatement as _PolicyStatement_f75dc775, Grant as _Grant_96af6d2d, IGrantable as _IGrantable_0fcfc53a, PolicyDocument as _PolicyDocument_1d1bca11)
from ..aws_kms import (IKey as _IKey_3336c79d)
from ..aws_lambda import (IFunction as _IFunction_1c1de0bc)


@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.AttachedSecretOptions", jsii_struct_bases=[], name_mapping={'target': 'target'})
...
class CfnResourcePolicy(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.CfnResourcePolicy"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, resource_policy: typing.Any, secret_id: str) -> None:
    ...
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnResourcePolicy":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.CfnResourcePolicyProps", jsii_struct_bases=[], name_mapping={'resource_policy': 'resourcePolicy', 'secret_id': 'secretId'})
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnRotationSchedule(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.CfnRotationSchedule"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, secret_id: str, rotation_lambda_arn: typing.Optional[str]=None, rotation_rules: typing.Optional[typing.Union["RotationRulesProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnRotationSchedule":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def rotation_rules(self) -> typing.Optional[typing.Union["RotationRulesProperty", _IResolvable_9ceae33e]]:
    ...
    def rotation_rules(self, value: typing.Optional[typing.Union["RotationRulesProperty", _IResolvable_9ceae33e]]) -> None:
        jsii.set(self, "rotationRules", value)

    @jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.CfnRotationSchedule.RotationRulesProperty", jsii_struct_bases=[], name_mapping={'automatically_after_days': 'automaticallyAfterDays'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.CfnRotationScheduleProps", jsii_struct_bases=[], name_mapping={'secret_id': 'secretId', 'rotation_lambda_arn': 'rotationLambdaArn', 'rotation_rules': 'rotationRules'})
class CfnRotationScheduleProps():
    def __init__(self, *, secret_id: str, rotation_lambda_arn: typing.Optional[str]=None, rotation_rules: typing.Optional[typing.Union["CfnRotationSchedule.RotationRulesProperty", _IResolvable_9ceae33e]]=None) -> None:
    ...
    @builtins.property
    def rotation_rules(self) -> typing.Optional[typing.Union["CfnRotationSchedule.RotationRulesProperty", _IResolvable_9ceae33e]]:
        """``AWS::SecretsManager::RotationSchedule.RotationRules``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnSecret(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.CfnSecret"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, description: typing.Optional[str]=None, generate_secret_string: typing.Optional[typing.Union["GenerateSecretStringProperty", _IResolvable_9ceae33e]]=None, kms_key_id: typing.Optional[str]=None, name: typing.Optional[str]=None, secret_string: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnSecret":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
    ...
    def generate_secret_string(self) -> typing.Optional[typing.Union["GenerateSecretStringProperty", _IResolvable_9ceae33e]]:
    ...
    def generate_secret_string(self, value: typing.Optional[typing.Union["GenerateSecretStringProperty", _IResolvable_9ceae33e]]) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.CfnSecret.GenerateSecretStringProperty", jsii_struct_bases=[], name_mapping={'exclude_characters': 'excludeCharacters', 'exclude_lowercase': 'excludeLowercase', 'exclude_numbers': 'excludeNumbers', 'exclude_punctuation': 'excludePunctuation', 'exclude_uppercase': 'excludeUppercase', 'generate_string_key': 'generateStringKey', 'include_space': 'includeSpace', 'password_length': 'passwordLength', 'require_each_included_type': 'requireEachIncludedType', 'secret_string_template': 'secretStringTemplate'})
    class GenerateSecretStringProperty():
        def __init__(self, *, exclude_characters: typing.Optional[str]=None, exclude_lowercase: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, exclude_numbers: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, exclude_punctuation: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, exclude_uppercase: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, generate_string_key: typing.Optional[str]=None, include_space: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, password_length: typing.Optional[jsii.Number]=None, require_each_included_type: typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]=None, secret_string_template: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def exclude_lowercase(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def exclude_numbers(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def exclude_punctuation(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def exclude_uppercase(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def include_space(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
        ...
        @builtins.property
        def require_each_included_type(self) -> typing.Optional[typing.Union[bool, _IResolvable_9ceae33e]]:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.CfnSecretProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'generate_secret_string': 'generateSecretString', 'kms_key_id': 'kmsKeyId', 'name': 'name', 'secret_string': 'secretString', 'tags': 'tags'})
class CfnSecretProps():
    def __init__(self, *, description: typing.Optional[str]=None, generate_secret_string: typing.Optional[typing.Union["CfnSecret.GenerateSecretStringProperty", _IResolvable_9ceae33e]]=None, kms_key_id: typing.Optional[str]=None, name: typing.Optional[str]=None, secret_string: typing.Optional[str]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None) -> None:
    ...
    @builtins.property
    def generate_secret_string(self) -> typing.Optional[typing.Union["CfnSecret.GenerateSecretStringProperty", _IResolvable_9ceae33e]]:
        """``AWS::SecretsManager::Secret.GenerateSecretString``.
...
@jsii.implements(_IInspectable_051e6ed8)
class CfnSecretTargetAttachment(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.CfnSecretTargetAttachment"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, secret_id: str, target_id: str, target_type: str) -> None:
    ...
    @jsii.member(jsii_name="fromCloudFormation")
    @builtins.classmethod
    def from_cloud_formation(cls, scope: _Construct_f50a3f53, id: str, resource_attributes: typing.Any, *, finder: _ICfnFinder_3b168f30) -> "CfnSecretTargetAttachment":
        """A factory method that creates a new instance of this class from an object containing the CloudFormation properties of this resource.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.CfnSecretTargetAttachmentProps", jsii_struct_bases=[], name_mapping={'secret_id': 'secretId', 'target_id': 'targetId', 'target_type': 'targetType'})
...
class ISecret(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def add_rotation_schedule(self, id: str, *, rotation_lambda: _IFunction_1c1de0bc, automatically_after: typing.Optional[_Duration_5170c158]=None) -> "RotationSchedule":
    ...
    def add_to_resource_policy(self, statement: _PolicyStatement_f75dc775) -> _AddToResourcePolicyResult_d2a345d1:
    ...
    def grant_read(self, grantee: _IGrantable_0fcfc53a, version_stages: typing.Optional[typing.List[str]]=None) -> _Grant_96af6d2d:
...
@jsii.interface(jsii_type="monocdk-experiment.aws_secretsmanager.ISecretAttachmentTarget")
...
@jsii.interface(jsii_type="monocdk-experiment.aws_secretsmanager.ISecretTargetAttachment")
...
class ResourcePolicy(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.ResourcePolicy"):
    """Secret Resource Policy.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, secret: "ISecret") -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.ResourcePolicyProps", jsii_struct_bases=[], name_mapping={'secret': 'secret'})
...
class RotationSchedule(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.RotationSchedule"):
    """A rotation schedule.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, secret: "ISecret", rotation_lambda: _IFunction_1c1de0bc, automatically_after: typing.Optional[_Duration_5170c158]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.RotationScheduleOptions", jsii_struct_bases=[], name_mapping={'rotation_lambda': 'rotationLambda', 'automatically_after': 'automaticallyAfter'})
class RotationScheduleOptions():
    def __init__(self, *, rotation_lambda: _IFunction_1c1de0bc, automatically_after: typing.Optional[_Duration_5170c158]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.RotationScheduleProps", jsii_struct_bases=[RotationScheduleOptions], name_mapping={'rotation_lambda': 'rotationLambda', 'automatically_after': 'automaticallyAfter', 'secret': 'secret'})
class RotationScheduleProps(RotationScheduleOptions):
    def __init__(self, *, rotation_lambda: _IFunction_1c1de0bc, automatically_after: typing.Optional[_Duration_5170c158]=None, secret: "ISecret") -> None:
...
class Secret(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.Secret"):
    """Creates a new secret in AWS SecretsManager.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, description: typing.Optional[str]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None, generate_secret_string: typing.Optional["SecretStringGenerator"]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, secret_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = SecretProps(description=description, encryption_key=encryption_key, generate_secret_string=generate_secret_string, removal_policy=removal_policy, secret_name=secret_name)

        jsii.create(Secret, self, [scope, id, props])

    @jsii.member(jsii_name="fromSecretArn")
    @builtins.classmethod
    def from_secret_arn(cls, scope: _Construct_f50a3f53, id: str, secret_arn: str) -> "ISecret":
        """
        :param scope: -
        :param id: -
        :param secret_arn: -
    ...
    @builtins.classmethod
    def from_secret_attributes(cls, scope: _Construct_f50a3f53, id: str, *, secret_arn: str, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> "ISecret":
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretAttachmentTargetProps", jsii_struct_bases=[], name_mapping={'target_id': 'targetId', 'target_type': 'targetType'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretAttributes", jsii_struct_bases=[], name_mapping={'secret_arn': 'secretArn', 'encryption_key': 'encryptionKey'})
class SecretAttributes():
    def __init__(self, *, secret_arn: str, encryption_key: typing.Optional[_IKey_3336c79d]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'encryption_key': 'encryptionKey', 'generate_secret_string': 'generateSecretString', 'removal_policy': 'removalPolicy', 'secret_name': 'secretName'})
class SecretProps():
    def __init__(self, *, description: typing.Optional[str]=None, encryption_key: typing.Optional[_IKey_3336c79d]=None, generate_secret_string: typing.Optional["SecretStringGenerator"]=None, removal_policy: typing.Optional[_RemovalPolicy_5986e9f3]=None, secret_name: typing.Optional[str]=None) -> None:
...
class SecretRotation(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.SecretRotation"):
    """Secret rotation for a service or database.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, application: "SecretRotationApplication", secret: "ISecret", target: _IConnectable_a587039f, vpc: _IVpc_3795853f, automatically_after: typing.Optional[_Duration_5170c158]=None, master_secret: typing.Optional["ISecret"]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class SecretRotationApplication(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.SecretRotationApplication"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretRotationApplicationOptions", jsii_struct_bases=[], name_mapping={'is_multi_user': 'isMultiUser'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretRotationProps", jsii_struct_bases=[], name_mapping={'application': 'application', 'secret': 'secret', 'target': 'target', 'vpc': 'vpc', 'automatically_after': 'automaticallyAfter', 'master_secret': 'masterSecret', 'security_group': 'securityGroup', 'vpc_subnets': 'vpcSubnets'})
class SecretRotationProps():
    def __init__(self, *, application: "SecretRotationApplication", secret: "ISecret", target: _IConnectable_a587039f, vpc: _IVpc_3795853f, automatically_after: typing.Optional[_Duration_5170c158]=None, master_secret: typing.Optional["ISecret"]=None, security_group: typing.Optional[_ISecurityGroup_d72ab8e8]=None, vpc_subnets: typing.Optional[_SubnetSelection_36a13cd6]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretStringGenerator", jsii_struct_bases=[], name_mapping={'exclude_characters': 'excludeCharacters', 'exclude_lowercase': 'excludeLowercase', 'exclude_numbers': 'excludeNumbers', 'exclude_punctuation': 'excludePunctuation', 'exclude_uppercase': 'excludeUppercase', 'generate_string_key': 'generateStringKey', 'include_space': 'includeSpace', 'password_length': 'passwordLength', 'require_each_included_type': 'requireEachIncludedType', 'secret_string_template': 'secretStringTemplate'})
...
class SecretTargetAttachment(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_secretsmanager.SecretTargetAttachment"):
    """An attached secret.

    stability
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, secret: "ISecret", target: "ISecretAttachmentTarget") -> None:
        """
        :param scope: -
        :param id: -
    ...
    @builtins.classmethod
    def from_secret_target_attachment_secret_arn(cls, scope: _Construct_f50a3f53, id: str, secret_target_attachment_secret_arn: str) -> "ISecretTargetAttachment":
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_secretsmanager.SecretTargetAttachmentProps", jsii_struct_bases=[AttachedSecretOptions], name_mapping={'target': 'target', 'secret': 'secret'})
