...
enum : int {
    ...
    SBK_QtNetworkQSSL_IDX                                    = 95,
    SBK_QSSL_KEYTYPE_IDX                                     = 99,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 97,
    SBK_QSSL_KEYALGORITHM_IDX                                = 98,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 96,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 101,
    SBK_QSSL_SSLOPTION_IDX                                   = 100,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 31,
    SBK_QSSLCERTIFICATE_IDX                                  = 102,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 104,
    SBK_QSSLCERTIFICATE_PATTERNSYNTAX_IDX                    = 103,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 105,
    SBK_QSSLCIPHER_IDX                                       = 106,
    SBK_QSSLCONFIGURATION_IDX                                = 107,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 108,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 109,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 110,
    SBK_QSSLERROR_IDX                                        = 111,
    SBK_QSSLERROR_SSLERROR_IDX                               = 112,
    SBK_QSSLKEY_IDX                                          = 113,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 114,
    SBK_QSSLSOCKET_IDX                                       = 115,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 117,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 116,
    SBK_QTCPSERVER_IDX                                       = 118,
    SBK_QTCPSOCKET_IDX                                       = 119,
    SBK_QUDPSOCKET_IDX                                       = 120,
    SBK_QDTLSERROR_IDX                                       = 20,
    SBK_QOCSPCERTIFICATESTATUS_IDX                           = 89,
    SBK_QOCSPREVOCATIONREASON_IDX                            = 91,
    SBK_QtNetwork_IDX_COUNT                                  = 121
};
