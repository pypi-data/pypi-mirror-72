...
def odoopbx_post_install(lib_dir):
    # Configure paths
    if not lib_dir:
        return
    base_dir = os.path.join(lib_dir, 'odoopbx')
...
class odoopbx_install(install):
    def run(self, *args, **kwargs):
        ...
        self.execute(odoopbx_post_install, (self.install_lib, ))
...
setup(
    ...
    install_requires=[
        ...
        'ipsetpy',
        'salt',
        'panoramisk @ git+https://github.com:litnimax/panoramisk.git',
        'odoorpc',
        'setproctitle',
        'terminado',
        'click',
