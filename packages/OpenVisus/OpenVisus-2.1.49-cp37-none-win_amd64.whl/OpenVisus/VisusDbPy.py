...
class BlockQuery(Query):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dataset = property(_VisusDbPy.BlockQuery_dataset_get, _VisusDbPy.BlockQuery_dataset_set)
    mode = property(_VisusDbPy.BlockQuery_mode_get, _VisusDbPy.BlockQuery_mode_set)
    field = property(_VisusDbPy.BlockQuery_field_get, _VisusDbPy.BlockQuery_field_set)
    time = property(_VisusDbPy.BlockQuery_time_get, _VisusDbPy.BlockQuery_time_set)
    aborted = property(_VisusDbPy.BlockQuery_aborted_get, _VisusDbPy.BlockQuery_aborted_set)
    buffer = property(_VisusDbPy.BlockQuery_buffer_get, _VisusDbPy.BlockQuery_buffer_set)
    status = property(_VisusDbPy.BlockQuery_status_get, _VisusDbPy.BlockQuery_status_set)
    errormsg = property(_VisusDbPy.BlockQuery_errormsg_get, _VisusDbPy.BlockQuery_errormsg_set)
...
class BoxQuery(Query):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dataset = property(_VisusDbPy.BoxQuery_dataset_get, _VisusDbPy.BoxQuery_dataset_set)
    mode = property(_VisusDbPy.BoxQuery_mode_get, _VisusDbPy.BoxQuery_mode_set)
    field = property(_VisusDbPy.BoxQuery_field_get, _VisusDbPy.BoxQuery_field_set)
    time = property(_VisusDbPy.BoxQuery_time_get, _VisusDbPy.BoxQuery_time_set)
    aborted = property(_VisusDbPy.BoxQuery_aborted_get, _VisusDbPy.BoxQuery_aborted_set)
    buffer = property(_VisusDbPy.BoxQuery_buffer_get, _VisusDbPy.BoxQuery_buffer_set)
    status = property(_VisusDbPy.BoxQuery_status_get, _VisusDbPy.BoxQuery_status_set)
    errormsg = property(_VisusDbPy.BoxQuery_errormsg_get, _VisusDbPy.BoxQuery_errormsg_set)
...
class PointQuery(Query):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dataset = property(_VisusDbPy.PointQuery_dataset_get, _VisusDbPy.PointQuery_dataset_set)
    mode = property(_VisusDbPy.PointQuery_mode_get, _VisusDbPy.PointQuery_mode_set)
    field = property(_VisusDbPy.PointQuery_field_get, _VisusDbPy.PointQuery_field_set)
    time = property(_VisusDbPy.PointQuery_time_get, _VisusDbPy.PointQuery_time_set)
    aborted = property(_VisusDbPy.PointQuery_aborted_get, _VisusDbPy.PointQuery_aborted_set)
    buffer = property(_VisusDbPy.PointQuery_buffer_get, _VisusDbPy.PointQuery_buffer_set)
    status = property(_VisusDbPy.PointQuery_status_get, _VisusDbPy.PointQuery_status_set)
    errormsg = property(_VisusDbPy.PointQuery_errormsg_get, _VisusDbPy.PointQuery_errormsg_set)
...
class Dataset(object):
    ...
    @staticmethod
    def interpolateSamples(Wsamples, Wbuffer, Rsamples, Rbuffer, aborted):
