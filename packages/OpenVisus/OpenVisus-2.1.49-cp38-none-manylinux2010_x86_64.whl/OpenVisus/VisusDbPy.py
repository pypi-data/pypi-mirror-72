...
class BlockQuery(Query):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["dataset"] = _VisusDbPy.BlockQuery_dataset_set
    __swig_getmethods__["dataset"] = _VisusDbPy.BlockQuery_dataset_get
    if _newclass:
        dataset = _swig_property(_VisusDbPy.BlockQuery_dataset_get, _VisusDbPy.BlockQuery_dataset_set)
    __swig_setmethods__["mode"] = _VisusDbPy.BlockQuery_mode_set
    __swig_getmethods__["mode"] = _VisusDbPy.BlockQuery_mode_get
    if _newclass:
        mode = _swig_property(_VisusDbPy.BlockQuery_mode_get, _VisusDbPy.BlockQuery_mode_set)
    ...
    __swig_setmethods__["status"] = _VisusDbPy.BlockQuery_status_set
    __swig_getmethods__["status"] = _VisusDbPy.BlockQuery_status_get
    if _newclass:
        status = _swig_property(_VisusDbPy.BlockQuery_status_get, _VisusDbPy.BlockQuery_status_set)
    __swig_setmethods__["errormsg"] = _VisusDbPy.BlockQuery_errormsg_set
    __swig_getmethods__["errormsg"] = _VisusDbPy.BlockQuery_errormsg_get
    if _newclass:
        errormsg = _swig_property(_VisusDbPy.BlockQuery_errormsg_get, _VisusDbPy.BlockQuery_errormsg_set)
    ...
    def getStatus(self):
        return _VisusDbPy.BlockQuery_getStatus(self)
    ...
    def isRunning(self):
        return _VisusDbPy.BlockQuery_isRunning(self)
    ...
    def setFailed(self, *args):
        return _VisusDbPy.BlockQuery_setFailed(self, *args)
...
class BoxQuery(Query):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["dataset"] = _VisusDbPy.BoxQuery_dataset_set
    __swig_getmethods__["dataset"] = _VisusDbPy.BoxQuery_dataset_get
    if _newclass:
        dataset = _swig_property(_VisusDbPy.BoxQuery_dataset_get, _VisusDbPy.BoxQuery_dataset_set)
    __swig_setmethods__["mode"] = _VisusDbPy.BoxQuery_mode_set
    __swig_getmethods__["mode"] = _VisusDbPy.BoxQuery_mode_get
    if _newclass:
        mode = _swig_property(_VisusDbPy.BoxQuery_mode_get, _VisusDbPy.BoxQuery_mode_set)
    __swig_setmethods__["field"] = _VisusDbPy.BoxQuery_field_set
    __swig_getmethods__["field"] = _VisusDbPy.BoxQuery_field_get
    if _newclass:
        field = _swig_property(_VisusDbPy.BoxQuery_field_get, _VisusDbPy.BoxQuery_field_set)
    __swig_setmethods__["time"] = _VisusDbPy.BoxQuery_time_set
    __swig_getmethods__["time"] = _VisusDbPy.BoxQuery_time_get
    if _newclass:
        time = _swig_property(_VisusDbPy.BoxQuery_time_get, _VisusDbPy.BoxQuery_time_set)
    __swig_setmethods__["aborted"] = _VisusDbPy.BoxQuery_aborted_set
    __swig_getmethods__["aborted"] = _VisusDbPy.BoxQuery_aborted_get
    if _newclass:
        aborted = _swig_property(_VisusDbPy.BoxQuery_aborted_get, _VisusDbPy.BoxQuery_aborted_set)
    __swig_setmethods__["buffer"] = _VisusDbPy.BoxQuery_buffer_set
    __swig_getmethods__["buffer"] = _VisusDbPy.BoxQuery_buffer_get
    if _newclass:
        buffer = _swig_property(_VisusDbPy.BoxQuery_buffer_get, _VisusDbPy.BoxQuery_buffer_set)
    __swig_setmethods__["status"] = _VisusDbPy.BoxQuery_status_set
    __swig_getmethods__["status"] = _VisusDbPy.BoxQuery_status_get
    if _newclass:
        status = _swig_property(_VisusDbPy.BoxQuery_status_get, _VisusDbPy.BoxQuery_status_set)
    __swig_setmethods__["errormsg"] = _VisusDbPy.BoxQuery_errormsg_set
    __swig_getmethods__["errormsg"] = _VisusDbPy.BoxQuery_errormsg_get
    if _newclass:
        errormsg = _swig_property(_VisusDbPy.BoxQuery_errormsg_get, _VisusDbPy.BoxQuery_errormsg_set)
    ...
    def getStatus(self):
        return _VisusDbPy.BoxQuery_getStatus(self)

    def setStatus(self, value):
        return _VisusDbPy.BoxQuery_setStatus(self, value)

    def ok(self):
        return _VisusDbPy.BoxQuery_ok(self)

    def failed(self):
        return _VisusDbPy.BoxQuery_failed(self)

    def isRunning(self):
        return _VisusDbPy.BoxQuery_isRunning(self)

    def setRunning(self):
        return _VisusDbPy.BoxQuery_setRunning(self)

    def setOk(self):
        return _VisusDbPy.BoxQuery_setOk(self)

    def setFailed(self, *args):
        return _VisusDbPy.BoxQuery_setFailed(self, *args)
...
class PointQuery(Query):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["dataset"] = _VisusDbPy.PointQuery_dataset_set
    __swig_getmethods__["dataset"] = _VisusDbPy.PointQuery_dataset_get
    if _newclass:
        dataset = _swig_property(_VisusDbPy.PointQuery_dataset_get, _VisusDbPy.PointQuery_dataset_set)
    __swig_setmethods__["mode"] = _VisusDbPy.PointQuery_mode_set
    __swig_getmethods__["mode"] = _VisusDbPy.PointQuery_mode_get
    if _newclass:
        mode = _swig_property(_VisusDbPy.PointQuery_mode_get, _VisusDbPy.PointQuery_mode_set)
    __swig_setmethods__["field"] = _VisusDbPy.PointQuery_field_set
    __swig_getmethods__["field"] = _VisusDbPy.PointQuery_field_get
    if _newclass:
        field = _swig_property(_VisusDbPy.PointQuery_field_get, _VisusDbPy.PointQuery_field_set)
    __swig_setmethods__["time"] = _VisusDbPy.PointQuery_time_set
    __swig_getmethods__["time"] = _VisusDbPy.PointQuery_time_get
    if _newclass:
        time = _swig_property(_VisusDbPy.PointQuery_time_get, _VisusDbPy.PointQuery_time_set)
    __swig_setmethods__["aborted"] = _VisusDbPy.PointQuery_aborted_set
    __swig_getmethods__["aborted"] = _VisusDbPy.PointQuery_aborted_get
    if _newclass:
        aborted = _swig_property(_VisusDbPy.PointQuery_aborted_get, _VisusDbPy.PointQuery_aborted_set)
    __swig_setmethods__["buffer"] = _VisusDbPy.PointQuery_buffer_set
    __swig_getmethods__["buffer"] = _VisusDbPy.PointQuery_buffer_get
    if _newclass:
        buffer = _swig_property(_VisusDbPy.PointQuery_buffer_get, _VisusDbPy.PointQuery_buffer_set)
    __swig_setmethods__["status"] = _VisusDbPy.PointQuery_status_set
    __swig_getmethods__["status"] = _VisusDbPy.PointQuery_status_get
    if _newclass:
        status = _swig_property(_VisusDbPy.PointQuery_status_get, _VisusDbPy.PointQuery_status_set)
    __swig_setmethods__["errormsg"] = _VisusDbPy.PointQuery_errormsg_set
    __swig_getmethods__["errormsg"] = _VisusDbPy.PointQuery_errormsg_get
    if _newclass:
        errormsg = _swig_property(_VisusDbPy.PointQuery_errormsg_get, _VisusDbPy.PointQuery_errormsg_set)
    ...
    def getStatus(self):
        return _VisusDbPy.PointQuery_getStatus(self)

    def setStatus(self, value):
        return _VisusDbPy.PointQuery_setStatus(self, value)

    def ok(self):
        return _VisusDbPy.PointQuery_ok(self)

    def failed(self):
        return _VisusDbPy.PointQuery_failed(self)

    def isRunning(self):
        return _VisusDbPy.PointQuery_isRunning(self)

    def setRunning(self):
        return _VisusDbPy.PointQuery_setRunning(self)

    def setOk(self):
        return _VisusDbPy.PointQuery_setOk(self)

    def setFailed(self, *args):
        return _VisusDbPy.PointQuery_setFailed(self, *args)

    def allocateBufferIfNeeded(self):
        return _VisusDbPy.PointQuery_allocateBufferIfNeeded(self)
...
class Dataset(_object):
    ...
    def getBlockSamples(self, blockid):
        return _VisusDbPy.Dataset_getBlockSamples(self, blockid)
    ...
    if _newclass:
        interpolateSamples = staticmethod(_VisusDbPy.Dataset_interpolateSamples)
    else:
        interpolateSamples = _VisusDbPy.Dataset_interpolateSamples
...
def Dataset_interpolateSamples(Wsamples, Wbuffer, Rsamples, Rbuffer, aborted):
    return _VisusDbPy.Dataset_interpolateSamples(Wsamples, Wbuffer, Rsamples, Rbuffer, aborted)
Dataset_interpolateSamples = _VisusDbPy.Dataset_interpolateSamples
...
class IdxDataset(Dataset):
    ...
    def getBlockSamples(self, blockid):
        return _VisusDbPy.IdxDataset_getBlockSamples(self, blockid)
