...
[boto3.ResourceGroupsTaggingAPI 1.14.8](https://boto3.amazonaws.com/v1/documentation/api/1.14.8/reference/services/resourcegroupstaggingapi.html#ResourceGroupsTaggingAPI) service
