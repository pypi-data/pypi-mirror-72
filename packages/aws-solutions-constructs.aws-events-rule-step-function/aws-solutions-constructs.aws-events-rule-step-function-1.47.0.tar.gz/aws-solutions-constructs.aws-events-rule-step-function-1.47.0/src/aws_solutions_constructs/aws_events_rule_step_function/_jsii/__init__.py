...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-solutions-constructs/aws-events-rule-step-function", "1.47.0", __name__[0:-6], "aws-events-rule-step-function@1.47.0.jsii.tgz")
