...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.2.0-alpha.1593620342+5c8fe293'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.2.0-alpha.1593620342+5c8fe293`
                """)
            else:
                raise
