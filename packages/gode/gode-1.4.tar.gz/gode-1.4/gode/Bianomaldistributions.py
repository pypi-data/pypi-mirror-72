...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        self.sdtev = self.calculate_stdev()
    ...
    def pdf(self, k):
        ...
        a = math.factorial(self.n)/(math.factorail(self.k)* (math.factoriql(self.n-k)))   
    ...
    def plot_bar_pdf(self):
        ...
        for i in range(self.n+1):
            ...
            y.append(self.pdf(i))
        plt.bar(x,y)
        plt.xlabel('distribution outcome')
        plt.ylable('prop')
