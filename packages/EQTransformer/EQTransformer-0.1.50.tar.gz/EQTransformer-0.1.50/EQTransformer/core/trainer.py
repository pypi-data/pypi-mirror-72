...
def trainer(input_hdf5=None,
    ...
    Args:        
        input_hdf5 (str, optional): Path to an hdf5 file containing only one class of "data" with NumPy arrays containing 3 component waveforms each 1 min long. Defaults to None.          
        input_csv (str, optional): Path to a CSV file with one column (trace_name) listing the name of all datasets in the hdf5 file. Defaults to None.                  
        output_name (str, optional): Output directory. Defaults to None.   
        input_dimention (int, optional): Loss types for detection, P picking, and S picking respectively. Defaults to (6000, 3).        
        cnn_blocks (int, optional): The number of residual blocks of convolutional layers. Defaults to 5.        
        lstm_blocks (int, optional): The number of residual blocks of BiLSTM layers. Defaults to 2.        
        padding (str, optional): Padding type. Defaults to 'same'.        
        activation (str, optional): Activation function used in the hidden layers. Defaults to 'relu'.        
        drop_rate (float, optional): Dropout value. Defaults to 0.1.        
        shuffle (bool, optional): To shuffle the list prior to the training. Defaults to True.        
        label_type (str, optional): Labeling type. 'gaussian', 'triangle', or 'box'. Defaults to 'triangle'.        
        normalization_mode (str, optional): Mode of normalization for data preprocessing, 'max': maximum amplitude among three components, 'std': standard deviation. 'gaussian', 'triangle', or 'box'. Defaults to 'std'.        
        laugmentation (bool, optional): If True, data will be augmented simultaneously during the training. 'gaussian', 'triangle', or 'box'. Defaults to True.        
        add_event_r (float, optional): Rate of augmentation for adding a secondary event randomly into the empty part of a trace. Defaults to 0.6.        
        shift_event_r (float, optional): Rate of augmentation for randomly shifting the event within a trace.. Defaults to 0.99.        
        add_noise_r (float, optional): Rate of augmentation for adding Gaussian noise with different SNR into a trace. Defaults to 0.3.        
        drop_channel_r (float, optional): Rate of augmentation for randomly dropping one of the channels. Defaults to 0.4.        
        add_gap_r (float, optional): Add an interval with zeros into the waveform representing filled gaps. Defaults to 0.2.        
        scale_amplitude_r (float, optional): Rate of augmentation for randomly scaling the trace. Defaults to None.        
        pre_emphasis (bool, optional): If True, waveforms will be pre-emphasized. Defaults to False.        
        loss_weights (list, [optional): Loss weights for detection, P picking, and S picking respectively. Defaults to [0.03, 0.40, 0.58].               
        loss_types (list, optional): Loss types for detection, P picking, and S picking respectively. Defaults to ['binary_crossentropy', 'binary_crossentropy', 'binary_crossentropy']        
        train_valid_test_split (list, optional): Precentage of data split into the training, validation, and test sets respectively. Defaults to [0.85, 0.05, 0.10].           
        mode: (str, optional): Mode of running. 'generator', or 'preload'. Defaults to 'generator'.           
        batch_size: (int, optional): Batch size. Defaults to 200.           
        epochs: (int, optional): The number of epochs. Defaults to 200.           
        monitor: (int, optional): The measure used for monitoring. Defaults to 'val_loss'.           
        patience: (int, optional): The number of epochs without any improvement in the monitoring measure to automatically stop the training. Defaults to 12.           
        multi_gpu: (bool, optional): If True, multiple GPUs will be used for the training. Defaults to False.           
        number_of_gpus: (int, optional): Number of GPUs uses for multi-GPU training. Defaults to 4.           
        gpuid (int, optional): Id of GPU used for the prediction. If using CPU set to None. Defaults to None.           
        gpu_limit (float, optional): Set the maximum percentage of memory usage for the GPU. Defaults to None.
        use_multiprocessing (bool optional): If True, multiple CPUs will be used for the preprocessing of data even when GPU is used for the prediction. Defaults to True.
