...
def tester(input_hdf5=None,
    ...
    Args:        
        ...
        input_testset (npy, optional): Path to a NumPy file (automaticaly generated by the trainer) containing a list of trace names. Defaults to None.                  
        ...
        mode: (str, optional): Mode of running. 'pre_load_generator' or 'generator'. Defaults to 'generator'.           
