...
def mseed_predictor(input_dir='downloads_mseeds',
    ...
    Args:        
        ...
        stations_json (str, optional): Path to a JSON file containing station information.Defaults to None.           
        ...
        overlap (float, optional): If set, detection, and picking are performed in overlapping windows. Defaults to 0.3.           
        gpuid (int, optional): Id of GPU used for the prediction. If using CPU set to None. Defaults to None.           
        gpu_limit (int, optional): Set the maximum percentage of memory usage for the GPU. Defaults to None.
...
def _detect_peaks(x, mph=None, mpd=1, threshold=0, edge='rising',
    ...
    kph : bool, optional (default = False)
