...
class Preference(models.Model):
    ...
    owner = models.ForeignKey(Account, verbose_name=_('owner'), related_name='preferences', on_delete=models.PROTECT, )
    # Doc says it's a UUID. It's not.
    mp_id = models.CharField(_('mercadopago id'), max_length=46, null=True,
    ...
    paid = models.BooleanField(_('paid'), default=False, help_text=_('Indicates if the preference has been paid.'), )
