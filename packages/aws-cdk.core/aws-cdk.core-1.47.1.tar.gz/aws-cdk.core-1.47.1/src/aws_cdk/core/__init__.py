...
@jsii.data_type(jsii_type="@aws-cdk/core.AssetOptions", jsii_struct_bases=[], name_mapping={'asset_hash': 'assetHash', 'asset_hash_type': 'assetHashType', 'bundling': 'bundling'})
class AssetOptions():
...
@jsii.data_type(jsii_type="@aws-cdk/core.BootstraplessSynthesizerProps", jsii_struct_bases=[], name_mapping={'cloud_formation_execution_role_arn': 'cloudFormationExecutionRoleArn', 'deploy_role_arn': 'deployRoleArn'})
...
class BundlingDockerImage(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.BundlingDockerImage"):
...
@jsii.data_type(jsii_type="@aws-cdk/core.BundlingOptions", jsii_struct_bases=[], name_mapping={'image': 'image', 'command': 'command', 'environment': 'environment', 'user': 'user', 'volumes': 'volumes', 'working_directory': 'workingDirectory'})
...
@jsii.data_type(jsii_type="@aws-cdk/core.CfnJsonProps", jsii_struct_bases=[], name_mapping={'value': 'value'})
class CfnJsonProps():
...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.ConstructNode"):
    ...
    @builtins.classmethod
    def synth(cls, node: "ConstructNode", *, outdir: typing.Optional[str]=None, skip_validation: typing.Optional[bool]=None, runtime_info: typing.Optional[aws_cdk.cx_api.RuntimeInfo]=None) -> aws_cdk.cx_api.CloudAssembly:
...
@jsii.data_type(jsii_type="@aws-cdk/core.DockerBuildOptions", jsii_struct_bases=[], name_mapping={'build_args': 'buildArgs'})
...
@jsii.data_type(jsii_type="@aws-cdk/core.DockerVolume", jsii_struct_bases=[], name_mapping={'container_path': 'containerPath', 'host_path': 'hostPath'})
class DockerVolume():
...
@jsii.data_type(jsii_type="@aws-cdk/core.FileAssetLocation", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'http_url': 'httpUrl', 'object_key': 'objectKey', 's3_object_url': 's3ObjectUrl', 's3_url': 's3Url', 'kms_key_arn': 'kmsKeyArn'})
...
@jsii.data_type(jsii_type="@aws-cdk/core.FromCloudFormationOptions", jsii_struct_bases=[], name_mapping={'finder': 'finder'})
...
@jsii.interface(jsii_type="@aws-cdk/core.ICfnFinder")
...
class _ICfnFinderProxy():
    ...
    :stability: experimental
    """
    __jsii_type__ = "@aws-cdk/core.ICfnFinder"
    @jsii.member(jsii_name="findCondition")
    def find_condition(self, condition_name: str) -> typing.Optional["CfnCondition"]:
        """Return the Condition with the given name from the template.
...
@jsii.data_type(jsii_type="@aws-cdk/core.StageProps", jsii_struct_bases=[], name_mapping={'env': 'env', 'outdir': 'outdir'})
class StageProps():
...
@jsii.data_type(jsii_type="@aws-cdk/core.StageSynthesisOptions", jsii_struct_bases=[], name_mapping={'skip_validation': 'skipValidation'})
...
@jsii.data_type(jsii_type="@aws-cdk/core.AssetStagingProps", jsii_struct_bases=[FingerprintOptions, AssetOptions], name_mapping={'exclude': 'exclude', 'follow': 'follow', 'extra_hash': 'extraHash', 'asset_hash': 'assetHash', 'asset_hash_type': 'assetHashType', 'bundling': 'bundling', 'source_path': 'sourcePath'})
...
class BootstraplessSynthesizer(DefaultStackSynthesizer, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.BootstraplessSynthesizer"):
...
class Stage(Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.Stage"):
    ...
    @jsii.member(jsii_name="synth")
    def synth(self, *, skip_validation: typing.Optional[bool]=None) -> aws_cdk.cx_api.CloudAssembly:
