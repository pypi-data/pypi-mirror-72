...
class ServiceXDataset(ServiceXABC):
    ...
    async def _get_files(self, selection_query: str, data_type: str,
        ...
        request_id = await self._get_request_id(query)
        ...
        try:
            ...
            stream_local_files = self._get_cached_files(cached_files, notifier) \
                ...
                else self._get_files_from_servicex(request_id, query, notifier)
    ...
    async def _get_request_id(self, query: Dict[str, Any]):
        '''
        ...
        if request_id is None:
            request_id = await self._servicex_adaptor.submit_query(query)
    ...
    async def _get_files_from_servicex(self, request_id: str,
        ...
        try:
            ...
            stream_status = transform_status_stream(self._servicex_adaptor, request_id)
