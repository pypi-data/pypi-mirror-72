...
def resize_window(width, height):
    r"""   If using interactive mode, resizes the window to the specified dimentions."""
...
class texture(static_factory):
    ...
    @staticmethod
    def create_from_image(name, path):
        r"""
        ...
        :return: a Texture allocated by the renderer.
        """
        return _visii.texture_create_from_image(name, path)
    ...
    def create_from_data(name, width, height, data):
        ...
        :type data: std::vector< glm::vec4,std::allocator< glm::vec4 > >
    ...
    def get(*args):
        ...
        *Overload 1:*
        ...
        :rtype: :py:class:`Texture`
        :return: a Texture who's primary name key matches name
        ...
        *Overload 2:*
        ...
        :rtype: :py:class:`Texture`
        :return: a Texture who's primary id key matches id
        """
        return _visii.texture_get(*args)
    ...
    def remove(*args):
        r"""
        *Overload 1:*
        Deletes the Texture who's primary name key matches name

        |

        *Overload 2:*
        Deletes the Texture who's primary id key matches id
        """
        return _visii.texture_remove(*args)
    ...
    @staticmethod
    def clean_up():
        return _visii.texture_clean_up()
...
def texture_create_from_image(name, path):
    r"""
     Constructs a Texture with the given name from a image located on the filesystem.
    Supported formats include JPEG, PNG, TGA, BMP, PSD, GIF, HDR, PIC, and PNM
    :type path: string
...
class material(static_factory):
    ...
    def set_bump_texture(self, texture):
        r"""
        ...
        """
        return _visii.material_set_bump_texture(self, texture)

    def clear_bump_texture(self):
        r""" Disconnects the Bump texture, reverting back to any existing constant Bump"""
        return _visii.material_clear_bump_texture(self)
...
class mesh(static_factory):
    ...
    def create_rounded_box(*args, **kwargs):
        r"""
         Creates a mesh component from a procedural parametric mesh. (TODO: accept a callback which given an x and y position
        			returns a Z hightfield)  Creates a rectangular box with rounded edges, centered at the origin and aligned along the x, y, and z axis.
    ...
    def create_from_obj(name, path):
        r"""
         Creates a mesh component from an OBJ file (ignoring any .mtl files)  :type name: string
        :param name: The name (used as a primary key) for this mesh component :type path: string
    ...
    def create_from_data(*args, **kwargs):
        r"""
         Creates a mesh component from a set of positions, optional normals, optional colors, optional texture coordinates, 	and optional indices. If anything other than positions is supplied (eg normals), that list must be the same length	as the point list. If indicies are supplied, indices must be a multiple of 3 (triangles). Otherwise, all other	supplied per vertex data must be a multiple of 3 in length.  :type positions: std::vector< glm::vec4,std::allocator< glm::vec4 > >
        :param positions: A list of 3D vertex positions. If indices aren't supplied, this must be a multiple of 3. :type normals: std::vector< glm::vec4,std::allocator< glm::vec4 > >
        :param normals: A list of 3D vertex normals. If indices aren't supplied, this must be a multiple of 3. :type colors: std::vector< glm::vec4,std::allocator< glm::vec4 > >
        :param colors: A list of per-vertex colors. If indices aren't supplied, this must be a multiple of 3. :type texcoords: std::vector< glm::vec2,std::allocator< glm::vec2 > >
        :param texcoords: A list of 2D per-vertex texture coordinates. If indices aren't supplied, this must be a multiple of 3. :type indices: std::vector< uint32_t,std::allocator< uint32_t > >
        :param indices: A list of integer indices connecting vertex positions in a counterclockwise ordering to form triangles. If supplied, indices must be a multiple of 3. :rtype: :py:class:`Mesh`
        :return: a reference to the mesh component
        """
    ...
    def get(*args):
        ...
        *Overload 1:*
        ...
        :rtype: :py:class:`Mesh`
        :return: a mesh who's primary name key matches name
        :type name: string
        ...
        *Overload 2:*
        ...
        :rtype: :py:class:`Mesh`
        :return: a mesh who's primary id key matches id
        :type id: int
        :param id: A unique id used to lookup this mesh.
        """
        return _visii.mesh_get(*args)
    ...
    def remove(*args):
        r"""
        *Overload 1:*
         Deletes the mesh who's primary name key matches name
        ...
        *Overload 2:*
         Deletes the mesh who's primary id key matches id

        :type id: int
        :param id: A unique id used to lookup the mesh for deletion.
        """
        return _visii.mesh_remove(*args)
    ...
    @staticmethod
    def clean_up():
        r""" Frees any tables used to store mesh components"""
        return _visii.mesh_clean_up()
