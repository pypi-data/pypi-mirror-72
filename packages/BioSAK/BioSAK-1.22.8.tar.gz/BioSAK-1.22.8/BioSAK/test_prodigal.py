...
def prodigal_parser(seq_file, sco_file, prefix, output_folder):
    ...
    for each_cds in open(sco_file):
        if each_cds.startswith('# Sequence Data'):
            ...
            current_seq_id = each_cds.strip().split('=')[3][1:-1].split(' ')[0]
...
seq_file        = '/Users/songweizhi/Desktop/999/IRC1_bins_test/IRC1_bin_1.fna'
sco_file        = '/Users/songweizhi/Desktop/999/IRC1_bins_test_1_prodigal_output/IRC1_bin_1.sco'
prefix          = 'IRC1_bin_1'
output_folder   = '/Users/songweizhi/Desktop/999'


prodigal_parser(seq_file, sco_file, prefix, output_folder)


test = '# Sequence Data: seqnum=1;seqlen=6938;seqhdr="c_000000002084"'
test = '# Sequence Data: seqnum=1;seqlen=71599;seqhdr="NODE_358 NODE_358_length_71599_cov_38.4297 [matched=9] [unmatched=0] [degenerate=0] [unbinned=0]"'
current_seq_id_1 = test.strip().split('=')[-1][1:-1].split(' ')[0]
current_seq_id_2 = test.strip().split('=')[3][1:-1].split(' ')[0]

print(current_seq_id_1)
print(current_seq_id_2)