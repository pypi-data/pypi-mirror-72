...
with open("supertoolbox/README.MD", "r") as fh:
    long_description = fh.read()
...
setuptools.setup(
    ...
    author="Frank YCJ",
    author_email="1320259466@qq.com",
    description="The super supertoolbox makes the code simpler!",
    keywords='tool util code simpler box',
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/YouAreOnlyOne",
    # packages=setuptools.find_packages(),
    packages=["supertoolbox"],
    # install_requires=[''],
    python_requires=">=2.6, !=3.0.*, !=3.1.*, !=3.2.*, !=3.3.*, !=3.4.*",
    license="Apache 2.0 license",
    Platform="OS All, Python 2.x",
    ...
    package_data={
        # If any package contains *.txt or *.rst files, include them:
        "supertoolbox": ["README.MD",],
        "supertoolbox": ["LICENSE",],
    },
    classifiers=[
        "Programming Language :: Python :: 2",
        "License :: OSI Approved :: MIT License",
