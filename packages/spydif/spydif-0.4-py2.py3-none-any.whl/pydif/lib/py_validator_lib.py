...
_SqlServerConn = os.environ.get('DB_SERVER_CONN_STR') or 'Driver={SQL Server};Server=cysgikdcdbmsq02;Database=DDI_STAG;uid=DDIAdmin;pwd=DDIAdmin;trusted_connection=NO'
