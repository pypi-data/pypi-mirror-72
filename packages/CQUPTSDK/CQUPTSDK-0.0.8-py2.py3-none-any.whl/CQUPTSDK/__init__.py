from CQUPTSDK import LoginApi
from CQUPTSDK import GetStudentInfo
from CQUPTSDK import GetSchedule
from CQUPTSDK import GetExam
from CQUPTSDK import GetRoom
 #  @author Longm
