...
class Projects :
    ...
    def clone( self,
        ...
        if hosts_not_established:
            if raise_exception:
                raise Exception("authenticity of servers "+", ".join(hosts_not_established)+" could not be established")
            if console:
                print("\n\t",coloring.red("[ERROR]"),"authenticity of at least one server could not be established.")
                print("\t",coloring.dim("possible fix: clone manually a repo from this server to establish authenticity via prompt\n"))
