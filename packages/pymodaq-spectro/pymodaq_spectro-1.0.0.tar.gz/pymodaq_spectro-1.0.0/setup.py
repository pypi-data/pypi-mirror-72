...
from pymodaq_spectro.version import get_version

with open('README.rst') as fd:
    long_description = fd.read()

setupOpts = dict(
    name='pymodaq_spectro',
    description='Spectrometer Interface using PyMoDAQ',
...
allPackages = (listAllPackages(pkgroot='pymodaq_spectro')) #+
