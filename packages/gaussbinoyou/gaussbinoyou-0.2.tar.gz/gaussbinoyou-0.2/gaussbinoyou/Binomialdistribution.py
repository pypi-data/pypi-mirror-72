...
class Binomial(Distribution):
    ...
    def plot_bar_pdf(self):
        ...
        interval = 1.0 * (max_range - min_range) / size
    ...
    def __add__(self, other):
        ...
        """
        comp = Binomial()
        comp.n = self.n + other.n
        comp.p = self.p
        comp.mean = self.calculate_mean()
        comp.stdev = self.calculate_stdev()
    ...
    def __repr__(self):
        ...
        """
        return "mean {}, standard deviation {}, Prob {}, Size {}".format(self.mean, self.stdev, self.p, self.n)
