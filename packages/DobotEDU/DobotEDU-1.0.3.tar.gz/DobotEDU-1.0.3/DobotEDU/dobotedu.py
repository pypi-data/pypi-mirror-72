...
class DobotEDU(object):
    def __init__(self, user_name: str, school_key: str):
        ...
        self.__host = 'https://aip.baidubce.com/oauth/2.0/token?grant_type=client_credentials&client_id='
    ...
    def get_image(self, file_path, count_down):  # count_down为拍照时间
    ...
    def conversation_robot(self, query, session_id):
        ...
        url = 'https://aip.baidubce.com/rpc/2.0/unit/service/chat?access_token='
        + str(access_token)
        ...
        post_data = "{\"log_id\":\""+log_id+"\",\"version\":\"2.0\",\"service_id\":\"" + s_id +\
                    ...
                    "\"},\"dialog_state\":{\"contexts\":{\"SYS_REMEMBERED_SKILLS\":[\"1027844\",\"1027543\",\"1027486\",\"1028254\",\"1028254\"]}}}"
