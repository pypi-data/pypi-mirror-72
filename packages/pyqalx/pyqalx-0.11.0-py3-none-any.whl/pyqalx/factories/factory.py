...
class Factory(BaseFactory):
    ...
    def validate(self, plan):
        ...
        """
        _msg_user(msg="Starting Factory Validation")
        self.session.factory.validate(plan)
        self.plan = self.read_plan(plan)
        _msg_user(msg="Factory Validation Successful")
    ...
    def pack(self, plan, stage=None, delete=True):
        ...
        """
        _msg_user(msg="Starting Factory Pack")
        ...
        _msg_user(msg="Factory Pack Successful")
    ...
    def build(self, plan, stage):
        ...
        :type  stage:   str
        """
        _msg_user(msg="Starting Factory Build")
        self.stage = stage
        ...
        def _delete_resources(_delete_stacks=True):
            ...
            _msg_user(msg=_error, title="pyqalx", level=logging.ERROR)
        ...
        if success:
            try:
                ...
                _msg_user(msg="Factory Build Successful")
            except QalxAPIResponseError:
    ...
    def demolish(self, factory_guid):
        ...
        """
        _msg_user(msg="Starting Factory Demolish")
        try:
        ...
        _msg_user(msg="Factory Demolish Successful")
