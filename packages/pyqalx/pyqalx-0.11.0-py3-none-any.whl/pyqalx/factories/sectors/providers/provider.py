...
class BaseProvider:
    ...
    pyqalx_configs: The configs for a User and a Bot based on the
     qalx_profile and bot_profile arguments on the stage.
    ...
    @classmethod
    def _send_message(cls, title, message, level, log=True):
        """
    ...
    def _msg_user(self, message, level=logging.DEBUG, log=True):
        """
    ...
    @staticmethod
    def validate_permissions(profile_name, region_name):
        """
    ...
    @staticmethod
    def default_region_name(validate):
        """
