...
import yaml
from troposphere import Tag, Tags, Template, Base64, Join, Ref, ssm
...
class AWSStack:
    ...
    def _resource_tags(self, name):
        ...
        tags = [
            ...
            self._add_tag("qalx-factory-guid", self.factory_entity.guid),
    ...
    def _config_parameters(self, sector_name):
        ...
        user_config = UserConfig._load_inifile(
            self.provider.stack[sector_name]["qalx_profile"]
        )
