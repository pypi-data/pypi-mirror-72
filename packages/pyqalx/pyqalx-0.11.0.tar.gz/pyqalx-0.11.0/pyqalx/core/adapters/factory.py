...
class QalxFactory(QalxFileAdapter):
    ...
    def add(self, name, input_file=None, file_name="", meta=None, **kwargs):
        """
        Adds a `Factory` instance

        :param name:        The name of the factory
        :type  name:        str
        :param input_file:  file path to the factory plan or instance of
                            StringIO or BytesIO
                            (https://docs.python.org/3/library/io.html)
        :type  input_file:  str or `io` object
        :param file_name:   Name for the factory plan input file. Optional if a
                            file path is given for input_file parameter.
    ...
    def save(self, entity, input_file=None, file_name="", **kwargs):
        """
