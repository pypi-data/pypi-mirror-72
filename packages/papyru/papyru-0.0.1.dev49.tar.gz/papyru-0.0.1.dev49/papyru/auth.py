...
from papyru import PlainContext
    ...
    def wrapper(view):
        ...
        def impl(*args, **kwargs):
            ...
            request.auth_user = _authenticate(
                user_map, _parse_authorization_headers(request))
...
def _parse_authorization_headers(request):
    ...
    try:
        encoded_credentials = b64decode(m[1]).decode('utf-8')
    except Exception:
        return None
