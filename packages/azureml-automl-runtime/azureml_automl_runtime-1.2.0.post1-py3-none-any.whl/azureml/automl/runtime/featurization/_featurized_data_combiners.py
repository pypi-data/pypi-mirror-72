...
class FeaturizedDataCombiners:
    ...
    @staticmethod
    def default_combiner(features: List[Any], **kwargs) -> np.array:
        """
    ...
    @staticmethod
    def sparse_combiner(features: List[Any], **kwargs) -> sparse.spmatrix:
        """
    ...
    @staticmethod
    def disk_based_sparse_combiner(features: List[Any], **kwargs) -> sparse.spmatrix:
        """
