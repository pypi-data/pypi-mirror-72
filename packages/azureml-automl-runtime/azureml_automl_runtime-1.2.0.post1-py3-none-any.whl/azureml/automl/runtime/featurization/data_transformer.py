...
class DataTransformer(AutoMLTransformer, FeaturizationInfoProvider):
        ...
        if self._is_onnx_compatible and self.mapper is not None:
            try:
                ...
                fit_exception = FitException.from_exception(
                    ...
                    has_pii=False,
                    reference_code=ReferenceCodes._DATA_TRANSFORMER_FIT_ONNX_CAMPATIBLE)
                raise fit_exception
        else:
    ...
    @logging_utilities.function_debug_log_wrapped
    def transform(self, df: DataInputType) -> Any:
        """
        ...
        return combiner(features, **{'working_directory': self.working_directory,
                                     'logger': self.logger,
    ...
    @property
    def get_column_names_and_types(self) -> Dict[str, np.dtype]:
        """
