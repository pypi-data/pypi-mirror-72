...
def _save_artifacts(fit_output: FitOutput,
    ...
    with automl_run_context.get_run() as run:
        ...
        properties_to_add = {
            ...
            inference.AutoMLInferenceArtifactIDs.PipelineGraphVersion:
                constants.PIPELINE_GRAPH_VERSION,
            ModelExpSupportStr:
                str(training_utilities._get_model_exp_property(run, logger))
        }
        if model_name:
            properties_to_add.update({
                ...
                inference.AutoMLInferenceArtifactIDs.ModelName:
                    model_name
            })
