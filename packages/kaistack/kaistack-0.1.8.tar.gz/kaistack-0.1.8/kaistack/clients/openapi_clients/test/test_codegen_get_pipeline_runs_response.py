...
from kaistack.clients.openapi_clients.models.codegen_get_pipeline_runs_response import CodegenGetPipelineRunsResponse  # noqa: E501
...
class TestCodegenGetPipelineRunsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kaistack.clients.openapi_clients.models.codegen_get_pipeline_runs_response.CodegenGetPipelineRunsResponse()  # noqa: E501
        if include_optional :
            return CodegenGetPipelineRunsResponse(
                runs = [
                    kaistack.clients.openapi_clients.models.codegen_run.codegenRun(
                        run_id = '0', 
                        name = '0', 
