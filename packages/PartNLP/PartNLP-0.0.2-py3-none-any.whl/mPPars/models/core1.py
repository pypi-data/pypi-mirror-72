"""
Pipline runs preprocess such as word-tokenize, sent-tokenize, stemming
"""
from mPPars.models import configuration
from mPPars.models.validation.config_validator import config_validator
from mPPars.models.constants.constants import NAME_TO_PACKAGE_DICT, NAME_TO_METHODS
...
class Pipeline:
    ...
    **Supproted operations**:
    ...
    def __init__(self, lang='persian', package='HAZM', processors=[], text='', report_process=True,
