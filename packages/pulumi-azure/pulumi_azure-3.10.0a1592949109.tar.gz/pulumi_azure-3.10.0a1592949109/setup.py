...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.10.0-alpha.1592949109+302f22a2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.10.0-alpha.1592949109+302f22a2`
                """)
            else:
                raise
