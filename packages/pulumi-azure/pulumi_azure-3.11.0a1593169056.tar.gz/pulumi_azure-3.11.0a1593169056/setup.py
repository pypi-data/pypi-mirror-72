...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.11.0-alpha.1593169056+4b6ad40e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.11.0-alpha.1593169056+4b6ad40e`
                """)
            else:
                raise
