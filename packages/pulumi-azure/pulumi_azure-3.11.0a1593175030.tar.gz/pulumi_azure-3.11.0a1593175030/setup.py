...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.11.0-alpha.1593175030+c6800eeb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.11.0-alpha.1593175030+c6800eeb`
                """)
            else:
                raise
