...
class UsrLog(Status):
    usr_insercao = models.ForeignKey('Usuario', on_delete=models.SET_NULL, null=True, related_name='usr_insercao')
    usr_edicao = models.ForeignKey('Usuario', on_delete=models.SET_NULL, null=True, related_name='usr_edicao')
    usr_delete = models.ForeignKey('Usuario', on_delete=models.SET_NULL, null=True, related_name='usr_delete')
    class Meta:
        abstract = True
