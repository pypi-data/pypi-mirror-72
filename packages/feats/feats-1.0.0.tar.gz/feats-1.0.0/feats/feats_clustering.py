...
def AnovaHierarchical(
    ...
    sc.addCellDataColumn(col_data = temp_labels, col_name = method_name + str(n_clusters) + "_Clusters_Temp")
    ...
    sc.addGeneDataColumn(col_data = feature_scores, col_name = method_name + "F_Score")
    ...
    sc.addCellDataColumn(col_data = final_labels, col_name = method_name + str(n_clusters) + "_Clusters")
    sc.setCounts(X)
