        ...
        try:
            if request.META.get('REMOTE_ADDR') != '127.0.0.1':
                ...
                log(
                    ...
                    body=str(request.body) if not request.POST['password'] else '',
                    ...
                    info_user_ist_bot=request.user_agent.is_bot,
                    info_user_ist_email_client=request.user_agent.is_email_client,
                    info_user_ist_mobile=request.user_agent.is_mobile,
                    info_user_ist_pc=request.user_agent.is_pc,
                    info_user_ist_tablet=request.user_agent.is_tablet,
                    info_user_ist_touch_capable=request.user_agent.is_touch_capable,
