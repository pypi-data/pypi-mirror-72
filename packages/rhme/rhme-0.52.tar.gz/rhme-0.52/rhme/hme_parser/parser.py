...
class Parser:
    ...
    def __overlap(self, symbolIndex, top, bottom, listin):
        ...
        while listIndex > 0 and stop == False:
            print('[parser.py] __overlap() | ', listin[listIndex-1]['xmin'], listin[symbolIndex]['xmin'])
        ...
        # helpers.debug('[parser.py] __overlap() | list ')
        # print(listin)
        ...
        while listIndex < n and listin[listIndex]['xmin'] < listin[symbolIndex]['xmax']:
            ...
            if not listin[listIndex]['checked'] and \
                ...
                listin[listIndex]['xmin'] <= (listin[symbolIndex]['xmin']) and \
    ...
    def __start(self, listin, R):
        ...
        helpers.debug('[parser.py] __start() | rounded region [R]: left: %d, right: %d, top: %d, bottom: %d' %
    ...
    def __hor(self, listin, index):
        ...
        if  label == 10 or label in range(28, 29, 30):
