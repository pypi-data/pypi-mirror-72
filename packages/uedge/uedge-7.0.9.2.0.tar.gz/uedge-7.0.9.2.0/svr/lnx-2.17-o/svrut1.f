...
c...  current section of the jacobian map
    8    do 9 irow=1,n
            do 10 jcol=jl,ju
               js=jcol-jl+1
               if (abs(a(irow,jcol)).le.1.d-100*scale)symbol(js)=sym(1)
               if (abs(a(irow,jcol)).gt.1.d-100*scale)symbol(js)=sym(2)
               if (abs(a(irow,jcol)).gt.0.00010d0*scale)symbol(js)=sym(3
     &               )
               if (abs(a(irow,jcol)).gt.0.00100d0*scale)symbol(js)=sym(4
     &               )
               if (abs(a(irow,jcol)).gt.0.01000d0*scale)symbol(js)=sym(5
     &               )
               if (abs(a(irow,jcol)).gt.0.10000d0*scale)symbol(js)=sym(6
     &               )
               if (abs(a(irow,jcol)).gt.1.00000d0*scale)symbol(js)=sym(7
     &               )
               if (abs(a(irow,jcol)).gt.10.0000d0*scale)symbol(js)=sym(8
     &               )
               if (abs(a(irow,jcol)).gt.100.000d0*scale)symbol(js)=sym(9
     &               )
               if (abs(a(irow,jcol)).gt.1000.00d0*scale)symbol(js)=sym(
     &               10)
               if (abs(a(irow,jcol)).gt.10000.0d0*scale)symbol(js)=sym(
     &               11)
   10          continue
c...
