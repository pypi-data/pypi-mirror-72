...
c ... In-out variables:
      doubleprecision AX, BX

c ... Output variables:
      doubleprecision CX, FA, FB, FC
...
c ... Local variables:
      doubleprecision ULIM, U, R, Q, FU, DUM
...
c     parabolic-fit step.
      doubleprecision GOLD, GLIMIT, TINY
      PARAMETER (GOLD=1.618034d0, TINY=1.d-20)
      GLIMIT = maxmag
