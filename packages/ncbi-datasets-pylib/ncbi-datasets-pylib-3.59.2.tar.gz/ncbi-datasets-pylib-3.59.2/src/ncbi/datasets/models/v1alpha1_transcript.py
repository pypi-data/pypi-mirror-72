...
class V1alpha1Transcript(object):
    ...
    def __init__(self, accession_version=None, cds=None, exons=None, genomic_range=None, length=None, name=None, protein=None, local_vars_configuration=None):  # noqa: E501
