...
class RobotApi(object):
    ...
    def run_poses(self, body, **kwargs):  # noqa: E501
        ...
        :param int acceleration: Acceleration of Robot. MUST be used together with velocity.
    ...
    def run_poses_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if 'acceleration' in params and params['acceleration'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `acceleration` when calling `run_poses`, must be a value less than or equal to `100`")  # noqa: E501
    ...
    def run_positions_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if 'acceleration' in params and params['acceleration'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `acceleration` when calling `run_positions`, must be a value less than or equal to `100`")  # noqa: E501
        if 'acceleration' in params and params['acceleration'] <= 0:  # noqa: E501
    ...
    def set_pose_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if 'acceleration' in params and params['acceleration'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `acceleration` when calling `set_pose`, must be a value less than or equal to `100`")  # noqa: E501
        if 'acceleration' in params and params['acceleration'] <= 0:  # noqa: E501
    ...
    def set_position_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if 'acceleration' in params and params['acceleration'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `acceleration` when calling `set_position`, must be a value less than or equal to `100`")  # noqa: E501
        if 'acceleration' in params and params['acceleration'] <= 0:  # noqa: E501
