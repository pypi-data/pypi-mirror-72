...
*OthersApi* | [**freeze**](docs/OthersApi.md#freeze) | **PUT** /freeze | Asking the arm to go to the freeze state
*OthersApi* | [**identifier**](docs/OthersApi.md#identifier) | **GET** /robot/id | Getting the arm ID
*OthersApi* | [**recover**](docs/OthersApi.md#recover) | **PUT** /recover | Recover robot after emergency if it is possible.
*OthersApi* | [**relax**](docs/OthersApi.md#relax) | **PUT** /relax | Asking the arm to relax
