...
class KvaMemoLibXmlDll(dllLoader.MyDll):
    function_prototypes = {
        ...
        'kvaBufferToXml': [[ct.c_char_p, ct.c_uint, ct.c_char_p, ct.POINTER(ct.c_uint), ct.POINTER(ct.c_long), ct.c_char_p]],
        'kvaXmlToBuffer': [[ct.c_char_p, ct.c_uint, ct.c_char_p, ct.POINTER(ct.c_uint), ct.POINTER(ct.c_long)]],
