...
class Converter(object):
    ...
    def __init__(self, filename, file_format):
        ...
        dll.kvlcCreateConverter(
            ct.byref(self.handle), self.filename.encode(), file_format.id_)
    ...
    def getDlcMismatch(self):
        ...
        dll.kvlcGetDlcMismatchList(self.handle, msg_id, msg_dlc, msg_occurance, ct.byref(max_length))
        mismatch_counter = {}
    ...
    def setInputFile(self, filename, file_format):
        ...
        Args:
            ...
            file_format (`canlib.kvlclib.FileFormat`): A supported input format
        """
        filename = os.path.realpath(filename)
        ct_filename = ct.c_char_p(filename.encode('utf-8'))
