...
from .enums import ProtocolType, ProtocolProperties, SignalByteOrder, SignalType
...
class KvaDbDll(dllLoader.MyDll):
    function_prototypes = {
        ...
        'kvaDbGetAttributeDefinitionEnumFirst': [[ct.c_void_p, ct.POINTER(ct.c_int), ct.c_char_p, ct.POINTER(ct.c_size_t)]],
        'kvaDbGetAttributeDefinitionEnumNext': [[ct.c_void_p, ct.POINTER(ct.c_int), ct.c_char_p, ct.POINTER(ct.c_size_t)]],
        'kvaDbGetAttributeDefinitionFloat': [[ct.c_void_p, ct.POINTER(ct.c_float), ct.POINTER(ct.c_float), ct.POINTER(ct.c_float)]],
        'kvaDbGetAttributeDefinitionInt': [[ct.c_void_p, ct.POINTER(ct.c_int), ct.POINTER(ct.c_int), ct.POINTER(ct.c_int)]],
        ...
        'kvaDbGetSignalValueLimits': [[ct.c_void_p, ct.POINTER(ct.c_double), ct.POINTER(ct.c_double)]],
        'kvaDbGetSignalValueScaling': [[ct.c_void_p, ct.POINTER(ct.c_double), ct.POINTER(ct.c_double)]],
        ...
        'kvaDbRetrieveSignalValuePhys': [[ct.c_void_p, ct.POINTER(ct.c_double), ct.c_void_p, ct.c_size_t]],
        'kvaDbRetrieveSignalValueRaw64': [[ct.c_void_p, ct.POINTER(ct.c_uint64), ct.c_void_p, ct.c_size_t]],
    ...
    def __init__(self, ct_dll):
        ...
        super(KvaDbDll, self).__init__(ct_dll, **self.function_prototypes)
