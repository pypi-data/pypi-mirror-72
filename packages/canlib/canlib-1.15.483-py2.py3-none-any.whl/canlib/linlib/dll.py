...
class LINLibDll(dllLoader.MyDll):
    ...
    function_prototypes = {
        ...
        'linGetTransceiverData': [[ct.c_int, ct.POINTER(ct.c_char), ct.POINTER(ct.c_char), ct.POINTER(ct.c_int)]],
        ...
        'linGetFirmwareVersion': [[c_LinHandle, ct.POINTER(ct.c_ubyte), ct.POINTER(ct.c_ubyte), ct.POINTER(ct.c_ubyte), ct.POINTER(ct.c_ubyte), ct.POINTER(ct.c_ubyte), ct.POINTER(ct.c_ubyte)]],
        ...
        'linReadMessage': [[c_LinHandle, ct.POINTER(ct.c_uint), ct.c_void_p, ct.POINTER(ct.c_uint), ct.POINTER(ct.c_uint), MessageInfo]],
        'linReadMessageWait': [[c_LinHandle, ct.POINTER(ct.c_uint), ct.c_void_p, ct.POINTER(ct.c_uint), ct.POINTER(ct.c_uint), ct.POINTER(MessageInfo), ct.c_ulong]],
