...
from .enums import ConfigMode, NetworkState, BasicServiceSet, RegulatoryDomain
...
from .wrapper import dll, HOST_NAME_MIN_SIZE


AddressInfo = namedtuple('AddressInfo', "adress1 address2 netmask gateway is_dhcp")
ConnectionStatus = namedtuple('ConnectionStatus', "state tx_rate rx_rate channel_number rssi tx_power")
ConnectionTestResult = namedtuple('ConnectionTestResult', "rssi rtt")
WlanScanResult = namedtuple('WlanScanResult', "rssi channel_number mac bss_type ssid security_text")
