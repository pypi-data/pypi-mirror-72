...
if __name__ == '__main__':
	app.run(host='0.0.0.0', debug=True, threaded=True, port=3456, ssl_context=("/usr/local/lib/python3.5/dist-packages/zumidashboard/crt/zumidashboard_ai.crt", "/usr/local/lib/python3.5/dist-packages/zumidashboard/crt/private.key"))
