...
htmlhelp_basename = 'aristopy_doc'
...
latex_documents = [
    (master_doc, 'aristopy.tex', 'aristopy documentation',
     'Stefan Bruche', 'manual'),
]
...
man_pages = [
    (master_doc, 'aristopy', 'aristopy documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aristopy', 'aristopy documentation',
     author, 'aristopy', 'One line description of project.',
     'Miscellaneous'),
]
