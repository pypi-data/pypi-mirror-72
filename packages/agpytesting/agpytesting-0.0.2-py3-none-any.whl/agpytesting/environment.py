...
from agpytesting.configuration import Configuration
...
class Environment:
    ...
    def get_transformer_params(self, args: argparse.Namespace, metadata: list) -> dict:
        ...
        check_md = {'timestamp': timestamp if timestamp else None,
                    'season': season_name if season_name else None,
                    'experiment': experiment_name if experiment_name else None,
                    'container_name': None,
