...
from viper_research.entity import Exchange, QuoteCycle, ContractType, CategoryType, IndexSource, ChangeType, \
    MeasureUnit, AdjustType
...
class ViperResearch(object):
    ...
    def get_bar_quote(start_time: str, finish_time: str, contract_code: str, exchange: Exchange,
                      quote_cycle: QuoteCycle, adjust_type: AdjustType = AdjustType.PRE):
        """
        获取K线行情
        ...
        params['adjustType'] = adjust_type.value
    ...
    def get_tick_quote(start_time: str, finish_time: str, contract_code: str, exchange: Exchange,
                       adjust_type: AdjustType = AdjustType.PRE):
        """
        获取tick行情
        :param start_time:开始时间
        :param finish_time:结束时间
