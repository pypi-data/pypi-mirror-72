...
def main():
    ...
    if typ == "L":
        ...
        if not program:
            print('\033[91m' + "Please pass program (API endpoint) name with param -p or --program CRS610MI" + '\033[0m')
        if not outputfile:
            print('\033[91m' + "Please pass output file name with param -o or --outputfile CRS610MI" + '\033[0m')
