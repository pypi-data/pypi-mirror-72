...
setup(
  ...
  version = '0.17.02',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/sizhky/torch_snippets/archive/0.17.02.tar.gz',    # I explain this later on
