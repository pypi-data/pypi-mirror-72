...
from synapse.rest.client.v1.jitsi import JitsiRestServlet
from synapse.rest.client.v1.notice import NoticeRestServlet
from synapse.rest.client.v1.notify import NotifyRestServlet
        ...
        for res in listener_config["resources"]:
            for name in res["names"]:
                if name == "metrics":
                    ...
                    JitsiRestServlet(self).register(resource)
                    NoticeRestServlet(self).register(resource)
                    NotifyRestServlet(self).register(resource)
