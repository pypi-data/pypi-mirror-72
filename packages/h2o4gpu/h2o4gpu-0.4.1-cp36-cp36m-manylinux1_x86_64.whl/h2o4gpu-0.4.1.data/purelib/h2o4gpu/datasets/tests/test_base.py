...
import numpy as np
from h2o4gpu.datasets import get_data_home
from h2o4gpu.datasets import clear_data_home
from h2o4gpu.datasets import load_files
from h2o4gpu.datasets import load_sample_images
from h2o4gpu.datasets import load_sample_image
from h2o4gpu.datasets import load_digits
from h2o4gpu.datasets import load_diabetes
from h2o4gpu.datasets import load_linnerud
...
from h2o4gpu.datasets import load_wine
from h2o4gpu.datasets.base import Bunch
from h2o4gpu.datasets.tests.test_common import check_return_X_y

from h2o4gpu.externals._pilutil import pillow_installed
...
def test_bunch_pickle_generated_with_0_16_and_read_with_0_17():
    ...
    # with h2o4gpu 0.16 and are read with 0.17. Basically there
    # is a surprising behaviour because reading bunch.key uses
    # bunch.__dict__ (which is non empty for 0.16 Bunch objects)
    # whereas assigning into bunch.key uses bunch.__setattr__. See
    # https://github.com/h2o4gpu/h2o4gpu/issues/6196 for
    # more details
