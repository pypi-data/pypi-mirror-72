...
(classification).
    ...
    data_home : optional, default: None
        ...
        all h2o4gpu data is stored in '~/scikit_learn_data' subfolders.
...
(classification).
    ...
    :class:`h2o4gpu.feature_extraction.text.CountVectorizer`. For more
    advanced usage (stopword filtering, n-gram extraction, etc.), combine
    fetch_20newsgroups with a custom
    :class:`h2o4gpu.feature_extraction.text.CountVectorizer`,
    :class:`h2o4gpu.feature_extraction.text.HashingVectorizer`,
    :class:`h2o4gpu.feature_extraction.text.TfidfTransformer` or
    :class:`h2o4gpu.feature_extraction.text.TfidfVectorizer`.
