...
from h2o4gpu.decomposition import FastICA, fastica, PCASklearn
from h2o4gpu.decomposition.fastica_ import _gs_decorrelation
...
def test_fastica_simple(add_noise, seed):
    ...
    for algo, nl, whiten in itertools.product(algos, nls, whitening):
        if whiten:
            ...
            pca = PCASklearn(n_components=2, whiten=True, random_state=rng)
