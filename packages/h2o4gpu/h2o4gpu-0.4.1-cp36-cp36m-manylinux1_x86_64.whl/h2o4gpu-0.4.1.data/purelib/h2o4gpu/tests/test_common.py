"""
General tests for all estimators in h2o4gpu.
"""
...
from h2o4gpu.utils.testing import all_estimators
...
from h2o4gpu.exceptions import ConvergenceWarning, SkipTestWarning

import h2o4gpu
from h2o4gpu.base import RegressorMixin
from h2o4gpu.cluster.bicluster import BiclusterMixin

from h2o4gpu.linear_model.base import LinearClassifierMixin
from h2o4gpu.linear_model import RidgeSklearn
from h2o4gpu.discriminant_analysis import LinearDiscriminantAnalysis
from h2o4gpu.utils import IS_PYPY
from h2o4gpu.utils.estimator_checks import (
    _yield_all_checks,
    _safe_tags,
        ...
        if len(required_parameters):
            if required_parameters in (["estimator"], ["base_estimator"]):
                if issubclass(Estimator, RegressorMixin):
                    estimator = Estimator(RidgeSklearn())
                else:
...
def test_configure():
    ...
    # 'configure' functions in the setup.pys in h2o4gpu
    cwd = os.getcwd()
    setup_path = os.path.abspath(os.path.join(h2o4gpu.__path__[0], '..'))
...
def test_import_all_consistency():
    ...
    pkgs = pkgutil.walk_packages(path=h2o4gpu.__path__, prefix='h2o4gpu.',
                                 onerror=lambda _: None)
    submods = [modname for _, modname, _ in pkgs]
    for modname in submods + ['h2o4gpu']:
        if ".tests." in modname:
            continue
...
def test_root_import_all_completeness():
    ...
    for _, modname, _ in pkgutil.walk_packages(path=h2o4gpu.__path__,
                                               onerror=lambda _: None):
        if '.' in modname or modname.startswith('_') or modname in EXCEPTIONS:
            continue
        assert_in(modname, h2o4gpu.__all__)
...
def test_all_tests_are_importable():
    ...
    lookup = {name: ispkg
              for _, name, ispkg
              in pkgutil.walk_packages(h2o4gpu.__path__, prefix='h2o4gpu.')}
