...
from h2o4gpu.isotonic import (check_increasing, isotonic_regression,
                              IsotonicRegression, _make_unique)

from h2o4gpu.utils.validation import check_array
from h2o4gpu.utils.testing import (assert_raises, assert_array_equal,
                                   assert_equal,
...
def test_isotonic_regression_with_ties_in_differently_sized_groups():
    ...
    https://github.com/h2o4gpu/h2o4gpu/issues/9432
...
def test_isotonic_ymin_ymax():
    ...
    # https://github.com/h2o4gpu/h2o4gpu/issues/6921
...
def test_isotonic_zero_weight_loop():
    ...
    # https://github.com/h2o4gpu/h2o4gpu/issues/4297
...
def test_fast_predict():
    ...
    # https://github.com/h2o4gpu/h2o4gpu/pull/6206
...
def test_isotonic_copy_before_fit():
    # https://github.com/h2o4gpu/h2o4gpu/issues/6628
    ir = IsotonicRegression()
    copy.copy(ir)
