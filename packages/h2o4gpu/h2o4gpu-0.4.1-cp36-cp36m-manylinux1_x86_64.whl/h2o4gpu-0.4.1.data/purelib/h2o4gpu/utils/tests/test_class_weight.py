...
from h2o4gpu.utils.class_weight import compute_class_weight
from h2o4gpu.utils.class_weight import compute_sample_weight
...
def test_compute_class_weight_not_present():
    ...
    # https://github.com/h2o4gpu/h2o4gpu/issues/8312
...
def test_compute_class_weight_invariance():
    ...
    logreg1 = LogisticRegressionSklearn(class_weight="balanced").fit(X_1, y_1)
    logreg0 = LogisticRegressionSklearn(class_weight="balanced").fit(X_0, y_0)
    logreg = LogisticRegressionSklearn(class_weight="balanced").fit(X_, y_)
