...
from h2o4gpu.utils.testing import SkipTest
from h2o4gpu.utils.testing import assert_array_equal
from h2o4gpu.utils.testing import assert_allclose_dense_sparse
from h2o4gpu.utils import as_float_array, check_array, check_symmetric
from h2o4gpu.utils import check_X_y
from h2o4gpu.utils import deprecated
from h2o4gpu.utils.mocking import MockDataFrame
from h2o4gpu.utils.estimator_checks import NotAnArray
from h2o4gpu.random_projection import sparse_random_matrix
from h2o4gpu.linear_model import ARDRegression
...
from h2o4gpu.utils.validation import (
    has_fit_parameter,
    check_is_fitted,
...
def test_memmap():
    ...
    with NamedTemporaryFile(prefix='h2o4gpu-test') as tmp:
...
def test_has_fit_parameter():
    ...
    assert has_fit_parameter(RandomForestRegressorSklearn, "sample_weight")
...
def test_check_consistent_length():
    ...
    assert_raises_regex(TypeError, 'estimator', check_consistent_length,
                        [1, 2], RandomForestRegressorSklearn())
    # XXX: We should have a test with a string, but what is correct behaviour?


def test_check_dataframe_fit_attribute():
    # check pandas dataframe with 'fit' column does not raise error
    # https://github.com/h2o4gpu/h2o4gpu/issues/8415
    try:
        import pandas as pd
...
def test_suppress_validation():
    ...
    h2o4gpu.set_config(assume_finite=True)
    assert_all_finite(X)
    h2o4gpu.set_config(assume_finite=False)
    assert_raises(ValueError, assert_all_finite, X)
...
def test_check_dataframe_warns_on_dtype():
    ...
    # https://github.com/h2o4gpu/h2o4gpu/issues/10948
    pd = importorskip("pandas")
