...
from h2o4gpu.utils import deprecated
from h2o4gpu.utils import _joblib
from h2o4gpu.utils.testing import (assert_raises_regex,
                                   assert_equal, ignore_warnings,
                                   assert_warns, assert_raises)
from h2o4gpu.utils.estimator_checks import check_estimator
from h2o4gpu.utils.estimator_checks \
    import check_class_weight_balanced_linear_classifier
from h2o4gpu.utils.estimator_checks import set_random_state
from h2o4gpu.utils.estimator_checks import set_checking_parameters
from h2o4gpu.utils.estimator_checks import check_estimators_unfitted
from h2o4gpu.utils.estimator_checks import check_fit_score_takes_y
from h2o4gpu.utils.estimator_checks import check_no_attributes_set_in_init
from h2o4gpu.utils.estimator_checks import check_outlier_corruption
from h2o4gpu.ensemble import AdaBoostClassifier, RandomForestClassifierSklearn
from h2o4gpu.linear_model import LinearRegressionSklearn, SGDClassifier
from h2o4gpu.mixture import GaussianMixture
from h2o4gpu.cluster import MiniBatchKMeansSklearn
from h2o4gpu.decomposition import NMF
from h2o4gpu.linear_model import MultiTaskElasticNetSklearn
from h2o4gpu.svm import SVC
from h2o4gpu.neighbors import KNeighborsRegressor
from h2o4gpu.utils.validation import check_X_y, check_array
...
def test_check_estimator():
    ...
    check_estimator(AdaBoostClassifier())
    check_estimator(MultiTaskElasticNetSklearn)
    check_estimator(MultiTaskElasticNetSklearn())
...
def test_check_estimator_clones():
    ...
    for Estimator in [GaussianMixture, LinearRegressionSklearn,
                      RandomForestClassifierSklearn, NMF, SGDClassifier,
