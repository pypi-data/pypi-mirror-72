...
class IterativeImputer(BaseEstimator, TransformerMixin):
    ...
    .. note::
      ...
      you need to explicitly import ``enable_iterative_imputer``::
        ...
        >>> # now you can import normally from h2o4gpu.impute
        >>> from h2o4gpu.impute import IterativeImputer

    Parameters
    ----------
    estimator : estimator object, default=BayesianRidgeSklearn()
    ...
    initial_strategy : str, optional (default="mean")
        ...
        ``strategy`` parameter in :class:`h2o4gpu.impute.SimpleImputer`
    ...
    Attributes
    ----------
    initial_imputer_ : object of type :class:`h2o4gpu.impute.SimpleImputer`
    ...
    indicator_ : :class:`h2o4gpu.impute.MissingIndicator`
    ...
    def _impute_one_feature(self,
        ...
        estimator : estimator with h2o4gpu API
    ...
    def fit_transform(self, X, y=None):
        ...
        if self.estimator is None:
            from ..linear_model import BayesianRidgeSklearn
            self._estimator = BayesianRidgeSklearn()
        else:
