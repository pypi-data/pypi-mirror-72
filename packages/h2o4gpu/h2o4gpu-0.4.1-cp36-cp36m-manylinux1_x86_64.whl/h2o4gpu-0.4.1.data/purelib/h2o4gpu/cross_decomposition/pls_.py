"""
The :mod:`h2o4gpu.pls` module implements Partial Least Squares (PLS).
"""
...
class PLSRegression(_PLS):
    ...
    Examples
    --------
    >>> from h2o4gpu.cross_decomposition import PLSRegression
...
class PLSCanonical(_PLS):
    ...
    Examples
    --------
    >>> from h2o4gpu.cross_decomposition import PLSCanonical
    >>> X = [[0., 0., 1.], [1.,0.,0.], [2.,2.,2.], [2.,5.,4.]]
    >>> Y = [[0.1, -0.2], [0.9, 1.1], [6.2, 5.9], [11.9, 12.3]]
...
class PLSSVD(BaseEstimator, TransformerMixin):
    ...
    --------
    >>> import numpy as np
    >>> from h2o4gpu.cross_decomposition import PLSSVD
    >>> X = np.array([[0., 0., 1.],
    ...     [1.,0.,0.],
    ...     [2.,2.,2.],
    ...     [2.,5.,4.]])
