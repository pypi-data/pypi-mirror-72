...
from . import KMeansSklearn, MiniBatchKMeansSklearn
...
class BaseSpectral(BaseEstimator, BiclusterMixin, metaclass=ABCMeta):
    ...
    def _k_means(self, data, n_clusters):
        if self.mini_batch:
            model = MiniBatchKMeansSklearn(n_clusters,
                                    init=self.init,
                                    n_init=self.n_init,
                                    random_state=self.random_state)
        else:
            model = KMeansSklearn(n_clusters, init=self.init,
...
class SpectralCoclustering(BaseSpectral):
    ...
    svd_method : string, optional, default: 'randomized'
        ...
        :func:`h2o4gpu.utils.extmath.randomized_svd`, which may be faster
    ...
    Examples
    --------
    >>> from h2o4gpu.cluster import SpectralCoclustering
    >>> import numpy as np
...
class SpectralBiclustering(BaseSpectral):
    ...
    svd_method : string, optional, default: 'randomized'
        ...
        `h2o4gpu.utils.extmath.randomized_svd`, which may be faster
    ...
    Examples
    --------
    >>> from h2o4gpu.cluster import SpectralBiclustering
    >>> import numpy as np
    >>> X = np.array([[1, 1], [2, 1], [1, 0],
    ...               [4, 7], [3, 5], [3, 6]])
