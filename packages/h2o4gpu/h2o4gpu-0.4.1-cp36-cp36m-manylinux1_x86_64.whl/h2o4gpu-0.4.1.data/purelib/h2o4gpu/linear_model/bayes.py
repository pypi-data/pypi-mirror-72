...
###############################################################################
# BayesianRidgeSklearn regression

class BayesianRidgeSklearn(LinearModel, RegressorMixin):
    ...
    >>> clf = linear_model.BayesianRidgeSklearn()
    >>> clf.fit([[0,0], [1, 1], [2, 2]], [0, 1, 2])
    ... # doctest: +NORMALIZE_WHITESPACE
    BayesianRidgeSklearn(alpha_1=1e-06, alpha_2=1e-06, compute_score=False,
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        sample_weight : numpy array of shape [n_samples]
            ...
            .. versionadded:: 0.20
               parameter *sample_weight* support to BayesianRidgeSklearn.
