...
def lars_path(X, y, Xy=None, Gram=None, max_iter=500, alpha_min=0,
    ...
    """Compute Least Angle Regression or LassoSklearn path using LARS algorithm [1]
    ...
    alpha_min : float, optional (default=0)
        ...
        regularization parameter alpha parameter in the LassoSklearn.

    method : {'lar', 'lasso'}, optional (default='lar')
        Specifies the returned model. Select ``'lar'`` for Least Angle
        Regression, ``'lasso'`` for the LassoSklearn.
    ...
    positive : boolean (default=False)
        ...
        the stepwise Lars-LassoSklearn algorithm are typically in congruence with the
    ...
    .. [3] `Wikipedia entry on the LassoSklearn
           <https://en.wikipedia.org/wiki/LassoSklearn_(statistics)>`_
...
class LassoSklearnLars(Lars):
    """LassoSklearn model fit with Least Angle Regression a.k.a. Lars
    ...
    alpha : float
        ...
        by :class:`LinearRegressionSklearn`. For numerical reasons, using
        ``alpha = 0`` with the LassoSklearnLars object is not advised and you
        should prefer the LinearRegressionSklearn object.
    ...
    positive : boolean (default=False)
        ...
        0.].min()`` when fit_path=True) reached by the stepwise Lars-LassoSklearn
        algorithm are typically in congruence with the solution of the
        coordinate descent LassoSklearn estimator.
    ...
    --------
    >>> from h2o4gpu import linear_model
    >>> reg = linear_model.LassoSklearnLars(alpha=0.01)
    >>> reg.fit([[-1, 1], [0, 0], [1, 1]], [-1, 0, -1])
    ... # doctest: +ELLIPSIS, +NORMALIZE_WHITESPACE
    LassoSklearnLars(alpha=0.01, copy_X=True, eps=..., fit_intercept=True,
...
def _lars_path_residues(X_train, y_train, X_test, y_test, Gram=None,
    ...
    positive : boolean (default=False)
        ...
        'lasso' for expected small values of alpha in the doc of LassoSklearnLarsCV
        and LassoSklearnLarsIC.
...
class LarsCV(Lars):
    ...
    Examples
    --------
    >>> from h2o4gpu.linear_model import LarsCV
    ...
    See also
    --------
    lars_path, LassoSklearnLars, LassoSklearnLarsCV
    """
    ...
    def fit(self, X, y):
        ...
        # it will call a lasso internally when self if LassoSklearnLarsCV
...
class LassoSklearnLarsCV(LarsCV):
    """Cross-validated LassoSklearn, using the LARS algorithm.
    ...
    positive : boolean (default=False)
        ...
        algorithm are typically in congruence with the solution of the
        coordinate descent LassoSklearn estimator.
        As a consequence using LassoSklearnLarsCV only makes sense for problems where
    ...
    Examples
    --------
    >>> from h2o4gpu.linear_model import LassoSklearnLarsCV
    >>> from h2o4gpu.datasets import make_regression
    >>> X, y = make_regression(noise=4.0, random_state=0)
    >>> reg = LassoSklearnLarsCV(cv=5).fit(X, y)
    >>> reg.score(X, y) # doctest: +ELLIPSIS
    0.9992...
    >>> reg.alpha_
    0.0484...
    ...
    The object solves the same problem as the LassoSklearnCV object. However,
    unlike the LassoSklearnCV, it find the relevant alphas values by itself.
    In general, because of this property, it will be more stable.
    However, it is more fragile to heavily multicollinear datasets.

    It is more efficient than the LassoSklearnCV if only a small number of
    features are selected compared to the total number, for instance if
    there are very few samples compared to the number of features.

    See also
    --------
    lars_path, LassoSklearnLars, LarsCV, LassoSklearnCV
    """
...
class LassoSklearnLarsIC(LassoSklearnLars):
    """LassoSklearn model fit with Lars using BIC or AIC for model selection
    ...
    positive : boolean (default=False)
        ...
        algorithm are typically in congruence with the solution of the
        coordinate descent LassoSklearn estimator.
        As a consequence using LassoSklearnLarsIC only makes sense for problems where
        a sparse solution is expected and/or reached.
    ...
    --------
    >>> from h2o4gpu import linear_model
    >>> reg = linear_model.LassoSklearnLarsIC(criterion='bic')
    >>> reg.fit([[-1, 1], [0, 0], [1, 1]], [-1.1111, 0, -1.1111])
    ... # doctest: +ELLIPSIS, +NORMALIZE_WHITESPACE
    LassoSklearnLarsIC(copy_X=True, criterion='bic', eps=..., fit_intercept=True,
