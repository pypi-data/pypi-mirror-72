...
from h2o4gpu.feature_selection.rfe import RFE, RFECV
from h2o4gpu.datasets import load_iris, make_friedman1
...
from h2o4gpu.utils.testing import assert_greater, assert_equal
...
def test_rfe_features_importance():
    ...
    clf = RandomForestClassifierSklearn(n_estimators=20,
...
def test_rfe_cv_groups():
    ...
    est_groups = RFECV(
        estimator=RandomForestClassifierSklearn(random_state=generator),
        step=1,
        scoring='accuracy',
