...
from ..decomposition import PCASklearn
...
def trustworthiness(X, X_embedded, n_neighbors=5,
    ...
    * "Learning a Parametric Embedding by Preserving Local Structure"
    ...
    metric : string, or callable, optional, default 'euclidean'
        ...
        documentation of argument metric in h2o4gpu.pairwise.pairwise_distances
...
class TSNE(BaseEstimator):
    ...
    method (e.g. PCASklearn for dense data or TruncatedSVDSklearn for sparse data)
    ...
    init : string or numpy array, optional (default: "random")
        ...
        PCASklearn initialization cannot be used with precomputed distances and is
    ...
    def _fit(self, X, skip_num_points=0):
        ...
        dimensionality reduction technique (e.g. TruncatedSVDSklearn).
        ...
        if self.method == 'barnes_hut' and sp.issparse(X):
            raise TypeError('A sparse matrix was passed, but dense '
                            ...
                            'reduction techniques (e.g. TruncatedSVDSklearn)')
        ...
        if isinstance(self.init, np.ndarray):
            ...
            pca = PCASklearn(n_components=self.n_components, svd_solver='randomized',
