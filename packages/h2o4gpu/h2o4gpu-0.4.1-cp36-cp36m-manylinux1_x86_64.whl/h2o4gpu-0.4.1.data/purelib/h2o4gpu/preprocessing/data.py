...
def scale(X, axis=0, with_mean=True, with_std=True, copy=True):
    ...
    StandardScaler: Performs scaling to unit variance using the``Transformer`` API
        (e.g. as part of a preprocessing :class:`h2o4gpu.pipeline.Pipeline`).
...
def minmax_scale(X, feature_range=(0, 1), axis=0, copy=True):
    ...
    .. versionadded:: 0.17
       *minmax_scale* function interface
       to :class:`h2o4gpu.preprocessing.MinMaxScaler`.
...
class StandardScaler(BaseEstimator, TransformerMixin):
    ...
    :class:`h2o4gpu.decomposition.PCASklearn`
...
class MaxAbsScaler(BaseEstimator, TransformerMixin):
    ...
    Examples
    --------
    >>> from h2o4gpu.preprocessing import MaxAbsScaler
    >>> X = [[ 1., -1.,  2.],
    ...      [ 2.,  0.,  0.],
    ...      [ 0.,  1., -1.]]
...
class RobustScaler(BaseEstimator, TransformerMixin):
    ...
    Examples
    --------
    >>> from h2o4gpu.preprocessing import RobustScaler
    >>> X = [[ 1., -2.,  2.],
    ...      [ -2.,  1.,  3.],
    ...      [ 4.,  1., -2.]]
...
class Normalizer(BaseEstimator, TransformerMixin):
    ...
    Examples
    --------
    >>> from h2o4gpu.preprocessing import Normalizer
    >>> X = [[4, 1, 2, 2],
    ...      [1, 3, 9, 3],
    ...      [5, 7, 5, 1]]
...
class Binarizer(BaseEstimator, TransformerMixin):
    ...
    Examples
    --------
    >>> from h2o4gpu.preprocessing import Binarizer
    >>> X = [[ 1., -1.,  2.],
    ...      [ 2.,  0.,  0.],
    ...      [ 0.,  1., -1.]]
...
class KernelCenterer(BaseEstimator, TransformerMixin):
    ...
    h2o4gpu.preprocessing.StandardScaler(with_std=False).

    Read more in the :ref:`User Guide <kernel_centering>`.

    Examples
    --------
    >>> from h2o4gpu.preprocessing import KernelCenterer
...
def add_dummy_feature(X, value=1.0):
    ...
    >>> from h2o4gpu.preprocessing import add_dummy_feature
...
class QuantileTransformer(BaseEstimator, TransformerMixin):
    ...
    --------
    >>> import numpy as np
    >>> from h2o4gpu.preprocessing import QuantileTransformer
...
def quantile_transform(X, axis=0, n_quantiles=1000,
    ...
    copy : boolean, optional, (default="warn")
        ...
        .. deprecated:: 0.21
            ...
            functions in :mod:`h2o4gpu.preprocessing.data`. Furthermore, the
    ...
    --------
    >>> import numpy as np
    >>> from h2o4gpu.preprocessing import quantile_transform
    >>> rng = np.random.RandomState(0)
    >>> X = np.sort(rng.normal(loc=0.5, scale=0.25, size=(25, 1)), axis=0)
    ...
    QuantileTransformer : Performs quantile-based scaling using the
        ...
        :class:`h2o4gpu.pipeline.Pipeline`).
...
class PowerTransformer(BaseEstimator, TransformerMixin):
    ...
    --------
    >>> import numpy as np
    >>> from h2o4gpu.preprocessing import PowerTransformer
    >>> pt = PowerTransformer()
    >>> data = [[1, 2], [3, 2], [4, 5]]
    >>> print(pt.fit(data))
...
def power_transform(X, method='warn', standardize=True, copy=True):
    ...
    --------
    >>> import numpy as np
    >>> from h2o4gpu.preprocessing import power_transform
    >>> data = [[1, 2], [3, 2], [4, 5]]
