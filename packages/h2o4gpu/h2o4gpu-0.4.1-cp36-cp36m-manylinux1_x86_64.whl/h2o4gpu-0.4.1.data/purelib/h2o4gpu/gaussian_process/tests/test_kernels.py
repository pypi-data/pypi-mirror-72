...
from h2o4gpu.gaussian_process.kernels import _approx_fprime

from h2o4gpu.metrics.pairwise \
    import PAIRWISE_KERNEL_FUNCTIONS, euclidean_distances, pairwise_kernels
from h2o4gpu.gaussian_process.kernels \
    import (RBF, Matern, RationalQuadratic, ExpSineSquared, DotProduct,
            ConstantKernel, WhiteKernel, PairwiseKernel, KernelOperator,
            Exponentiation)
from h2o4gpu.base import clone

from h2o4gpu.utils.testing import (assert_equal, assert_almost_equal,
...
def test_kernel_clone(kernel):
    # Test that h2o4gpu's clone works correctly on kernels.
    kernel_cloned = clone(kernel)

    # XXX: Should this be fixed?
    # This differs from the h2o4gpu's estimators equality check.
...
def test_kernel_clone_after_set_params(kernel):
    ...
    # See https://github.com/h2o4gpu/h2o4gpu/issues/6961
    # for more details.
    bounds = (1e-5, 1e5)
    kernel_cloned = clone(kernel)
    params = kernel.get_params()
