...
from h2o4gpu.feature_extraction.text import strip_tags
from h2o4gpu.feature_extraction.text import strip_accents_unicode
from h2o4gpu.feature_extraction.text import strip_accents_ascii

from h2o4gpu.feature_extraction.text import HashingVectorizer
from h2o4gpu.feature_extraction.text import CountVectorizer
from h2o4gpu.feature_extraction.text import TfidfTransformer
from h2o4gpu.feature_extraction.text import TfidfVectorizer

from h2o4gpu.feature_extraction.text import ENGLISH_STOP_WORDS
...
from h2o4gpu.utils.testing import (assert_equal, assert_not_equal,
...
def test_tfidf_vectorizer_type(vectorizer_dtype, output_dtype,
                               warning_expected):
    X = np.array(["numpy", "scipy", "h2o4gpu"])
...
def test_countvectorizer_sort_features_64bit_sparse_indices():
    ...
    This test is skipped on 32bit platforms, see:
        https://github.com/h2o4gpu/h2o4gpu/pull/11295
    for more details.
    """
