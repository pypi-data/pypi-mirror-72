...
from h2o4gpu.metrics import (f1_score, r2_score, roc_auc_score, fbeta_score,
                             log_loss, precision_score, recall_score,
                             jaccard_score)
from h2o4gpu.metrics import cluster as cluster_module
from h2o4gpu.metrics.scorer import (check_scoring, _PredictScorer,
                                    _passthrough_scorer)
from h2o4gpu.metrics import accuracy_score
from h2o4gpu.metrics.scorer import _check_multimetric_scoring
from h2o4gpu.metrics import make_scorer, get_scorer, SCORERS
from h2o4gpu.svm import LinearSVC
from h2o4gpu.pipeline import make_pipeline
from h2o4gpu.cluster import KMeansSklearn
from h2o4gpu.linear_model import RidgeSklearn, LogisticRegressionSklearn
...
def setup_module():
    ...
    TEMP_FOLDER = tempfile.mkdtemp(prefix='h2o4gpu_test_score_objects_')
...
def test_scoring_is_not_metric():
    assert_raises_regexp(ValueError, 'make_scorer', check_scoring,
                         LogisticRegressionSklearn(), f1_score)
    assert_raises_regexp(ValueError, 'make_scorer', check_scoring,
                         LogisticRegressionSklearn(), roc_auc_score)
    assert_raises_regexp(ValueError, 'make_scorer', check_scoring,
                         RidgeSklearn(), r2_score)
    assert_raises_regexp(ValueError, 'make_scorer', check_scoring,
                         KMeansSklearn(), cluster_module.adjusted_rand_score)
