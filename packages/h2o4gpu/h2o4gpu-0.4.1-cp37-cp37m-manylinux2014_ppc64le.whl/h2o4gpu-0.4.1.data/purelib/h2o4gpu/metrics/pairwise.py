...
def pairwise_distances_argmin_min(X, Y, axis=1, metric="euclidean",
    ...
    metric : string or callable, default 'euclidean'
        metric to use for distance computation. Any metric from h2o4gpu
        ...
        - from h2o4gpu: ['cityblock', 'cosine', 'euclidean', 'l1', 'l2',
          'manhattan']
    ...
    batch_size : integer
        .. deprecated:: 0.20
            ...
            Use h2o4gpu.set_config(working_memory=...) instead.
    ...
    See also
    --------
    h2o4gpu.metrics.pairwise_distances
    h2o4gpu.metrics.pairwise_distances_argmin
    """
...
def pairwise_distances_argmin(X, Y, axis=1, metric="euclidean",
    ...
    --------
    h2o4gpu.metrics.pairwise_distances
    h2o4gpu.metrics.pairwise_distances_argmin_min
    """
    if metric_kwargs is None:
        metric_kwargs = {}
...
def haversine_distances(X, Y=None):
    ...
    array([[    0.        , 11279.45379464],
           [11279.45379464,     0.        ]])
    """
    from h2o4gpu.neighbors import DistanceMetric
...
def cosine_distances(X, Y=None):
    ...
    See also
    --------
    h2o4gpu.metrics.pairwise.cosine_similarity
...
def additive_chi2_kernel(X, Y=None):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    h2o4gpu.kernel_approximation.AdditiveChi2Sampler : A Fourier approximation
        to this kernel.
    """
    if issparse(X) or issparse(Y):
...
def pairwise_distances_chunked(X, Y=None, reduce_func=None,
    ...
    working_memory : int, optional
        ...
        ``h2o4gpu.get_config()['working_memory']`` is used.
    ...
    >>> import numpy as np
    >>> from h2o4gpu.metrics import pairwise_distances_chunked
...
def pairwise_distances(X, Y=None, metric="euclidean", n_jobs=None, **kwds):
    ...
    valid scipy.spatial.distance metrics), the h2o4gpu implementation
    will be used, which is faster and has support for sparse matrices (except
    for 'cityblock'). For a verbose description of the metrics from
    h2o4gpu, see the __doc__ of the h2o4gpu.pairwise.distance_metrics
    function.
...
def kernel_metrics():
    ...
    The valid distance metrics, and the function they map to, are:
      ...
      metric            Function
      ===============   ========================================
      'additive_chi2'   h2o4gpu.pairwise.additive_chi2_kernel
      'chi2'            h2o4gpu.pairwise.chi2_kernel
      'linear'          h2o4gpu.pairwise.linear_kernel
      'poly'            h2o4gpu.pairwise.polynomial_kernel
      'polynomial'      h2o4gpu.pairwise.polynomial_kernel
      'rbf'             h2o4gpu.pairwise.rbf_kernel
      'laplacian'       h2o4gpu.pairwise.laplacian_kernel
      'sigmoid'         h2o4gpu.pairwise.sigmoid_kernel
      'cosine'          h2o4gpu.pairwise.cosine_similarity
      ===============   ========================================
