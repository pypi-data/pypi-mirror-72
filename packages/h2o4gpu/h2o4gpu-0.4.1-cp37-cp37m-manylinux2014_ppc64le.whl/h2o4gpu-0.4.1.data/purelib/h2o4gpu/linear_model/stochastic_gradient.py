...
class SGDClassifier(BaseSGDClassifier):
    ...
    See also
    --------
    h2o4gpu.svm.LinearSVC, LogisticRegressionSklearn, Perceptron
    ...
    def predict_proba(self):
        ...
        the classifier with
        :class:`h2o4gpu.calibration.CalibratedClassifierCV` instead.
...
class SGDRegressor(BaseSGDRegressor):
    ...
    See also
    --------
    RidgeSklearn, ElasticNetSklearn, LassoSklearn, h2o4gpu.svm.SVR
