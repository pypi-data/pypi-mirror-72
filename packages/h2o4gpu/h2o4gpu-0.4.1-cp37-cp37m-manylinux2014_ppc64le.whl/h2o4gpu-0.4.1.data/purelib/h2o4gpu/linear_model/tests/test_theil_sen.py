"""
Testing for Theil-Sen module (h2o4gpu.linear_model.theil_sen)
"""
...
from h2o4gpu.linear_model import LinearRegressionSklearn, TheilSenRegressor
from h2o4gpu.linear_model.theil_sen import _spatial_median, _breakdown_point
from h2o4gpu.linear_model.theil_sen import _modified_weiszfeld_step
...
def test_theil_sen_1d():
    ...
    lstq = LinearRegressionSklearn().fit(X, y)
...
def test_theil_sen_1d_no_intercept():
    ...
    # Check that Least Squares fails
    lstq = LinearRegressionSklearn(fit_intercept=False).fit(X, y)
