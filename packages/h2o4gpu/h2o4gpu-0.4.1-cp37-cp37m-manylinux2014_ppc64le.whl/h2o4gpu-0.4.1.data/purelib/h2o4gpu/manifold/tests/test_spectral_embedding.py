...
from h2o4gpu.manifold.spectral_embedding_ import SpectralEmbedding
from h2o4gpu.manifold.spectral_embedding_ import _graph_is_connected
from h2o4gpu.manifold.spectral_embedding_ import _graph_connected_component
from h2o4gpu.manifold import spectral_embedding
from h2o4gpu.metrics.pairwise import rbf_kernel
from h2o4gpu.metrics import normalized_mutual_info_score
...
def test_pipeline_spectral_clustering(seed=36):
    ...
    for se in [se_rbf, se_knn]:
        km = KMeansSklearn(n_clusters=n_clusters, random_state=random_state)
