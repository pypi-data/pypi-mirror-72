...
def partial_dependence(estimator, X, features, response_method='auto',
    ...
    >>> gb = GradientBoostingClassifierSklearn(random_state=0).fit(X, y)
    ...
    See also
    --------
    h2o4gpu.inspection.plot_partial_dependence: Plot partial dependence
...
def plot_partial_dependence(estimator, X, features, feature_names=None,
    ...
    >>> X, y = make_friedman1()
    >>> clf = GradientBoostingRegressorSklearn(n_estimators=10).fit(X, y)
    >>> plot_partial_dependence(clf, X, [0, (0, 1)]) #doctest: +SKIP

    See also
    --------
    h2o4gpu.inspection.partial_dependence: Return raw partial
      dependence values
