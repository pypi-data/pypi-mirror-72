...
class Birch(BaseEstimator, TransformerMixin, ClusterMixin):
    ...
    alternative to :class:`MiniBatchKMeansSklearn`. It constructs a tree
    ...
    n_clusters : int, instance of h2o4gpu.cluster model, default 3
        ...
        - `h2o4gpu.cluster` Estimator : If a model is provided, the model is
