"""
Testing for export functions of decision trees (h2o4gpu.tree.export).
"""
import pytest
...
from h2o4gpu.base import is_classifier
...
from h2o4gpu.tree import export_graphviz, plot_tree, export_text
from io import StringIO
from h2o4gpu.utils.testing import (assert_in, assert_equal, assert_raises,
...
def test_friedman_mse_in_graphviz():
    ...
    clf = GradientBoostingClassifierSklearn(n_estimators=2, random_state=0)
    clf.fit(X, y)
