"""
The :mod:`h2o4gpu.compose._column_transformer` module implements utilities
...
boolean mask array or callable
    ...
    See also
    --------
    h2o4gpu.compose.make_column_transformer : convenience function for
    ...
    --------
    >>> import numpy as np
    >>> from h2o4gpu.compose import ColumnTransformer
...
def make_column_transformer(*transformers, **kwargs):
    ...
    *transformers : tuples of transformers and column selections
    ...
    See also
    --------
    h2o4gpu.compose.ColumnTransformer : Class that allows combining the
        outputs of multiple transformer objects used on column subsets
        of the data into a single feature space.

    Examples
    --------
    >>> from h2o4gpu.preprocessing import StandardScaler, OneHotEncoder
    >>> from h2o4gpu.compose import make_column_transformer
