...
from h2o4gpu.exceptions import FitFailedWarning

from h2o4gpu.model_selection.tests.test_search import FailingClassifier
...
from h2o4gpu.utils.mocking import CheckingClassifier, MockDataFrame

from h2o4gpu.model_selection import cross_val_score, ShuffleSplit
from h2o4gpu.model_selection import cross_val_predict
from h2o4gpu.model_selection import cross_validate
from h2o4gpu.model_selection import permutation_test_score
from h2o4gpu.model_selection import KFold
from h2o4gpu.model_selection import StratifiedKFold
from h2o4gpu.model_selection import LeaveOneOut
from h2o4gpu.model_selection import LeaveOneGroupOut
from h2o4gpu.model_selection import LeavePGroupsOut
from h2o4gpu.model_selection import GroupKFold
from h2o4gpu.model_selection import GroupShuffleSplit
from h2o4gpu.model_selection import learning_curve
from h2o4gpu.model_selection import validation_curve
from h2o4gpu.model_selection._validation import _check_is_permutation
from h2o4gpu.model_selection._validation import _fit_and_score
from h2o4gpu.model_selection._validation import _score
...
from h2o4gpu.datasets import load_digits
from h2o4gpu.metrics import explained_variance_score
from h2o4gpu.metrics import make_scorer
from h2o4gpu.metrics import accuracy_score
from h2o4gpu.metrics import confusion_matrix
from h2o4gpu.metrics import precision_recall_fscore_support
from h2o4gpu.metrics import precision_score
from h2o4gpu.metrics import r2_score
from h2o4gpu.metrics.scorer import check_scoring

from h2o4gpu.linear_model import RidgeSklearn, LogisticRegressionSklearn, SGDClassifier
from h2o4gpu.linear_model import PassiveAggressiveClassifier, RidgeSklearnClassifier
...
from h2o4gpu.cluster import KMeansSklearn

from h2o4gpu.impute import SimpleImputer

from h2o4gpu.preprocessing import LabelEncoder
from h2o4gpu.pipeline import Pipeline

from io import StringIO
from h2o4gpu.base import BaseEstimator
from h2o4gpu.base import clone
from h2o4gpu.multiclass import OneVsRestClassifier
from h2o4gpu.utils import shuffle
from h2o4gpu.datasets import make_classification
from h2o4gpu.datasets import make_multilabel_classification

from h2o4gpu.model_selection.tests.common import OneTimeSplitter
...
def test_cross_val_score():
    ...
    assert_raises(ValueError, cross_val_score, clf, X, y2, scoring="h2o4gpu")
...
def test_cross_validate():
    ...
    reg = RidgeSklearn(random_state=0)
...
def test_cross_val_score_with_score_func_regression():
    ...
    # Default score of the RidgeSklearn regression estimator
...
def test_cross_val_predict():
    ...
    preds = cross_val_predict(KMeansSklearn(), X)
    assert_equal(len(preds), len(y))
    ...
    assert_warns_message(RuntimeWarning, warning_message,
                         cross_val_predict, LogisticRegressionSklearn(),
...
def test_cross_val_predict_decision_function_shape():
    ...
    preds = cross_val_predict(LogisticRegressionSklearn(), X, y,
    ...
    assert_raise_message(ValueError,
                         ...
                         cross_val_predict, RidgeSklearnClassifier(), X, y,
...
def test_cross_val_predict_input_types():
    ...
    clf = RidgeSklearn(fit_intercept=False, random_state=0)
    ...
    predictions = cross_val_predict(LogisticRegressionSklearn(), X.tolist(),
                                    y.tolist(), method='decision_function')
    predictions = cross_val_predict(LogisticRegressionSklearn(), X,
                                    y.tolist(), method='decision_function')
...
def test_cross_val_predict_unbalanced():
    ...
    y[0] = 2
    clf = LogisticRegressionSklearn(random_state=1)
...
def test_cross_val_predict_with_method():
    check_cross_val_predict_with_method_binary(LogisticRegressionSklearn())
    check_cross_val_predict_with_method_multiclass(LogisticRegressionSklearn())
...
def test_gridsearchcv_cross_val_predict_with_method():
    ...
    X, y = iris.data, iris.target
    X, y = shuffle(X, y, random_state=0)
    est = GridSearchCV(LogisticRegressionSklearn(random_state=42),
                       {'C': [0.1, 1]},
                       cv=2)
    for method in ['decision_function', 'predict_proba', 'predict_log_proba']:
        check_cross_val_predict_multiclass(est, X, y, method)
...
def test_cross_val_predict_with_method_multilabel_ovr():
    ...
    X, y = make_multilabel_classification(n_samples=n_samp, n_labels=3,
                                          ...
                                          random_state=42)
    est = OneVsRestClassifier(LogisticRegressionSklearn(random_state=0,
                                                 solver='lbfgs'))
    for method in ['predict_proba', 'decision_function']:
        check_cross_val_predict_binary(est, X, y, method=method)


class RFWithDecisionFunction(RandomForestClassifierSklearn):
