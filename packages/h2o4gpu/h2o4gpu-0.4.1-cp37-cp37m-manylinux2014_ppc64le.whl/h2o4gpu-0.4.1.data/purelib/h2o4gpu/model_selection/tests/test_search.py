...
from h2o4gpu.utils.fixes import sp_version
...
from h2o4gpu.utils.testing import assert_greater_equal
...
from h2o4gpu.datasets import make_blobs
from h2o4gpu.datasets import make_multilabel_classification

from h2o4gpu.model_selection import fit_grid_point
from h2o4gpu.model_selection import cross_val_score
from h2o4gpu.model_selection import KFold
from h2o4gpu.model_selection import StratifiedKFold
from h2o4gpu.model_selection import StratifiedShuffleSplit
...
from h2o4gpu.model_selection import RandomizedSearchCV
from h2o4gpu.model_selection import ParameterGrid
from h2o4gpu.model_selection import ParameterSampler
from h2o4gpu.model_selection._search import BaseSearchCV

from h2o4gpu.model_selection._validation import FitFailedWarning

from h2o4gpu.svm import LinearSVC, SVC
from h2o4gpu.tree import DecisionTreeRegressor
from h2o4gpu.tree import DecisionTreeClassifier
from h2o4gpu.cluster import KMeansSklearn
from h2o4gpu.neighbors import KernelDensity
from h2o4gpu.metrics import f1_score
from h2o4gpu.metrics import recall_score
from h2o4gpu.metrics import accuracy_score
from h2o4gpu.metrics import make_scorer
from h2o4gpu.metrics import roc_auc_score
from h2o4gpu.impute import SimpleImputer
from h2o4gpu.pipeline import Pipeline
from h2o4gpu.linear_model import RidgeSklearn, SGDClassifier
...
def test_classes__property():
    ...
    grid_search = GridSearchCV(RidgeSklearn(), {'alpha': [1.0, 2.0]})
    grid_search.fit(X, y)
...
def test_unsupervised_grid_search():
    ...
    km = KMeansSklearn(random_state=0)
...
def test_fit_grid_point():
    ...
    assert_raise_message(ValueError, "For evaluating multiple scores, use "
                         "h2o4gpu.model_selection.cross_validate instead.",
...
def test_empty_cv_iterator_error():
    ...
    train_size = 100
    ridge = RandomizedSearchCV(RidgeSklearn(), {'alpha': [1e-3, 1e-2, 1e-1]},
                               cv=cv, n_jobs=-1)
