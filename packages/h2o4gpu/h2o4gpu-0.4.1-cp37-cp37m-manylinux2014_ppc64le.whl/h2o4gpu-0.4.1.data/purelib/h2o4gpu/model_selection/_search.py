"""
The :mod:`h2o4gpu.model_selection._search` includes utilities to fine-tune the
...
def fit_grid_point(X, y, estimator, parameters, train, test, scorer,
    ...
    estimator : estimator object
        ...
        This is assumed to implement the h2o4gpu estimator interface.
...
class GridSearchCV(BaseSearchCV):
    ...
    Examples
    --------
    >>> from h2o4gpu import svm, datasets
    ...
    :func:`h2o4gpu.model_selection.train_test_split`:
