...
class LinearSVC(BaseEstimator, LinearClassifierMixin,
    ...
    SVC
        ...
        :class:`h2o4gpu.multiclass.OneVsRestClassifier` wrapper.

        Finally SVC can fit dense data without memory copy if the input
        is C-contiguous. Sparse data will still incur memory copy though.

    h2o4gpu.linear_model.SGDClassifier
...
class LinearSVR(LinearModel, RegressorMixin):
    ...
    Examples
    --------
    >>> from h2o4gpu.svm import LinearSVR
    ...
    h2o4gpu.linear_model.SGDRegressor
...
class SVC(BaseSVC):
    ...
    consider using :class:`h2o4gpu.linear_model.LinearSVC` or
    :class:`h2o4gpu.linear_model.SGDClassifier` instead, possibly after a
    :class:`h2o4gpu.kernel_approximation.Nystroem` transformer.
...
class SVR(BaseLibSVM, RegressorMixin):
    ...
    datasets consider using :class:`h2o4gpu.linear_model.LinearSVR` or
    :class:`h2o4gpu.linear_model.SGDRegressor` instead, possibly after a
    :class:`h2o4gpu.kernel_approximation.Nystroem` transformer.
