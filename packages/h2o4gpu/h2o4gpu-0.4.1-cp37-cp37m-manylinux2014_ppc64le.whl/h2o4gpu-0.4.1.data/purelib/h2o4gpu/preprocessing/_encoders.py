...
class OneHotEncoder(_BaseEncoder):
    ...
    This encoding is needed for feeding categorical data to many h2o4gpu
    ...
    See also
    --------
    h2o4gpu.preprocessing.OrdinalEncoder : performs an ordinal (integer)
      encoding of the categorical features.
    h2o4gpu.feature_extraction.DictVectorizer : performs a one-hot encoding of
      dictionary items (also handles string-valued features).
    h2o4gpu.feature_extraction.FeatureHasher : performs an approximate one-hot
      encoding of dictionary items or strings.
    h2o4gpu.preprocessing.LabelBinarizer : binarizes labels in a one-vs-all
      fashion.
    h2o4gpu.preprocessing.MultiLabelBinarizer : transforms between iterable of
...
class OrdinalEncoder(_BaseEncoder):
    ...
    >>> from h2o4gpu.preprocessing import OrdinalEncoder
    >>> enc = OrdinalEncoder()
    >>> X = [['Male', 1], ['Female', 3], ['Female', 2]]
    >>> enc.fit(X)
    ... # doctest: +ELLIPSIS
    ...
    See also
    --------
    h2o4gpu.preprocessing.OneHotEncoder : performs a one-hot encoding of
      categorical features.
    h2o4gpu.preprocessing.LabelEncoder : encodes target labels with values
