"""
Testing for the forest module (h2o4gpu.ensemble.forest).
"""
...
from h2o4gpu.utils._joblib import joblib
from h2o4gpu.utils._joblib import parallel_backend
from h2o4gpu.utils._joblib import register_parallel_backend
from h2o4gpu.utils._joblib import __version__ as __joblib_version__
...
from h2o4gpu.utils.testing import assert_less, assert_greater
...
from h2o4gpu.decomposition import TruncatedSVDSklearn
from h2o4gpu.datasets import make_classification
from h2o4gpu.ensemble import ExtraTreesClassifier
from h2o4gpu.ensemble import ExtraTreesRegressor
from h2o4gpu.ensemble import RandomForestClassifierSklearn
from h2o4gpu.ensemble import RandomForestRegressorSklearn
from h2o4gpu.ensemble import RandomTreesEmbedding
...
from h2o4gpu.tree.tree import SPARSE_SPLITTERS
...
FOREST_CLASSIFIERS = {
    ...
    "RandomForestClassifierSklearn": RandomForestClassifierSklearn,
}

FOREST_REGRESSORS = {
    "ExtraTreesRegressor": ExtraTreesRegressor,
    "RandomForestRegressorSklearn": RandomForestRegressorSklearn,
}
...
def test_random_hasher():
    ...
    svd = TruncatedSVDSklearn(n_components=2)
...
def test_parallel_train():
    ...
    clfs = [
        RandomForestClassifierSklearn(n_estimators=20, n_jobs=n_jobs,
...
def test_dtype_convert(n_classes=15):
    classifier = RandomForestClassifierSklearn(random_state=0, bootstrap=False)
...
def test_min_impurity_split():
    ...
    all_estimators = [RandomForestClassifierSklearn, RandomForestRegressorSklearn,
...
def test_backend_respected():
    clf = RandomForestClassifierSklearn(n_estimators=10, n_jobs=2)
...
def test_forest_feature_importances_sum():
    X, y = make_classification(n_samples=15, n_informative=3, random_state=1,
                               n_classes=3)
    clf = RandomForestClassifierSklearn(min_samples_leaf=5, random_state=42,
...
def test_forest_degenerate_feature_importances():
    ...
    X = np.zeros((10, 10))
    y = np.ones((10,))
    gbr = RandomForestRegressorSklearn(n_estimators=10).fit(X, y)
