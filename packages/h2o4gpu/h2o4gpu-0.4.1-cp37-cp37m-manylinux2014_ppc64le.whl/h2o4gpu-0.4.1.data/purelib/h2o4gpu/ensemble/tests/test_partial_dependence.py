...
from h2o4gpu.ensemble.partial_dependence import partial_dependence
from h2o4gpu.ensemble.partial_dependence import plot_partial_dependence
...
def test_partial_dependecy_input():
    ...
    assert_raises(ValueError, partial_dependence,
                  GradientBoostingClassifierSklearn(), [0], X=X)
