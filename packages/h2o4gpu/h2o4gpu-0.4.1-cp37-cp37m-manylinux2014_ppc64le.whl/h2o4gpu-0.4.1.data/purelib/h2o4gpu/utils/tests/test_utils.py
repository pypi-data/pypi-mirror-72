...
from h2o4gpu.utils.testing import (assert_equal, assert_raises,
                                   assert_array_equal,
                                   SkipTest, assert_raises_regex,
                                   assert_warns_message, assert_no_warnings)
from h2o4gpu.utils import check_random_state
from h2o4gpu.utils import deprecated
from h2o4gpu.utils import resample
from h2o4gpu.utils import safe_mask
from h2o4gpu.utils import column_or_1d
from h2o4gpu.utils import safe_indexing
from h2o4gpu.utils import shuffle
from h2o4gpu.utils import gen_even_slices
from h2o4gpu.utils import _message_with_time, _print_elapsed_time
from h2o4gpu.utils import get_chunk_n_rows
from h2o4gpu.utils import is_scalar_nan
...
def test_deprecation_joblib_api(tmpdir):
    ...
    # Ensure that the joblib API is deprecated in h2o4gpu.util
    from h2o4gpu.utils import Parallel, Memory, delayed
    from h2o4gpu.utils import cpu_count, hash, effective_n_jobs
    ...
    # h2o4gpu.utils
    from h2o4gpu.utils import parallel_backend, register_parallel_backend
    assert_no_warnings(parallel_backend, 'loky', None)
    assert_no_warnings(register_parallel_backend, 'failing', None)

    # Ensure that the deprecation have no side effect in h2o4gpu.utils._joblib
    from h2o4gpu.utils._joblib import Parallel, Memory, delayed
    from h2o4gpu.utils._joblib import cpu_count, hash, effective_n_jobs
