...
from h2o4gpu.utils.fixes import MaskedArray
from h2o4gpu.utils.fixes import _joblib_parallel_args
from h2o4gpu.utils.fixes import _object_dtype_isnan
...
def test_joblib_parallel_args(monkeypatch, joblib_version):
    import h2o4gpu.utils._joblib
    monkeypatch.setattr(h2o4gpu.utils._joblib, '__version__', joblib_version)
