...
from h2o4gpu.linear_model.sag import get_auto_step_size
from h2o4gpu.linear_model.sag_fast import _multinomial_grad_loss_all_samples
from h2o4gpu.linear_model import LogisticRegressionSklearn, RidgeSklearn
from h2o4gpu.linear_model.base import make_dataset
from h2o4gpu.linear_model.logistic import _multinomial_loss_grad

from h2o4gpu.utils.fixes import logsumexp
...
from h2o4gpu.utils import compute_class_weight
from h2o4gpu.utils import check_random_state
from h2o4gpu.preprocessing import LabelEncoder, LabelBinarizer
from h2o4gpu.datasets import make_blobs, load_iris, make_classification
...
def test_classifier_matching():
    ...
    for solver in ['sag', 'saga']:
        if solver == 'sag':
            ...
            n_iter = 300
        clf = LogisticRegressionSklearn(solver=solver, fit_intercept=fit_intercept,
...
def test_regressor_matching():
    ...
    clf = RidgeSklearn(fit_intercept=fit_intercept, tol=.00000000001, solver='sag',
...
def test_sag_pobj_matches_logistic_regression():
    ...
    clf1 = LogisticRegressionSklearn(solver='sag', fit_intercept=False, tol=.0000001,
                              C=1. / alpha / n_samples, max_iter=max_iter,
                              random_state=10, multi_class='ovr')
    clf2 = clone(clf1)
    clf3 = LogisticRegressionSklearn(fit_intercept=False, tol=.0000001,
                              C=1. / alpha / n_samples, max_iter=max_iter,
                              random_state=10, multi_class='ovr',
                              solver='lbfgs')
...
def test_sag_pobj_matches_ridge_regression():
    ...
    clf1 = RidgeSklearn(fit_intercept=fit_intercept, tol=.00000000001, solver='sag',
                 alpha=alpha, max_iter=n_iter, random_state=42)
    clf2 = clone(clf1)
    clf3 = RidgeSklearn(fit_intercept=fit_intercept, tol=.00001, solver='lsqr',
                 alpha=alpha, max_iter=n_iter, random_state=42)
...
def test_sag_regressor_computed_correctly():
    ...
    clf1 = RidgeSklearn(fit_intercept=fit_intercept, tol=tol, solver='sag',
    ...
    # TODO: uncomment when sparse RidgeSklearn with intercept will be fixed (#4710)
...
def test_sag_regressor():
    ...
    clf1 = RidgeSklearn(tol=tol, solver='sag', max_iter=max_iter,
...
def test_sag_classifier_computed_correctly():
    ...
    clf1 = LogisticRegressionSklearn(solver='sag', C=1. / alpha / n_samples,
...
def test_classifier_single_class():
    ...
    assert_raise_message(ValueError,
                         ...
                         "in the data",
                         LogisticRegressionSklearn(solver='sag').fit,
                         X, y)
...
def test_step_size_alpha_error():
    ...
    clf1 = LogisticRegressionSklearn(solver='sag', C=1. / alpha,
                              fit_intercept=fit_intercept)
    assert_raise_message(ZeroDivisionError, msg, clf1.fit, X, y)

    clf2 = RidgeSklearn(fit_intercept=fit_intercept, solver='sag', alpha=alpha)
...
def test_multinomial_loss():
    ...
    # compute loss and gradient like in multinomial LogisticRegressionSklearn
    lbin = LabelBinarizer()
...
def test_sag_classifier_raises_error(solver):
    ...
    clf = LogisticRegressionSklearn(solver=solver, random_state=rng, warm_start=True)
    clf.fit(X, y)
