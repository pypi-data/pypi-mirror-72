...
from h2o4gpu.experimental import enable_iterative_imputer  # noqa

from h2o4gpu.impute import MissingIndicator
from h2o4gpu.impute import SimpleImputer, IterativeImputer
from h2o4gpu.dummy import DummyRegressor
from h2o4gpu.linear_model import BayesianRidgeSklearn, ARDRegression, RidgeSklearnCV
...
@pytest.mark.parametrize(
    "estimator",
    [None, DummyRegressor(), BayesianRidgeSklearn(), ARDRegression(), RidgeSklearnCV()]
)
def test_iterative_imputer_estimators(estimator):
    ...
    for triplet in imputer.imputation_sequence_:
        expected_type = (type(estimator) if estimator is not None
                         else type(BayesianRidgeSklearn()))
