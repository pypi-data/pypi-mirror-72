...
def get_data_home(data_home=None):
    """Return the path of the h2o4gpu data dir.
...
def load_files(container_path, description=None, categories=None,
    ...
    To use text files in a h2o4gpu classification or clustering algorithm,
    you will need to use the `h2o4gpu.feature_extraction.text` module to build
    ...
    to use most functions in `h2o4gpu.feature_extraction.text`.
...
def _pkl_filepath(*args, **kwargs):
    ...
    Therefore, dataset loaders in h2o4gpu use different files for pickles
