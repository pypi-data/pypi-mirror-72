...
def check_openmp_support():
    ...
    err_message = textwrap.dedent(
        ...
        It seems that h2o4gpu cannot be built with OpenMP support.

        - Make sure you have followed the installation instructions:

            https://h2o4gpu.org/dev/developers/advanced_installation.html

        - If your compiler supports OpenMP but the build still fails, please
          submit a bug report at:

            https://github.com/h2o4gpu/h2o4gpu/issues

        - If you want to build h2o4gpu without OpenMP support, you can set
