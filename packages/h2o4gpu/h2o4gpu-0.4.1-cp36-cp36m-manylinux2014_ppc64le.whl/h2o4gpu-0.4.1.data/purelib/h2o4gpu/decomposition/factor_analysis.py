...
FactorAnalysis is similar to probabilistic PCASklearn implemented by PCASklearn.score
While PCASklearn assumes Gaussian noise with the same variance for each
...
class FactorAnalysis(BaseEstimator, TransformerMixin):
    ...
    >>> from h2o4gpu.decomposition import FactorAnalysis
    ...
    See also
    --------
    PCASklearn: Principal component analysis is also a latent linear variable model
        which however assumes equal noise variance for each feature.
        This extra assumption makes probabilistic PCASklearn faster as it can be
