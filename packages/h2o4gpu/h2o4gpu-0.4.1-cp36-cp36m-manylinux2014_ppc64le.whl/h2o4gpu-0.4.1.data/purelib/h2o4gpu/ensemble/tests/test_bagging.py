"""
Testing for the bagging ensemble module (h2o4gpu.ensemble.bagging).
"""
...
from h2o4gpu.model_selection import GridSearchCV, ParameterGrid
from h2o4gpu.ensemble import BaggingClassifier, BaggingRegressor
from h2o4gpu.linear_model import Perceptron, LogisticRegressionSklearn
from h2o4gpu.neighbors import KNeighborsClassifier, KNeighborsRegressor
from h2o4gpu.tree import DecisionTreeClassifier, DecisionTreeRegressor
from h2o4gpu.svm import SVC, SVR
from h2o4gpu.random_projection import SparseRandomProjection
from h2o4gpu.pipeline import make_pipeline
from h2o4gpu.feature_selection import SelectKBest
from h2o4gpu.model_selection import train_test_split
from h2o4gpu.datasets import load_boston, load_iris, make_hastie_10_2
from h2o4gpu.utils import check_random_state
from h2o4gpu.utils import _joblib
from h2o4gpu.preprocessing import FunctionTransformer
...
def test_probability():
    ...
    with np.errstate(divide="ignore", invalid="ignore"):
        ...
        ensemble = BaggingClassifier(base_estimator=LogisticRegressionSklearn(),
                                     random_state=rng,
...
def test_estimators_samples():
    ...
    X, y = make_hastie_10_2(n_samples=200, random_state=1)
    bagging = BaggingClassifier(LogisticRegressionSklearn(), max_samples=0.5,
...
def test_set_oob_score_label_encoding():
    ...
    # See: https://github.com/h2o4gpu/h2o4gpu/issues/8933
    random_state = 5
    X = [[-1], [0], [1]] * 5
    Y1 = ['A', 'B', 'C'] * 5
    Y2 = [-1, 0, 1] * 5
...
def test_bagging_small_max_features():
    ...
    bagging = BaggingClassifier(LogisticRegressionSklearn(),
