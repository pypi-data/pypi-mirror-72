"""
Testing for Isolation Forest algorithm (h2o4gpu.ensemble.iforest).
"""
...
from h2o4gpu.ensemble import IsolationForest
from h2o4gpu.ensemble.iforest import _average_path_length
...
# chunk = 3 rows:
@patch(
    "h2o4gpu.ensemble.iforest.get_chunk_n_rows",
