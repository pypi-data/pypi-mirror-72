...
- ``GradientBoostingClassifierSklearn`` implements gradient boosting for
  classification problems.

- ``GradientBoostingRegressorSklearn`` implements gradient boosting for
  regression problems.
"""
...
@deprecated("All Losses in h2o4gpu.ensemble.gradient_boosting are "
...
class ExponentialLoss(ClassificationLossFunction):
    ...
    References
    ----------
    Greg RidgeSklearnway, Generalized Boosted Models: A guide to the gbm package, 2007
...
class GradientBoostingClassifierSklearn(BaseGradientBoosting, ClassifierMixin):
...
shape (n_estimators, ``loss_.K``)
    ...
    See also
    --------
    h2o4gpu.ensemble.HistGradientBoostingClassifierSklearn,
    h2o4gpu.tree.DecisionTreeClassifier, RandomForestClassifierSklearn
    AdaBoostClassifier
...
class GradientBoostingRegressorSklearn(BaseGradientBoosting, RegressorMixin):
    ...
    See also
    --------
    h2o4gpu.ensemble.HistGradientBoostingRegressorSklearn,
    h2o4gpu.tree.DecisionTreeRegressor, RandomForestRegressorSklearn
