...
from h2o4gpu.base import BaseEstimator, RegressorMixin, ClassifierMixin
from h2o4gpu.utils import check_X_y, check_random_state, check_array
from h2o4gpu.utils.validation import check_is_fitted
from h2o4gpu.utils.multiclass import check_classification_targets
from h2o4gpu.metrics import check_scoring
...
class HistGradientBoostingRegressorSklearn(BaseHistGradientBoosting, RegressorMixin):
    """Histogram-based Gradient Boosting Regression Tree.

    This estimator is much faster than
    :class:`GradientBoostingRegressorSklearn<h2o4gpu.ensemble.GradientBoostingRegressorSklearn>`
    ...
    >>> est = HistGradientBoostingRegressorSklearn().fit(X, y)
    >>> est.score(X, y)
    0.98...
    """
    ...
    def __init__(self, loss='least_squares', learning_rate=0.1,
        ...
        super(HistGradientBoostingRegressorSklearn, self).__init__(
...
class HistGradientBoostingClassifierSklearn(BaseHistGradientBoosting,
                                     ClassifierMixin):
    """Histogram-based Gradient Boosting Classification Tree.

    This estimator is much faster than
    :class:`GradientBoostingClassifierSklearn<h2o4gpu.ensemble.GradientBoostingClassifierSklearn>`
    for big datasets (n_samples >= 10 000). The input data ``X`` is pre-binned
    into integer-valued bins, which considerably reduces the number of
    splitting points to consider, and allows the algorithm to leverage
    integer-based data structures. For small sample sizes,
    ...
    >>> clf = HistGradientBoostingClassifierSklearn().fit(X, y)
    >>> clf.score(X, y)
    1.0
    """
    ...
    def __init__(self, loss='auto', learning_rate=0.1, max_iter=100,
        ...
        super(HistGradientBoostingClassifierSklearn, self).__init__(
            loss=loss, learning_rate=learning_rate, max_iter=max_iter,
            max_leaf_nodes=max_leaf_nodes, max_depth=max_depth,
            min_samples_leaf=min_samples_leaf,
            l2_regularization=l2_regularization, max_bins=max_bins,
