...
@pytest.mark.parametrize('GradientBoosting, X, y', [
    (HistGradientBoostingClassifierSklearn, X_classification, y_classification),
    (HistGradientBoostingRegressorSklearn, X_regression, y_regression)
])
...
def test_invalid_classification_loss():
    binary_clf = HistGradientBoostingClassifierSklearn(loss="binary_crossentropy")
...
def test_early_stopping_regression(scoring, validation_fraction,
    ...
    gb = HistGradientBoostingRegressorSklearn(
...
def test_early_stopping_classification(data, scoring, validation_fraction,
    ...
    gb = HistGradientBoostingClassifierSklearn(
        verbose=1,  # just for coverage
        min_samples_leaf=5,  # easier to overfit fast
        scoring=scoring,
        tol=tol,
...
def test_should_stop(scores, n_iter_no_change, tol, stopping):
    ...
    gbdt = HistGradientBoostingClassifierSklearn(
