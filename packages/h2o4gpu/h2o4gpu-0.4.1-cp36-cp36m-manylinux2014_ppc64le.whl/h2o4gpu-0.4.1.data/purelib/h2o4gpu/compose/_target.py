...
class TransformedTargetRegressor(BaseEstimator, RegressorMixin):
    ...
    Parameters
    ----------
    regressor : object, default=LinearRegressionSklearn()
    ...
    >>> tt = TransformedTargetRegressor(regressor=LinearRegressionSklearn(),
    ...
    to be used by h2o4gpu transformers. At the time of prediction, the
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        if self.regressor is None:
            from ..linear_model import LinearRegressionSklearn
            self.regressor_ = LinearRegressionSklearn()
        else:
