...
from h2o4gpu.linear_model import LinearRegressionSklearn, RANSACRegressor, LassoSklearn
from h2o4gpu.linear_model.ransac import _dynamic_max_trials
...
def test_ransac_inliers_outliers():
    ...
    base_estimator = LinearRegressionSklearn()
