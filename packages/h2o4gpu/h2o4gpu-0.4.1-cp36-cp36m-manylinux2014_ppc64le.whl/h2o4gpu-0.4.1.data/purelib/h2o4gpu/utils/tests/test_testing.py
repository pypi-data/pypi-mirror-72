...
from h2o4gpu.utils.deprecation import deprecated
from h2o4gpu.utils.metaestimators import if_delegate_has_method
...
def test_check_docstring_parameters():
    ...
    assert (
        incorrect == [
            "h2o4gpu.utils.tests.test_testing.f_check_param_definition There "
            "was no space between the param name and colon ('a: int')",
            "h2o4gpu.utils.tests.test_testing.f_check_param_definition There "
            "was no space between the param name and colon ('b:')",
            "h2o4gpu.utils.tests.test_testing.f_check_param_definition "
