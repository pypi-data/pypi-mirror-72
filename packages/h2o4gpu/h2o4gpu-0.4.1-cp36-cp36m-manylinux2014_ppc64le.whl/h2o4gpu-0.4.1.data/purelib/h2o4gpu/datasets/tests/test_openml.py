...
from h2o4gpu.datasets import fetch_openml
from h2o4gpu.datasets.openml import (_open_openml_url,
...
def _monkey_patch_webbased_functions(context,
    ...
    # XXX: Global variable
    if test_offline:
        context.setattr(h2o4gpu.datasets.openml, 'urlopen', _mock_urlopen)
...
def test_open_openml_url_cache(monkeypatch, gzip_response, tmpdir):
    ...
    openml_path = h2o4gpu.datasets.openml._DATA_FILE.format(data_id)
...
def test_open_openml_url_unlinks_local_path(
    ...
    monkeypatch.setattr(h2o4gpu.datasets.openml, 'urlopen', _mock_urlopen)
...
def test_fetch_openml_cache(monkeypatch, gzip_response, tmpdir):
    ...
    monkeypatch.setattr(h2o4gpu.datasets.openml, 'urlopen',
                        _mock_urlopen_raise)
