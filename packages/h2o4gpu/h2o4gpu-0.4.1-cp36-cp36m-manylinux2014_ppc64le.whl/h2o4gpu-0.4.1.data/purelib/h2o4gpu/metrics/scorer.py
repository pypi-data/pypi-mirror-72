"""
The :mod:`h2o4gpu.metrics.scorer` submodule implements a flexible
interface for model selection and evaluation using
arbitrary score functions.

A scorer object is a callable that can be passed to
:class:`h2o4gpu.model_selection.GridSearchCV` or
:func:`h2o4gpu.model_selection.cross_val_score` as the ``scoring``
    ...
    if isinstance(scoring, str):
        try:
            ...
            raise ValueError('%r is not a valid scoring value. '
                             'Use sorted(h2o4gpu.metrics.SCORERS.keys()) '
...
def check_scoring(estimator, scoring=None, allow_none=False):
    ...
    if isinstance(scoring, str):
        ...
        if hasattr(module, 'startswith') and \
           module.startswith('h2o4gpu.metrics.') and \
           not module.startswith('h2o4gpu.metrics.scorer') and \
           not module.startswith('h2o4gpu.metrics.tests.'):
...
def _check_multimetric_scoring(estimator, scoring=None):
    ...
    Parameters
    ----------
    estimator : h2o4gpu estimator instance
...
def make_scorer(score_func, greater_is_better=True, needs_proba=False,
    ...
    **kwargs : additional arguments
    ...
    Examples
    --------
    >>> from h2o4gpu.metrics import fbeta_score, make_scorer
