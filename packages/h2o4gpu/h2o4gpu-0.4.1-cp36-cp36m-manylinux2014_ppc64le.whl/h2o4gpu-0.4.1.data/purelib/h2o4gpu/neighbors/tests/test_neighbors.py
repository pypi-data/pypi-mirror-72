...
from h2o4gpu import neighbors, datasets
...
from h2o4gpu.neighbors.base import VALID_METRICS_SPARSE, VALID_METRICS
...
def test_pairwise_boolean_distance():
    ...
    # 'ball_tree': uses h2o4gpu.neighbors.dist_metrics
    rng = np.random.RandomState(0)
