...
"""
The :mod:`h2o4gpu.naive_bayes` module implements Naive Bayes algorithms. These
...
class ComplementNB(BaseDiscreteNB):
    ...
    >>> X = np.random.randint(5, size=(6, 100))
    >>> y = np.array([1, 2, 3, 4, 5, 6])
    >>> from h2o4gpu.naive_bayes import ComplementNB
    >>> clf = ComplementNB()
    >>> clf.fit(X, y)
...
class BernoulliNB(BaseDiscreteNB):
    ...
    >>> from h2o4gpu.naive_bayes import BernoulliNB
    >>> clf = BernoulliNB()
    >>> clf.fit(X, Y)
