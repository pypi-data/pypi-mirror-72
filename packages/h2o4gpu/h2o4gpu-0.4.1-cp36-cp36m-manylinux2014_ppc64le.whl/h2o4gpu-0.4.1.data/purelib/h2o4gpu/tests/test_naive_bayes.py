...
from h2o4gpu.datasets import load_digits, load_iris
...
from h2o4gpu.naive_bayes import GaussianNB, BernoulliNB
from h2o4gpu.naive_bayes import MultinomialNB, ComplementNB
