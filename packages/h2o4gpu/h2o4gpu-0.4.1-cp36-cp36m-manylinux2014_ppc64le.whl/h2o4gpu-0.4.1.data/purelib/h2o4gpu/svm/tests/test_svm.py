"""
Testing for Support Vector Machine module (h2o4gpu.svm)
...
from h2o4gpu import svm, linear_model, datasets, metrics, base
from h2o4gpu.model_selection import train_test_split
from h2o4gpu.datasets import make_classification, make_blobs
...
from h2o4gpu.utils.testing import assert_greater, assert_in, assert_less
from h2o4gpu.utils.testing import assert_raises_regexp, assert_warns
from h2o4gpu.utils.testing import assert_warns_message, assert_raise_message
from h2o4gpu.utils.testing import ignore_warnings, assert_raises
from h2o4gpu.utils.testing import assert_no_warnings
from h2o4gpu.exceptions import ConvergenceWarning
from h2o4gpu.exceptions import NotFittedError, UndefinedMetricWarning
...
def test_weight():
    ...
    for clf in (linear_model.LogisticRegressionSklearn(),
