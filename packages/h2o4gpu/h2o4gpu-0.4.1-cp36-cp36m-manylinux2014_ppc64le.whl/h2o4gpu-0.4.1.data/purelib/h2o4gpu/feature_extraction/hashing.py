...
if not IS_PYPY:
    ...
    def _hashing_transform(*args, **kwargs):
        raise NotImplementedError(
                ...
                'https://github.com/h2o4gpu/h2o4gpu/issues/11540 '
...
class FeatureHasher(BaseEstimator, TransformerMixin):
    ...
    Examples
    --------
    >>> from h2o4gpu.feature_extraction import FeatureHasher
    ...
    h2o4gpu.preprocessing.OneHotEncoder : handles nominal/categorical features.
    """
    ...
    def fit(self, X=None, y=None):
        ...
        with the h2o4gpu transformer API.
