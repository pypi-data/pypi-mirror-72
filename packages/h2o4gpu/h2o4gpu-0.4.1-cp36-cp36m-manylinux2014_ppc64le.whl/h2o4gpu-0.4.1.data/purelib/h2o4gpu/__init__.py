...
__version__ = '0.4.1'
__git_revision__ = '6eaf8afa3e2b73d9b5c18fe8743aaacbbc8569fe'
...
try:
    ...
    # process. It is used to enable importing subpackages of h2o4gpu when
...
if __SKLEARN_SETUP__:
    ...
    # We are not importing the rest of h2o4gpu during the build
