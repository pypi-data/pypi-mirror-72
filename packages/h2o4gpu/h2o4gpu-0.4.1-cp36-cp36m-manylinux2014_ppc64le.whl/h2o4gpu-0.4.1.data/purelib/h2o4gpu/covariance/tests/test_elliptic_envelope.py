"""
Testing for Elliptic Envelope algorithm (h2o4gpu.covariance.elliptic_envelope).
"""

import numpy as np
from h2o4gpu.covariance import EllipticEnvelope
...
from h2o4gpu.utils.testing import assert_array_equal, assert_warns_message
