...
setup(
    ...
    description="Enables one Django project to authenticate via a second Django project via oauth2.",  # Optional
    ...
    url="https://github.com/pandichef/djangito",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="David R",  # Optional
    ...
    #
    # packages=find_packages(exclude=["contrib", "docs", "tests", "djangito_client", "djangito_client*"]),  # Required
