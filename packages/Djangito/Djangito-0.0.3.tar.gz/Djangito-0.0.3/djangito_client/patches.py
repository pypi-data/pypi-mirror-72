...
class DgangitoAdminSite(sites.AdminSite):
    def get_urls(self):
        ...
        except ConnectionError as e:  # todo: requests.get breaks during tests; handle this more elegantly
            # print(e)
            djangito_server_admin_url = ''
        redirect_urls = [
...
# settings.LOGOUT_REDIRECT_URL = 'https://www.nytimes.com'
