...
class ArgParseInated:  # pylint: disable=too-few-public-methods
    """
...
class ArgParseInator:  # pylint: disable=too-many-instance-attributes
    """
    ...
    def _compile(self, module=None):
        ...
        if self.add_output:
            ...
            if isinstance(self.add_output, str):
        ...
        if len(self.commands) == 1 and self.never_single is False:
            ...
            func = next(iter(self.commands.values()))
