...
class ClusterApi(object):
    ...
    def cluster(self, cluster_task, **kwargs):  # noqa: E501
        ...
        :param ClusterTask cluster_task: Новый запрос на Кластеризация (required)
    ...
    def delete_result(self, id, **kwargs):  # noqa: E501
        ...
        Удаление результата кластеризации по идентификатору расчета  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str id: Идентификатор расчета (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_result(self, id, **kwargs):  # noqa: E501
        ...
        Получение результата кластеризации по идентификатору расчета  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def run_cluster(self, cluster_task, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param ClusterTask cluster_task: Запуск асинхронной кластеризации (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
