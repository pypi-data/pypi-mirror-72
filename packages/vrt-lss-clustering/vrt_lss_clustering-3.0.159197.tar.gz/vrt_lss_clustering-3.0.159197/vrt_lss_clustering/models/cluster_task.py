...
class ClusterTask(object):
    ...
    def clusters(self):
        ...
        Список кластеров, которые будут использоваться как базовое решение. Данные кластера не являются ограничением для кластеризации, т.е. точки из указанного кластера могут быть перемещены в другой кластер.   # noqa: E501
