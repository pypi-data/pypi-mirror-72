...
class ClusterSettings(object):
    ...
    def configuration(self):
        ...
        Название конфигурации кластеризации. Конфигурация определяет цель и качество результата.   # noqa: E501
    ...
    def calculation_time(self):
        ...
        Время расчета в минутах. Cтарт отсчета начинается от времени завершения загрузки данных на сервер и начала кластеризации.   # noqa: E501
    ...
    def result_ttl(self):
        ...
        Время жизни результата кластеризации в минутах. Cтарт отсчета начинается от времени завершения кластеризации.   # noqa: E501
