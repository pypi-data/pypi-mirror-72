...
def add_classified_outputs (outputs, labels):
    ...
    outputs ['classes'] = table.lookup(tf.cast(indices, dtype=dtypes.int64))
...
def save (model_dir, signature_name, inputs, outputs, sess = None, graph = None, labels = None, train_dir = None):
    ...
    with graph.as_default ():
        labels and add_classified_outputs (outputs, labels)
