...
from airflow.api.common.experimental.gen_dag_file import gen_dag_file,rm_dag_file
...
@csrf.exempt
@api_experimental.route('/create_dagfile', methods=['POST'])
@requires_authentication
def create_dagfile():
    """Create a dag file."""
    params = request.get_json(force=True)
...
@api_experimental.route('/delete_dagfile', methods=['GET'])
@requires_authentication
def delete_dagfile():
    """delete the dag."""
    try:
