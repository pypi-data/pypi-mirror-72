...
class SecretLockTransactionDTO(object):
    ...
    def __init__(self, size=None, signature=None, signer_public_key=None, version=None, network=None, type=None, max_fee=None, deadline=None, secret=None, mosaic_id=None, amount=None, duration=None, hash_algorithm=None, recipient_address=None, local_vars_configuration=None):  # noqa: E501
