...
class TransactionRoutesApi(object):
    ...
    def get_transactions_by_id(self, transaction_ids, **kwargs):  # noqa: E501
        """Get transactions information  # noqa: E501

        Returns transactions information for a given array of transactionIds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transactions_by_id(transaction_ids, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_transactions_by_id_with_http_info(transaction_ids, **kwargs)  # noqa: E501

    def get_transactions_by_id_with_http_info(self, transaction_ids, **kwargs):  # noqa: E501
        """Get transactions information  # noqa: E501

        Returns transactions information for a given array of transactionIds.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transactions_by_id_with_http_info(transaction_ids, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('transaction_ids' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `transaction_ids` when calling `get_transactions_by_id`")  # noqa: E501
    ...
    def search_confirmed_transactions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['address', 'recipient_address', 'signer_public_key', 'height', 'type', 'embedded', 'page_size', 'page_number', 'offset', 'order']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
