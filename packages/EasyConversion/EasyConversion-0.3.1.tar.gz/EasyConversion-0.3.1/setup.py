...
0.3.1 - Patched some bugs with docs.
"""
setup(
  ...
  description = 'Easily converting binary and decimal (early) Updated the way you import',   # Give a short description about your library
  ...
  download_url = 'https://github.com/Coolo2/EasyConversion/archive/v_031.tar.gz',    # I explain this later on
  keywords = ['Decimal', 'Binary', 'Convert'],   # Keywords that define your package best
  install_requires=[],
  classifiers=[
