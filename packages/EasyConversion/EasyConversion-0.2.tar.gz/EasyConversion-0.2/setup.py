...
setup(
  ...
  description = 'Easily converting binary and decimal (early)',   # Give a short description about your library
  ...
  download_url = 'https://github.com/Coolo2/EasyConversion/archive/v_011.tar.gz',    # I explain this later on
