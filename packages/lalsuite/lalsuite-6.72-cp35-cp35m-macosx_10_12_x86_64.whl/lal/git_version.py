...
id = "e82541ec1632f7ce72a02834e34c00bc383d2e2e"
date = "2020-06-26 18:56:34 +0000"
branch = "None"
tag = "lalsuite-v6.72"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "e82541ec1632f7ce72a02834e34c00bc383d2e2e":
        return
    msg = "Program id (e82541ec1632f7ce72a02834e34c00bc383d2e2e) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
