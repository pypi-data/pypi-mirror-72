...
from tensorflow_probability.python.experimental.inference_gym.internal.datasets._jax import synthetic_item_response_theory as synthetic_item_response_theory_mod  # pylint: disable=g-import-not-at-top
