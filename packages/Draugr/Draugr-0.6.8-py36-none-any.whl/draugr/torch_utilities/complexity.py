...
def get_model_complexity_info(model, input_res, print_per_layer_stat: bool = True, as_strings: bool = True,
                              input_constructor=None, ost=sys.stdout) -> Union[
  ...
  if input_constructor:
    ...
    try:
      batch = torch.ones(()).new_empty((1, *input_res), dtype=next(flops_model.parameters()).dtype,
...
def flops_to_string(flops, units='GMac', precision=2)->str:
  """
...
def print_model_with_flops(model, units='GMac', precision:int=3, ost=sys.stdout)->None:
  """
