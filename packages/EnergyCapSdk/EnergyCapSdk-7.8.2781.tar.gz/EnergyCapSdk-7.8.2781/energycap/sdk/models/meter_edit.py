...
class MeterEdit(Model):
    ...
    :param use_unit_id: The use unit ID is the reporting unit for use for this
     meter.
     It is used to determine initial bill format for this meter. <span
     class='property-internal'>Required (defined)</span>
    ...
    _validation = {
        ...
        'bill_entry_note': {'required': True, 'max_length': 64, 'min_length': 0},
        'primary_use_id': {'required': True},
    ...
    def __init__(self, meter_code, meter_info, place_id, commodity_id, address, bill_entry_note, primary_use_id, meter_time_zone_id, active, properties, include_in_energy_star=None, use_unit_id=None, demand_unit_id=None):
