...
class UserEditRequest(Model):
    ...
    def __init__(self, user_code, full_name, email, active_directory, active, password_expiration_interval, strong_password, force_password_change, user_role_id, max_approval_amount, report_group_id, password=None, cost_center_id=None, topmost_cost_center_ids=None, place_id=None, topmost_place_ids=None, user_groups=None):
