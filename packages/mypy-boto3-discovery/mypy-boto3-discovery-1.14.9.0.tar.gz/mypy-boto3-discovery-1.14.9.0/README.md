...
[boto3.ApplicationDiscoveryService 1.14.9](https://boto3.amazonaws.com/v1/documentation/api/1.14.9/reference/services/discovery.html#ApplicationDiscoveryService) service
