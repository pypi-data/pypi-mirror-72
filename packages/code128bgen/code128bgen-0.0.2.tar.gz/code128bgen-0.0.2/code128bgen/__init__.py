...
def generate_raw_bar_widths(build_barcode):
    ...
    :return:
    """
    start_code = str(WIDTHS[START_CODE]) + "".join(str(WIDTHS[i]) for i in build_barcode)
    check_digit = build_check_digit(start_code)
    return start_code + check_digit + str(WIDTHS[STOP_CODE])
...
if __name__ == '__main__':
    ...
    write_barcode_to_image_file(bar_widths_str, 'test_raw.png')
