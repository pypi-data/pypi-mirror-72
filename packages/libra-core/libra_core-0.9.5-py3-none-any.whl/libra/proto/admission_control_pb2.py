...
_ADMISSIONCONTROLMSG = _descriptor.Descriptor(
  name='AdmissionControlMsg',
  full_name='admission_control.AdmissionControlMsg',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='submit_transaction_request', full_name='admission_control.AdmissionControlMsg.submit_transaction_request', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='submit_transaction_response', full_name='admission_control.AdmissionControlMsg.submit_transaction_response', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='message', full_name='admission_control.AdmissionControlMsg.message',
...
_SUBMITTRANSACTIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='transaction', full_name='admission_control.SubmitTransactionRequest.transaction', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADMISSIONCONTROLMSG.fields_by_name['submit_transaction_request'].message_type = _SUBMITTRANSACTIONREQUEST
_ADMISSIONCONTROLMSG.fields_by_name['submit_transaction_response'].message_type = _SUBMITTRANSACTIONRESPONSE
_ADMISSIONCONTROLMSG.oneofs_by_name['message'].fields.append(
  _ADMISSIONCONTROLMSG.fields_by_name['submit_transaction_request'])
_ADMISSIONCONTROLMSG.fields_by_name['submit_transaction_request'].containing_oneof = _ADMISSIONCONTROLMSG.oneofs_by_name['message']
_ADMISSIONCONTROLMSG.oneofs_by_name['message'].fields.append(
  _ADMISSIONCONTROLMSG.fields_by_name['submit_transaction_response'])
_ADMISSIONCONTROLMSG.fields_by_name['submit_transaction_response'].containing_oneof = _ADMISSIONCONTROLMSG.oneofs_by_name['message']
_SUBMITTRANSACTIONREQUEST.fields_by_name['transaction'].message_type = transaction__pb2._SIGNEDTRANSACTION
...
_SUBMITTRANSACTIONRESPONSE.fields_by_name['mempool_status'].message_type = mempool__status__pb2._MEMPOOLSTATUS
...
DESCRIPTOR.message_types_by_name['AdmissionControlMsg'] = _ADMISSIONCONTROLMSG
...
AdmissionControlMsg = _reflection.GeneratedProtocolMessageType('AdmissionControlMsg', (_message.Message,), {
  'DESCRIPTOR' : _ADMISSIONCONTROLMSG,
  '__module__' : 'admission_control_pb2'
  # @@protoc_insertion_point(class_scope:admission_control.AdmissionControlMsg)
  })
_sym_db.RegisterMessage(AdmissionControlMsg)
