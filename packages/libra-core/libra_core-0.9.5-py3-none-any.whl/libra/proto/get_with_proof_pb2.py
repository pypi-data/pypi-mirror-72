...
_UPDATETOLATESTLEDGERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='epoch_change_proof', full_name='types.UpdateToLatestLedgerResponse.epoch_change_proof', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATETOLATESTLEDGERRESPONSE.fields_by_name['epoch_change_proof'].message_type = epoch__change__pb2._EPOCHCHANGEPROOF
