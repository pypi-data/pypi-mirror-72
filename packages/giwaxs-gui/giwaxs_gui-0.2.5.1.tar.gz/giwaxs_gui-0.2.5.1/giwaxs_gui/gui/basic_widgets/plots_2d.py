...
from giwaxs_gui.gui.basic_widgets.mouse_events import MouseEventsController
...
class CustomImageViewer(GraphicsLayoutWidget):
    ...
    def __init__(self, parent=None, *, hist_range: tuple = None, sigma_factor: float = 3,
                 mouse_event_controller: MouseEventsController = None, **kwargs):
        ...
        self.mouse_event_controller: MouseEventsController or None = mouse_event_controller
    ...
    def mouseMoveEvent(self, ev):
        if self.mouse_event_controller:
            self.mouse_event_controller.mouseMoveEvent(ev)
            if self.mouse_event_controller.exec_super_method:
    ...
    def mouseReleaseEvent(self, ev):
        if self.mouse_event_controller:
            self.mouse_event_controller.mouseReleaseEvent(ev)
            if self.mouse_event_controller.exec_super_method:
    ...
    def mousePressEvent(self, ev):
        if self.mouse_event_controller:
            self.mouse_event_controller.mousePressEvent(ev)
            if self.mouse_event_controller.exec_super_method:
