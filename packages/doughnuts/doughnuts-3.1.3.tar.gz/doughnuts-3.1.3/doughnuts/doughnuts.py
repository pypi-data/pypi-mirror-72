...
def change_prompt():
    ...
    if (namespace == "main"):
        ...
        print(color.yellow("[rs|reshell]   ") + color.cyan(
            "(Only for both system is linux) (Testing command) Bind a port and waiting for target connect back to get a full shell"))
        ...
        print(color.yellow("[search]       ") +
              color.cyan("Search file by glob, pattern support . * [...]"))
