...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '2.2.0-alpha.1592964853+3c2e407b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 2.2.0-alpha.1592964853+3c2e407b`
                """)
            else:
                raise
