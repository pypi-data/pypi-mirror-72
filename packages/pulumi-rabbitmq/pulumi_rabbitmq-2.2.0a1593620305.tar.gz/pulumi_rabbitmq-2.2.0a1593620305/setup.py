...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '2.2.0-alpha.1593620305+660b8efd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 2.2.0-alpha.1593620305+660b8efd`
                """)
            else:
                raise
