...
def prepare_resumable_split(file, fromdir, todir, chunksize=4194304): 
    ...
    :param todir: path of the folder where the file is located
    ...
    file_size = os.path.getsize(os.path.join(fromdir, file))
    ...
    partnum = 0
    chunked_files = []
    input = open(fromdir + '/' + file_name + extention, 'rb')
    while 1:
