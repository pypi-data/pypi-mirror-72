...
setup(
      ...
      license='GNU GPLv3',
      packages=['kuafu'],
      install_requires=['PyQt5', 'numpy'], #external packages as dependencies
      classifiers=[
      ...
      data_files=[
                 ...
                 ('resources', ['kuafu/resources/ui_main.py', 'kuafu/resources/ui_library.py', 
                                'kuafu/resources/ui_document.py', 'kuafu/resources/resources_rc.py',
                                'kuafu/resources/ui_annotation_item.py'])
      ],
