...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.AccessPointProps", jsii_struct_bases=[], name_mapping={'file_system': 'fileSystem', 'create_acl': 'createAcl', 'path': 'path', 'posix_user': 'posixUser'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.Acl", jsii_struct_bases=[], name_mapping={'owner_gid': 'ownerGid', 'owner_uid': 'ownerUid', 'permissions': 'permissions'})
class Acl():
...
class CfnAccessPoint(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-efs.CfnAccessPoint"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, file_system_id: str, access_point_tags: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "AccessPointTagProperty"]]]]=None, client_token: typing.Optional[str]=None, posix_user: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "PosixUserProperty"]]=None, root_directory: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RootDirectoryProperty"]]=None) -> None:
    ...
    def from_cloud_formation(cls, scope: aws_cdk.core.Construct, id: str, resource_attributes: typing.Any, *, finder: aws_cdk.core.ICfnFinder) -> "CfnAccessPoint":
    ...
    def access_point_tags(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "AccessPointTagProperty"]]]]:
    ...
    def access_point_tags(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "AccessPointTagProperty"]]]]) -> None:
    ...
    def posix_user(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "PosixUserProperty"]]:
    ...
    @posix_user.setter
    def posix_user(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "PosixUserProperty"]]) -> None:
        jsii.set(self, "posixUser", value)

    @builtins.property
    @jsii.member(jsii_name="rootDirectory")
    def root_directory(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RootDirectoryProperty"]]:
    ...
    def root_directory(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "RootDirectoryProperty"]]) -> None:
        jsii.set(self, "rootDirectory", value)

    @jsii.data_type(jsii_type="@aws-cdk/aws-efs.CfnAccessPoint.AccessPointTagProperty", jsii_struct_bases=[], name_mapping={'key': 'key', 'value': 'value'})
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-efs.CfnAccessPoint.CreationInfoProperty", jsii_struct_bases=[], name_mapping={'owner_gid': 'ownerGid', 'owner_uid': 'ownerUid', 'permissions': 'permissions'})
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-efs.CfnAccessPoint.PosixUserProperty", jsii_struct_bases=[], name_mapping={'gid': 'gid', 'uid': 'uid', 'secondary_gids': 'secondaryGids'})
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-efs.CfnAccessPoint.RootDirectoryProperty", jsii_struct_bases=[], name_mapping={'creation_info': 'creationInfo', 'path': 'path'})
    class RootDirectoryProperty():
        def __init__(self, *, creation_info: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.CreationInfoProperty"]]=None, path: typing.Optional[str]=None) -> None:
            """
        ...
        @builtins.property
        def creation_info(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.CreationInfoProperty"]]:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.CfnAccessPointProps", jsii_struct_bases=[], name_mapping={'file_system_id': 'fileSystemId', 'access_point_tags': 'accessPointTags', 'client_token': 'clientToken', 'posix_user': 'posixUser', 'root_directory': 'rootDirectory'})
class CfnAccessPointProps():
    def __init__(self, *, file_system_id: str, access_point_tags: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.AccessPointTagProperty"]]]]=None, client_token: typing.Optional[str]=None, posix_user: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.PosixUserProperty"]]=None, root_directory: typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.RootDirectoryProperty"]]=None) -> None:
    ...
    @builtins.property
    def access_point_tags(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.AccessPointTagProperty"]]]]:
        """``AWS::EFS::AccessPoint.AccessPointTags``.
    ...
    @builtins.property
    def posix_user(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.PosixUserProperty"]]:
        """``AWS::EFS::AccessPoint.PosixUser``.
    ...
    @builtins.property
    def root_directory(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnAccessPoint.RootDirectoryProperty"]]:
        """``AWS::EFS::AccessPoint.RootDirectory``.
...
class CfnFileSystem(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-efs.CfnFileSystem"):
    ...
    @encrypted.setter
    def encrypted(self, value: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]) -> None:
    ...
    def lifecycle_policies(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "LifecyclePolicyProperty"]]]]:
    ...
    def lifecycle_policies(self, value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "LifecyclePolicyProperty"]]]]) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.CfnFileSystemProps", jsii_struct_bases=[], name_mapping={'encrypted': 'encrypted', 'file_system_policy': 'fileSystemPolicy', 'file_system_tags': 'fileSystemTags', 'kms_key_id': 'kmsKeyId', 'lifecycle_policies': 'lifecyclePolicies', 'performance_mode': 'performanceMode', 'provisioned_throughput_in_mibps': 'provisionedThroughputInMibps', 'throughput_mode': 'throughputMode'})
class CfnFileSystemProps():
    def __init__(self, *, encrypted: typing.Optional[typing.Union[bool, aws_cdk.core.IResolvable]]=None, file_system_policy: typing.Any=None, file_system_tags: typing.Optional[typing.List["CfnFileSystem.ElasticFileSystemTagProperty"]]=None, kms_key_id: typing.Optional[str]=None, lifecycle_policies: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnFileSystem.LifecyclePolicyProperty"]]]]=None, performance_mode: typing.Optional[str]=None, provisioned_throughput_in_mibps: typing.Optional[jsii.Number]=None, throughput_mode: typing.Optional[str]=None) -> None:
    ...
    @builtins.property
    def lifecycle_policies(self) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnFileSystem.LifecyclePolicyProperty"]]]]:
        """``AWS::EFS::FileSystem.LifecyclePolicies``.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.FileSystemProps", jsii_struct_bases=[], name_mapping={'vpc': 'vpc', 'encrypted': 'encrypted', 'file_system_name': 'fileSystemName', 'kms_key': 'kmsKey', 'lifecycle_policy': 'lifecyclePolicy', 'performance_mode': 'performanceMode', 'provisioned_throughput_per_second': 'provisionedThroughputPerSecond', 'removal_policy': 'removalPolicy', 'security_group': 'securityGroup', 'throughput_mode': 'throughputMode', 'vpc_subnets': 'vpcSubnets'})
class FileSystemProps():
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, encrypted: typing.Optional[bool]=None, file_system_name: typing.Optional[str]=None, kms_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, lifecycle_policy: typing.Optional["LifecyclePolicy"]=None, performance_mode: typing.Optional["PerformanceMode"]=None, provisioned_throughput_per_second: typing.Optional[aws_cdk.core.Size]=None, removal_policy: typing.Optional[aws_cdk.core.RemovalPolicy]=None, security_group: typing.Optional[aws_cdk.aws_ec2.ISecurityGroup]=None, throughput_mode: typing.Optional["ThroughputMode"]=None, vpc_subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-efs.PosixUser", jsii_struct_bases=[], name_mapping={'gid': 'gid', 'uid': 'uid', 'secondary_gids': 'secondaryGids'})
class PosixUser():
    def __init__(self, *, gid: str, uid: str, secondary_gids: typing.Optional[typing.List[str]]=None) -> None:
...
class AccessPoint(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-efs.AccessPoint"):
    """Represents the AccessPoint.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, file_system: "IFileSystem", create_acl: typing.Optional["Acl"]=None, path: typing.Optional[str]=None, posix_user: typing.Optional["PosixUser"]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param file_system: The efs filesystem.
    ...
    @builtins.classmethod
    def from_access_point_id(cls, scope: aws_cdk.core.Construct, id: str, access_point_id: str) -> "IAccessPoint":
