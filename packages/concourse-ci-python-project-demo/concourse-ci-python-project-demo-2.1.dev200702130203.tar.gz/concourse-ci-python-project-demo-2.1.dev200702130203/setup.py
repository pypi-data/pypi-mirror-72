...
# Package meta-data.
NAME = 'concourse-ci-python-project-demo'
DESCRIPTION = 'Concourse CI testing package.'
URL = 'https://github.com/timefcuk/sample-python-project.git'
...
class UploadCommand(Command):
    ...
    def run(self):
        ...
        os.system('twine upload --repository concourse-ci-python-project-demo dist/*')
