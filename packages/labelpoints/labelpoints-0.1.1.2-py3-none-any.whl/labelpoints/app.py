...
from labelpoints import __appname__
from labelpoints import PY2
from labelpoints import QT5

from . import utils
from labelpoints.config import get_config
from labelpoints.label_file import LabelFile
from labelpoints.label_file import LabelFileError
from labelpoints.logger import logger
from labelpoints.shape import Shape
from labelpoints.widgets import BrightnessContrastDialog
from labelpoints.widgets import Canvas
from labelpoints.widgets import LabelDialog
from labelpoints.widgets import LabelListWidget
from labelpoints.widgets import LabelListWidgetItem
from labelpoints.widgets import ToolBar
from labelpoints.widgets import UniqueLabelQListWidget
from labelpoints.widgets import ZoomWidget
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        # see labelpoints/config/default_config.yaml for valid configuration
        if config is None:
            config = get_config()
        self._config = config
        ...
        self.settings = QtCore.QSettings("labelpoints", "labelpoints")
