...
class Shape(object):
    ...
    def drawVertex(self, path, i):
        ...
        if shape == self.P_SQUARE:
            ...
            path.addText(point, QtGui.QFont("Microsoft YaHei", 100, 50, False), str(i+1))
        elif shape == self.P_ROUND:
            path.addEllipse(point, d / 2.0, d / 2.0)
            path.addText(point, QtGui.QFont("Microsoft YaHei", 50, 50, False), str(i+1))
        else:
    ...
    def nearestVertex(self, point, epsilon):
        ...
        min_i = None
        for i, p in enumerate(self.points):
            dist = labelpoints.utils.distance(p - point)
    ...
    def nearestEdge(self, point, epsilon):
        ...
        for i in range(len(self.points)):
            ...
            dist = labelpoints.utils.distancetoline(point, line)
            if dist <= epsilon and dist < min_distance:
                min_distance = dist
                post_i = i
        return post_i
