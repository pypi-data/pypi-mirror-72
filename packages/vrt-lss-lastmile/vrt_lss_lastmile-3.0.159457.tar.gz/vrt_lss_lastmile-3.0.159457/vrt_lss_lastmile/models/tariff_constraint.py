...
class TariffConstraint(object):
    ...
    def __init__(self, stage_length=11594570, cost_per_unit=0, local_vars_configuration=None):  # noqa: E501
    ...
    def stage_length(self, stage_length):
        ...
        if (self.local_vars_configuration.client_side_validation and
                stage_length is not None and stage_length > 11594570):  # noqa: E501
            raise ValueError("Invalid value for `stage_length`, must be a value less than or equal to `11594570`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
