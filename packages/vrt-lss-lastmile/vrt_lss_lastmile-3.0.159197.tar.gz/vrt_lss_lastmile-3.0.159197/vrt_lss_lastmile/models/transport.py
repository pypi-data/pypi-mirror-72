...
class Transport(object):
    ...
    def key(self):
        ...
        Ключ транспорта, уникальный идентификатор.  # noqa: E501
    ...
    def transport_features(self):
        ...
        Список возможностей транспорта, используется для проверки совместимости транспорта с заказами, локациями и исполнителями.  # noqa: E501
    ...
    def performer_restrictions(self):
        ...
        Список требований к исполнителю, определяющий возможность использования транспорта исполнителями.  # noqa: E501
    ...
    def boxes(self):
        ...
        Список отсеков транспорта, которые могут вмещать груз.  # noqa: E501
