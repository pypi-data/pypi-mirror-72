...
class Order(object):
    ...
    def performer_blacklist(self):
        ...
        Список запрещенных требований к исполнителю работы, используется для проверки совместимости исполнителя данной работе по списку возможностей исполнителями. Данный список не должен пересекаться с performer_restrictions.   # noqa: E501
