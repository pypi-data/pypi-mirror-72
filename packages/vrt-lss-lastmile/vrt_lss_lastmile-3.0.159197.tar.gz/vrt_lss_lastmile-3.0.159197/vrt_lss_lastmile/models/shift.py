...
class Shift(object):
    ...
    def key(self):
        ...
        Ключ смены, уникальный идентификатор.  # noqa: E501
    ...
    def shift_type(self):
        ...
        Тип смены, может быть исполнителем (PERFORMER) или транспортом (TRANSPORT).  # noqa: E501
    ...
    def resource_key(self):
        ...
        Ключ ресурса, на который ссылается смена.  # noqa: E501
    ...
    def start_location_key(self):
        ...
        Ключ начальной локации, если не определена то рейс начинается на первом заказе.  # noqa: E501
    ...
    def finish_location_key(self):
        ...
        Ключ финальной локации, если не определена то рейс завершается на последнем заказе.  # noqa: E501
