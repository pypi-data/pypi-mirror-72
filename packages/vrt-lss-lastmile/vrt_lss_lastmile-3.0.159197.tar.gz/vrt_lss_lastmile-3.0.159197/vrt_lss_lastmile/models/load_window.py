...
class LoadWindow(object):
    ...
    def gates_count(self):
        ...
        Количество одновременно обслуживаемого транспорта в данном временном окне.  Если 0, то ограничение не учитывается.  Данный параметр сильно влияет на скорость и качество решения.   # noqa: E501
