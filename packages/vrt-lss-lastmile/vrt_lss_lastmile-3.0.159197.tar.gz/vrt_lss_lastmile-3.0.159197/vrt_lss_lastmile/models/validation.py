...
class Validation(object):
    ...
    def type(self):
        ...
        Тип валидации * `info` - информация * `warning` - предупреждение * `error` - ошибка   # noqa: E501
    ...
    def entity_key(self):
        ...
        Описание целевой сущности данных.  # noqa: E501
    ...
    def info(self):
        ...
        Информация о валидации.  # noqa: E501
