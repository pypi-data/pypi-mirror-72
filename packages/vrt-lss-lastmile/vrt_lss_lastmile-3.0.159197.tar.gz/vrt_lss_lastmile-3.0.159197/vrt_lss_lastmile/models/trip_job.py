...
class TripJob(object):
    ...
    def job_type(self):
        ...
        Возможные типы работ   * `LOCATION_ARRIVAL` - прибытие на локацию   * `READY_TO_WORK` - исполнитель готов к работе   * `START_WORK` - начало работы на локации   * `FINISH_WORK` - конец работы на локации   * `LOCATION_DEPARTURE` - отъезд с локации   # noqa: E501
