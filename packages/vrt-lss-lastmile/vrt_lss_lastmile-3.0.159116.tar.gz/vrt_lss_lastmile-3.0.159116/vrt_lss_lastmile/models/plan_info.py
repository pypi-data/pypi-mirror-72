...
class PlanInfo(object):
    ...
    def result_version(self, result_version):
        ...
        if (self.local_vars_configuration.client_side_validation and
                result_version is not None and result_version > 1159116):  # noqa: E501
            raise ValueError("Invalid value for `result_version`, must be a value less than or equal to `1159116`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
