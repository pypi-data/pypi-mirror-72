...
class ShiftTariffConstraints(object):
    ...
    def __init__(self, stage_length=None, cost_per_unit=None, local_vars_configuration=None):  # noqa: E501
        """ShiftTariffConstraints - a model defined in OpenAPI"""  # noqa: E501
