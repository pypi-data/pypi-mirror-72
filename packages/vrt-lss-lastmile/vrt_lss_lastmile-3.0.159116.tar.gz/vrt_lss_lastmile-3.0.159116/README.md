...
*ConvertApi* | [**convert_to_lss**](docs/ConvertApi.md#convert_to_lss) | **POST** /lastmile/convert/lss | Конвертация из формата UD в формат LSS.
*ConvertApi* | [**convert_to_lss_form**](docs/ConvertApi.md#convert_to_lss_form) | **POST** /lastmile/convert/lss_form | Конвертация из формата UD в формат LSS.
