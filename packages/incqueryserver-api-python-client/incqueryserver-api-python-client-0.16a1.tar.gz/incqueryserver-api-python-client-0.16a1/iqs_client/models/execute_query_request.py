...
class ExecuteQueryRequest(object):
    ...
    def __init__(self, revision_descriptor=None, query_fqn=None, parameter_binding=None, use_osmc_links_for_elements=None, query_mode=None, local_vars_configuration=None):  # noqa: E501
