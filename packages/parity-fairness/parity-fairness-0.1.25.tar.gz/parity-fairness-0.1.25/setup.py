...
setup(
  ...
  version = '0.1.25', # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/xmpuspus/parity-fairness/archive/v_01.25.tar.gz', # I explain this later on
