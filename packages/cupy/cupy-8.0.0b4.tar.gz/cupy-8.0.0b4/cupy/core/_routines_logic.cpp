...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_4cupy_4cuda_6memory_MemoryPool = __Pyx_ImportType("cupy.cuda.memory", "MemoryPool", sizeof(struct __pyx_obj_4cupy_4cuda_6memory_MemoryPool), 1); if (unlikely(!__pyx_ptype_4cupy_4cuda_6memory_MemoryPool)) __PYX_ERR(2, 52, __pyx_L1_error)
  ...
  __pyx_ptype_4cupy_4cuda_6memory_CFunctionAllocatorMemory = __Pyx_ImportType("cupy.cuda.memory", "CFunctionAllocatorMemory", sizeof(struct __pyx_obj_4cupy_4cuda_6memory_CFunctionAllocatorMemory), 1); if (unlikely(!__pyx_ptype_4cupy_4cuda_6memory_CFunctionAllocatorMemory)) __PYX_ERR(2, 69, __pyx_L1_error)
  __pyx_ptype_4cupy_4cuda_6memory_CFunctionAllocator = __Pyx_ImportType("cupy.cuda.memory", "CFunctionAllocator", sizeof(struct __pyx_obj_4cupy_4cuda_6memory_CFunctionAllocator), 1); if (unlikely(!__pyx_ptype_4cupy_4cuda_6memory_CFunctionAllocator)) __PYX_ERR(2, 76, __pyx_L1_error)
  ...
  __pyx_ptype_4cupy_4cuda_8function_LinkState = __Pyx_ImportType("cupy.cuda.function", "LinkState", sizeof(struct __pyx_obj_4cupy_4cuda_8function_LinkState), 1); if (unlikely(!__pyx_ptype_4cupy_4cuda_8function_LinkState)) __PYX_ERR(3, 32, __pyx_L1_error)
  __pyx_vtabptr_4cupy_4cuda_8function_LinkState = (struct __pyx_vtabstruct_4cupy_4cuda_8function_LinkState*)__Pyx_GetVtable(__pyx_ptype_4cupy_4cuda_8function_LinkState->tp_dict); if (unlikely(!__pyx_vtabptr_4cupy_4cuda_8function_LinkState)) __PYX_ERR(3, 32, __pyx_L1_error)
  __pyx_ptype_4cupy_4core_7_carray_CArray = __Pyx_ImportType("cupy.core._carray", "CArray", sizeof(struct __pyx_obj_4cupy_4core_7_carray_CArray), 1); if (unlikely(!__pyx_ptype_4cupy_4core_7_carray_CArray)) __PYX_ERR(4, 20, __pyx_L1_error)
  ...
  __pyx_ptype_4cupy_4core_7_carray_CIndexer = __Pyx_ImportType("cupy.core._carray", "CIndexer", sizeof(struct __pyx_obj_4cupy_4core_7_carray_CIndexer), 1); if (unlikely(!__pyx_ptype_4cupy_4core_7_carray_CIndexer)) __PYX_ERR(4, 35, __pyx_L1_error)
  ...
  __pyx_ptype_4cupy_4core_7_carray_Indexer = __Pyx_ImportType("cupy.core._carray", "Indexer", sizeof(struct __pyx_obj_4cupy_4core_7_carray_Indexer), 1); if (unlikely(!__pyx_ptype_4cupy_4core_7_carray_Indexer)) __PYX_ERR(4, 42, __pyx_L1_error)
  ...
  __pyx_ptype_4cupy_4core_4core_ndarray = __Pyx_ImportType("cupy.core.core", "ndarray", sizeof(struct __pyx_obj_4cupy_4core_4core_ndarray), 1); if (unlikely(!__pyx_ptype_4cupy_4core_4core_ndarray)) __PYX_ERR(5, 10, __pyx_L1_error)
