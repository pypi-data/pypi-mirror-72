...
@jsii.data_type(jsii_type="cdk8s-plus.DeploymentSpec", jsii_struct_bases=[], name_mapping={'pod_metadata_template': 'podMetadataTemplate', 'pod_spec_template': 'podSpecTemplate', 'replicas': 'replicas'})
class DeploymentSpec():
    def __init__(self, *, pod_metadata_template: typing.Optional[cdk8s.ApiObjectMetadata]=None, pod_spec_template: typing.Optional["PodSpec"]=None, replicas: typing.Optional[jsii.Number]=None) -> None:
        ...
        if isinstance(pod_spec_template, dict): pod_spec_template = PodSpec(**pod_spec_template)
        self._values = {
        }
    ...
    @builtins.property
    def pod_spec_template(self) -> typing.Optional["PodSpec"]:
...
class DeploymentSpecDefinition(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.DeploymentSpecDefinition"):
    ...
    def __init__(self, *, pod_metadata_template: typing.Optional[cdk8s.ApiObjectMetadata]=None, pod_spec_template: typing.Optional["PodSpec"]=None, replicas: typing.Optional[jsii.Number]=None) -> None:
        ...
        :stability: experimental
        """
        props = DeploymentSpec(pod_metadata_template=pod_metadata_template, pod_spec_template=pod_spec_template, replicas=replicas)

        jsii.create(DeploymentSpecDefinition, self, [props])
    ...
    def pod_spec_template(self) -> "PodSpecDefinition":
...
@jsii.data_type(jsii_type="cdk8s-plus.JobSpec", jsii_struct_bases=[], name_mapping={'pod_metadata_template': 'podMetadataTemplate', 'pod_spec_template': 'podSpecTemplate', 'ttl_after_finished': 'ttlAfterFinished'})
class JobSpec():
    def __init__(self, *, pod_metadata_template: typing.Optional[cdk8s.ApiObjectMetadata]=None, pod_spec_template: typing.Optional["PodSpec"]=None, ttl_after_finished: typing.Optional["Duration"]=None) -> None:
...
class JobSpecDefinition(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.JobSpecDefinition"):
    """
    stability
    :stability: experimental
    """
    def __init__(self, *, pod_metadata_template: typing.Optional[cdk8s.ApiObjectMetadata]=None, pod_spec_template: typing.Optional["PodSpec"]=None, ttl_after_finished: typing.Optional["Duration"]=None) -> None:
        ...
        :stability: experimental
        """
        props = JobSpec(pod_metadata_template=pod_metadata_template, pod_spec_template=pod_spec_template, ttl_after_finished=ttl_after_finished)

        jsii.create(JobSpecDefinition, self, [props])
...
@jsii.data_type(jsii_type="cdk8s-plus.PodSpec", jsii_struct_bases=[], name_mapping={'containers': 'containers', 'restart_policy': 'restartPolicy', 'service_account': 'serviceAccount', 'volumes': 'volumes'})
class PodSpec():
...
class PodSpecDefinition(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.PodSpecDefinition"):
    ...
    def __init__(self, *, containers: typing.Optional[typing.List["Container"]]=None, restart_policy: typing.Optional["RestartPolicy"]=None, service_account: typing.Optional["IServiceAccount"]=None, volumes: typing.Optional[typing.List["Volume"]]=None) -> None:
        ...
        :stability: experimental
        """
        props = PodSpec(containers=containers, restart_policy=restart_policy, service_account=service_account, volumes=volumes)

        jsii.create(PodSpecDefinition, self, [props])
...
class Service(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.Service"):
    ...
    def spec(self) -> "ServiceSpecDefinition":
...
class ServiceProps(ResourceProps):
    def __init__(self, *, metadata: typing.Optional[cdk8s.ApiObjectMetadata]=None, spec: typing.Optional["ServiceSpec"]=None) -> None:
        ...
        """
        if isinstance(metadata, dict): metadata = cdk8s.ApiObjectMetadata(**metadata)
        if isinstance(spec, dict): spec = ServiceSpec(**spec)
        self._values = {
        }
        if metadata is not None: self._values["metadata"] = metadata
...
@jsii.data_type(jsii_type="cdk8s-plus.ServiceSpec", jsii_struct_bases=[], name_mapping={'cluster_ip': 'clusterIP', 'external_i_ps': 'externalIPs', 'ports': 'ports', 'type': 'type'})
class ServiceSpec():
...
class ServiceSpecDefinition(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.ServiceSpecDefinition"):
    ...
    def __init__(self, *, cluster_ip: typing.Optional[str]=None, external_i_ps: typing.Optional[typing.List[str]]=None, ports: typing.Optional[typing.List["ServicePort"]]=None, type: typing.Optional["ServiceType"]=None) -> None:
        ...
        :stability: experimental
        """
        props = ServiceSpec(cluster_ip=cluster_ip, external_i_ps=external_i_ps, ports=ports, type=type)

        jsii.create(ServiceSpecDefinition, self, [props])
...
class Deployment(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.Deployment"):
    ...
    @builtins.property
    @jsii.member(jsii_name="spec")
    def spec(self) -> "DeploymentSpecDefinition":
        """Provides access to the underlying spec.
...
class DeploymentProps(ResourceProps):
    def __init__(self, *, metadata: typing.Optional[cdk8s.ApiObjectMetadata]=None, spec: typing.Optional["DeploymentSpec"]=None) -> None:
        ...
        """
        if isinstance(metadata, dict): metadata = cdk8s.ApiObjectMetadata(**metadata)
        if isinstance(spec, dict): spec = DeploymentSpec(**spec)
        self._values = {
        }
        if metadata is not None: self._values["metadata"] = metadata
        if spec is not None: self._values["spec"] = spec
...
class Job(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.Job"):
    ...
    @builtins.property
    @jsii.member(jsii_name="spec")
    def spec(self) -> "JobSpecDefinition":
        """
        stability
        :stability: experimental
        """
...
class Pod(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus.Pod"):
    ...
    @builtins.property
    @jsii.member(jsii_name="spec")
    def spec(self) -> "PodSpecDefinition":
        """Provides access to the underlying spec.
...
class PodProps(ResourceProps):
    def __init__(self, *, metadata: typing.Optional[cdk8s.ApiObjectMetadata]=None, spec: typing.Optional["PodSpec"]=None) -> None:
        ...
        """
        if isinstance(metadata, dict): metadata = cdk8s.ApiObjectMetadata(**metadata)
        if isinstance(spec, dict): spec = PodSpec(**spec)
        self._values = {
        }
        if metadata is not None: self._values["metadata"] = metadata
        if spec is not None: self._values["spec"] = spec
