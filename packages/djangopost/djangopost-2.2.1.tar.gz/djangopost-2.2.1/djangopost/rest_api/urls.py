from djangopost.rest_api import viewsets as views 
...
urlpatterns = [
    ...
    re_path(r'^category/published/$', views.CategoryListPublishedViewset.as_view(), name='category_published_viewset'),
