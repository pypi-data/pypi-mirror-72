...
import cloudmersive_configuration_api_client.models
from cloudmersive_configuration_api_client import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cloudmersive_configuration_api_client.models, klass)
