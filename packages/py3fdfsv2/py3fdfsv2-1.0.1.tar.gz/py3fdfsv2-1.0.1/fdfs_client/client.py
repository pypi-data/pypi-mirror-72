...
class Fdfs_client(object):
    ...
    def upload_chunks_by_filename(self, filename: str, chunk_size=1024 * 500, max_retry_count=5):
            ...
            while buffer:
                ...
                while retry_count < max_retry_count:
                    try:
                        ...
                        retry_count += 1
                        log.exception('smart upload fail, retry now. fileid: %s, retry_count: %d, exception: %s',
                                      remote_fileid, retry_count, e)
