...
class Util:
  ...
  def get_component_set_by_id(self, component_set_id):
    component_set = self.cli_request('GET', self.build_url('{app}/iot/v1/component-sets/{component_set_id}',\
  ...
  def get_component_set_by_url_ref(self, url_ref):
    component_set_res = self.cli_request('GET', self.build_url('{app}/iot/v1/component-sets?urlRef={urlRef}', {'urlRef': url_ref}))
  ...
  def get_component_set_version_by_id(self, component_set_id, version_id):
    version = self.cli_request('GET', self.build_url('{app}/iot/v1/component-sets/{component_set_id}/versions/{version_id}',\
  ...
  def get_all_component_set_versions(self, component_set_id):
    versions = self.cli_request('GET', self.build_url('{app}/iot/v1/component-sets/{component_set_id}/versions',\
        {'component_set_id': component_set_id}))['payload']['data']

    return versions

  def get_all_collections(self):
    resp = self.cli_request('GET', self.build_url('{app}/iot/v1/experience-collections'))
    return resp['payload']['data']
  ...
  def get_collection(self, collection):
    try:
      ...
      resp = self.cli_request('GET',
          self.build_url('{app}/iot/v1/experience-collections?id={id}', {'id': collection_id})).get('payload', {}).get('data')
      ...
      resp = self.cli_request('GET',
          self.build_url('{app}/iot/v1/experience-collections?name={name}', {'name': collection})).get('payload', {}).get('data')
  ...
  def get_container_by_url_ref(self, url_ref, container_type):
    container_res = self.cli_request('GET', self.build_url('{app}/iot/v1/containers?urlRef={urlRef}&type={container_type}',\
  ...
  def get_all_container_versions(self, container_id):
    versions = self.cli_request('GET', self.build_url('{app}/iot/v1/containers/{container_id}/versions',\
  ...
  def get_container_by_id(self, container_id, container_type):
    version = self.cli_request('GET', self.build_url('{app}/iot/v1/containers/{container_id}?type={container_type}',\
  ...
  def get_container_version_by_id(self, container_id, version_id):
    version = self.cli_request('GET', self.build_url('{app}/iot/v1/containers/{container_id}/versions/{version_id}',\
