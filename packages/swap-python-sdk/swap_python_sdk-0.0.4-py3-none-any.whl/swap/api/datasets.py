...
class Dataset:
    def __init__(self, input_dataset, metadata=""):
    ...
    def to_dict(self):
        dataset_dict = {}
        dataset_dict['url'] = self.url
        dataset_dict['name'] = self.name
        dataset_dict['metadata'] = self.metadata
        return dataset_dict


class CDFDataset:
    def __init__(self, dataset_id, survey_id="N/A", metadata=""):
        if survey_id != "N/A":
