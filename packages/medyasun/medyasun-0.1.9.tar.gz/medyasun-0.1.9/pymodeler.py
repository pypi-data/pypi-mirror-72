...
def main (train,test,target,Id="None",n_r=0.6,s_r=0.75,c_r=1,n_f="full",t_s=0.25,r_s=42,replace="mm",cat_count=100,n=2):
...
#------------------------------------------all models--------------------------------------------------------------------------------------     
    ...
    my_models= [ 
               ...
               LogisticRegression(max_iter=500,random_state=r_s)
               ]
