...
def main (train,test,target,Id="None",n_r=0.6,s_r=0.75,c_r=1,n_f="full",t_s=0.25,r_s=42,replace="mm",cat_count=100,n=3,submission="False"):
...
#------------------------------------------all models--------------------------------------------------------------------------------------     
    ...
    my_models= [ 
               ...
               XGBClassifier(silent=False,scale_pos_weight=1,learning_rate=0.01,colsample_bytree = 0.4,subsample = 0.8,
