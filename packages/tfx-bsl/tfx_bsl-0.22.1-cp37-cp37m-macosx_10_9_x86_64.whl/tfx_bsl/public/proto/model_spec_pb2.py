...
InferenceSpecType = _reflection.GeneratedProtocolMessageType('InferenceSpecType', (_message.Message,), dict(
...
AIPlatformPredictionModelSpec = _reflection.GeneratedProtocolMessageType('AIPlatformPredictionModelSpec', (_message.Message,), dict(
