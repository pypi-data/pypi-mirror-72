...
def create_network():
    ...
    network = fastr.create_network(id='add_ints')
    ...
    source1.output >> node.inputs['left_hand']
...
def source_data(network):
    return {'source': [1, 'vfslist://example_data/add_ints/values', 'vfslist://example_data/add_ints/values', 'vfslist://example_data/add_ints/values']}
