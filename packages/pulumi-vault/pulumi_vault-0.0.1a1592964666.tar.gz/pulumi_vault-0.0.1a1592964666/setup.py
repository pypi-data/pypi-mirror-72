...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '0.0.1-alpha.1592964666+ea34c457'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 0.0.1-alpha.1592964666+ea34c457`
                """)
            else:
                raise
