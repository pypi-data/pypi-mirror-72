...
from threadPlotter.TP_structure.PathList import PathList
from threadPlotter.TP_utils.shapeEditing import pressIntoABox
from threadPlotter.TP_punchneedle import embroideryCalculation as EC
