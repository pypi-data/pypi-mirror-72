...
PKL_PATH=pkg_resources.resource_filename('threadPlotter', 'data/threadColor.pkl')
CSV_PATH=pkg_resources.resource_filename('threadPlotter', 'data/embroidery_thread_color.csv')
