...
@click.option('--end-date', 'end_date', default=None, help='Only show jobs before (and not including) this date')
...
@click.pass_context
def jobs(
    ctx, is_mine, user_name, is_all, is_latest, is_raw, is_page, status, start_date, end_date, num, job_filter, add_fields
):
