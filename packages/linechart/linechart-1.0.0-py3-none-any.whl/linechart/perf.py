...
class DailyPerformance(object):
    ...
    def __init__(
        ...
        self._cum_pnl = None
        self._average_holding_periods = None
    ...
    @property
    def average_holding_periods(self):
        if self._average_holding_periods is None:
            self._average_holding_periods = get_average_holding_periods(self.total_holdings)

        return self._average_holding_periods
