...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.2.0-alpha.1592974391+752a991e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.2.0-alpha.1592974391+752a991e`
                """)
            else:
                raise
