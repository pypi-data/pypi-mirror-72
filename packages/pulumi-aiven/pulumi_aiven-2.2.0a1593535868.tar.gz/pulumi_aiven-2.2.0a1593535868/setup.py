...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.2.0-alpha.1593535868+3d0e6adf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.2.0-alpha.1593535868+3d0e6adf`
                """)
            else:
                raise
