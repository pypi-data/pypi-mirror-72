...
class MagneticStirrer(Runnable):
    ...
    def __init__(self,
        ...
        self.set_up_save_files(save_path=save_path)
    ...
    def set_up_save_files(self, save_path: Path):
        self.save_path = save_path if save_path is not None else Path.cwd().joinpath('ika')
        file_name = self.save_path.name
        self.state_csv_path = self.save_path.with_name(f'{file_name}_state_data.csv')
        self.command_csv_path = self.save_path.with_name(f'{file_name}_command_data.csv')
        self.state_data: pd.DataFrame = None
        self.command_data: pd.DataFrame = None
        self.set_up_data()
