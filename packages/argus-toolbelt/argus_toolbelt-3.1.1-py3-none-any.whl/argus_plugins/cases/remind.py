...
def remind(subject: str, message: str, notify: list = None,
           ...
           customer: str = None, priority: utils.PRIORITIES = None, skip: SKIPABLES = None,
           start: date_or_relative = None, end: date_or_relative = None,
    ...
    cases = advanced_case_search(
        limit=0,
        type=case_type, service=service, status=status, priority=priority, customer=customer,
        startTimestamp=start, timeFieldStrategy=["createdTimestamp"],
        subCriteria=[{
            "endTimestamp": days,
