...
class AnalyticsApi(object):
    ...
    def analytics(self, analytics_task, **kwargs):  # noqa: E501
        ...
        Используется для получения [аналитической справки](https://docs.veeroute.com/#/lss/analytics) по результатам планирования  # noqa: E501
        ...
        :param AnalyticsTask analytics_task: Запрос на аналитику (required)
