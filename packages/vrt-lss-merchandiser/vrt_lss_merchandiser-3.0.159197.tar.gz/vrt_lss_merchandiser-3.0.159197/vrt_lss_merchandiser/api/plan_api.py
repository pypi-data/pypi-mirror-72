...
class PlanApi(object):
    ...
    def plan(self, plan_task, **kwargs):  # noqa: E501
        ...
        Создание рейсов для торгового представителя  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param PlanTask plan_task: Новый запрос на планирование (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def run_plan(self, plan_task, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param PlanTask plan_task: Запуск асинхронного планирования (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
