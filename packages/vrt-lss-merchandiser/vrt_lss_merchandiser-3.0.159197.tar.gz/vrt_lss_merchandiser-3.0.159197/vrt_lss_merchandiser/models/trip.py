...
class Trip(object):
    ...
    def key(self):
        ...
        Уникальный идентификатор рейса  # noqa: E501
    ...
    def actions(self):
        ...
        Список запланированных заказов  # noqa: E501
    ...
    def waitlist(self):
        ...
        Назначенные на исполнителя, но не запланированные на определенное время заказы  # noqa: E501
