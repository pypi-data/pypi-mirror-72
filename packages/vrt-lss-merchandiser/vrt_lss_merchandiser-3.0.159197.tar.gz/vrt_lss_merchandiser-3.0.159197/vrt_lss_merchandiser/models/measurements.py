...
class Measurements(object):
    ...
    def waiting_time(self):
        ...
        Суммарное время ожидания по всем локациям, в минутах. Для остановки - продолжительность ожидания исполнения работы на локациии в минутах.   # noqa: E501
    ...
    def arriving_time(self):
        ...
        Суммарное время на подъезд\\парковку на локациях, в минутах. Для остановки - время, затраченное на подъезд\\парковку на локации.   # noqa: E501
    ...
    def total_time(self):
        ...
        Суммарное время на остановку/рейс/совокупность рейсов, в минутах.        Складывается из driving_time + waiting_time + working_time + arriving_time + departure_time.    # noqa: E501
