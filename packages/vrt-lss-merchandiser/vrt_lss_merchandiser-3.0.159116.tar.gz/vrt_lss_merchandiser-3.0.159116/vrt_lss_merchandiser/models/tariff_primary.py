...
class TariffPrimary(object):
    ...
    def __init__(self, cost_per_shift=None, cost_per_meter=None, max_length=None, cost_per_minute=None, max_time=None, local_vars_configuration=None):  # noqa: E501
    ...
    def max_length(self, max_length):
        ...
        if (self.local_vars_configuration.client_side_validation and
                max_length is not None and max_length < 0.1):  # noqa: E501
            raise ValueError("Invalid value for `max_length`, must be a value greater than or equal to `0.1`")  # noqa: E501
    ...
    def max_time(self, max_time):
        ...
        if (self.local_vars_configuration.client_side_validation and
                max_time is not None and max_time < 0.1):  # noqa: E501
            raise ValueError("Invalid value for `max_time`, must be a value greater than or equal to `0.1`")  # noqa: E501
