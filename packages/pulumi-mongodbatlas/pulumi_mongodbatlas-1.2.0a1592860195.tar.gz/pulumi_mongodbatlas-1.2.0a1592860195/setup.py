...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.2.0-alpha.1592860195+f62bfc59'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.2.0-alpha.1592860195+f62bfc59`
                """)
            else:
                raise
