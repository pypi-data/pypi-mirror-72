...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '1.2.0-alpha.1593620168+ad578fb2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 1.2.0-alpha.1593620168+ad578fb2`
                """)
            else:
                raise
