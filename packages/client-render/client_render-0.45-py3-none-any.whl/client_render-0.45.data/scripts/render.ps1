...
Start-Process -FilePath "python" -ArgumentList "-m render.watch Corona $WatchDelay" -NoNewWindow -RedirectStandardOutput "${LogDir}\watch-out.log" -RedirectStandardError "${LogDir}\watch-err.log"
