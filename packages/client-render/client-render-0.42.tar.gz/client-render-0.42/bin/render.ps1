...
Start-Process -FilePath "python" -ArgumentList "-m render.watch $WatchDelay" -NoNewWindow -RedirectStandardOutput "${LogDir}\watch-out.log" -RedirectStandardError "${LogDir}\watch-err.log"
