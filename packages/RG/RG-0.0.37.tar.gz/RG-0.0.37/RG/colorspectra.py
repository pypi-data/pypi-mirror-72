...
def colorspectra(X,y,x_label='wavelength',y_label='intensity',colorbar_label='concentration',labelpad = 0):
    '''
    ...
    Y [n x 1] <numpy.ndarray> 
        spectra
    x_label, y_label, colorbar_label, labelpad [] <str> 
        optional inputs
        labels of x-axis, y-axis and colorbar
        labelpad is horizontal location of the label
    ...
    cbar.set_label(colorbar_label, labelpad, rotation=270)
