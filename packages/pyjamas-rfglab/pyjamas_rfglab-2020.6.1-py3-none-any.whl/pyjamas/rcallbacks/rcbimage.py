...
class RCBImage(RCallback):
    ...
    def cbCrop(self, polyline: numpy.ndarray = None, margin_size: int = 0, new_window: bool = False) -> bool:
        ...
        minx, miny, maxx, maxy = self.get_crop_bounds(coordinates=polyline, margin_size=margin_size)
    ...
    def get_crop_bounds(self, coordinates: numpy.ndarray = None, margin_size: int = 0):
