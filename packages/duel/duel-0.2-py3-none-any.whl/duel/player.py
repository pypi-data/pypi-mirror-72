...
class Player(pygame.sprite.DirtySprite):
    ...
    def moveLeft(self):
        if (self.getPlayerState("ghost_counter") > 300 or self.getPlayerState("ghost_counter") == -1):
            self.setPlayerState("x_velocity", self.getPlayerState("x_velocity") - 0.5)
            ...
            if self.getPlayerState("x_velocity") < -5:
                self.setPlayerState("x_velocity", -5)
        else:
    ...
    def calculateGravity(self, time):
        ...
        self.setPlayerState("y_velocity", self.getPlayerState("y_velocity") + 2 * (time - self.getPlayerState("air_time")))
    ...
    def jump(self, time):
        self.setPlayerState("y_velocity", - 7)
        self.setPlayerState("air_time", time)
