...
pause_buttons = {
    "play_button": duel.pauseButtons.PauseButton("Play"),
    "restart_button": duel.pauseButtons.PauseButton("Restart"),
    "exit_button": duel.pauseButtons.PauseButton("Exit")
}
...
def startGame(screen, map_selection, skin_selection1, skin_selection2):
    ...
    draw_buffer, my_sprites = duel.gameFrame.init(player1, player2, current_map, entities, pause_buttons)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_ESCAPE:
                    duel.mainMenuFrame.pauseMenu(screen, p1_meta_info, p2_meta_info, pause_buttons, draw_buffer, my_sprites)
