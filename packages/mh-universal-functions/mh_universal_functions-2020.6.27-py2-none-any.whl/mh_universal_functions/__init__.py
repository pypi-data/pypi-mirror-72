# Module                       : universal_function_module.py
...
# pymysql       external          0.9.3        0.9.3          -             print(pymysql.__version__)
...
def database_update_universal(mysql_const, row, table, value, id1, id1_value, id2, id2_value):
    ...
    try:
        ...
        db_connection.close()
        return True
    except (ConnectionRefusedError, err) as error_detail1:
...
# ToDO: think about adding _telegram_message_address to above module_logger message...
                ...
                return True
            except CalledProcessError as error_detail3:
