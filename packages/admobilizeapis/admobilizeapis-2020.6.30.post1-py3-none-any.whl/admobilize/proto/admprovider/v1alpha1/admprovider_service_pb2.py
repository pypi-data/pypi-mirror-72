...
_ADMPROVIDERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SendLogStream',
    full_name='admobilize.admprovider.v1alpha1.AdmproviderService.SendLogStream',
    index=11,
    containing_service=None,
