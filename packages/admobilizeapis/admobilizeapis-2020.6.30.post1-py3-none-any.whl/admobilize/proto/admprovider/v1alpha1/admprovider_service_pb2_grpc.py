...
class AdmproviderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendLogStream = channel.stream_unary(
                '/admobilize.admprovider.v1alpha1.AdmproviderService/SendLogStream',
...
class AdmproviderServiceServicer(object):
    ...
    def SendLogStream(self, request_iterator, context):
        """Send log stream
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_AdmproviderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendLogStream': grpc.stream_unary_rpc_method_handler(
                    servicer.SendLogStream,
...
class AdmproviderService(object):
    ...
    @staticmethod
    def SendLogStream(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/admobilize.admprovider.v1alpha1.AdmproviderService/SendLogStream',
