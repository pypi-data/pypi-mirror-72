...
class WordCloud(object):
    ...
    def __init__(self, font_path=None, width=400, height=200, margin=2,
        ...
        print("You are using the custom version yippie! This text changed time to parteeey!")
    ...
    def generate_from_frequencies(self, frequencies, max_font_size=None):  # noqa: C901
        ...
        for word, freq in frequencies:
            ...
            while True:
                ...
                font = ImageFont.truetype(io.BytesIO(self.font_path), font_size)
    ...
    def to_image(self):
        ...
        for (word, count), font_size, position, orientation, color in self.layout_:
            font = ImageFont.truetype(io.BytesIO(self.font_path),
    ...
    def to_svg(self, embed_font=False, optimize_embedded_font=True, embed_image=False):
        ...
        font = ImageFont.truetype(io.BytesIO(self.font_path), int(max_font_size * self.scale))
        ...
        if embed_font:
            ...
            ttf = fontTools.subset.load_font(io.BytesIO(self.font_path), options)
        ...
        for (word, count), font_size, (y, x), orientation, color in self.layout_:
            ...
            # Get text metrics
            font = ImageFont.truetype(io.BytesIO(self.font_path), int(font_size * self.scale))
