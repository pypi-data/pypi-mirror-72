...
class SupportedModels:
    ...
    class Classification:
        ...
        need to specify the algorithms directly. Use the ``whitelist_models`` and
        ``blacklist_models`` parameters of :class:`azureml.train.automl.automlconfig.AutoMLConfig` class
    ...
    class Forecasting(Regression):
        ...
        Azure supports these regression algorithms, but you as a user do not
        need to specify the algorithms. Use the ``whitelist_models`` and
        ``blacklist_models`` parameters of :class:`azureml.train.automl.automlconfig.AutoMLConfig` class
        to include or exclude models.
