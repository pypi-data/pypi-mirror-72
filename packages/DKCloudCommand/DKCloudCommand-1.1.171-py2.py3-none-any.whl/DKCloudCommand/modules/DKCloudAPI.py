...
class DKCloudAPI:
    ...
    def delete_kitchen(self, existing_kitchen_name: Optional[str], message: Optional[str]) -> DKReturnCode:
        return convert_return_code(self._api_helper.delete_kitchen(existing_kitchen_name, message=message))
