...
class PlanResult(object):
    ...
    def trips(self):
        ...
        Расписание рейсов, назначенных на исполнителей.  # noqa: E501
    ...
    def unplanned_orders(self):
        ...
        Список незапланированных заказов  # noqa: E501
    ...
    def progress(self):
        ...
        Прогресс планирования в процентах. Прогресс отражает текущее количество завершенных шагов.   # noqa: E501
