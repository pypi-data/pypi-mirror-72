...
class PlanInfo(object):
    ...
    def result_version(self):
        ...
        Версия результата планирования.  # noqa: E501
    ...
    def result_version(self, result_version):
        ...
        if (self.local_vars_configuration.client_side_validation and
                result_version is not None and result_version > 1159197):  # noqa: E501
            raise ValueError("Invalid value for `result_version`, must be a value less than or equal to `1159197`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def planning_time(self):
        ...
        Время фактического планирования, в минутах.  # noqa: E501
    ...
    def waiting_time(self):
        ...
        Время подготовки к планированию, в минутах.  # noqa: E501
