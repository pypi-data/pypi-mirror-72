...
class OrderCost(object):
    ...
    def reward(self):
        ...
        Базовое вознаграждение за выполнение данного заказа. Из вознаграждения вычитаются штрафы за невыполнение заказа вовремя.   # noqa: E501
    ...
    def reward(self, reward):
        ...
        if (self.local_vars_configuration.client_side_validation and
                reward is not None and reward > 1159197):  # noqa: E501
            raise ValueError("Invalid value for `reward`, must be a value less than or equal to `1159197`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
