...
class CostPenalty(object):
    ...
    def start_time(self):
        ...
        Время в соответствии с [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6), с которого начинает действовать штраф.  # noqa: E501
    ...
    def period(self):
        ...
        Период в минутах, по истечении которого сумма штрафа увеличивается на value.  # noqa: E501
    ...
    def value(self):
        ...
        Стоимость, на которую увеличивается штраф каждый period.  # noqa: E501
    ...
    def value(self, value):
        ...
        if (self.local_vars_configuration.client_side_validation and
                value is not None and value > 1159197):  # noqa: E501
            raise ValueError("Invalid value for `value`, must be a value less than or equal to `1159197`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def max_value(self):
        ...
        Максимально возможное значение штрафа.  # noqa: E501
    ...
    def max_value(self, max_value):
        ...
        if (self.local_vars_configuration.client_side_validation and
                max_value is not None and max_value > 1159197):  # noqa: E501
            raise ValueError("Invalid value for `max_value`, must be a value less than or equal to `1159197`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
