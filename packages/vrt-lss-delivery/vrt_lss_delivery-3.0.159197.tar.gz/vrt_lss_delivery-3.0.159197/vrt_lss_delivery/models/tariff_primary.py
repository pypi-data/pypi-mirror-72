...
class TariffPrimary(object):
    ...
    def __init__(self, cost_per_shift=0, cost_per_meter=0, max_length=11591970, cost_per_minute=0, max_time=43800, local_vars_configuration=None):  # noqa: E501
    ...
    def cost_per_shift(self, cost_per_shift):
        ...
        if (self.local_vars_configuration.client_side_validation and
                cost_per_shift is not None and cost_per_shift > 1159197):  # noqa: E501
            raise ValueError("Invalid value for `cost_per_shift`, must be a value less than or equal to `1159197`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def max_length(self, max_length):
        ...
        if (self.local_vars_configuration.client_side_validation and
                max_length is not None and max_length > 11591970):  # noqa: E501
            raise ValueError("Invalid value for `max_length`, must be a value less than or equal to `11591970`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
