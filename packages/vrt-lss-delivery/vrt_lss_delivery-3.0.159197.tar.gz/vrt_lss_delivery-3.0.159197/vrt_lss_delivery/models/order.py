...
class Order(object):
    ...
    def key(self):
        ...
        Ключ заказа, уникальный идентификатор.  # noqa: E501
    ...
    def warehouse_keys(self):
        ...
        Список ключей возможных складов для забора или доставки груза.  # noqa: E501
    ...
    def cargos(self):
        ...
        Список грузов. Все указанные грузы берутся из одной точки и доставлются на другую точку одним исполнителем за один рейс.   # noqa: E501
    ...
    def warehouse_duration(self):
        ...
        Среднее время на загрузку всех грузов одного заказа, в минутах.  # noqa: E501
    ...
    def customer_duration(self):
        ...
        Среднее время на выгрузку всех грузов одного заказа, в минутах.  # noqa: E501
    ...
    def restrictions(self):
        ...
        Список необходимых требований к исполнителю. Используется для проверки совместимости исполнителя и заказа (работы).   # noqa: E501
    ...
    def blacklist(self):
        ...
        Список требований, наличие которых у исполнителя не допустимо. Используется для проверки совместимости исполнителя и заказа (работы).   # noqa: E501
