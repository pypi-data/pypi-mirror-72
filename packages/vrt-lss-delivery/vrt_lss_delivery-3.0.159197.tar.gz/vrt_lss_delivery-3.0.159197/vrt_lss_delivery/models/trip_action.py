...
class TripAction(object):
    ...
    def warehouse_key(self):
        ...
        Ключ точки (склад или клиента), на которой производится действие. Если ключ указан - значит действие происходит на складе, если не указан - у клиента.   # noqa: E501
