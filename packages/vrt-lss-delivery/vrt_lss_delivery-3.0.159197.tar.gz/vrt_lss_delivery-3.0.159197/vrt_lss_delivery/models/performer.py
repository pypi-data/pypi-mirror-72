...
class Performer(object):
    ...
    def count(self):
        ...
        Количество одинаковых исполнителей в данной группе  # noqa: E501
    ...
    def features(self):
        ...
        Список возможностей исполнителя. Используется для проверки совместимости исполнителя с заказами.   # noqa: E501
    ...
    def shifts(self):
        ...
        Список смен исполнителя  # noqa: E501
