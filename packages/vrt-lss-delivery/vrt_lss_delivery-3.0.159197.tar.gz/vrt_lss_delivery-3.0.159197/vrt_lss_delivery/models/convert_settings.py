...
class ConvertSettings(object):
    ...
    def route_index_from(self):
        ...
        Порядковый номер маршрута, с которого нужно начать конвертацию. Если не указан - конвертация начинается с первого маршрута.   # noqa: E501
    ...
    def route_index_to(self):
        ...
        Порядковый номер маршрута, на котором нужно закончить конвертацию.  Если не указан - конвертация заканчивается на последнем маршруте.   # noqa: E501
