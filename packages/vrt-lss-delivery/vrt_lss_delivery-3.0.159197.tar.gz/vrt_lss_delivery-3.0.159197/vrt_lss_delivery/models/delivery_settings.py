...
class DeliverySettings(object):
    ...
    def restrict_middle_warehouses(self):
        ...
        Запретить заезжать в середине рейса на склад - всегда начинать и\\или заканчивать рейс на складе.  # noqa: E501
    ...
    def restrict_multiple_warehouses(self):
        ...
        Запретить исполнителю в одном рейсы заезжать больше, чем на один склад. Работает только в том случае, когда у всех заказов один склад. Если у одного из заказов указано больше одного склада и включена эта опция, то валидация будет выдавать ошибку.   # noqa: E501
    ...
    def restrict_multiple_order_types(self):
        ...
        Запретить в одном рейсе возить заказы с типом PICKUP совместо с типом DROP.   # noqa: E501
