...
class Statistics(object):
    ...
    def cost(self):
        ...
        Суммарные затраты, которые считаются на базе тарифов исполнителей и транспорта. Суммарная стоимость при этом равна разнице между суммарным вознаграждением (reward) и расходами (cost).   # noqa: E501
    ...
    def reward(self):
        ...
        Суммарное вознаграждение за выполнение заказов.  # noqa: E501
