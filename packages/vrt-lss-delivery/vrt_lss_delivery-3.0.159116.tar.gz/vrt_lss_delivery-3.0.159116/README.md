# vrt_lss_delivery
Программный интерфейс для планирования задач курьерской доставки

This Python package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:

- API version: 3.0.159116
- Package version: 3.0.159116
...
with vrt_lss_delivery.ApiClient(configuration) as api_client:
    ...
    analytics_task = vrt_lss_delivery.AnalyticsTask() # AnalyticsTask | Запрос на аналитику
...
------------ | ------------- | ------------- | -------------
*AnalyticsApi* | [**analytics**](docs/AnalyticsApi.md#analytics) | **POST** /delivery/analytics/xlsx | Аналитика результатов планирования
*ConvertApi* | [**convert_to_json**](docs/ConvertApi.md#convert_to_json) | **POST** /delivery/convert/json | Конвертация задачи и результата планирования
*ConvertApi* | [**convert_to_xlsx**](docs/ConvertApi.md#convert_to_xlsx) | **POST** /delivery/convert/xlsx | Конвертация задачи и результата планирования
*PlanApi* | [**delete_result**](docs/PlanApi.md#delete_result) | **DELETE** /delivery/result/{id} | Удаление результата планирования
*PlanApi* | [**get_result**](docs/PlanApi.md#get_result) | **GET** /delivery/result/{id} | Получение результата планирования
*PlanApi* | [**plan**](docs/PlanApi.md#plan) | **POST** /delivery/plan | Планирование, синхронный вызов.
*PlanApi* | [**run_plan**](docs/PlanApi.md#run_plan) | **POST** /delivery/run_plan | Запуск процесса планирования
*PredictApi* | [**predict**](docs/PredictApi.md#predict) | **POST** /delivery/predict | Подсказка временного окна
*SystemApi* | [**check**](docs/SystemApi.md#check) | **GET** /delivery/check | Проверка доступности сервиса
*SystemApi* | [**version**](docs/SystemApi.md#version) | **GET** /delivery/version | Получение версии сервиса
*ValidateApi* | [**validate**](docs/ValidateApi.md#validate) | **POST** /delivery/validate | Валидация данных для планирования
