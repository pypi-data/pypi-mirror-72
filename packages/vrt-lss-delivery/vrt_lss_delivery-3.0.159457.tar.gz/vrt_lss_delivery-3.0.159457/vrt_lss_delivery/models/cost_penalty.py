...
class CostPenalty(object):
    ...
    def value(self, value):
        ...
        if (self.local_vars_configuration.client_side_validation and
                value is not None and value > 1159457):  # noqa: E501
            raise ValueError("Invalid value for `value`, must be a value less than or equal to `1159457`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def max_value(self, max_value):
        ...
        if (self.local_vars_configuration.client_side_validation and
                max_value is not None and max_value > 1159457):  # noqa: E501
            raise ValueError("Invalid value for `max_value`, must be a value less than or equal to `1159457`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
