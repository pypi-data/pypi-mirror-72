...
class NameBookmark(PypeVal):
    ...
    '''
    def __init__(self,name,storedVal):

        self.bookmarkName=name
        self.storedVal=storedVal


    def stored_val(self):

        return self.storedVal
    ...
    def val(self):
        ...
        return NameBookmark(self.bookmarkName,self.storedVal)


    def __repr__(self):

        return f"NameBookmark(bookmarkName='{self.bookmarkName}',storedVal={str(self.storedVal)})"
