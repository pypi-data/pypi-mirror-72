...
def merge_dcts_ls(*dctLS):

    return reudce(dct_merge_ls_vals,dctLS)
...
'''
def dct_merge_ls_rec(dct1,dct2):
    ...
    for (k,v) in dct2.items():
        ...
        if k in dct1:
            ...
            if isinstance(v,list) and isinstance(dct1[k],list):
