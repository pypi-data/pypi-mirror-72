...
def test_audit_logs(db):
    ...
    assert logs == [
        ...
        "/tmp/dir/file,dst/file,completed,False,,,File Skipped\n",
        "/tmp/dir2/file2,dst/file2,failed,True,UNKNOWN,Unknown error,File Skipped\n",
        ...
        "/tmp/dir5/file5,dst/file5,failed,False,UNKNOWN,Foo bar error message,File Skipped\n",
        "/tmp/dir6/file6,dst/file6,skipped,False,UNKNOWN,Skipped due to erroneous parent container,File Skipped\n",
    ]
