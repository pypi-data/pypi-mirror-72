...
class _CalibrationTestHash(object):
    def __init__(self, desired_begin_at=None):
        ...
        self.valid_inject_01 = _CalibrationTestHash._build_valid_test_hash_01(
            desired_begin_at)
        self.valid_inject_by_det_01 = _CalibrationTestHash._build_valid_test_hash_03(
            desired_begin_at)
        self.valid_search_01 = _CalibrationTestHash._build_valid_test_hash_02(
            desired_begin_at)
        self.valid_search_by_det_01 = _CalibrationTestHash._build_valid_test_hash_04(
            desired_begin_at)
    ...
    def _build_valid_hash(ccv_valid_dt, flg_mode):
        ...
        ccv_h = {
            ...
            # If pdu_physical_name is present, detector_identifier and pdu_karabo_da are ignored
