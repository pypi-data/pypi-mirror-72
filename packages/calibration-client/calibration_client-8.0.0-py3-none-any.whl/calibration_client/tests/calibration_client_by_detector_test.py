...
class CalibrationClientByDetectorTest(ModuleBase, unittest.TestCase):
    ...
    def test_inject_new_calibration_constant_version(self):
        ...
        assert resp_ccv['flg_good_quality'] == True
        ...
        assert resp_ccv['flg_deployed'] == True
        ...
        assert resp_cc['flg_available'] == True
        assert resp_cc['flg_auto_approve'] == True
        ...
        assert resp_pd['flg_available'] == True
    ...
    def test_retrieve_calibration_constant_version(self):
        ...
        assert resp_ccv['name'] == expected_return['name']
        assert resp_ccv['flg_good_quality'] == True

        assert resp_ccv['begin_validity_at'] == expected_return[
            'begin_validity_at']
        assert resp_ccv['end_validity_at'] == expected_return['end_validity_at']
        assert resp_ccv['begin_at'] == expected_return['begin_at']

        assert resp_ccv['flg_deployed'] == True
        assert resp_ccv['raw_data_location'] == expected_return[
            'raw_data_location']
        assert resp_ccv['file_name'] == expected_return['file_name']
        assert resp_ccv['path_to_file'] == expected_return['path_to_file']
        assert resp_ccv['description'] == expected_return['description']
        # Special cases...
        assert resp_ccv['data_set_name'] == expected_return['data_set_name']
        assert resp_ccv['start_idx'] == expected_return['start_idx']
        assert resp_ccv['end_idx'] == expected_return['end_idx']
        ...
        expected_return_pd = expected_return['physical_detector_unit']
    ...
    def test_retrieve_all_calibration_constant_versions(self):
        ...
        assert resp_ccv_0['name'] == self.existing_db_06['name']
        assert resp_ccv_0['flg_good_quality'] == self.existing_db_06[
            'flg_good_quality']

        assert resp_ccv_0['begin_validity_at'] == self.existing_db_06[
            'begin_validity_at']
        assert resp_ccv_0['end_validity_at'] == self.existing_db_06[
            'end_validity_at']
        assert resp_ccv_0['begin_at'] == self.existing_db_06['begin_at']

        assert resp_ccv_0['flg_deployed'] == self.existing_db_06['flg_deployed']
        assert resp_ccv_0['raw_data_location'] == self.existing_db_06[
            'raw_data_location']
        assert resp_ccv_0['file_name'] == self.existing_db_06['file_name']
        assert resp_ccv_0['path_to_file'] == self.existing_db_06['path_to_file']
        assert resp_ccv_0['description'] == self.existing_db_06['description']
        # Special cases...
        assert resp_ccv_0['data_set_name'] == self.existing_db_06[
            'data_set_name']
        assert resp_ccv_0['start_idx'] == self.existing_db_06['start_idx']
        assert resp_ccv_0['end_idx'] == self.existing_db_06['end_idx']

        # Calibration Constant info
        assert resp_ccv_0['calibration_constant']['id'] == self.existing_db_06[
            'calibration_constant_id']

        # Physical Device info
        assert resp_ccv_0['physical_detector_unit']['id'] == \
               self.existing_db_06['physical_detector_unit_id']

        #
        # Calibration Constant Version info (position 1)
        resp_ccv_1 = response_data[1]

        assert resp_ccv_1['name'] == self.existing_db_05['name']
        assert resp_ccv_1['flg_good_quality'] == self.existing_db_05[
            'flg_good_quality']

        assert resp_ccv_1['begin_validity_at'] == self.existing_db_05[
            'begin_validity_at']
        assert resp_ccv_1['end_validity_at'] == self.existing_db_05[
            'end_validity_at']
        assert resp_ccv_1['begin_at'] == self.existing_db_05['begin_at']

        assert resp_ccv_1['flg_deployed'] == self.existing_db_05['flg_deployed']
        assert resp_ccv_1['raw_data_location'] == self.existing_db_05[
            'raw_data_location']
        assert resp_ccv_1['file_name'] == self.existing_db_05['file_name']
        assert resp_ccv_1['path_to_file'] == self.existing_db_05['path_to_file']
        assert resp_ccv_1['description'] == self.existing_db_05['description']
        # Special cases...
        assert resp_ccv_1['data_set_name'] == self.existing_db_05[
            'data_set_name']
        assert resp_ccv_1['start_idx'] == self.existing_db_05['start_idx']
        assert resp_ccv_1['end_idx'] == self.existing_db_05['end_idx']

        # Calibration Constant info
        assert resp_ccv_1['calibration_constant']['id'] == self.existing_db_05[
            'calibration_constant_id']

        # Physical Device info
        assert resp_ccv_1['physical_detector_unit']['id'] == \
               self.existing_db_05['physical_detector_unit_id']
    ...
    def test_retrieve_ccv_no_data_found(self):
        ...
        resp = self.cal_client.retrieve_calibration_constant_version(retrieve_h)
    ...
    def test_update_calibration_constant_version(self):
        ...
        assert resp_failed['success'] == False
    ...
    def test_retrieve_all_phy_det_units_from_detector(self):
        ...
        assert resp_pdus[0]['id'] == exp_pdu_0['id']
        assert resp_pdus[0]['physical_name'] == exp_pdu_0['physical_name']
        assert resp_pdus[0]['detector_type_id'] == exp_pdu_0['detector_type_id']
        assert resp_pdus[0]['detector_id'] == exp_pdu_0['detector_id']
        assert resp_pdus[0]['karabo_da'] == exp_pdu_0['karabo_da']
        ...
        assert resp_pdus[1]['id'] == exp_pdu_1['id']
        assert resp_pdus[1]['physical_name'] == exp_pdu_1['physical_name']
        assert resp_pdus[1]['detector_type_id'] == exp_pdu_1['detector_type_id']
        assert resp_pdus[1]['detector_id'] == exp_pdu_1['detector_id']
        assert resp_pdus[1]['karabo_da'] == exp_pdu_1['karabo_da']
        ...
        assert resp_pdus[2]['id'] == exp_pdu_2['id']
        assert resp_pdus[2]['physical_name'] == exp_pdu_2['physical_name']
        assert resp_pdus[2]['detector_type_id'] == exp_pdu_2['detector_type_id']
        assert resp_pdus[2]['detector_id'] == exp_pdu_2['detector_id']
        assert resp_pdus[2]['karabo_da'] == exp_pdu_2['karabo_da']
