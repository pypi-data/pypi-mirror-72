...
def test_error_val_to_api_bool():
    # String
    assert Util.val_to_api_bool('False') == "Error: Value False is of type <class 'str'>"
    assert Util.val_to_api_bool('True') == "Error: Value True is of type <class 'str'>"

    # Double
    assert Util.val_to_api_bool(0.000000223232) == "Error: Value 2.23232e-07 is of type <class 'float'>"
