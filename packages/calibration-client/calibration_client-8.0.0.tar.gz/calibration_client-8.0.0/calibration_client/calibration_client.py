...
class CalibrationClient(CalibrationApi,
    ...
    def retrieve_calibration_constant_version_by_pdu(self,
        ...
        #  - closest_by_pdu (default)
        #  - exactly_contained_by_pdu
        #  - closest_by_detector [ERROR! <= Not available in this method!]
        ...
        if ret_strategy == 'exactly_contained_by_pdu':
            ...
            error_msg = 'Strategy "closest_by_detector" not available in ' \
                        'retrieve_calibration_constant_version'
            logging.error(error_msg)
            return resp
    ...
    def retrieve_calibration_constant_version_by_detector(self,
        ...
        # Retrieve the desired retrieve Strategy
        # OPTIONS:
        #  - closest_by_pdu  [ERROR! <= Not available in this method!]
        #  - exactly_contained_by_pdu [ERROR! <= Not available in this method!]
        #  - closest_by_detector (default)
        ...
        # Get calibration_constant_version
        if ret_strategy == 'exactly_contained_by_pdu':
            error_msg = 'Strategy "exactly_contained_by_pdu" not available' \
                        'in retrieve_calibration_constant_version_by_detector'
            logging.error(error_msg)
            return resp

        elif ret_strategy == 'closest_by_pdu':
            error_msg = 'Strategy "closest_by_pdu" not available in' \
        ...
        # if ret_strategy == '' or
        #    ret_strategy is None or
        #    ret_strategy == 'closest_by_detector':
        else:
