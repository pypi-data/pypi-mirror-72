...
class OSAsset(object):
	...
	"""
	The <a:schema>OSAsset</a:schema> must have os_asset_mime_type = text/plain
	for template values to be replaced with variable and secret's values.
	Streamed OSAsset files (an OSAsset referencing a file through a HTTP URL)
	will not function as templates at all.
	"""
	os_asset_variable_names_required = [];
