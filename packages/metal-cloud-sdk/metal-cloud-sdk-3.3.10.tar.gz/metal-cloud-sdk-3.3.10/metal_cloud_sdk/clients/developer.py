...
class Developer(Client):
	...
	""" 936 functions available on endpoint. """
	...
	def server_update_ipmi_credentials(self, nServerID, strIPMIHostname, strIPMIUsername, strIPMIPassword):
	...
	def tftpserver_agent_os_templates_os_assets_updated(self, nAgentID, arrChanges = None):
	...
	def os_template_add_os_asset(self, nOSTemplateID, nOSAssetID, strOSAssetFilePath):
	...
	def query_agent_for_metric_datapoints_multidc(self, strTarget, strFrom, strFormat = None, strUntil = None):
	...
	def os_template_make_public(self, nOSTemplateID):
		...
		objVolumeTemplate = self.rpc("os_template_make_public", arrParams)
		for strKeyVolumeTemplate in objVolumeTemplate:
			objVolumeTemplate[strKeyVolumeTemplate] = Deserializer.deserialize(objVolumeTemplate[strKeyVolumeTemplate])
		return objVolumeTemplate
	...
	def os_template_make_private(self, nOSTemplateID, strUserIDOwner):
		...
		objVolumeTemplate = self.rpc("os_template_make_private", arrParams)
		for strKeyVolumeTemplate in objVolumeTemplate:
			objVolumeTemplate[strKeyVolumeTemplate] = Deserializer.deserialize(objVolumeTemplate[strKeyVolumeTemplate])
		return objVolumeTemplate
	...
	def infrastructure_monitoring_data_get(self, nInfrastructureID, nGranularityMinutes = 1, strTimestampStart = None, strTimestampEnd = None):
		...
		return self.rpc("infrastructure_monitoring_data_get", arrParams)
