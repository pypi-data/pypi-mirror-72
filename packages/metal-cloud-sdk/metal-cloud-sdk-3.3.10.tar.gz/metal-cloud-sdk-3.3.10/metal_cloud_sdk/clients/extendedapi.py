...
class ExtendedAPI(Client):
	...
	""" 391 functions available on endpoint. """
	...
	def server_efibootmgr_cleanup(self, nServerID):
	...
	def server_ipmi_users_and_networking_cleanup(self, nServerID):
	...
	def server_interfaces_cleanup(self, nServerID):
	...
	def server_networking_intel_cleanup(self, nServerID):
	...
	def server_disks_cleanup(self, nServerID):
