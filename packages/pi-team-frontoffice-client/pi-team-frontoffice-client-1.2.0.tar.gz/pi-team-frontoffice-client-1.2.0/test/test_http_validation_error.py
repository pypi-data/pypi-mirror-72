...
import frontoffice
from frontoffice.models.http_validation_error import HTTPValidationError  # noqa: E501
...
class TestHTTPValidationError(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = frontoffice.models.http_validation_error.HTTPValidationError()  # noqa: E501
        if include_optional :
            return HTTPValidationError(
                detail = [
                    frontoffice.models.validation_error.ValidationError(
                        loc = [
                            '0'
                            ], 
                        msg = '0', 
