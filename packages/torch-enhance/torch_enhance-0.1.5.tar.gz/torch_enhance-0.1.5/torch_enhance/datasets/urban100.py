...
from .base import URBAN100_URL, BaseDataset


@dataclass()
class Urban100(BaseDataset):
    ...
    def __post_init__(self):
        ...
        self.url = URBAN100_URL
        self.extensions = [".png"]

        if self.data_dir == "":
            self.data_dir = os.path.join(os.getcwd(), self.base_dir)

        self.root_dir = os.path.join(self.data_dir, "urban100")
        self.download_google_drive(self.data_dir, filename="urban100.zip")
